...
local bindPhone = class("bindPhone", function ()
...
bindPhone.ctor = function (self)
	...
	res.get2("pic/panels/activity/bdbg.png"):anchor(0, 0):addto(self):pos(20, 20)
...
bindPhone.showView = function (self)
	local content = json.decode(res.getfile("config/bindPhone.txt"))

	dump(res.getfile("config/bindPhone.txt"))
	...
	local offY = 6
	local descLabel_1 = an.newLabelM(1000, 20, 1).anchor(slot4, 0, 0.5):pos(55, offY + 270):add2(self.bg)

	extractInfo(descLabel_1, content.ADis1)

	local descLabel_2 = an.newLabelM(1000, 20, 1):pos(55, offY + 228):anchor(0, 0.5):add2(self.bg)

	extractInfo(descLabel_2, content.ADis2)

	local descLabel_3 = an.newLabelM(1000, 20, 1):pos(55, offY + 186):anchor(0, 0.5):add2(self.bg)

	extractInfo(descLabel_3, content.ADis3)

	local descLabel_4 = an.newLabelM(1000, 20, 1):pos(55, offY + 144):anchor(0, 0.5):add2(self.bg)

	extractInfo(descLabel_4, content.ADis4)
