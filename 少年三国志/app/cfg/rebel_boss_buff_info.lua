...
---@classdef record_rebel_boss_buff_info
...
rebel_boss_buff_info = {
   _data = {
    [1] = {1,"魏国","魏将伤害+300%","所有上阵的魏国武将伤害加成+300%","ui/text/txt/zhenying_wei_xuanzhong.png","ui/text/txt/zhenying_wei.png",4301,},
    [2] = {2,"蜀国","蜀将伤害+300%","所有上阵的蜀国武将伤害加成+300%","ui/text/txt/zhenying_shu_xuanzhong.png","ui/text/txt/zhenying_shu.png",4302,},
    [3] = {3,"吴国","吴将伤害+300%","所有上阵的吴国武将伤害加成+300%","ui/text/txt/zhenying_wu_xuanzhong.png","ui/text/txt/zhenying_wu.png",4303,},
    [4] = {4,"群雄","群雄伤害+300%","所有上阵的群雄武将伤害加成+300%","ui/text/txt/zhenying_qun_xuanzhong.png","ui/text/txt/zhenying_qun.png",4304,},
    }
}
...
---
--@return @class record_rebel_boss_buff_info
...
function rebel_boss_buff_info.get(id)
    ...
    return rebel_boss_buff_info.indexOf(__index_id[id])
