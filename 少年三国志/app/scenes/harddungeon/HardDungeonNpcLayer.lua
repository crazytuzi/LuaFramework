local HardDungeonNpcLayer = class("HardDungeonNpcLayer", UFCCSModelLayer)

function HardDungeonNpcLayer.create(bgTexture, ...)
    return DungeonNpcLayer.new("ui_layout/dungeon_DungeonNpc.json",nil,bgTexture, ...)
end


function HardDungeonNpcLayer:ctor(json,color,bgTexture,...)
...
function HardDungeonNpcLayer:onLayerEnter(...)
...
function HardDungeonNpcLayer:onTouchEnd()
...
function HardDungeonNpcLayer:_onBack(widget)
    if widget:getOpacity() > 0 then

    end
end

function HardDungeonNpcLayer:_onLeave(widget)
    if widget:getOpacity() > 0 then
     self:close()
    end
end

function HardDungeonNpcLayer:onLayerExit()
end

return HardDungeonNpcLayer
