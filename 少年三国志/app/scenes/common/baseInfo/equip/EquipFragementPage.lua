...
local EquipFragementPage = class("EquipFragementPage", KnightPageBase)

function EquipFragementPage.create(...)
	return KnightPageBase._create_(EquipFragementPage.new(...), "ui_layout/BaseInfo_EquipFragement.json", ...)
end

function EquipFragementPage.delayCreate(...)
	local page = KnightPageBase._create_(EquipFragementPage.new(...), nil, ...)
	page:delayLoad("ui_layout/BaseInfo_EquipFragement.json")

	return page
end

function EquipFragementPage:ctor( baseId, fragmentId, scenePack,... )
...
function EquipFragementPage:afterLayerLoad( ... )
	...
	if icon ~= nil then
		local heroPath = G_Path.getEquipmentIcon(fragmentInfo.res_id)
...
function EquipFragementPage:_initAcquireWays( fragmentInfo )
