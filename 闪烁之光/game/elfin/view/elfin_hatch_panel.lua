...
function ElfinHatchPanel:initView(  )
    ...
    self.elfin_book_txt:setString(_string_format(TI18N("<div href=xxx >精灵图鉴 </div><img src='%s'/>"), PathTool.getResFrame("elfin","elfin_1016")))
...
function ElfinHatchItem:configUI(  )
    ...
    self.egg_name:setString(TI18N("灵窝"))
    ...
    self.open_lab = createLabel(20,cc.c4b(0x7a,0xfa,0x6d,0xff),cc.c4b(0x19,0x3b,0x17,0xff),100,100,"",self.main_container,2, cc.p(0.5,0.5))
