...
function ElfinSelectItemWindow:open_callback(  )
	...
	self.label_tip_2 = createRichLabel(20, cc.c4b(120, 80, 70, 255), cc.p(1, 0.5), cc.p(636, 138), nil, nil, 400)
    ...
    if item_cfg then
		...
		if cell_root and item_cfg.id == 10602 then--奇紫蛋增加合成按钮
			if cell.hc_btn == nil then
				cell.hc_btn = createButton(cell_root,TI18N("合成"), 620, 580, cc.size(105, 54), PathTool.getResFrame("common", "common_1027"), 24, Config.ColorData.data_color4[1])
				cell.hc_btn:setPosition(cell_root:getContentSize().width / 2, -70)
				cell.hc_btn:enableOutline(Config.ColorData.data_color4[264], 2)
