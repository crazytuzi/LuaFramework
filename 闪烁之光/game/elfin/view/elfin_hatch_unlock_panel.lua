...
function ElfinHatchUnlockItem:configUI(  )
	self.size = cc.size(575, 50)
	self:setTouchEnabled(false)
    self:setContentSize(self.size)

    self.lock_desc = createLabel(24,cc.c4b(0x95,0x53,0x22,0xff),nil,20,self.size.height/2,"",self,nil, cc.p(0,0.5))
    self.status_tips = createLabel(24,cc.c4b(0x95,0x53,0x22,0xff),nil,500,self.size.height/2,"",self,nil, cc.p(0,0.5))
end
...
function ElfinHatchUnlockItem:setData( data )
    ...
    if isLock == true then
        self.lock_desc:setTextColor(cc.c4b(0x95,0x53,0x22,0xff))
        self.status_tips:setTextColor(cc.c4b(0x95,0x53,0x22,0xff))
        self.status_tips:setString(TI18N("未达成"))
    else
        self.lock_desc:setTextColor(cc.c4b(0x24,0x90,0x23,0xff))
        self.status_tips:setTextColor(cc.c4b(0x24,0x90,0x23,0xff))
