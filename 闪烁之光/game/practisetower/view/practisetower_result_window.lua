...
function PractiseTowerResultWindow:open_callback()
	...
	self.time_label = createRichLabel(22, 1, cc.p(0.5, 0.5), cc.p(self.root_wnd:getContentSize().width / 2 + 5,420), nil, nil, 1000)
	...
	self.fight_text = createLabel(24, cc.c4b(0xff,0xee,0xac,0xff), nil, 360, 455, "",self.source_container, nil, cc.p(0.5,0.5))

	self.tips_lab = createLabel(24, cc.c4b(0xff,0xee,0xac,0xff), nil, 360, 250, "",self.source_container, nil, cc.p(0.5,0.5))
	...
	self.pass_time = createRichLabel(24, 31, cc.p(0.5, 0.5), cc.p(360, 415), nil, nil, 1000)
	self.pass_time:setString(TI18N("本次造成伤害：0"))
	self.source_container:addChild(self.pass_time) 


	local label  = createRichLabel(22,31, cc.p(0.5, 0.5), cc.p(360,368), nil, nil, 1000)
	...
	self.cancel_btn = createButton(self.root_wnd,TI18N("重新挑战"), 620, 580, cc.size(162, 62), PathTool.getResFrame("common", "common_1018"), 24, Config.ColorData.data_color4[1])
	...
	self.fight_num = createLabel(24, cc.c4b(0xff,0xee,0xac,0xff), nil, self.root_wnd:getContentSize().width / 2 + 170, 420, "",self.root_wnd, nil, cc.p(0.5,0.5))
end
