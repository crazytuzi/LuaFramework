...
function HallowsTraceWindow:open_callback()
    ...
    main_panel:getChildByName("win_title"):setString(TI18N("圣印"))
	...
	self.cost_item:setPosition(336, 290)
	main_panel:addChild(self.cost_item)

    self.can_use_label = createRichLabel(24, 175, cc.p(0.5,0), cc.p(338, 370), nil, nil, 400) 
