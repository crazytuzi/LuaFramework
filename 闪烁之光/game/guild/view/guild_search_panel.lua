...
function GuildSearchPanel:ctor(ctrl)
    ...
    self.guild_value = createEditBox(self.search_container, res, cc.size(327, 50), nil, 18, Config.ColorData.data_color4[1], 22, TI18N("请输入需要查找的内容"), nil, nil, LOADTEXT_TYPE_PLIST)
