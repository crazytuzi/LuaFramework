...
function MergeSignPanel:configUI()
	...
	self.root_wnd:setPosition(cc.p(-40,-60))
    ...
    for i=1, 7 do
        ...
        tab.rewardItem = BackPackItem.new(true, true, false, 0.8)
...
function MergeSignPanel:createList( data )
    ...
    for k,v in ipairs(data_list) do
	    ...
	    self.touchTotleDay[k].rewardItem:setGoodsName(Config.ItemData.data_get_data(bid).name,nil,20,274)
