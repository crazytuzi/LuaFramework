...
function ActionLimitCommonItem2:configUI(  )
    ...
    if self.action_id == ActionLimitYuanZhenPanel.action_yuanzhen_id then
        ...
        self.title_desc = createRichLabel(22, cc.c4b(0x64,0x32,0x23,0xff), cc.p(0,0.5), cc.p(14,129), nil, nil, 400)
        main_container:addChild(self.title_desc)

        self.goal_desc = createRichLabel(26, cc.c4b(0x93,0x53,0x22,0xff), cc.p(0.5,0.5), cc.p(596,127), nil, nil, 400)
        main_container:addChild(self.goal_desc)

        self.time_desc = createRichLabel(22, cc.c4b(0x93,0x53,0x22,0xff), cc.p(0.5,0.5), cc.p(594,24), nil, nil, 400)
        ...
        self.btn_goto:setPositionY(76)
        self.btn_get:setPositionY(76)
        self.btn_has:setPositionY(76)


        self.Image_1:setVisible(false)
        --标题
        self.title_desc = createRichLabel(28, cc.c4b(0x64,0x32,0x23,0xff), cc.p(0,0.5), cc.p(148,100), nil, nil, 400)
        main_container:addChild(self.title_desc)
        --小标题
        self.little_desc = createRichLabel(22, cc.c4b(0x95,0x53,0x22,0xff), cc.p(0,1), cc.p(148,72), nil, nil, 320)
