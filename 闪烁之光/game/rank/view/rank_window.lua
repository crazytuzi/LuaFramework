...
function RankWindow:open_callback()
    ...
    self.four_label = createRichLabel(24, Config.ColorData.data_color4[175],cc.p(0.5,0.5), cc.p(370,35), 0, 0, 500)
	self.my_rank:addChild(self.four_label)
    self.my_rank_power = createLabel(24,Config.ColorData.data_color4[175],nil,528,35,"",self.my_rank,0, cc.p(0.5,0.5))

    self.my_head = PlayerHead.new(PlayerHead.type.circle)
    self.my_head:setHeadLayerScale(0.9)
    self.my_head:setPosition(160, 60)
    self.my_rank:addChild(self.my_head)

    self.no_rank = createLabel(24,Config.ColorData.data_color4[175],nil,62,45,TI18N("未上榜"),self.my_rank,0, cc.p(0.5,0.5))
    self.my_name = createLabel(24,Config.ColorData.data_color4[175],nil,285,56,"",self.my_rank,0, cc.p(0.5,0.5))
    ...
    if self.click_index == RankConstant.RankType.elite then
        ...
        local btn = createButton(self.my_rank, TI18N('查看结算奖励'), 509, 60, cc.size(179, 54), PathTool.getResFrame('common', 'common_1018'), 26,cc.c4b(0x25,0x55,0x05,0xff))
...
function RankWindow:updateMyData()
    ...
    if my_idx and my_idx >= 1 and my_idx <= 3 then
        ...
        self.my_rank_icon:loadTexture(PathTool.getResFrame("common","common_200"..my_idx),LOADTEXT_TYPE_PLIST)
    ...
    elseif self.click_index == RankConstant.RankType.union then 
        str = string.format(TI18N("<div fontsize=20 fontcolor=#a95f0f>会长名：%s</div>"),data.leader_name)
        ...
        self.my_head:setVisible(false)
        self.four_label:setPosition(cc.p(215,45))
        ...
        self.my_rank_power:setPositionX(535)
    elseif self.click_index == RankConstant.RankType.tower or self.click_index == RankConstant.RankType.action_tower  then 
        ...
        str = data.my_val1 or ""
        self.four_label:setPosition(cc.p(430,53))
