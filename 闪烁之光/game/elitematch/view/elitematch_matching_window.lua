...
function ElitematchMatchingWindow:open_callback(  )
    ...
    self.buy_tips = createRichLabel(20, cc.c4b(0xff,0xf8,0xbf,0xff), cc.p(0.5,0.5), cc.p(578.41,126), nil, nil, 600)
