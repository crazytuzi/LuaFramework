...
function ElitematchOrderactionUntieRewardWindow:open_callback()
    ...
    local label_lock = createRichLabel(22, cc.c4b(0x2b, 0x19, 0x5e, 0xff), cc.p(0.5, 0.5), cc.p(305, 360), nil, nil, 400)
    local str = string.format(TI18N("<div fontcolor=#ffecac >激活王者赠礼，立即解锁</div><div fontcolor=#0DFD00 >4阶</div><div fontcolor=#ffecac >奖励！</div>"))
