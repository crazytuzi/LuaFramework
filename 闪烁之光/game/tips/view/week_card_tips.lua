...
function WeekCardTips:open_callback()
	...
	--标题说明
	self.tips_desc = createRichLabel(22, cc.c4b(0xff,0xff,0xf8,0xff), cc.p(0,0.5), cc.p(15,378), nil, nil, 400)
...
function WeekCardTips:setGoodsData(index, bid, num, pos, text_pos)
    ...
    local name_text = createLabel(22,cc.c4b(0xff,0xee,0xdd,0xff),nil,text_pos[1],text_pos[2],"",self.main_panel,nil, cc.p(0,0.5))
