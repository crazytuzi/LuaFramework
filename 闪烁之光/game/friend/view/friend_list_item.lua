...
function FriendListItem:updateMyFriend()
    ...
    if not self.my_friend then 
        ...
        self.send_btn = createButton(self.my_friend, "", 445, 55,nil, res)
        ...
        local str = TI18N("私聊")
        self.chat_btn = createButton(self.my_friend, str, 545, 55, cc.size(96,53), res, 24, Config.ColorData.data_color4[1])
...
function FriendListItem:updateAwardPanel()
    if not self.award_panel then 
        ...
        local res = PathTool.getResFrame("common","common_1027")
        local str = TI18N("回礼")
        self.return_btn = createButton(self.award_panel, str, 545, 57, cc.size(96,53), res, 24, Config.ColorData.data_color4[1])
...
function FriendListItem:updateApplyPanel()
    if not self.apply_panel then 
        ...
        local res = PathTool.getResFrame("common","common_1027")
        local str = TI18N("拒绝")
        self.cancel_btn = createButton(self.apply_panel, str, 435, 55, cc.size(96,53), res, 24, Config.ColorData.data_color4[1])
        ...
        local res = PathTool.getResFrame("common","common_1027")
        local str = TI18N("接受")
        self.ok_btn = createButton(self.apply_panel, str, 545, 55, cc.size(96,53), res, 24, Config.ColorData.data_color4[1])
...
function FriendListItem:updateBlackPanel()
    if not self.black_panel then 
        ...
        local res = PathTool.getResFrame("common","common_1027")
        local str = TI18N("移除")
        self.del_btn = createButton(self.black_panel, str, 545, 57, cc.size(96,53), res, 24, Config.ColorData.data_color4[1])
...
function FriendListItem:updateRecommendPanel()
    if not self.recommend_panel then 
        ...
        self.add_btn = createButton(self.recommend_panel, str, 537, 57, cc.size(127,53), res, 24, Config.ColorData.data_color4[1])
