...
function HeroController:registerProtocals()
    ...
    self:RegisterProtocal(11009, "handle11009")     --购买英雄数量上限
    ...
    self:RegisterProtocal(11015, "handle11015")     --英雄锁定
    ...
    self:RegisterProtocal(11040, "handle11040")     --英雄图鉴信息
    self:RegisterProtocal(11060, "handle11060")     --英雄图鉴信息

    self:RegisterProtocal(11063, "handle11063")     --英雄详细信息

    self:RegisterProtocal(11075, "handle11075")     --请求英雄遣散 分解材料
    self:RegisterProtocal(11087, "handle11087")     --请求英雄升星的材料
    self:RegisterProtocal(11076, "handle11076")     --英雄遣散 分解
    ...
    self:RegisterProtocal(11099, "handle11099")     --获取英雄天赋信息
    ...
    self:RegisterProtocal(25224, "handle25224")     --应用方案到英雄
    ...
    self:RegisterProtocal(26423, "handle26423")     --计算赋能英雄战力"
    self:RegisterProtocal(26424, "handle26424")     --弹出获得的赋能英雄"

    self:RegisterProtocal(26425, "handle26425")     --水晶信息"
    self:RegisterProtocal(26426, "handle26426")     --放入共鸣英雄"
    self:RegisterProtocal(26427, "handle26427")     --卸下共鸣英雄"
    ...
    self:RegisterProtocal(26431, "handle26431")     --请求水晶升级后的共鸣英雄总战力"
    ...
    self:RegisterProtocal(11066, "handle11066")     --英雄回退返回材料"

    --重生(针对 100级一下的英雄)
    self:RegisterProtocal(11067, "handle11067")     --英雄重生信息
    self:RegisterProtocal(11068, "handle11068")     --英雄重生
...
--打开英雄图书馆信息根据bid 和星级 is_hide_ui:是否隐藏上下部分的UI
