    ...
    elseif num >= 10 then
        ...
        if new_num > 0 then
            if star_setting.star_label == nil then
                ...
                star_setting.star_label = createLabel(12,Config.ColorData.data_color4[1],Config.ColorData.data_color4[9],size.width * 0.5 - 2, size.height * 0.5,"10",star_setting.star_icon, 1, cc.p(0.5,0.5))
            else
