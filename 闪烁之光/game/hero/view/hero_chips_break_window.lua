...
function HeroChipsBreakWindow:open_callback()
    ...
    self.disband_btn_lable:setString(TI18N("碎片分解"))
    ...
    self.title_img:getChildByName("label"):setString(TI18N("碎片分解"))
    ...
    -- self.fuse_btn_label:setString(string_format("<div fontcolor=#ffffff>%s</div><div href=xxx>%s</div> ", TI18N("该碎片满足召唤英雄所需,是否"), TI18N("召唤英雄->")))
