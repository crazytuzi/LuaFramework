...
function HeroResonatePutDownPanel:open_callback()
    ...
    self.title:setString(TI18N("卸下英雄"))
    ...
    self.tips2:setString(TI18N("离开<div fontcolor=#ff0000>原力水晶</div>英雄等级将被还原"))
    ...
    self.tips3:setString(string_format(TI18N("<div fontcolor=#249003>%s</div>后槽位可以重新添加英雄"), str))
    --底部线
