...
function HeroResetWindow:loadResResources(index)
    ...
    elseif _index == HeroConst.SacrificeType.eHeroSacrifice then --英雄献祭资源
        self.res_list = {
    ...
    elseif _index == HeroConst.SacrificeType.eHeroDisband then                                                                  --英雄回退资源
        self.res_list = {
...
function HeroResetWindow:updateTab(hero_vo)
    ...
    if partner_const.hero_return_limit then
        if role_vo.lev >= partner_const.hero_return_limit.val then     -- 是否开启英雄回退
...
function HeroResetWindow:createPanel( index, hero_vo )
    ...
    if panel == nil then
        ...
        elseif index == HeroConst.SacrificeType.eHeroDisband then -- 英雄回退    
