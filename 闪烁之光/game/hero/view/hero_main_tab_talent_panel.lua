...
function HeroMainTabTalentPanel:layoutUI()
    ...
    if self.skill_item_list[3] then
        ...
        self.skill_bg_item_load = loadSpriteTextureFromCDN(skill_bg, bg_res, ResourcesType.single, self.skill_bg_item_load) 
    end
    --目前写死第二个
        ...
        self.bg:setPositionY(242)
         ...
         for i,v in ipairs(self.skill_item_list) do
            if i == 3 then
                ...
                v.skill_panel:setPositionY(266)
            end
        end
