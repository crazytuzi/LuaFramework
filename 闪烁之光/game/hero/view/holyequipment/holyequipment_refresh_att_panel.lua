...
function HolyequipmentRefreshAttPanel:open_callback(  )
    ...
    self.checkbox_tips = createRichLabel(22, cc.c4b(0xff,0xf2,0xc7,0xff), cc.p(1, 0.5), cc.p(638, 551), nil, nil, 380)
    container:addChild(self.checkbox_tips)
    --基础属性值
    self.base_att_label = createRichLabel(24, cc.c4b(0x64,0x32,0x23,0xff), cc.p(0, 0.5), cc.p(200, 625), nil, nil, 380)
    ...
    self.reset_count_tips = createRichLabel(22, cc.c4b(0x64,0x32,0x23,0xff), cc.p(0, 0.5), cc.p(20, 35), nil, nil, 380)
...
function HolyequipmentRefreshAttPanel:createAttInfo(x, y, container)
    local item_info =  {}
    item_info.att_label = createRichLabel(24, cc.c4b(0x64,0x32,0x23,0xff), cc.p(0, 0.5), cc.p(x, y), nil, nil, 720)
    item_info.value_lable = createRichLabel(24, cc.c4b(0x64,0x32,0x23,0xff), cc.p(0, 0.5), cc.p(x + 300, y), nil, nil, 380)
    ...
    local bg,comp_bar = createLoadingBar(res, res1, size, container, cc.p(0.5,0.5), x + 210, y, true, true)
...
function HolyequipmentRefreshAttPanel:setBaseAttrInfo(  )
    ...
    if res then
        local tips = TI18N("不变")
        local attr_str = string_format("<img src='%s' scale=1 /><div fontcolor=#643223> %s：%s </div><div fontcolor=#955322>(%s)</div>", res, attr_name, attr_val, tips)
