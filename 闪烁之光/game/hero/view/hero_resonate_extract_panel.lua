...
function HeroResonateExtractPanel:open_callback(  )
    ...
    self.txt_value_1 = createRichLabel(20, cc.c4b(0x64,0x32,0x23,0xff), cc.p(0,0.5),cc.p(500, 521),nil,nil,1900)
    self.txt_value_2 = createRichLabel(20, cc.c4b(0x64,0x32,0x23,0xff), cc.p(0,0.5),cc.p(480, 492),nil,nil,1900)
