...
function RoleSetNameView:open_callback(  )
    ...
    self.invite_code_edit = createEditBox(self.main_panel, PathTool.getResFrame("common", "common_1021"), cc.size(280, 50), cc.c4b(0x95,0x95,0x95,0xff), 26, cc.c4b(0x95,0x95,0x95,0xff), 26, str, nil, 12, LOADTEXT_TYPE_PLIST)
    ...
    -- 名字输入框
    self.input_edit = createEditBox(self.main_panel, PathTool.getResFrame("common", "common_1021"), cc.size(340, 50), Config.ColorData.data_color3[175], 24, Config.ColorData.data_color3[151], 24, placeholder, nil, 6, LOADTEXT_TYPE_PLIST)
