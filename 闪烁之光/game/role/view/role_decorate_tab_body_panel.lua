...
-- <br/> 2019年8月16日
-- --------------------------------------------------------------------
RoleDecorateTabBodyPanel = class("RoleDecorateTabBodyPanel", function()
...
function RoleDecorateTabBodyPanel:changeTabType(index, check_repeat_click)
    ...
    if self.cur_tab ~= nil then
        self.cur_tab.label:setTextColor(cc.c4b(0xff,0xf4,0xe4,0xff))
    ...
    if self.cur_tab ~= nil then
        self.cur_tab.label:setTextColor(cc.c4b(0x64,0x32,0x23,0xff))
