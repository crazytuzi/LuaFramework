...
function BattlDramaQuickBattleWindow:open_callback()
    ...
    self.quick_btn = createButton(self.main_container, TI18N("快速作战"), self.main_container:getContentSize().width/2,426, cc.size(220, 64), PathTool.getResFrame("common", "common_1017"), 26, Config.ColorData.data_color4[1])
