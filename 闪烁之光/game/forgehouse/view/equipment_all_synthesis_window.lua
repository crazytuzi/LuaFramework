...
function EquipmentAllSynthesisWindow:open_callback()
	...
	main_container:getChildByName("Image_7"):getChildByName("Text_6"):setString(TI18N("一键合成"))
    ...
    self.comp_coin_num = createRichLabel(26, cc.c4b(0x64,0x32,0x23,0xff), cc.p(0,0.5), cc.p(43,377), nil, nil, 600)
