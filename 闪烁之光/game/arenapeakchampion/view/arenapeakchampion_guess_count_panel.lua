...
function ArenapeakchampionGuessCountPanel:open_callback()
    ...
    self.guess_title = createRichLabel(26, cc.c4b(0x64,0x32,0x23,0xff), cc.p(0.5, 0.5), cc.p(312,306),nil,nil,1000)
    container:addChild(self.guess_title)
    self.tips = createRichLabel(26, cc.c4b(0x64,0x32,0x23,0xff), cc.p(0.5, 0.5), cc.p(312,260),nil,nil,1000)
