...
function MailWindow:open_callback()
    ...
    self.empty_label = createLabel(26,Config.ColorData.data_color4[274],nil,self.emptyTips:getContentSize().width/2,-35,TI18N("暂时没有邮件"),self.emptyTips,0, cc.p(0.5,0))
    local setting = {
