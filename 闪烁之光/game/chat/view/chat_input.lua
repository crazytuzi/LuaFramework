...
function ChatInput:initView()
    ...
    self.edit_box = createEditBox(self, PathTool.getResFrame("mainui", "mainui_chat_input_bg"),editSize, nil, 22, cc.c4b(0x7a,0x60,0x41,0xff), 20, self.default_msg, nil, nil, LOADTEXT_TYPE_PLIST, nil, nil--[[, cc.KEYBOARD_RETURNTYPE_SEND]])
    ...
    self.link_btn = CustomButton.New(self.edit_box,PathTool.getResFrame("mainui", "mainui_chat_face_icon"),nil,nil,LOADTEXT_TYPE_PLIST)
