...
function PrivateChatPanel:showNoPeople(bool)
    if not self.no_people then
        ...
        self.no_people =  createLabel(24,Config.ColorData.data_color4[66],nil,self.cose_list:getContentSize().width/2+1.5, self.no_img:getPositionY()-90,TI18N("暂时没有人说话"),self)
