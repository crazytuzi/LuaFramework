...
function GuildskillLevelUpPanel:open_callback()
    ...
    self.skill_desc = createRichLabel(24, cc.c3b(0x64,0x32,0x23), cc.p(0, 1), cc.p(168, 433), nil, nil, 460)

    self.next_skill_desc = createRichLabel(24, cc.c3b(0x24,0x90,0x03), cc.p(0, 1), cc.p(168, 298), nil, nil, 460)
...
function GuildskillLevelUpPanel:openRootWnd(career)
    ...
    if pvp_skill_config then
        ...
        self.skill_item:showName(true,skill_config.name,nil,22,false,cc.c4b(0x64,0x32,0x23,0xff),PathTool.getResFrame("common","common_90003"),cc.size(168,31))
