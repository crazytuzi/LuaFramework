...
-- <br/>Create: 2020-1-4
-- --------------------------------------------------------------------
ContactServicePanel = ContactServicePanel or ContactServicePanel(BaseView)

function ContactServicePanel:__init( url)
    -- self.url = url
...
function ContactServicePanel:open_callback()
...
-- function ContactServicePanel:layoutWebView()
...
-- function ContactServicePanel:register_event()
...
function ContactServicePanel:setMessage(url)
...
function ContactServicePanel:setWebViewUrl(url)
...
function ContactServicePanel:addNoticeContent(list)
...
function ContactServicePanel:createSubContent(x, y, content, width, linespace)
...
-- function ContactServicePanel:close_callback()
