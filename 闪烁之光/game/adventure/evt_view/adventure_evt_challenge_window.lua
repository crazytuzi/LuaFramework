...
function AdventureEvtChallengeWindow:open_callback()
    ...
    container:getChildByName("change_title"):setString(TI18N("选择英雄"))
    ...
    self.cur_hero_item:setPosition(158, 447)
    ...
    self.target_hero_item:setPosition(560, 447)
    ...
    self.fight_label:setPosition(103, 30)
    ...
    self.checkbox_skip:setPosition(280,359)
...
function AdventureEvtChallengeWindow:createHeroList()
    ...
    for i,v in ipairs(hero_list) do
        ...
        if self.hero_list[i] == nil then
            ...
            self.hero_list[i]:setPosition(110 + (i-1)* 124, 206)
