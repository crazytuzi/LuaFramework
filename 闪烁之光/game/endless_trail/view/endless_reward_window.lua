...
function EndlessRewardWindow:open_callback(...)
    ...
    if not self.sub_tab_scrollview then
        ...
        self.sub_tab_scrollview = CommonSubBtnList.new(self.btn_panel, cc.p(0, 0.5), cc.p(0, panel_size.height * 0.5), cc.size(142, 50), handler(self, self.changeSelectedTab))
    end
