...
function CrossarenaHonourPanel:createRoorWnd(  )
    ...
    bottom_panel:getChildByName("title_max_rank"):setString(TI18N("历史最高排名:"))
    ...
    if not self.check_award_txt then
    	self.check_award_txt = createRichLabel(26, 1, cc.p(0.5, 0.5), cc.p(558, 328))
    	self.check_award_txt:setString(string.format(TI18N("<img src='%s' scale=1 /><div href=xxx fontcolor=#fff8bf outline=2,#000000 >奖励预览</div>"), PathTool.getResFrame("common", "common_1093")))
