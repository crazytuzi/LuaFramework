...
function CrossarenaRoleTips:open_callback(  )
    ...
    self.role_head:setPosition(cc.p(95, 931))
    ...
    self.my_role_head:setPosition(cc.p(95, 466))
        ...
        for n=1,5 do
            ...
            delayRun(self.container, delay_time, function (  )
                ...
                if hero_data then
                    ...
                    hero_item:setPosition(cc.p(230+(n-1)*(HeroExhibitionItem.Width*0.7+10), 352 - (i-1)*100))
