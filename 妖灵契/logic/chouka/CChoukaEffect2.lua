local CChoukaEffect2 = class("CChoukaEffect2", CEffect)

function CChoukaEffect2.ctor(self, iShape, layer, cached, cb)
	local path =  "Effect/UI/ui_eff_6200/Prefabs/ui_eff_6200_pr_02.prefab"
	...
	self.m_Shape = iShape or 301
end

function CChoukaEffect2.OnEffLoadExt(self)
...
function CChoukaEffect2.OnTextureLoadDone(self, asset, path)
...
function CChoukaEffect2.OnEffLoad(self, oClone, sPath)
	if oClone then
...
function CChoukaEffect2.SetParent(self, mTransform)
	if mTransform then
		CObject.SetParent(self, mTransform)
	end
end

-- function CChoukaEffect2.GetParentTransform(self)
-- 	return nil
-- end

return CChoukaEffect2