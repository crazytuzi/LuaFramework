local CTerraWarOrgRewardPage = class("CTerraWarOrgRewardPage", CPageBase)

function CTerraWarOrgRewardPage.ctor(self, cb)
	CPageBase.ctor(self, cb)
end

function CTerraWarOrgRewardPage.OnInitPage(self)
...
function CTerraWarOrgRewardPage.InitContent(self)
...
function CTerraWarOrgRewardPage.InitTotalTable(self)
	self:InitOrgBox()
...
function CTerraWarOrgRewardPage.InitOrgBox(self)
