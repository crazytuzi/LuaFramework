local CUIEffectTrail = class("CUIEffectTrail", CObject)

function CUIEffectTrail.ctor(self, oAttach, size, pos)
	...
	g_ResCtrl:LoadCloneAsync("Effect/UI/ui_eff_1110/Prefabs/ui_eff_1110.prefab", callback(self, "OnEffLoad"), false)
end 

function CUIEffectTrail.OnEffLoad(self, oClone, sPath)
...
function CUIEffectTrail.RecaluatePanelDepth(self)
	if self.m_Eff then
		self.m_Eff.m_RenderQComponent:RecaluatePanelDepth()
	end
end

return CUIEffectTrail