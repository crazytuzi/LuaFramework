...
DATA={
	...
	cmds={
		...
		[4]={
			args={sound_path=[[Magic/sound_magic_100401_1.wav]],sound_rate=1,},
			func_name=[[PlaySound]],
			start_time=0,
		},
		[5]={args={},func_name=[[MagcAnimStart]],start_time=0.5,},
		[6]={
		...
		[7]={
			args={
				...
				effect={
					is_cached=true,
					magic_layer=[[center]],
					path=[[Effect/Magic/magic_eff_1004/Prefabs/magic_eff_100401_att.prefab]],
					preload=true,
				},
		...
		[10]={args={},func_name=[[End]],start_time=1.45,},
	},
	group_cmds={},
	magic_anim_end_time=1.3,
	magic_anim_start_time=0.5,
	pre_load_res={[1]=[[Effect/Magic/magic_eff_1004/Prefabs/magic_eff_100401_att.prefab]],},
	run_env=[[war]],
	type=1,
	wait_goback=true,
}
