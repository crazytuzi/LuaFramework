...
DATA={
	...
	cmds={
		...
		[3]={
			args={
				...
				effect={
					is_cached=true,
					magic_layer=[[center]],
					path=[[Effect/Magic/magic_eff_403/Prefabs/magic_eff_40302_att.prefab]],
					preload=true,
				},
		...
		[6]={
			args={sound_path=[[Magic/sound_magic_40302_1.wav]],sound_rate=1,},
			func_name=[[PlaySound]],
			start_time=0.5,
		},
		[7]={
		...
		[9]={args={},func_name=[[MagcAnimEnd]],start_time=1.7,},
		[10]={
			args={
	...
	pre_load_res={
		[1]=[[Effect/Magic/magic_eff_403/Prefabs/magic_eff_40302_att.prefab]],
