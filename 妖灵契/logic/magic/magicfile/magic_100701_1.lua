...
DATA={
	...
	cmds={
		...
		[5]={
			args={sound_path=[[Magic/sound_magic_100701_1.wav]],sound_rate=1,},
			func_name=[[PlaySound]],
			start_time=0,
		},
		[6]={
		...
		[13]={args={},func_name=[[MagcAnimEnd]],start_time=0.8,},
	...
	pre_load_res={
		[1]=[[Effect/Magic/magic_eff_1007/Prefabs/magic_eff_100701_hit.prefab]],
