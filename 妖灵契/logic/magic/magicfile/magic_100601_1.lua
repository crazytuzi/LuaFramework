...
DATA={
	...
	cmds={
		...
		[3]={
			args={sound_path=[[Magic/sound_magic_100601_1.wav]],sound_rate=1,},
			func_name=[[PlaySound]],
			start_time=0,
		},
		[4]={
		...
		[5]={args={},func_name=[[MagcAnimStart]],start_time=0.55,},
		[6]={
		...
		[7]={
			args={
				...
				effect={
					is_cached=true,
					magic_layer=[[center]],
					path=[[Effect/Magic/magic_eff_1006/Prefabs/magic_eff_100601_att.prefab]],
					preload=true,
				},
	...
	magic_anim_start_time=0.55,
	pre_load_res={
		[1]=[[Effect/Magic/magic_eff_1006/Prefabs/magic_eff_100601_att.prefab]],
