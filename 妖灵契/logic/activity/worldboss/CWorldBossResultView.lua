local CWorldBossResultView = class("CWorldBossResultView", CViewBase)

function CWorldBossResultView.ctor(self, cb)
	CViewBase.ctor(self, "UI/Activity/WorldBoss/WorldBossResultView.prefab", cb)
	self.m_ExtendClose = "Black"
end

function CWorldBossResultView.OnCreateView(self)
...
function CWorldBossResultView.OnShowView(self)
	self.m_WarID = nil
...
function CWorldBossResultView.OnWarEvnet(self, oCtrl)
...
function CWorldBossResultView.SetWarID(self, id)
	self.m_WarID = id
	self:RefeshAll()
end

function CWorldBossResultView.RefeshAll(self)
...
function CWorldBossResultView.RefreshItemGrid(self)
...
function CWorldBossResultView.RefeshDesc(self)
...
function CWorldBossResultView.RefeshCoin(self)
...
function CWorldBossResultView.SetWin(self, bWin)
	self.m_Win:SetActive(bWin)
	self.m_End:SetActive(not bWin)
end

function CWorldBossResultView.OrgFuBenWarEnd(self)
...
function CWorldBossResultView.CloseView(self)
	CViewBase.CloseView(self)
	g_WarCtrl:SetInResult(false)
end

function CWorldBossResultView.SetDelayCloseView(self)
