...
function SCMergeRoleListAck:Decode()
	...
	for i = 1, self.count do
		...
		role_item.camp = role_item.country
		...
		role_item.wuqi_use_type = MsgAdapter.ReadShort()
		role_item.body_use_type = MsgAdapter.ReadShort()
		role_item.shenbing_img_id = MsgAdapter.ReadShort()
		role_item.shenbing_texiao_id = MsgAdapter.ReadShort()
		role_item.baojia_img_id = MsgAdapter.ReadShort()
		role_item.baojia_texiao_id = MsgAdapter.ReadShort()
		role_item.fazhen_used_imageid = MsgAdapter.ReadShort()
		MsgAdapter.ReadShort()
		role_item.appearance = ProtocolStruct.ReadRoleAppearance()
...
--各国平均战斗力
SCCampCapability = SCCampCapability or BaseClass(BaseProtocolStruct)
function SCCampCapability:__init()
	self.msg_type = 7008
end

function SCCampCapability:Decode()
