...
--精灵光环升级装备请求
CSJinglingGuanghuanUplevelEquip = CSJinglingGuanghuanUplevelEquip or BaseClass(BaseProtocolStruct)
function CSJinglingGuanghuanUplevelEquip:__init()
	self.msg_type = 6854
	self.equip_idx = 0
end

function CSJinglingGuanghuanUplevelEquip:Encode()
	MsgAdapter.WriteBegin(self.msg_type)
