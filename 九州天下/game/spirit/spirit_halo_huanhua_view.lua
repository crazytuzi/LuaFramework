...
function SpiritHaloHuanHuaView:__init()
	self.ui_config = {"uis/views/spiritview", "SpiritHaloHuanHuaView"}
	self.cell_list = {}
end
...
function SpiritHaloHuanHuaView:SetSelectAttr(index)
	...
	local capability = CommonDataManager.GetCapabilityCalculation(attr_list)
	self.fight_power:SetValue()
