...
function GoldTextView:FlushGoldTextView()
	...
	local cur_attr, total_attr = CoolChatData.Instance:GetJingHuaAllAttr()
...
function GoldItem:__delete()
	self.icon = nil
	self.gray = nil
	self.num_visible = nil
	self.lev = nil
	self.show_high_light = nil
...
function GoldItem:OnFlush()
	...
	-- 	self.num_visible:SetValue(false)
	-- end
	local bubble, asset = ResPath.GetItemIcon(self.data.item_id)
