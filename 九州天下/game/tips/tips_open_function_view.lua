...
function TipOpenFunctionView:__init()
	self.ui_config = {"uis/views/tips/openfunctiontips", "OpenFunctionTips"}
...
function TipOpenFunctionView:SetModle()
	...
	if cfg.res_type == "Halo" then
		self.model_view:SetModelTransformParameter(DISPLAY_MODEL_TYPE[DISPLAY_TYPE.ROLE], 001001, DISPLAY_PANEL.OPEN_FUN)
	else
		self.model_view:SetModelTransformParameter(DISPLAY_MODEL_TYPE[display_type], cfg.res_id, DISPLAY_PANEL.OPEN_FUN)
	end
end
