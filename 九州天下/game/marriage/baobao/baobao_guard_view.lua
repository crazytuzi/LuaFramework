...
function BaoBaoGuardView:LoadCallBack()
...
function BaoBaoGuardView:RefreshView(cell,data_index)
    ...
    if nil == attr_cell then
        attr_cell = BabyGuardAttrCell.New(cell.gameObject)
...
function BaoBaoGuardView:AutoBuyConfirm(item_id)
    ...
    -- return true
    SysMsgCtrl.Instance:ErrorRemind(Language.Marriage.NoItemTip)
end
...
--------------------------------------------AttrCell---------------------------------------------------------------
BabyGuardAttrCell = BabyGuardAttrCell or BaseClass(BaseCell)

function BabyGuardAttrCell:__init()
...
function BabyGuardAttrCell:FlushAttr()
...
function BabyGuardAttrCell:OnFlush()
