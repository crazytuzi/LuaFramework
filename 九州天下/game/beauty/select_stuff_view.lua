...
function SelectStuffView:__init()
	self.ui_config = {"uis/views/beauty","SelectStuffView"}
	self.select_data = {}
end
...
function SelectStuffView:BackOnClick()
	ViewManager.Instance:Close(ViewName.BeautyXiLianStuffView)
end
...
function SelectItem:OnFlush()
	...
	self.desc:SetValue(ToColorStr(string.format(Language.HunQi.MaxStarNum, self.data.max_star_number), ITEM_COLOR[item_cfg.color]))
