...
function KuaFuXiuLuoTowerBuyView:__init()
	self.ui_config = {"uis/views/kuafuxiuluotower", "XiuLuoTaBuffView"}
end
...
function KuaFuXiuLuoTowerBuyView:LoadCallBack()
	...
	self:ListenEvent("OnEnter", BindTool.Bind(self.OnEnterHandler, self))
...
function KuaFuXiuLuoTowerBuyView:OnEnterHandler()
...
function KuaFuXiuLuoTowerBuyView:OnFlush()
	...
	self.max_buy:SetValue(5 - buff_info.buy_realive_count)
