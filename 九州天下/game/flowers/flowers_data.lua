...
function FlowersData:__init()
	...
	self.flower_play_state999 = false
...
function FlowersData:SetFriendInfo(info)
	if info.user_id then
		self.flowers_info.target_uid = info.user_id
		self.friend_name = info.gamename or info.user_name
	else
...
function FlowersData:IsFlowerPlay()
	return self.flower_play_state
end

function FlowersData:SetFlowerPlay(state)
	self.flower_play_state = state
end

function FlowersData:IsFlowerPlay999()
	return self.flower_play_state999
end

function FlowersData:SetFlowerPlay999(state)
	self.flower_play_state999 = state
end
