...
function ClashTerritoryShopView:__init()
	self.ui_config = {"uis/views/clashterritory","ClashTerritoryShopView"}
end
...
function TerritoryShopScrollCell:Flush()
	...
	self.score_color:SetValue(data.current_credit < self.data.cost_credit and "#ff0000" or "#b7d3f9")
