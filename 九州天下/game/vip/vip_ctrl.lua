...
require("game/vip/vip_recharge_tip_view")
require("game/tips/tips_vip_buff_view")
...
function VipCtrl:__init()
	...
	self.vip_recharge_tip_view = VipRechargeTipView.New()
	self.tips_vip_buff_view = TipsVipBuffView.New()
...
function VipCtrl:__delete()
	...
	if self.vip_recharge_tip_view then
		self.vip_recharge_tip_view:DeleteMe()
		self.vip_recharge_tip_view = nil
	end

	if self.tips_vip_buff_view then
		self.tips_vip_buff_view:DeleteMe()
		self.tips_vip_buff_view = nil
	end
...
function VipCtrl:GoToVipRecharge()
	self.vip_view:RechargeClick()
end

function VipCtrl:GoToPage()
	self.vip_view:OnClickNextButton()
end

function VipCtrl:ShowVipRechargeTipView()
	self.vip_recharge_tip_view:Open()
end

-- 打开vip buff tips
function VipCtrl:ShowVipBuffTipView(vip_level)
	self.tips_vip_buff_view:SetData(vip_level)
	self.tips_vip_buff_view:Open()
end
