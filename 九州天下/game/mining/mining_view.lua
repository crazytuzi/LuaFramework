...
function MiningView:__init()
	self.ui_config = {"uis/views/mining","MiningView"}
...
function MiningView:LoadCallBack()
	...
	local mining_mine_content = self:FindObj("MiningView")
	mining_mine_content.uiprefab_loader:Wait(function(obj)
		obj = U3DObject(obj)
		self.mining_mine_view = MiningMineView.New(obj)
	end)

	local mining_sea_content = self:FindObj("SeaView")
	mining_sea_content.uiprefab_loader:Wait(function(obj)
		obj = U3DObject(obj)
		self.mining_sea_view = MiningSeaView.New(obj)
	end)
    
    local mining_challenge_content = self:FindObj("ChallengeView")
    mining_challenge_content.uiprefab_loader:Wait(function(obj)
		obj = U3DObject(obj)
...
function MiningView:OpenMiningMineView()
	print("TabIndex.OpenMiningMineView--->>")
