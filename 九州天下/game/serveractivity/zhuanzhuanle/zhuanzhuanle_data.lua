...
function ZhuangZhuangLeData:GetIsShield()
	return self.is_shield
end

function ZhuangZhuangLeData:SetIsShield(is_shield)
...
function ZhuangZhuangLeData:GetZhuanZhuanLeKeyNum()
...
function ZhuangZhuangLeData:GetZhuanZhuanLeOtherCfg()
	local zzl_cur_day = 0
