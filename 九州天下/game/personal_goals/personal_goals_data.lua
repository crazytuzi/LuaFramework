...
function PersonalGoalsData:__init()
	...
	self.personal_goal_list_cfg = ListToMap(self.personal_goal_cfg, "chapter")
	self.open_panel_list_cfg = ListToMap(self.open_panel_cfg, "type")
...
function PersonalGoalsData:GetPersonalGoalCfgByChapter(chapter)
	...
	-- 	end
	-- end
	if self.personal_goal_list_cfg then
		cfg = self.personal_goal_list_cfg[chapter]
	end
...
function PersonalGoalsData:GetOpenPanelByType(open_type)
	...
	if self.open_panel_list_cfg then
		open_panel = self.open_panel_list_cfg[open_type].goto_panel
	end
