...
Proto.recv = {
   ...
   [23240] = {
      { name = 'info_list', type = 'array', fields = {
         { name = 'lev', type = 'uint32' },
         { name = 'status', type = 'uint32' }
      } },
      { name = 'rewards', type = 'array', fields = {
         { name = 'lev', type = 'uint32' },
         { name = 'rewards_sub_list', type = 'array', fields = {
            { name = 'item_id', type = 'uint32' }
         } }
      } }
   },
   ...
   [29201] = {
      { name = "is_successful", type = "uint32" },
      { name = "cultivate_num", type = "uint32" },
   },
   [29202] = {
      { name = 'round', type = 'uint32' },
      { name = 'process', type = 'uint32' },
   ...
   [29205] = {
      { name = 'activity_id', type = 'uint32' },
      { name = 'has_time', type = 'uint32' }, --剩余时间 （秒）
      { name = 'cost_num', type = 'uint32' },
      { name = 'active_layer', type = 'uint32' },
      { name = 'info_list', type = 'array', fields = {
         { name = 'id', type = 'uint32' },
         { name = 'num', type = 'uint32' },
      } },
   ...
   [29207] = {
      { name = 'cur_grid', type = 'uint32' },
      { name = 'box_num',  type = 'uint32' },
      { name = 'open_box', type = 'uint32' },
   },

   [29208] = {
      { name = 'cur_grid', type = 'uint32' },
      { name = 'box_num', type = 'uint32' },
      { name = 'can_open', type = 'uint32' },
   },
