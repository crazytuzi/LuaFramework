...
function CommonTabBtn:setExtendData( extend )
	if extend then
		...
		self.select_color = extend.select_color or cc.c4b(255,255,255,255)
		--self.select_outline = extend.select_outline or cc.c4b(0x2a,0x16,0x0f,0)
		self.select_shadow = extend.select_shadow or cc.c4b(133,64,0,0xff)
		self.normal_color = extend.normal_color or  cc.c4b(37,81,116,0xff)
		--self.normal_outline = extend.normal_outline or cc.c4b(0x2a,0x16,0x0f,0)
		self.normal_shadow = extend.normal_shadow or cc.c4b(0x2a,0x16,0x0f,0x00)
...
function CommonTabBtn:setBtnSelectStatus( status )
	if status then
		...
		--self.title:enableOutline(self.select_outline or cc.c4b(0x2a,0x16,0x0f,0), 2)
		self.title:enableShadow(self.select_shadow or cc.c4b(133,64,0,0xff),cc.size(0, -2),2)
	else
		...
		--self.title:enableOutline(self.normal_outline or cc.c4b(0x2a,0x16,0x0f,0), 2)
		self.title:enableShadow(self.normal_shadow or cc.c4b(40,19,0,0),cc.size(0, -2),2)
...
function CommonTabBtn:setBtnOpenStatus( status )
	...
	setChildUnEnabled(not status, self,Config.ColorData.data_new_color4[18])
end
