...
cc.Handler.EVENT_SPINE_ANIMATION_START = 64
cc.Handler.EVENT_SPINE_ANIMATION_INTERRUPT = 65
cc.Handler.EVENT_SPINE_ANIMATION_END = 66
cc.Handler.EVENT_SPINE_ANIMATION_DISPOSE = 67
cc.Handler.EVENT_SPINE_ANIMATION_COMPLETE = 68
cc.Handler.EVENT_SPINE_ANIMATION_EVENT = 69
----
