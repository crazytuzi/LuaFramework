...
function VersionView:ctor()
    ...
    --dump(Config.LoadingDescData.data_desc, "Config.LoadingDescData.data_desc")
    ...
    self.info_label = self.root_wnd:getChildByName("info_label")
    self.info_label:setVisible(CHARGE_CONFIG_TYPE and CHARGE_CONFIG_TYPE == "zh")
    -- 设置健康公告显示
