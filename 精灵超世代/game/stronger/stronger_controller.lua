...
function StrongerController:clickCallBack( evt_type )
    if evt_type then
        ...
        elseif evt_type == 203 then -- 玩家宝可梦信息界面
        ...
        elseif evt_type == 122 then --宝可梦商城
        ...
        elseif evt_type == 151 then --宝可梦远征
        ...
        elseif evt_type == 404 then --宝可梦界面
            JumpController:getInstance():jumpViewByEvtData({19})
