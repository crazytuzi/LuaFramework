...
function HalidomUpStepWindow:open_callback(  )
    ...
    self.level_txt = createLabel(20,Config.ColorData.data_new_color4[1],nil,15,15,"1",self.level_bg,nil,cc.p(0.5,0.5))
    self.name_txt = createLabel(26,Config.ColorData.data_new_color4[6],nil,size.width/2,430,"",self.main_panel,2,cc.p(0.5,0))
    self.desc_txt = createRichLabel(20, Config.ColorData.data_new_color4[6], cc.p(0.5,1), cc.p(size.width/2,415), nil, nil, 570)
...
function HalidomUpStepWindow:setData()
    ...
    if self.desc_txt then
    	...
    	desc_str = string.format( "%s", desc_str)
