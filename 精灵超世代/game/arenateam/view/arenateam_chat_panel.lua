...
function ArenateamChatPanel:open_callback(  )
    ...
    local buttomBg =  self.main_container:getChildByName("inputLay")  --createScale9Sprite(PathTool.getResFrame("mainui","mainui_chat_bottom_bg"),0,0,LOADTEXT_TYPE_PLIST,self.main_container)
    local buttonBg_size = cc.size(710,75)
    ...
    self.btn_send:getLabel():enableShadow(Config.ColorData.data_new_color4[3],cc.size(0, -2),2)
