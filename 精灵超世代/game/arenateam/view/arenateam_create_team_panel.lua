...
function ArenateamCreateTeamPanel:open_callback()
    ...
    self.edit_box:setPlaceholderFontColor(Config.ColorData.data_new_color4[6])
    self.edit_box:setFontColor(Config.ColorData.data_new_color4[6])
...
function ArenateamCreateTeamPanel:initData()
    ...
    for i,v in ipairs(power_list) do
        ...
        if v.power == 0 then
            ...
            local power = changeBtValueForPower(v.power)/10000 
...
function ArenateamCreateTeamPanel:createNewCell(width, height)
    ...
    cell.label = createLabel(26, Config.ColorData.data_new_color4[6], nil, 10, height * 0.5 , "", cell, nil, cc.p(0,0.5))
