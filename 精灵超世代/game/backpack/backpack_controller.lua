...
function BackpackController:gotoItemSources(evt_type, extend, bid, need_item_list)
    ...
    elseif evt_type == "evt_bag_partner" then --宝可梦背包
    ...
    elseif evt_type == "evt_partner" then --打开宝可梦界面
    ...
    elseif evt_type == "evt_hero_conversion" then --先知召唤 宝可梦转换
    ...
    elseif evt_type == "evt_expedition" then --宝可梦远征
    ...
    elseif evt_type == "evt_week_water_breed_shop" then --周活动商城
        JumpController:getInstance():jumpViewByEvtData({77,3})
    elseif evt_type == "evt_week_action" then --周活动任务
        JumpController:getInstance():jumpViewByEvtData({77,extend[1]})
    else
