...
BackPackConst.tips_btn_type = {
    ...
    hero_source = 6,        --跳转宝可梦信息界面
    skill_source = 7,       --跳转宝可梦技能界面
...
BackPackConst.tips_btn_title ={
    ...
    [BackPackConst.tips_btn_type.weekly_activity]       = TI18N("使用"),
...
function BackPackConst.getBlackQualityColorStr(quality)
    quality = quality or 0
    if quality == BackPackConst.quality.red then
        return Config.ColorData.data_new_color_str[11]
    elseif quality == BackPackConst.quality.orange then
        return Config.ColorData.data_new_color_str[10]
    elseif quality == BackPackConst.quality.purple then
        return Config.ColorData.data_new_color_str[9]
    elseif quality == BackPackConst.quality.blue then
        return Config.ColorData.data_new_color_str[8]
    elseif quality == BackPackConst.quality.green then
        return Config.ColorData.data_new_color_str[13]
    else
        return Config.ColorData.data_new_color_str[6]
    end
end
