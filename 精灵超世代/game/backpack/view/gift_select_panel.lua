...
function GiftSelectPanel:open_callback()
    ...
    self.desc_label = createRichLabel(24, Config.ColorData.data_new_color4[6], cc.p(0.5,1), cc.p(size.width/2,650), 2, nil, 600)
...
function GiftSelectPanel:updateGiftList(giftid,giftBid, goods_list, choose_num)
    ...
    local max_height = math.max(scroll_size.height, len*140 +20)
    ...
    self.item_scrollview:addEndCallBack(function()
        ...
        if self.is_single then
            ...
            if self.item_name == nil then
                self.item_name = createLabel(26, Config.ColorData.data_new_color4[6], nil, 180, 65, name_text .. "X" .. quantity_text, self.container, nil, cc.p(0, 0.5))
            else
