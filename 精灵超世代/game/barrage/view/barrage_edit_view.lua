...
function BarrageEditView:open_callback()
    ...
    self.editbox = createEditBox(content_container, PathTool.getResFrame("common","common_99998"), size, Config.ColorData.data_new_color4[6], 22, Config.ColorData.data_new_color4[6], 22, TI18N("请输入内容"), nil, 40, LOADTEXT_TYPE_PLIST)
