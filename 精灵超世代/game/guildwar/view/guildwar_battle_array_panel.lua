...
function GuildwarBattleArrayPanel:configUI(  )
    ...
    self.powerText = container:getChildByName("powerText")
...
function GuildwarBattleArrayPanel:setData( data, is_spec )
    ...
    self.powerText:setString(TI18N("战力：")..(data.power or 0))
    ...
    if data.formation_type then
        ...
        loadSpriteTexture(self.form_image, res, ccui.TextureResType.localType)
    else
