...
function WorldMapItem:createRootWnd()
    ...
    self.name_label = createLabel(18, 175, nil, self.size.width * 0.5-2, -15,  TI18N(self.config.name) , self, nil, cc.p(0.5, 0.5))
    local name_bg = createImage(self, res, self.size.width * 0.5, -20, cc.p(0.5, 0.5), true, -1, true)
    name_bg:setCapInsets(cc.rect(105, 1, 1, 1))
    name_bg:setContentSize(cc.size(self.name_label:getContentSize().width+40,37))
    self:registerEvent()
    self:fillData()
end
