...
function HeavenStarAwardItem:configUI(  )
    ...
    if self.go_btn_label ~= nil then
        self.go_btn_label:enableShadow(Config.ColorData.data_new_color4[3],cc.size(0, -2),2)
    end
    ...
    if self.get_btn_label ~= nil then
		self.get_btn_label:enableShadow(Config.ColorData.data_new_color4[2],cc.size(0, -2),2)
    end
