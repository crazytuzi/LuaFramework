...
function HeavenBattleWinView:open_callback(  )
    ...
    self.fight_text = createLabel(24, Config.ColorData.data_new_color4[6], nil, 360, 430, "",container, nil, cc.p(0.5,0.5))
    ...
    self.comfirm_btn:setRichText(string.format(TI18N("<div fontcolor=#ffffff shadow=0,-2,2,%s>确定</div>"), Config.ColorData.data_new_color_str[3]))
    ...
    self.cancel_btn:setRichText(string.format(TI18N("<div fontcolor=#ffffff shadow=0,-2,2,%s>返回玩法</div>"), Config.ColorData.data_new_color_str[2]))
...
function HeavenBattleAwardItem:ctor()
    ...
    self.item_name_label = createLabel(16, Config.ColorData.data_new_color4[6],nil, 60, 30, "", self, nil, cc.p(0.5, 1))
    self.item_name_label:setDimensions(130,60)
    self.item_name_label:setAlignment(cc.TEXT_ALIGNMENT_CENTER)
