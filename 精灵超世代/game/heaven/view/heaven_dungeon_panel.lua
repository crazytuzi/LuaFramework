...
function HeavenDungeonPanel:configUI(  )
	...
	self.btn_rank = main_container:getChildByName("btn_rank")
	...
	self.btn_book = main_container:getChildByName("btn_book")
...
function HeavenDungeonPanel:createCapterList(  )
    ...
    self.chapter_scrollview = CommonScrollViewSingleLayout.new(self.chapter_list, cc.p(0, 220) , ScrollViewDir.vertical, ScrollViewStartPos.bottom, scroll_view_size, setting)
