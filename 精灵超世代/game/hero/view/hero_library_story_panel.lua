...
function HeroLibraryStoryPanel:openRootWnd(name, content)
    ...
    local val = createRichLabel(24, Config.ColorData.data_new_color4[6], cc.p(0.5, 1), cc.p(self.content_scrollview_size.width * 0.5,0), 12, nil, self.content_scrollview_size.width)
