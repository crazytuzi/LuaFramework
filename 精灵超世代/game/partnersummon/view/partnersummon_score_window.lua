...
function PartnerSummonScoreWindow:open_callback(  )
	...
	content_label:setString(string.format(TI18N("消耗%d点积分可进行积分召唤，必出5星传说宝可梦"), score_cost))
