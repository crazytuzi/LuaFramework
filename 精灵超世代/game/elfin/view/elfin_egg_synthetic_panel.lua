...
function ElfinEggSyntheticPanel:open_callback()
    ...
    self.left_item_1:setPosition(self.main_container:getContentSize().width / 2-160, 290)
    ...
    self.right_item_1:setPosition(self.main_container:getContentSize().width / 2+170, 290)
