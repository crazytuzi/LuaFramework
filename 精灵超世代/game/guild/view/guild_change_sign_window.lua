...
function GuildChangeSignWindow:open_callback()
    ...
    self.edit_title  = createEditBox(container, res, cc.size(390, 130), nil, 22, Config.ColorData.data_color4[26], 22, TI18N("请输入公会宣言内容"), nil, nil, LOADTEXT_TYPE_PLIST)
    self.edit_title:setAnchorPoint(cc.p(0, 1))
    self.edit_title:setPlaceholderFontColor(Config.ColorData.data_color4[26])
