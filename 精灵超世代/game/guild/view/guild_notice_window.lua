...
local common_font_color = Config.ColorData.data_new_color4[6]
...
function GuildNoticeItem:layoutUI()
    ...
    self.day_label = createRichLabel(24, Config.ColorData.data_new_color4[1] , cc.p(0, 0.5), cc.p(11, 22))
    ...
    if data and next(data) ~= nil then
        ...
        for k,v in ipairs(data) do
            ...
            if list.item then
                ...
                list.content_label:setString(string_format("<div>%s</div> %s", v.role_name, v.msg))
