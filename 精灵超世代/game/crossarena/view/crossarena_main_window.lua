...
function CrossareanMainWindow:open_callback(  )
	...
	for i=1,2 do
		...
		if tab_btn then
			...
			object.title:setColor(Config.ColorData.data_new_color4[6])
...
function CrossareanMainWindow:changeSelectedTab( index )
    ...
    if self.tab_object then
		...
		self.tab_object.title:setColor(Config.ColorData.data_new_color4[6])
    ...
    if self.tab_object then
		...
		self.tab_object.title:setColor(Config.ColorData.data_new_color4[1])
