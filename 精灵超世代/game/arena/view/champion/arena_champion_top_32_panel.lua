...
function ArenaChampionTop32Panel:ctor(view_type)
    ...
    for i=1, 2 do
        ...
        if tab_btn then
            ...
            label:enableOutline(Config.ColorData.data_new_color4[3], 2)
            if i == 1 then
                if self.view_type == ArenaConst.champion_type.normal then
...
function ArenaChampionTop32Panel:changeTabView( index, is_change_tab )
    ...
    if self.cur_selected then
        ...
        self.cur_selected.label:enableOutline(Config.ColorData.data_new_color4[3], 2)
    ...
    self.cur_selected.label:enableOutline(Config.ColorData.data_new_color4[2], 2)
