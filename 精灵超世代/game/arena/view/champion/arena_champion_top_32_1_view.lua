...
function ArenaChampionTop321View:ctor(view_type)
    ...
    self.notice_label = createLabel(22, Config.ColorData.data_new_color4[1], 2, 360, 750, "", self, nil, cc.p(0.5,0))
    self.notice_label:enableOutline(Config.ColorData.data_new_color4[6], 2)
end
