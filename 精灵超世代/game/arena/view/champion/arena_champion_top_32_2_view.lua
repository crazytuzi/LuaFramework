...
ArenaChampionTop322View = class("ArenaChampionTop322View", function()
...
function ArenaChampionTop322View:ctor(view_type)
	self.root_wnd = createCSBNote(PathTool.getTargetCSB("arena/arena_champion_top_32_2_view"))
    ...
    self.role_head:setPosition(60, 60)
...
function ArenaChampionTop322View:registerEvent()
...
function ArenaChampionTop322View:addToParent(status)
	self:setVisible(status)
    self:handleEvent(status)
end

function ArenaChampionTop322View:updateInfo(status)
...
function ArenaChampionTop322View:handleEvent(status)
...
--@return 
--==============================--
function ArenaChampionTop322View:updateCheckStatus(pos)
...
--@return 
--==============================--
function ArenaChampionTop322View:updateTop4Info(list)
    ...
    -- 取出第7位用于设置头像,第7位就是冠军
    local champion_data = pos_list[7]
...
function ArenaChampionTop322View:DeleteMe()
