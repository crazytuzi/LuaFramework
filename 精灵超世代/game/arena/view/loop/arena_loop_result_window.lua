...
function ArenaLoopResultWindow:open_callback()
    ...
    self.top_result = createRichLabel(24, cc.c3b(0xff, 0xcc, 0x00), cc.p(0, 0.5), cc.p(440, 317))
    ...
    self.bottom_result = createRichLabel(24, 1, cc.p(0, 0.5), cc.p(440, 215))
    ...
    self.fight_text = createLabel(24, Config.ColorData.data_new_color4[6], nil, 360, 378, "",self.container, nil, cc.p(0.5,0.5))
