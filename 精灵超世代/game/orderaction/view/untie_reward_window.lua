...
-- @Author:      hyxing 
-- @description: 奖励总览
-- @DateTime:    2019-04-19 18:08:37
-- *******************************
UntieRewardWindow = UntieRewardWindow or BaseClass(BaseView)
...
function UntieRewardWindow:__init()
...
function UntieRewardWindow:open_callback()
...
function UntieRewardWindow:commonShowReward()
...
function UntieRewardWindow:register_event()
...
function UntieRewardWindow:openRootWnd()
    
end
function UntieRewardWindow:close_callback()
