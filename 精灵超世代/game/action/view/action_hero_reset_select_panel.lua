...
function ActionHeroResetSelectPanel:__init()
    ...
    self.is_hero_return = false -- 是否常驻宝可梦回退功能调用
...
function ActionHeroResetSelectPanel:open_callback()
    ...
    self.title:setString(TI18N("重生宝可梦选择"))
...
function ActionHeroResetSelectPanel:updateHeroList()
    ...
    self.hero_list = {}
    if self.is_hero_return == true then--宝可梦常驻回退功能
        self.title:setString(TI18N("回退宝可梦选择"))
