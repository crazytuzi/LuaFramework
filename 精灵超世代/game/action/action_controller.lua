...
function ActionController:needRequireData(force)
	...
	WeeklyActivitiesController:getInstance():send_29200()
	WeeklyActivitiesController:getInstance():send_29212()
	FreeCaptureController:getInstance():sender23240()
end
...
function ActionController:on16601(data)
	...
	--local data = WeeklyActivitiesController:getInstance().model:getWeeklyActivityData()
...
function ActionController:sender28800()
	print("ActionController:sender28800")
	local protocal = {}
    self:SendProtocal(28800, {})
end

function ActionController:handle28800(data)
	print("ActionController:handle28800", data)
