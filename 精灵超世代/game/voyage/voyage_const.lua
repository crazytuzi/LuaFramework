...
-- 订单名称
VoyageConst.Order_Name = {
	[VoyageConst.Order_Rarity.Normal] = "普通",
	[VoyageConst.Order_Rarity.Excellent] = "精良",
	[VoyageConst.Order_Rarity.Uncommon] = "稀有",
	[VoyageConst.Order_Rarity.Epic] = "史诗",
	[VoyageConst.Order_Rarity.Legend] = "传说",
	[VoyageConst.Order_Rarity.Eternity] = "不朽",
}
...
VoyageConst.Order_Rarity_Color = {
	...
	[VoyageConst.Order_Rarity.Normal] = "#C0EBFF",
	[VoyageConst.Order_Rarity.Excellent] = "#BDFFA3",
	[VoyageConst.Order_Rarity.Uncommon] = "#75F9FE",
	[VoyageConst.Order_Rarity.Epic] = "#FCB0FF",
	[VoyageConst.Order_Rarity.Legend] = "#FFFAB0",
	[VoyageConst.Order_Rarity.Eternity] = "#FF8888",
}

-- 订单稀有度对应的描边
VoyageConst.Order_Rarity_OutLine = {
	[VoyageConst.Order_Rarity.Normal] = "#3C6D78",
	[VoyageConst.Order_Rarity.Excellent] = "#2B8063",
	[VoyageConst.Order_Rarity.Uncommon] = "#3067AC",
	[VoyageConst.Order_Rarity.Epic] = "#7630AC",
	[VoyageConst.Order_Rarity.Legend] = "#AC5C30",
	[VoyageConst.Order_Rarity.Eternity] = "#992626",
}
