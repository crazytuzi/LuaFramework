...
function ArenapeakchampionMymatchTabForm:showEmptyInfo()
    ...
    self.fuse_btn_label = createRichLabel(26,Config.ColorData.data_new_color4[6], cc.p(0.5,1),cc.p(360, 555),nil,nil, 550)
    self.fuse_btn_label:setString(TI18N("您未能参加本次冠军赛可<div fontColor=#1a9222 href=xxx>前往竞猜</div>界面参与竞猜"))
