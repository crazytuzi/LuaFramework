...
function ArenapeakchampionMymatchPanel:open_callback(  )
    ...
    for i=1,2 do
        ...
        tab_btn.title:enableOutline(Config.ColorData.data_new_color4[3],2)
...
function ArenapeakchampionMymatchPanel:changeTabType(index, check_repeat_click)
    ...
    if self.cur_tab ~= nil then
        ...
        self.cur_tab.title:enableOutline(Config.ColorData.data_new_color4[3],2)
    ...
    if self.cur_tab ~= nil then
        ...
        self.cur_tab.title:enableOutline(Config.ColorData.data_new_color4[2],2)
