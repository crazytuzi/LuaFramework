...
function SummonSelectWindow:open_callback(  )
	...
	container:getChildByName("win_title"):setString(TI18N("宝可梦选择"))
	...
	self.hero_info_panel:getChildByName("name_txt"):setString(TI18N("请在下面列表中选择一名宝可梦作为指定UP宝可梦"))
