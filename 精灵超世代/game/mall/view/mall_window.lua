...
function MallWindow:__init()
    ...
    self.res_list = {
        ...
        {path = PathTool.getPlistImgForDownLoad("bigbg/mall","mall_bg_1"), type = ResourcesType.single},
        {path = PathTool.getPlistImgForDownLoad("bigbg/mall","mall_bg_2"), type = ResourcesType.single},
        {path = PathTool.getPlistImgForDownLoad("bigbg/mall","mall_bg_3"), type = ResourcesType.single},
    }
    --开启条件信息字段
    self.open_key_list = {
