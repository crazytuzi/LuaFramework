...
function MallActionWindow:open_callback()
    ...
    self.time = createRichLabel(22,Config.ColorData.data_new_color4[6],cc.p(1,0.5),cc.p(650,self.count:getPositionY()))
...
function MallActionWindow:createNewCell(width, height)
    ...
    --cell.name_panel:setContentSize(cc.size(180, 28))
    --cell.name_panel:setPosition(130, 75)
    cell.name = cell.name_panel:getChildByName("name")
    --cell.name:setAnchorPoint(cc.p(0.5, 0.5))
    --cell.name:setContentSize(cc.size(180, 28))
    --cell.name:setPosition(90, 14)
    ...
    --超值或者折扣图片
    local zhe_res = PathTool.getResFrame("mall", "mall_06")
    cell.discount = cell.main_container:getChildByName("discount")
    cell.discount:loadTexture(zhe_res, LOADTEXT_TYPE_PLIST)
    cell.discount:setContentSize(cc.size(59, 80))
    cell.discount:setLocalZOrder(20)
    --cell.discount:getChildByName("discount_num")
    cell.discount_num = createLabel(20,Config.ColorData.data_new_color4[1],nil,28,50,"",cell.discount,nil,cc.p(0.5,0.5))
    ...
    --限购
    cell.discount_label = createRichLabel(20,Config.ColorData.data_new_color4[6],cc.p(1,0),cc.p(320,10))
    cell.main_container:addChild(cell.discount_label)

    -- 解锁条件
    cell.lock_label = createRichLabel(22,Config.ColorData.data_new_color4[6],cc.p(0.5,0.5),cc.p(width*0.5,height*0.5))
    cell.main_container:addChild(cell.lock_label, 99)

    --道具item
    cell.goods_item = BackPackItem.new(true,true)
    cell.goods_item:setPosition(20+cell.goods_item:getContentSize().width/2,height/2)
    cell.goods_item:setScale(0.8)
