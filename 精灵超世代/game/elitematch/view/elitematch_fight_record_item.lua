...
function ElitematchFightRecordItem:configUI(  )
    ...
    local icon_res = PathTool.getTargetRes("vedio", "txt_cn_common_90012",false)
    loadSpriteTexture(self.result_win, icon_res,LOADTEXT_TYPE)
    local icon_res = PathTool.getTargetRes("vedio", "txt_cn_common_90013",false)
    loadSpriteTexture(self.result_loss, icon_res,LOADTEXT_TYPE)
