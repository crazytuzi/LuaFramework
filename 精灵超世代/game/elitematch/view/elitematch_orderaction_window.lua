...
function ElitematchOrderactionWindow:updateIconImg(status)
    ...
    if status == 1 then
        ...
        loadSpriteTexture(self.icon_img, PathTool.getResFrame("elitematch","elitematch_20_1"), LOADTEXT_TYPE_PLIST)
    end
...
function ElitematchOrderActiodRewardItem2:configUI()
    ...
    self.num_bg = createImage(self.root_wnd, PathTool.getResFrame("planesafkorderaction", "planesafkaction_7"),self.size.width/2,self.size.height/5+11,cc.p(0.5, 0.5),true,nil,true)
