...
function HonorIconTips:open_callback()
    ...
    self.label_desc1 = createRichLabel(20, Config.ColorData.data_new_color4[6], cc.p(0,1), cc.p(16,185), nil, nil, 388)
    self.main_panel:addChild(self.label_desc1)

    self.have_name = createRichLabel(20, Config.ColorData.data_new_color4[6], cc.p(0,1), cc.p(16,118), nil, nil, 388)
    self.main_panel:addChild(self.have_name)

    self.Image_3 = self.main_panel:getChildByName("Image_3")
    self.label_desc2 = createRichLabel(18, Config.ColorData.data_new_color4[6], cc.p(0,1), cc.p(16,68), nil, nil, 388)
...
function HonorIconTips:openRootWnd(setting)
    ...
    self.honor_name:setFontSize(20)
