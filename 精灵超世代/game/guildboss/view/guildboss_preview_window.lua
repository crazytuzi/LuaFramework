...
function GuildBossPreviewItem:ctor()
	...
	self.boss_icon:setScale(0.7)
	self.boss_icon:setPosition(self.center_x,self.size.height/2+10)
...
function GuildBossPreviewItem:setSelect(status)
	if status and  not self.select_img then
		self.select_img = createSprite(PathTool.getResFrame("common","common_1060"),50,55,self.root_wnd,cc.p(0.5,0.5))
