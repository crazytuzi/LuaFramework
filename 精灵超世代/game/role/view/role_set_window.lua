            ...
            if event_type == ccui.TouchEventType.ended then
                ...
                if self.role_vo.sex == 2 then
                    ...
                    --if self.alert == nil then
                        local msg = string.format(TI18N("<div fontcolor=#a95f0f>改名需消耗200 <img src=%s scale=0.3 visible=true /></div>"),PathTool.getItemRes(Config.ItemData.data_get_data(3).icon))
