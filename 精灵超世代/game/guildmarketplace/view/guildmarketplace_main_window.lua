...
function GuildmarketplaceMainWindow:__init()
    ...
    self.res_list = {
        ...
        { path = PathTool.getPlistImgForDownLoad("bigbg/guild","guild_bg_5",true), type = ResourcesType.single },
        { path = PathTool.getPlistImgForDownLoad("bigbg/guild","guild_people",false), type = ResourcesType.single },
    }
...
function GuildmarketplaceMainWindow:open_callback(  )
    ...
    --local bg_res = PathTool.getPlistImgForDownLoad("guild", "guild_bg_5", true)
    --self.item_load_bg = loadImageTextureFromCDN(self.background, bg_res, ResourcesType.single, self.item_load_bg)
    self.background:loadTexture(PathTool.getPlistImgForDownLoad("bigbg/guild","guild_bg_5",true), LOADTEXT_TYPE)

    self.container = self.root_wnd:getChildByName("container")

    self.people_node = self.container:getChildByName("people_node")
    --self.people_node:loadTexture(PathTool.getPlistImgForDownLoad("bigbg/guild","guild_people",false), LOADTEXT_TYPE)
    loadSpriteTexture(self.people_node, PathTool.getPlistImgForDownLoad("bigbg/guild","guild_people",false), LOADTEXT_TYPE)
    ...
    self.record_info_btn = createRichLabel(22, cc.c4b(0x15,0x7e,0x22,0xff), cc.p(0.5, 0.5), cc.p(300, 28))
    ...
    self.lay_srollview_0 = self.top_panel:getChildByName("lay_srollview_0")
    ...
    self.message_scroll_view = createScrollView(self.message_size.width, self.message_size.height, 0, 0, self.lay_srollview_0, ScrollViewDir.vertical)
