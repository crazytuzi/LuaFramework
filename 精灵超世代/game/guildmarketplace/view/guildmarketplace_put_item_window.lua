...
function GuildmarketplacePutItemWindow:open_callback(  )
    ...
    local scroll_view_size = cc.size(bgSize.width-100, 60)
    local setting = {
    ...
    self.tab_scrollview = CommonScrollViewLayout.new(self.tableContainer, cc.p(100, 0) , ScrollViewDir.horizontal, ScrollViewStartPos.bottom, scroll_view_size, setting)
    ...
    tab_setting.select_res = PathTool.getResFrame("common", "common_1011")
    tab_setting.normal_res = PathTool.getResFrame("common", "common_1012")
    ...
    self.message_scroll_view = createScrollView(self.message_size.width, self.message_size.height, 20, 24, self.record_img, ScrollViewDir.vertical) 
