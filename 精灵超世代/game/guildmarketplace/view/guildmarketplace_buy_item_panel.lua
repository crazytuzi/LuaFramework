...
function GuildmarketplaceBuyItemPanel:open_callback(  )
    ...
    if self.ok_btn.label ~= nil then
        self.ok_btn.label:enableShadow(Config.ColorData.data_new_color4[2],cc.size(0, -2),2)
    end
    ...
    if self.cancel_btn.label ~= nil then
        self.cancel_btn.label:enableShadow(Config.ColorData.data_new_color4[3],cc.size(0, -2),2)
    end
