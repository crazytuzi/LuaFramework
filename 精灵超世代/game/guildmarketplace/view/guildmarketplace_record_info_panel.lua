...
function GuildRecordItem:layoutUI()
    ...
    self.img_time_bg = createImage(self.container, PathTool.getResFrame("common","common_90003"), 0, self.size.height, cc.p(0, 1), true, 1, true)
    self.img_time_bg:setContentSize(cc.size(self.size.width, 44))

    self.day_label = createRichLabel(24, Config.ColorData.data_new_color4[6], cc.p(0, 0.5), cc.p(11, 22))
...
function GuildRecordItem:createOneNotice()
    ...
    local time_label = createRichLabel(24, Config.ColorData.data_new_color4[6], cc.p(0, 1), cc.p(10, size.height))
    layout:addChild(time_label)

    local content_label = createRichLabel(24,Config.ColorData.data_new_color4[6], cc.p(0, 1), cc.p(80, size.height), 5, 0, 500)
