...
function HomeworldUnlockKeyPanel:__init()
    ...
    self.res_list = {
        ...
        {path = PathTool.getPlistImgForDownLoad("homeworld/txt_homeworld","homeworld_unlock_bg"), type = ResourcesType.single },
...
function HomeworldUnlockKeyPanel:open_callback(  )
    ...
    local bg_res = PathTool.getPlistImgForDownLoad("homeworld/txt_homeworld", "homeworld_unlock_bg")
