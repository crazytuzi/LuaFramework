...
function HomeworldInfoBaseItem:setData( data )
	...
	if not self.name_txt then
		self.name_txt = createLabel(24, Config.ColorData.data_new_color4[1], nil, 20, self.size.height*0.5, nil, self.root_wnd, nil, cc.p(0, 0.5))
	end
	...
	if not self.num_txt then
		self.num_txt = createLabel(24, Config.ColorData.data_new_color4[6], nil, 295, self.size.height*0.5, nil, self.root_wnd, nil, cc.p(0, 0.5))
	end
	self.num_txt:setString(data.num .. "/" .. unit_cfg.effect_count)

	if not self.soft_txt then
		self.soft_txt = createLabel(24, Config.ColorData.data_new_color4[6], nil, 450, self.size.height*0.5, nil, self.root_wnd, nil, cc.p(0, 0.5))
	end
...
function HomeworldInfoSuitItem:setData( data )
	...
	if not self.name_txt then
		self.name_txt = createLabel(24, Config.ColorData.data_new_color4[6], nil, 20, self.size.height*0.5, nil, self.root_wnd, nil, cc.p(0, 0.5))
	end
	self.name_txt:setString(data.cfg.name)

	if not self.num_txt then
		self.num_txt = createLabel(24, Config.ColorData.data_new_color4[6], nil, 283, self.size.height*0.5, nil, self.root_wnd, nil, cc.p(0, 0.5))
	end
