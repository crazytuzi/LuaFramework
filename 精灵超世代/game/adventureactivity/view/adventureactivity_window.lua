...
function AdventureActivityWindow:__init()
	...
	self.res_list = {
        ...
        {path = PathTool.getPlistImgForDownLoad("adventureactivity/txt_adventureactivity","txt_adventureactivity_1"), type = ResourcesType.single},
        {path = PathTool.getPlistImgForDownLoad("adventureactivity/txt_adventureactivity","txt_adventureactivity_2"), type = ResourcesType.single},
        {path = PathTool.getPlistImgForDownLoad("adventureactivity/txt_adventureactivity","txt_adventureactivity_3"), type = ResourcesType.single}
	}
...
function AdventureActivityItem:configUI()
    ...
    self:setContentSize(cc.size(676, 184))
...
function AdventureActivityItem:setData(data)
    ...
    local txt_res = PathTool.getPlistImgForDownLoad("adventureactivity/txt_adventureactivity", string.format("txt_adventureactivity_%d", data.res_id))
    self.txt_load = loadSpriteTextureFromCDN(self.txt_title, txt_res, ResourcesType.single, self.txt_load)
    ...
    self.join_bg:setContentSize(cc.size(size.width+60, 37))
	-- 奖励数据
	local item_list = {}
...
function AdventureActivityItem:DeleteMe()
    ...
    if self.txt_load then
        self.txt_load:DeleteMe()
        self.txt_load = nil
    end
