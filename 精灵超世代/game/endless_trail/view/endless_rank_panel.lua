...
function EndlessRankPanel:ctor(type)
    ...
    self.my_score_info = createRichLabel(20, 175, cc.p(0.5, 0.5), cc.p(500, 65), nil, nil, 180)
...
function EndlessRankItem:ctor()
    ...
    self.score_info = createRichLabel(20, 175, cc.p(0.5, 0.5), cc.p(500, 60), nil, nil, 180)
