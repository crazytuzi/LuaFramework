...
function EndlessHelpMePanel:ctor()
    ...
    local desc_label = createRichLabel(18,Config.ColorData.data_color3[175],
cc.p(0.5,0.5),cc.p(300,0),nil,nil,600)
container:addChild(desc_label)
    desc_label:setString(TI18N("(超出拥有宝可梦120%战力的支援宝可梦不可选择)"))
