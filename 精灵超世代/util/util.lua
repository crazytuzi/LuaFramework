...
function GetSymbolByType(priceType)
    priceType = priceType or getCurPriceType()
    if priceType == PRICE_TYPE.CNY then
        return "¥"
    elseif priceType == PRICE_TYPE.USD then
        return "$"
    elseif priceType == PRICE_TYPE.HKD then
        return "HK$"
    elseif priceType == PRICE_TYPE.GBP then
        return "￡"
    elseif priceType == PRICE_TYPE.EUR then
        return "€"
    end
end
