...
WIN_UPDATE                  = false 
UPDATE_SKIP                 = false                  -- 是否跳过版本更新
SHOW_GM                     = false
MUTIL_LOGIN                 = 0                     -- 客户端登录入口个数 (0平台登录 ) 
WAIT_SDK_INIT_SUC           = false                 -- 需要等待SDK初始化完成
CC_SHOW_FPS                 = false

MAIN_VERSION                = 102                   -- 主版本号，显示用，1.0.100前面的1.0就是这个算出来的
...
-- CHANNEL_PRE                   = ""
-- PLATFORM_NAME               = "symlf"               -- 平台名，决定读取的cdn，注册服地址之类的。
-- URL_LUA_CONFIG="http://register.sszg.shiyuegame.com/update/config/url_config_sszgmix.lua"    

-- 日志上报地址
LOG_URL = "http://log.sszg.siyuegame.com/index.php"
