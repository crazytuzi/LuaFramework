--[[ 累计充值分段奖励 ]]--
local M = class( "temp152" , require("src/TabViewLayer") )
...
function M:tableCellAtIndex( table , idx )
    ...
    createLabel( cell , string.format( game.getStrByKey("charge_yuanbao") , curData.level ) , cc.p( 10 , size.height-32 ) , cc.p( 0 , 0 ) , 20 , nil , nil , nil , MColor.lable_yellow )
