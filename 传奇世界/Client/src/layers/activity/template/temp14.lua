-- 连续登录送
local temp14 = class( "temp14" , function() return cc.Node:create() end )
function temp14:ctor( params )
    self.data = {}
    ...
    local function createLayout()
        ...
        createLabel( self.viewLayer , game.getStrByKey("lianxu_login") .. ": " .. self.data.progress .. "/" .. self.data.arg1, cc.p( 350 , 82 ) , cc.p( 0.5 , 0 ) , 22 , true , 200 , nil , MColor.lable_yellow , nil , nil , MColor.black , 3 )
