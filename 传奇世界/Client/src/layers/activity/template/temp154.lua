-- 累计击杀指定怪物数
local M = class( "temp154" , require("src/TabViewLayer") )
...
function M:tableCellAtIndex( table , idx )
    ...
    createLabel( cell , string.format( game.getStrByKey("kill_monster") , curData.level ) , cc.p( 10 , size.height-32 ) , cc.p( 0 , 0 ) , 20 , nil , nil , nil , MColor.lable_yellow )
    ...
    -- 右对齐
    createLabel( cell , tmpNumStr, cc.p( 640 , 90 ) , cc.p( 1 , 0 ) , 20 , nil , nil , nil , MColor.lable_yellow )
