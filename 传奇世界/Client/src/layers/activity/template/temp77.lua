-- 组队击杀指定怪物
local M = class( "temp77" , require("src/TabViewLayer") )
...
function M:tableCellAtIndex( table , idx )
    ...
    createLabel( cell , game.getStrByKey("make_team") .. game.getStrByKey("social_kill_me") .. curData.level .. game.getStrByKey("baby_material_number") , cc.p( 10 , size.height-32 ) , cc.p( 0 , 0 ) , 20 , nil , nil , nil , MColor.lable_yellow )
