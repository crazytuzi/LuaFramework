-- 任务送
local M = class( "temp78" , require("src/TabViewLayer") )
...
function M:tableCellAtIndex( table , idx )
    ...
    createLabel( cell , string.format(game.getStrByKey("week_tuto22"), curData.level), cc.p( 10 , size.height-32 ) , cc.p( 0 , 0 ) , 20 , nil , nil , nil , MColor.lable_yellow )
