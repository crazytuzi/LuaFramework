-- 累计登录送
local temp13 = class( "temp13" , function() return cc.Node:create() end )
function temp13:ctor( params )
    self.data = {}
    ...
    local function createLayout()
        ...
        createLabel( self.viewLayer , game.getStrByKey("total_login") .. ": " .. self.data.progress .. "/" .. self.data.arg1, cc.p( 350 , 82 ) , cc.p( 0.5 , 0 ) , 22 , true , 200 , nil , MColor.lable_yellow , nil , nil , MColor.black , 3 )
