-- 累计充值促销
local temp111 = class( "temp111" , function() return cc.Node:create() end )
function temp111:ctor( params )
    self.data = {}
    ...
    local function createLayout()
        ...
        createLabel( self.viewLayer , game.getStrByKey("totoal_charge") .. ": " .. self.data.progress .. "/" .. self.data.money, cc.p( 350 , 82 ) , cc.p( 0.5 , 0 ) , 22 , true , 200 , nil , MColor.lable_yellow , nil , nil , MColor.black , 3 )
