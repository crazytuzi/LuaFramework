--[[ 世界boss参与送 ]]--
local M = class( "temp72" , require("src/TabViewLayer") )
...
function M:tableCellAtIndex( table , idx )
    ...
    createLabel( cell , game.getStrByKey("join_str") .. curData.level .. game.getStrByKey("times") , cc.p( 10 , size.height-32 ) , cc.p( 0 , 0 ) , 20 , nil , nil , nil , MColor.lable_yellow )
