-- 熔炼指定部位N次返利
local M = class( "temp74" , require("src/TabViewLayer") )
...
function M:tableCellAtIndex( table , idx )
    ...
    createLabel( cell , string.format(game.getStrByKey("ronglian_number"), curData.level), cc.p( 10 , size.height-32 ) , cc.p( 0 , 0 ) , 20 , nil , nil , nil , MColor.lable_yellow )
