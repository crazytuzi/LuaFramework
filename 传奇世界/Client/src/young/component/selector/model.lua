...
local switch = 
{
	-- 数据是等差数列
	["+"] = function(params)
		return require("src/young/component/selector/AProgression").new(params)
	end,
	
	-- 数据是等比数列
	["*"] = function(params)
		return require("src/young/component/selector/GProgression").new(params)
	end,
	
	-- 定制的数据
	["table"] = function(params)
		return require("src/young/component/selector/customized").new(params)
	end,
