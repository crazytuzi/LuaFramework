CYZDDDlgItem = class("CYZDDDlgItem", CcsSubView)
function CYZDDDlgItem:ctor(rank, info)
  CYZDDDlgItem.super.ctor(self, "views/yzdditem.json")
  local rankPath
  if rank == 1 then
