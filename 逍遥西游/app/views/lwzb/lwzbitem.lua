CLWZBDlgItem = class("CLWZBDlgItem", CcsSubView)
function CLWZBDlgItem:ctor(rank, info)
  CLWZBDlgItem.super.ctor(self, "views/lwzbitem.json")
  local rankPath
  if rank == 1 then
  ...
  local honour = info.honour or 0
  self:getNode("hounr"):setText(tostring(honour))
