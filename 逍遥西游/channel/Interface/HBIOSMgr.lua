local HBIOSMgr = class("HBIOSMgr", ChannelClassBase)
local appId = "116870"
...
function HBIOSMgr:Init(gameParam, listener)
  print("HBIOSMgr:Init:", listener)
...
function HBIOSMgr:getLoginAccessToken()
...
function HBIOSMgr:setGameServer(serverParam)
end
function HBIOSMgr:showToolBar(place)
  local r_place = 0
...
function HBIOSMgr:hideToolBar()
  return self:setToolBar(0)
end
function HBIOSMgr:setToolBar(place)
...
function HBIOSMgr:enterPersonCenter()
...
function HBIOSMgr:MessageCallBack(data, isSucceed)
  if data == nil then
...
function HBIOSMgr:CallAfterPayDelay(cbkey)
...
function HBIOSMgr:sendLoginProtocol(gameType, deveceType)
...
function HBIOSMgr:enterGame(roleParam)
