local t = 
{
				...
				
				{
					...
					components = 
					{
						...
						},
						{
							...
							ignoreSize = "True",
							name = "btn_ok",
							normal = "ui_new/common/btn_tomission.png",
							sizepercentx = "0",
							sizepercenty = "0",
							sizeType = "0",
							srcBlendFunc = "1",
						...
						},
						{
							...
							sizeType = "0",
							srcBlendFunc = "1",
							texturePath = "ui_new/common/img_zhuangbeibuzu.png",
							touchAble = "False",
							UILayoutViewModel = 
							{
								PositionY = 100,
						...
						},
						{
							...
							height = "43",
							ignoreSize = "True",
							name = "Image_NeedEquipComfirmLayer_1",
							sizepercentx = "0",
							sizepercenty = "0",
							sizeType = "0",
							srcBlendFunc = "1",
	...
	respaths = 
	{
		textures = 
		{
			...
			"ui_new/common/btn_tomission.png",
			"ui_new/common/btn_cancel.png",
			"ui_new/common/img_zhuangbeibuzu.png",
