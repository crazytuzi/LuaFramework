-- Filename: PreHeroShowLayer.lua
-- Author: zhz
-- Date: 2013-09-18
-- Purpose: 该文件用于: 武将系统中招将预览

module("PreHeroShowLayer", package.seeall)
...
function createLayer(  )
	...
	heroShowBg:addChild(titleBg)	
	 --武将兑换的的标题文本
	local labelTitle = CCRenderLabel:create(GetLocalizeStringBy("key_3165"), g_sFontPangWa,33,2,ccc3(0x00,0x00,0x0),type_shadow)
    ...
    -- 说明
    _introduceLabel = CCRenderLabel:create(GetLocalizeStringBy("key_1919"), g_sFontName,20,1,ccc3(0x49,0x00,0x0),type_stroke)
    _introduceLabel:setColor(ccc3(0xff,0xe4,0x00))
    _introduceLabel:setPosition(ccp(58,531))
