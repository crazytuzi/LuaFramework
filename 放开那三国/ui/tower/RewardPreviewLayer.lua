-- FileName: RewardPreviewLayer.lua 
-- Author: Li Cong 
-- Date: 14-1-7 
-- Purpose: function description of module 


module("RewardPreviewLayer", package.seeall)
...
function createLayer( )
	...
	--奖励的标题文本
	local labelTitle = CCRenderLabel:create(GetLocalizeStringBy("key_2924"), g_sFontPangWa,33,1,ccc3(0x0,0x00,0x0),type_stroke)
	...
	-- -- 休息前一晚23点发奖
	-- local tableDay = {GetLocalizeStringBy("key_1557"),GetLocalizeStringBy("zzh_1284"),GetLocalizeStringBy("key_2665"),GetLocalizeStringBy("key_2579"),GetLocalizeStringBy("key_1504"),GetLocalizeStringBy("key_2645"),GetLocalizeStringBy("zzh_1285")}
	-- local dateStr = nil
...
function createTableView( )
    ...
    local h = LuaEventHandler:create(function(fn, table, a1, a2)    --创建
        ...
        elseif fn == "cellAtIndex" then
            a2 = RewardPreviewCell.createCell(rewardData[a1+1])
            r = a2
...
function hanleRewardData( )
	...
	for k,v in pairs(tData) do
		table.insert(rewardData, DB_Tower_layer.getDataById(v[1]))
	end
