-- Filename: TrainIntroductionLayer.lua
-- Author: DJN
-- Date: 2014-08-11
-- Purpose: 修行玩法介绍

module("TrainIntroductionLayer", package.seeall)
...
function createBgUI()
    ...
    local bgSize = CCSizeMake(620,520)
    ...
    --正文
    local descLabel = CCLabelTTF:create(GetLocalizeStringBy("djn_25"),g_sFontName,24,CCSizeMake(bgSize.width*0.9,bgSize.height*0.6),kCCTextAlignmentLeft)
