-- Filename: CardIntroductionLayer.lua
-- Author: DJN
-- Date: 2014-08-11
-- Purpose: 铜雀翻牌活动介绍

module("CardIntroductionLayer", package.seeall)
...
function createBgUI()
    ...
    --正文
    local descLabel = CCLabelTTF:create(GetLocalizeStringBy("djn_24"),g_sFontName,24,CCSizeMake(bgSize.width*0.9,bgSize.height*0.6),kCCTextAlignmentLeft)
