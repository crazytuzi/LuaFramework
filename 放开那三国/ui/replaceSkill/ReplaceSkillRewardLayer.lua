-- Filename: ReplaceSkillRewardLayer.lua
-- Author: DJN
-- Date: 2014-08-12
-- Purpose: 主角换技能翻牌奖励预览

module("ReplaceSkillRewardLayer", package.seeall)
require "script/audio/AudioUtil"
require "script/ui/replaceSkill/ReplaceSkillRewardTableView"
...
function createBgUI()
    ...
    local titleLabel = CCLabelTTF:create(GetLocalizeStringBy("djn_22"), g_sFontPangWa, 30)
    ...
    brownSprite:setContentSize(CCSizeMake(575,732))
    ...
    --创建展示的tableview
    local _preViewLayer = ReplaceSkillRewardTableView.createTableView()
