-- Filename: NewPackageNotice.lua
-- Author: lichenyang
-- Date: 2017-04-07
-- Purpose: 新包公告

require "script/utils/BaseUI"
module("NewPackageNotice",package.seeall)
...
function create( p_touchPriority )
    ...
    local displayName = CCRenderLabel:create(GetLocalizeStringBy("key_2171"), g_sFontPangWa, 35, 3, ccc3( 255, 255, 255), type_stroke)
    ...
    local baseLabel = CCLabelTTF:create(GetLocalizeStringBy("key_10047"), g_sFontName, 24)
    ...
    local descLabel = CCLabelTTF:create(GetLocalizeStringBy("lcyx_9048"),g_sFontName,24,CCSizeMake(m_layerSize.width*0.9, height),kCCTextAlignmentLeft)
