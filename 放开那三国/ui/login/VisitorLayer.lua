...
module ("VisitorLayer", package.seeall)
...
function showVisitorLayer( username, password, uid )
	ininlize()
	_username = username
	_password = password
	_uid = uid
	...
	--奖励的标题文本
	local labelTitle = CCRenderLabel:create(GetLocalizeStringBy("bx_1003"), g_sFontPangWa,35,2,ccc3(0x0,0x00,0x0),type_stroke)
	...
	local infoLabel2 = CCLabelTTF:create(GetLocalizeStringBy("bx_1011"), g_sFontName, 28,size_infoLabel,kCCTextAlignmentCenter,kCCVerticalTextAlignmentCenter)
