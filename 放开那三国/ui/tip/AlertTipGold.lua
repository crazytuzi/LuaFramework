...
-- Filename：	AlertTipGold.lua
-- Author：		Cheng Liang
-- Date：		2013-11-11
-- Purpose：		据点攻打次数不够,重置

module("AlertTipGold", package.seeall)
...
--
function showAlert(tip_text, gold_num, confirmCBFunc)
	...
	-- 描述
	local descLabel = CCLabelTTF:create(GetLocalizeStringBy("key_2173") ..  gold_num .. tip_text, g_sFontName, 25, CCSizeMake(460, 120), kCCTextAlignmentCenter, kCCVerticalTextAlignmentTop)
