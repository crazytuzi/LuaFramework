...
--[[
	...
	@return void
--]]
function showAlert( tipText, confirmCBFunc, isNeedCancel, argsCB, confirmTitle, cancelTitle, closeCallbackFunc,isNeedKuoChong,isNeedCloseBtn)
	...
	closeBtn:setVisible(isNeedCloseBtn)
