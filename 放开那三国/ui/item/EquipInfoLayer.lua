...
function createItemInfo( pDesc )
    ...
    local textInfo = {
 	...
 	-- 计算高度
 	needHeight = fontNode:getContentSize().height + 40
...
function createInfoScrollview( ... )
	...
	if judgeUserLvShowLv() and equip_desc.new_quality ~= nil then
		contentHeight = cardSprite:getContentSize().height+attrSprite:getContentSize().height+infoSprite:getContentSize().height+devAttrSprite:getContentSize().height+devAllAttrSprite:getContentSize().height+150
	else
		contentHeight = cardSprite:getContentSize().height+attrSprite:getContentSize().height+infoSprite:getContentSize().height+90
	end
	...
	attrSprite:setPosition(ccp(bgSprite:getContentSize().width*0.5,cardSprite:getPositionY()-cardSprite:getContentSize().height-30))
	if judgeUserLvShowLv() and equip_desc.new_quality ~= nil then
...
function setDevCallback( pCallback )
	equipDevCallback = pCallback
end
