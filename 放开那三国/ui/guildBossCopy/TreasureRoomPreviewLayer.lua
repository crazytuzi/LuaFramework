...
module("TreasureRoomPreviewLayer", package.seeall)
...
function create( p_touchPriority, p_zOrder)
	...
	local dialogInfo = {}
    dialogInfo.title = GetLocalizeStringBy("key_10137")
...
function loadTableView( ... )
    ...
    tableViewBg:setContentSize(CCSizeMake(490, 409))
    ...
    title:setColor(ccc3(0xff, 0xe4, 0x00))
     ...
     local h = LuaEventHandler:create(function(fn, tableView, a1, a2)    --创建
        ...
        elseif fn == "numberOfCells" then
            r = math.ceil(#GuildBossCopyData.getBoxRewardInfo() / 3)
