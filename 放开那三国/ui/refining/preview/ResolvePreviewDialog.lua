-- Filename: ResolvePreviewDialog.lua
-- Author: lgx
-- Date: 2016-05-09
-- Purpose: 炼化预览界面

module("ResolvePreviewDialog", package.seeall)
...
function createDialog( pItemArrData, pHadFiveStr, pHadMaxStar, pCallBackFunc, pTouchPriority, pZorder )
	...
	local titleLabel = CCRenderLabel:create(GetLocalizeStringBy("lgx_1050"), g_sFontPangWa, 33 ,1, ccc3( 0x00, 0x00, 0x00), type_stroke)
	...
	-- 提示文字 炼化后将会获得
	local noticeLabel = CCLabelTTF:create(GetLocalizeStringBy("lgx_1052"), g_sFontPangWa, 25)
