-- FileName: TsTreasurePreviewLayer.lua 
-- Author: licong 
-- Date: 16/3/4 
-- Purpose: 宝物转换预览


module("TsTreasurePreviewLayer", package.seeall)
...
function createTableView( ... )
	_showItems = TsTreasureData.getAllTransformItemTid()
...
function createUI()
	...
	local titleLabel = CCLabelTTF:create(GetLocalizeStringBy("lic_1803"), g_sFontPangWa, 33)
	...
	_secondBg:setContentSize(CCSizeMake(550, 400))
 	...
 	-- 提示
 	local tipFont = CCLabelTTF:create(GetLocalizeStringBy("lic_1808"), g_sFontPangWa, 25)
