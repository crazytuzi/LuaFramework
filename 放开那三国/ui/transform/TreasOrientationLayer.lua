-- FileName: TreasOrientationLayer.lua 
-- Author: licong 
-- Date: 16/3/4 
-- Purpose: 宝物定向选择界面


module("TreasOrientationLayer", package.seeall)
...
function createTableView( ... )
	_showItems = TsTreasureData.getTransformItemByTid(_oldTid)
...
function createUI()
	...
	_secondBg:setContentSize(CCSizeMake(550, 320))
 	...
 	-- 提示
 	local tipFont = CCLabelTTF:create(GetLocalizeStringBy("lic_1806"), g_sFontPangWa, 25)
