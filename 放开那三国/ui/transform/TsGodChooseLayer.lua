-- FileName: TsGodChooseLayer.lua 
-- Author: licong 
-- Date: 16/3/3 
-- Purpose: 转换神兵选择界面 


module("TsGodChooseLayer", package.seeall)
...
function initSelectData( )
	-- 得到材料列表
	local materialListData = TransformGodData.getChooseItemData()
	-- 得到已选择的列表
	_selectList = TransformGodData.getSelectGodList()
...
function checkedSelectCell( item_id )
	...
	--  添加新的
	TransformGodData.addGodToSelectList(item_id)
end
---------------------------------------------------------------- 创建ui --------------------------------------------------------------------
