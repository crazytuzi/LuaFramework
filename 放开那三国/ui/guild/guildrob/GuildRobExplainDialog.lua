-- Filename: LordWarExplainDialog.lua
-- Author: lichenyang
-- Date: 2014-07-14
-- Purpose: 擂台争霸4强场景

require "script/utils/BaseUI"
module("GuildRobExplainDialog",package.seeall)
...
function create( p_touchPriority )
    ...
    local baseLabel = CCLabelTTF:create(GetLocalizeStringBy("key_10039"), g_sFontName, 24)
    local height =  baseLabel:getContentSize().height * 36
    ...
    local descLabel = CCLabelTTF:create(GetLocalizeStringBy("lcyx_105"),g_sFontName,24,CCSizeMake(m_layerSize.width*0.9, height),kCCTextAlignmentLeft)
