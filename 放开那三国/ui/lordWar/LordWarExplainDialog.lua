...
module("LordWarExplainDialog",package.seeall)
...
function create( p_touchPriority )
    ...
    local descLabel = CCLabelTTF:create(GetLocalizeStringBy("lcy_50047"),g_sFontName,24,CCSizeMake(m_layerSize.width*0.9, height),kCCTextAlignmentLeft)
