...
function getPidUrl( sessionid )
	...
	local postString = url .. "?token=" .. sessionid .. "&sid=" .. Platform.sdkLoginInfo.username .. "&account=".. Platform.getSdk():callStringFuncWithParam("getLoginName",nil).."&time=".. BTUtil:getSvrTimeInterval() .. Platform.getUrlParam().."&bind=" .. g_dev_udid
 	return postString
end 
