...
function getPidUrl( sessionid )
	...
	local postString = url .. "?UserCode=" .. sessionid .. "&username=" .. Platform.sdkLoginInfo.username .. "&account=".. Platform.getSdk():callStringFuncWithParam("getLoginName",nil).."&time=".. BTUtil:getSvrTimeInterval() .. Platform.getUrlParam().."&bind=" .. g_dev_udid
 	return postString
end 
