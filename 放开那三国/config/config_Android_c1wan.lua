...
function getPidUrl( sessionid )
	...
	local postString = url .. "?session_id=" .. sessionid .. "&pid=" .. Platform.sdkLoginInfo.pid .. "&uid=" .. Platform.sdkLoginInfo.uid .. "&account=".. Platform.getSdk():callStringFuncWithParam("getLoginName",nil).."&time=".. BTUtil:getSvrTimeInterval() .. Platform.getUrlParam().."&bind=" .. g_dev_udid
 	return postString
end 
...
function getAppKey( ... )
	return "ef1a38140af857a1382213e8026dc945"
end
