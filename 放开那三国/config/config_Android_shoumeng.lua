-- Filename: config_Android_shoumeng.lua
-- Author: kun liao
-- Date: 2014-05-06
-- Purpose: android 手盟 平台配置
...
function getPidUrl( sessionid )
	...
	local postString = url .. "?sessionid=" .. sessionid.."&userid="..Platform.sdkLoginInfo.userId..Platform.getUrlParam().."&bind=" .. g_dev_udid
 	return postString
end 
