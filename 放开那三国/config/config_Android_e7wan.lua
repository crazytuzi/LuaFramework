-- Filename: config_Android_e7wan.lua
-- Author: lei yang
-- Date: 2014-5-5
-- Purpose: android e7玩 平台配置
...
function getPidUrl( sessionid )
	...
	local postString = url .. "?uid=" .. sessionid .. "&username=" .. Platform.sdkLoginInfo.username .. "&account=".. Platform.getSdk():callStringFuncWithParam("getLoginName",nil).."&time=".. BTUtil:getSvrTimeInterval() .. Platform.getUrlParam().."&bind=" .. g_dev_udid
 	return postString
end 
