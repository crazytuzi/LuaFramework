...
function getGsFont( ... )
    local gsFontTable = {}
    gsFontTable.fontName    = "Tahoma"              --"STHeitiSC-Medium"    -- 通用字体名称
    gsFontTable.fontPangWa  = "UVNNguyenDu"         -- 胖娃体
    return gsFontTable
end 
...
function getAdShowUrl( ... )
 	return g_web_domain_name.. "phone/adshow?pl="..getFlag().."&os=ios&gn=sanguo&version="
end 
