...
function getPidUrl( sessionid )
	...
	local postString = url .."?access_token=" .. Platform.sdkLoginInfo.sid .. "&open_uid=" .. Platform.sdkLoginInfo.uid .. Platform.getUrlParam() .."&bind=" .. g_dev_udid
 	return postString
end 
