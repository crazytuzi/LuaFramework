-- Filename: config_Android_taobao.lua
-- Author: kun liao
-- Date: 2014-04-12
-- Purpose: android 淘宝 平台配置
...
function getPidUrl( sessionid )
	...
	local postString = url .. "?userid=" .. sessionid.."&nick="..Platform.sdkLoginInfo.nick..Platform.getUrlParam().."&bind=" .. g_dev_udid
 	return postString
end 
...
function getAppKey( ... )
	return "5851d1981739be93588c90f6ae700978"
end
...
function getAppKey_debug( ... )
	--return "1539fad7784494515ff180c4432fdb24"
    return "5851d1981739be93588c90f6ae700978"
end
