-- Filename: config_Android_ck.lua
-- Author: lei yang
-- Date: 2014-3-13
-- Purpose: android 触控 平台配置
...
function getPidUrl( sessionid )
	...
	local postString = url .. "?userId=" .. sessionid .. "&account=".. Platform.getSdk():callStringFuncWithParam("getLoginName",nil).."&time=".. BTUtil:getSvrTimeInterval() .. Platform.getUrlParam().."&bind=" .. g_dev_udid
 	return postString
end 
...
function getAppKey( ... )
	return "689d24c059f8d5494c1fcc3c78f87989"
end
