...
function getPidUrl( sessionid )
	...
	local postString = url .."?openid=" .. Platform.sdkLoginInfo.uid .. Platform.getUrlParam() .."&bind=" .. g_dev_udid
 	return postString
end 
-- 这俩属性必须写，否则启动黑屏
function getAppId( ... )
...
function getInitParam(  )
    ...
    dict:setObject(CCString:create("11005"),"TRUNID")
    dict:setObject(CCString:create("5506"),"APPID")
    return dict
end