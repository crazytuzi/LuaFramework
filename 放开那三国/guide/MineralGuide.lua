-- FileName: MineralGuide.lua 
-- Author: Li Cong 
-- Date: 13-9-29 
-- Purpose: function description of module 


module("MineralGuide", package.seeall)
...
function create3Layer(touchRect)
	...
	local str = GetLocalizeStringBy("key_3331")
