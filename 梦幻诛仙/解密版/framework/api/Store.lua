...
function Store.init(listener)
  ...
  cc.storeProvider = CCStore:sharedStore()
...
function Store.setReceiptVerifyMode(mode, isSandbox)
  ...
  if type(mode) ~= "number" or mode ~= CCStoreReceiptVerifyModeNone and mode ~= CCStoreReceiptVerifyModeDevice and mode ~= CCStoreReceiptVerifyModeServer then
