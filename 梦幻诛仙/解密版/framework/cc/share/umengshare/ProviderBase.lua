...
function ProviderBase:doCommand(args)
  ...
  elseif args.command == "shareMusic" then
    self:shareMusic(args.args.shareText, args.args.shareMusic, args.args.shareMusicImg, args.args.shareTitle, args.args.shareAuthor)
  elseif args.command == "shareVideo" then
    self:shareMusic(args.args.shareText, args.args.shareVideo, args.args.shareVideoImg, args.args.shareTitle)
  else
