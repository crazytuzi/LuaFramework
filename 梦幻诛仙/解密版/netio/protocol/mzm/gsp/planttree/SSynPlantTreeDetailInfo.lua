local SSynPlantTreeDetailInfo = class("SSynPlantTreeDetailInfo")
SSynPlantTreeDetailInfo.TYPEID = 12611601
function SSynPlantTreeDetailInfo:ctor(owner_id, activity_cfg_id, current_section_id, current_section_point, special_state_index, logs)
  self.id = 12611601
...
function SSynPlantTreeDetailInfo:marshal(os)
...
function SSynPlantTreeDetailInfo:unmarshal(os)
...
function SSynPlantTreeDetailInfo:sizepolicy(size)
  return size <= 65535
end
return SSynPlantTreeDetailInfo
