...
local SBrocastEndParade = class("SBrocastEndParade")
SBrocastEndParade.TYPEID = 12599842
function SBrocastEndParade:ctor(role1Info, role2Info)
  self.id = 12599842
  self.role1Info = role1Info or ParadeRoleInfo.new()
  self.role2Info = role2Info or ParadeRoleInfo.new()
end
function SBrocastEndParade:marshal(os)
  self.role1Info:marshal(os)
  self.role2Info:marshal(os)
end
function SBrocastEndParade:unmarshal(os)
  self.role1Info = ParadeRoleInfo.new()
  self.role1Info:unmarshal(os)
  self.role2Info = ParadeRoleInfo.new()
  self.role2Info:unmarshal(os)
end
function SBrocastEndParade:sizepolicy(size)
  return size <= 65535
end
return SBrocastEndParade
