...
local AddBindVitalityInfo = class("AddBindVitalityInfo")
AddBindVitalityInfo.TYPEID = 12600380
function AddBindVitalityInfo:ctor(vitality_info, recall_bind_infos, back_bind_infos)
  self.id = 12600380
...
function AddBindVitalityInfo:marshal(os)
...
function AddBindVitalityInfo:unmarshal(os)
...
function AddBindVitalityInfo:sizepolicy(size)
  return size <= 65535
end
return AddBindVitalityInfo
