...
local WantedRoleInfo = class("WantedRoleInfo")
function WantedRoleInfo:ctor(roleId, name, avatarId, gender, menpai, level, endTimeStamp, avatarFrameId)
...
function WantedRoleInfo:marshal(os)
...
function WantedRoleInfo:unmarshal(os)
