...
local OperationLockHunItemUse = Lplus.Extend(OperationBase, "OperationLockHunItemUse")
local def = OperationLockHunItemUse.define
def.override("number", "table", "table", "=>", "boolean").CanDispaly = function(self, source, item, itemBase)
  local ItemType = require("consts.mzm.gsp.item.confbean.ItemType")
  if source == ItemTipsMgr.Source.Bag and itemBase.itemType == ItemType.LOCK_EQUIP_HUN_ITEM then
    return true
  else
    return false
  end
...
OperationLockHunItemUse.Commit()
return OperationLockHunItemUse
