...
local OperationMarketShareWorld = Lplus.Extend(OperationMarketShareBase, "OperationMarketShareWorld")
local def = OperationMarketShareWorld.define
...
OperationMarketShareWorld.Commit()
return OperationMarketShareWorld
