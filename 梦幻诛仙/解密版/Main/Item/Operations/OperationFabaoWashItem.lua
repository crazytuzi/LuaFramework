...
local OperationFabaoWashItem = Lplus.Extend(OperationBase, "OperationFabaoWashItem")
local def = OperationFabaoWashItem.define
...
OperationFabaoWashItem.Commit()
return OperationFabaoWashItem
