...
local PrisonPlayer = Lplus.Class("PrisonPlayer")
local def = PrisonPlayer.define
...
def.method("=>", "number").GetPrisonEndTime = function(self)
  if self.endTime == nil then
    return 0
  end
  return Int64.ToNumber(self.endTime / 1000)
end
