...
local CrossBattleFinalFightInfoPanel16 = Lplus.Extend(ECPanelBase, "CrossBattleFinalFightInfoPanel16")
...
local def = CrossBattleFinalFightInfoPanel16.define
...
local instance
def.static("=>", CrossBattleFinalFightInfoPanel16).Instance = function()
  if instance == nil then
    instance = CrossBattleFinalFightInfoPanel16()
  end
  return instance
end
def.method("number", "table", "table", "table", "number").ShowPanel = function(self, curStage, stageInfo, corpsData, fightInfo, ruleTipsId)
  ...
  self:CreatePanel(RESPATH.PREFAB_TEAM_PVP_CROSS_FIGHT_INFO_16, 1)
  self:SetModal(true)
end
...
def.method().InitUI = function(self)
  ...
  self.uiObjs.Group_Graph = self.uiObjs.Img_Bg0:FindDirect("Group_Type02")
...
def.method().FillSelectedBattleGraph = function(self)
  ...
  local Group16 = {
    "Group_Left/Group_01/Position01",
    "Group_Left/Group_01/Position02",
    "Group_Left/Group_02/Position01",
    "Group_Left/Group_02/Position02",
    "Group_Left/Group_03/Position01",
    "Group_Left/Group_03/Position02",
    "Group_Left/Group_04/Position01",
    "Group_Left/Group_04/Position02",
    "Group_Right/Group_01/Position01",
    "Group_Right/Group_01/Position02",
    "Group_Right/Group_02/Position01",
    "Group_Right/Group_02/Position02",
    "Group_Right/Group_03/Position01",
    "Group_Right/Group_03/Position02",
    "Group_Right/Group_04/Position01",
    "Group_Right/Group_04/Position02"
  }
  local stageFightResult16 = self:GetStageFightResult(self.stageFightInfo[1])
  for i = 1, #Group16 do
  ...
  local Group8 = {
    "Group_Left/Group_01/Position03",
    "Group_Left/Group_02/Position03",
    "Group_Left/Group_03/Position03",
    "Group_Left/Group_04/Position03",
    "Group_Right/Group_01/Position03",
    "Group_Right/Group_02/Position03",
    "Group_Right/Group_03/Position03",
    "Group_Right/Group_04/Position03"
  }
  local stageFightResult8 = self:GetStageFightResult(self.stageFightInfo[2])
  for i = 1, #Group8 do
  ...
  local Group4 = {
    "Group_Left/Group_05/Position01",
    "Group_Left/Group_06/Position01",
    "Group_Right/Group_05/Position01",
    "Group_Right/Group_06/Position01"
  }
  local stageFightResult4 = self:GetStageFightResult(self.stageFightInfo[3])
  for i = 1, #Group4 do
  ...
  local stageFightResult3 = self:GetStageFightResult(self.stageFightInfo[4])
  for i = 1, #Group3 do
  ...
  local Group1 = {
    "Group_Left/Group_07/Position01",
    "Group_Right/Group_07/Position01"
  }
  local stageFightResult1 = self:GetStageFightResult(self.stageFightInfo[5])
  for i = 1, #Group1 do
...
CrossBattleFinalFightInfoPanel16.Commit()
return CrossBattleFinalFightInfoPanel16
