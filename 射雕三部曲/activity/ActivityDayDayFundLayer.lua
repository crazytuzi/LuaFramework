--[[
    文件名: ActivityDayDayFundLayer.lua
	描述: 天天基金页面, 模块Id为：ModuleSub.eExtraActivityDayDayFund
	效果图: j精彩活动_天天基金.jpg
	创建人: liaoyuangang
	创建时间: 2016.6.2
--]]

local ActivityDayDayFundLayer = class("ActivityDayDayFundLayer", function()
...
function ActivityDayDayFundLayer:ctor(params)
	params = params or {}
	-- 活动实体Id列表
...
-- 获取恢复数据
function ActivityDayDayFundLayer:getRestoreData()
	local retData = {
...
-- 初始化页面控件
function ActivityDayDayFundLayer:initUI()
	-- Todo
end

return ActivityDayDayFundLayer
