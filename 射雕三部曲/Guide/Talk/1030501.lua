...
----正式剧情
...

	{
     ...
     {
         load = {tmpl = "talk",
             params = {"lby",TR("江湖凶险，需要不断提升实力才能存活，而突破是最有效的方式之一"),419},},
     },
     ...
     {
         load = {tmpl = "talk",
             params = {"zj",TR("那我要怎么做才能突破呢？"),74},},
     },

     {
         load = {tmpl = "talk",
             params = {"lby",TR("突破需要打通奇经八脉，每次须辅以丹药配合，否者极易走火入魔"),417},},
     },


     {
         load = {tmpl = "talk",
             params = {"zj",TR("哇，这么危险？"),75},},
     },

     {
         load = {tmpl = "talk",
             params = {"lby",TR("不必担心，为师会在关键时刻以内力为你护持，保你周全"),418},},
     },
