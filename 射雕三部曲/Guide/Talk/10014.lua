...
----正式剧情
...

	{
     ...
     {
         load = {tmpl = "move2",
             params = {"hlb","hlb.png",TR("洪凌波")},},
     },
     {
         load = {tmpl = "talk",
             params = {"hlb",TR("我叫洪凌波！多谢相助！"),248},},
     },
     ...
     {
         load = {tmpl = "talk1",
             params = {"zj",TR("没事！没事！路见不平拔刀相助，顺便再砍他两刀，这都是应该的！"),7},},
     },
     ...
     {
         load = {tmpl = "talk2",
             params = {"zj",TR("洪姑娘，看你独自一人，不若与我们同行！"),8},},
     },


     {
         load = {tmpl = "talk",
             params = {"hlb",TR("（这家伙虽然傻里傻气的，功夫倒是挺厉害！反正也找不着师父，不如就跟着他好了。）"),249},},
     },
