...
-------------------------
...

	{
     ...
     {
         load = {tmpl = "zm",
             params = {TR("郭芙拉着杨过偷看丐帮大会，"),"900"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("却无意中听到——"),"850"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("郭靖想将自己许配给杨过，"),"800"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("郭芙又羞又急，心中不知是何滋味。"),"750"},},
     },
...
----正式剧情
...

	{
     ...
     {
         load = {tmpl = "talk",
             params = {"hr",TR("芙儿，怎么刚才不出去吃晚饭？是不是过儿惹我们大小姐生气啦？"),"6018.mp3"},},
     },
     ...
     {
         load = {tmpl = "talk",
             params = {"gf",TR("娘啊，你别老是过儿长过儿短的，我都听得烦死了。"),"6019.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"hr",TR("芙儿，你是不是很讨厌过儿？"),"6020.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"gf",TR("是啊，他老是仗着爹爹疼他，不可一世，而且自大得要命。"),"6021.mp3"},},
     },

     {
         load = {tmpl = "talk1",
             params = {"hr",TR("既然你说他一无是处，那为何当初他离开桃花岛的时候，你又对他依依不舍呢！"),"6022.mp3"},},
     },

     {
         load = {tmpl = "talk2",
             params = {"hr",TR("还整天打探他在全真教的消息呢？"),"6023.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"gf",TR("人家只是可怜他无父无母嘛，像他这种人，我怎么会把他放在心上！"),"6024.mp3"},},
     },

     {
         load = {tmpl = "talk1",
             params = {"hr",TR("是吗？你这几句话啊骗大小武还行。"),"6025.mp3"},},
     },

     {
         load = {tmpl = "talk0",
             params = {"hr",TR("这也难怪啦，过儿一表人才，聪明伶俐，比起大小武是强了许多！"),"6026.mp3"},},
     },

     {
         load = {tmpl = "talk0",
             params = {"hr",TR("你和他在一起当然比较开心，可惜啊，过儿的性格又倔强又自负…"),"6027.mp3"},},
     },

     {
         load = {tmpl = "talk2",
             params = {"hr",TR("真是让人对他又喜欢又不甘心，又想放弃又舍不得，你说是不是？"),"6028.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"gf",TR("娘啊，人家哪有舍不得啊！"),"6029.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"hr",TR("反正是你终身大事，勉强不来的，一切顺其自然吧！"),"6030.mp3"},},
     },
