...
-------------------------
...

	{
     ...
     {
         load = {tmpl = "zm",
             params = {TR("话说杨过下山寻找小龙女。"),"900"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("路途中偶遇陆无双，又被李莫愁一路追杀，"),"850"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("最后在郭芙的帮助下，吓跑了李莫愁，"),"800"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("然而相聚不久，杨过便因大小武的言语挤兑，"),"750"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("选择不辞而别。"),"700"},},
     },
    ...
    {delay = {time = 1,},},
     ...
     {
         load = {tmpl = "zm",
             params = {TR("经历一系列的人和事之后"),"600"},},
     },
     {
         load = {tmpl = "zm",
             params = {TR("杨过发现，在这世上……"),"550"},},
     },
     {
         load = {tmpl = "zm",
             params = {TR("只有小龙女是真心对自己好的人！"),"500"},},
     },
     {
         load = {tmpl = "zm",
             params = {TR("这让杨过不禁回忆起——"),"450"},},
     },
     {
         load = {tmpl = "zm",
             params = {TR("在古墓中与小龙女生活的点点滴滴！"),"400"},},
     },
...
----正式剧情
...

	{
     ...
     {
         load = {tmpl = "talk",
             params = {"yg",TR("龙姑娘，这几副棺材是……"),"3001.mp3"},},
     },
     ...
     {
         load = {tmpl = "talk",
             params = {"xln",TR("一副是我祖师婆婆的，一副是我师父的，一副是为我准备的！不过还少准备了一副！"),"3002.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"yg",TR("少了一副？给谁啊？"),"3003.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"xln",TR("给你的！"),"3004.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"yg",TR("不……不……不用了，我……我不想死在这里，我的那副，就不劳龙姑娘费心了！"),"3005.mp3"},},
     },

     {
         load = {tmpl = "talk1",
             params = {"xln",TR("我答应孙婆婆照顾你一生一世，而我——永远也不会离开这里！"),"3006.mp3"},},
     },

     {
         load = {tmpl = "talk2",
             params = {"xln",TR("你——自然也不例外！"),"3007.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"yg",TR("你不让我离开这里，那我可以等你死后，我再出去！你年纪比我大，肯定比我先死！"),"3008.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"xln",TR("既然我要照顾你一生一世，那我就一定不会比你先死！"),"3009.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"yg",TR("你不让我离开这里，那我可以等你死后我再出去，你年纪比我大，肯定比我先死！"),"3008.mp3"},},
     },
     ...
     {
         load = {tmpl = "talk",
             params = {"yg",TR("你——你怎么知道你一定比我长命？"),"3010.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"xln",TR("那当然了，因为在我死之前，我会先杀了你，这样——我也算真正照顾你一生一世！"),"3011.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"yg",TR("啊！？你——你怎么能这样，这哪算是照顾啊！"),"3012.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"xln",TR("你害怕了！"),"3013.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"yg",TR("谁……谁说我怕！"),"3014.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"xln",TR("真的不怕？那就跟我一起进古墓吧！"),"3015.mp3"},},
     },
