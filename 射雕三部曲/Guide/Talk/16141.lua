...
----正式剧情
...

	{
     ...
     {
         load = {tmpl = "talk1",
             params = {"gf",TR("杨过啊，你有没有空呀？"),"6001.mp3"},},
     },

     {
         load = {tmpl = "talk2",
             params = {"gf",TR("我娘呢——和丐帮的人在开丐帮大会，场面很热闹的，我们一起去看呀！"),"6002.mp3"},},
     },
     ...
     {
         load = {tmpl = "talk",
             params = {"yg",TR("还是算了吧，我这人不喜欢热闹！"),"6003.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"gf",TR("那个……杨过啊，你说大武小武俩兄弟谁比较好？"),"6004.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"yg",TR("我说两个都不好？"),"6005.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"gf",TR("为什么？"),"6006.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"yg",TR("如果我说他们好的话，那我岂不是没戏了！"),"6007.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"gf",TR("你说什么呢？人家可是说正经的。"),"6008.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"yg",TR("（杨过啊杨过，你在乱说什么呢！你难道忘了，你来这里是为了什么吗？）"),"6009.mp3"},},
     },

     {
         load = {tmpl = "talk1",
             params = {"gf",TR("啊！对了，上次你不告而别，我们找你的时候遇到一个白衣女子。"),"6010.mp3"},},
     },

     {
         load = {tmpl = "talk2",
             params = {"gf",TR("她听到你的名字，好像很在意的样子……"),"6011.mp3"},},
     },


     {
         load = {tmpl = "talk1",
             params = {"yg",TR("（什么！难道是姑姑！）"),"6012.mp3"},},
     },

     {
         load = {tmpl = "talk2",
             params = {"yg",TR("你……你是在哪里遇到她的？"),"6013.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"gf",TR("你这么紧张干嘛？她是什么人啊？"),"6014.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"yg",TR("她！？是……我师父！你先告诉我她在哪里？"),"6015.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"gf",TR("师父？真的吗？那你先陪我去看丐帮大会，路上我再告诉你！"),"6016.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"yg",TR("好！那我们快走！"),"6017.mp3"},},
     },
