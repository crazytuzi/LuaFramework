...
----正式剧情
...

	{
     ...
     {
         load = {tmpl = "talk",
             params = {"lws",TR("谁让你出手，这些臭道士我陆无双一只手就能打败，真是狗拿耗子多管闲事！"),199},},
     },
     ...
     {
         load = {tmpl = "talk1",
             params = {"zj",TR("（还真是陆无双！这泼辣劲也就只有她了！）"),42},},
     },

     {
         load = {tmpl = "talk0",
             params = {"zj",TR("可惜腿有点瘸，咦！？嘿嘿嘿！"),43},},
     },

     {
         load = {tmpl = "talk2",
             params = {"zj",TR("原来是陆姑娘啊，我看陆姑娘腿脚似乎……"),44},},
     },

     {
         load = {tmpl = "talk",
             params = {"lws",TR("你！——你要是不想和那些臭道士一个下场，就给我闭嘴！"),200},},
     },

     {
         load = {tmpl = "talk",
             params = {"zj",TR("唉！亏我好心——想替某人解决隐疾，看来我还真是狗拿耗子多管闲事！"),45},},
     },

     {
         load = {tmpl = "talk",
             params = {"lws",TR("（跛脚是我生平最大的恨事，如果这家伙真的有办法，那我就不用被人嘲笑……傻蛋也会……）"),201},},
     },

    {
     ...
     {
         load = {tmpl = "move1",
             params = {"lyj","lyj.png",TR("丐帮弟子")},},
     },
     {
         load = {tmpl = "talk",
             params = {"lyj",TR("长老，就是这妖女，害兄弟们被李莫愁所伤！"),202},},
     },

    {
     ...
     {
         load = {tmpl = "move1",
             params = {"wst","wst.png",TR("丐帮长老")},},
     },

     {
         load = {tmpl = "talk",
             params = {"wst",TR("姑娘，还请你随我到丐帮解释清楚!"),203},},
     },

     {
         load = {tmpl = "talk",
             params = {"lws",TR("有什么好解释的！你们自己蠢，武功还不济事，能怪得了谁！"),204},},
     },
     {
         load = {tmpl = "talk",
             params = {"wst",TR("既然这样，就别怪我们不客气了!"),205},},
     },
...

    {
     ...
     {
         load = {tmpl = "talk1",
             params = {"zj",TR("不是吧，这——又要和丐帮打一场——！"),46},},
     },	
