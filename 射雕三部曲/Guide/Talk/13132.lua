...
-------------------------
	...
	{
        music = {file = "xiangyang.mp3",},
    },


     {
         load = {tmpl = "zm",
             params = {TR("杨过初入古墓，"),"900"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("便拜了小龙女为师。"),"850"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("接着小龙女便开始传授杨过武功，"),"800"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("随着时间流逝，"),"750"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("杨过却发现了一丝不妙……"),"700"},},
     },
...
----正式剧情
...

	{
     ...
     {
         load = {tmpl = "talk",
             params = {"yg",TR("姑姑，你让我休息一下再练吧！我真的不行了！"),"3016.mp3"},},
     },
     ...
     {
         load = {tmpl = "talk",
             params = {"xln",TR("你只练了半个时辰，就已经喊累了，你这样怎么能练成武功呢？"),"3017.mp3"},},
     },

     {
         load = {tmpl = "talk1",
             params = {"yg",TR("姑姑，我来了两天，一粒饭，一块肉都没有吃过，就吃了一点点蜂蜜……"),"3018.mp3"},},
     },

     {
         load = {tmpl = "talk2",
             params = {"yg",TR("我本来就是个饭桶，你光给我吃蜂蜜，不是要我的命吗！"),"3019.mp3"},},
     },
     ...
     {
         load = {tmpl = "talk",
             params = {"xln",TR("你的意思是一定要吃饭了！"),"3020.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"yg",TR("啊！？姑姑，你和孙婆婆都不用吃饭的吗？"),"3021.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"xln",TR("不是不吃，只不过自从孙婆婆死了以后，有米没人煮……"),"3022.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"yg",TR("啊！？有米你不早点说，你不会煮，我会啊！"),"3023.mp3"},},
     },
    {
        load = {tmpl = "out3",
            params = {"yg","xln"},},
    ...
    {delay = {time = 0.6,},},
     {
         load = {tmpl = "zm",
             params = {TR("一阵忙活之后，"),"900"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("杨过为小龙女献上了——"),"850"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("热腾腾的饭菜。"),"800"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("小龙女捡起筷子，"),"750"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("细心品尝起来……"),"700"},},
     },
...

    {
     ...
     {
         load = {tmpl = "talk",
             params = {"yg",TR("那当然了！姑姑，你年纪比我大，结果还不会做饭，我俩到底谁照顾谁啊？"),"3025.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"xln",TR("你！那好——以后你也别做饭了，我们俩谁也别吃饭！走！跟我练功去！"),"3026.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"yg",TR("姑姑！我错了！你这么用心教我武功，我以后一定做好多好吃孝敬姑姑！"),"3027.mp3"},},
     },
