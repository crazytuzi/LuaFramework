...
----正式剧情
...

	{
     ...
     {
         load = {tmpl = "talk",
             params = {"zj",TR("这位兄台，请问有没有见到一个美丽的白衣女子从这里经过……!"),38},},
     },


     {
         load = {tmpl = "move2",
             params = {"sqs","sqs.png",TR("酒客")},},
     },
     {
         load = {tmpl = "talk",
             params = {"sqs",TR("你眼瞎啊，呐！这不正好来了一个吗！"),193},},
     },

    {
     ...
     {
         load = {tmpl = "move2",
             params = {"lws","lws.png",TR("白衣少女")},},
     },
     {
         load = {tmpl = "talk",
             params = {"lws",TR("死傻蛋，臭傻蛋，竟然丢下我一个人，还有那个臭郭芙，最好不要落在我手里，不然要你好看！"),194},},
     },
     ...
     {
         load = {tmpl = "talk",
             params = {"zj",TR("（这个小美人到是有些味道！）"),39},},
     },


     {
         load = {tmpl = "talk",
             params = {"zj",TR("（嗯？有点瘸？……啊！？难道是陆无双！）"),40},},
     },

     {
         load = {tmpl = "talk",
             params = {"lws",TR("看什么看！再看，我把你耳朵割下来！"),195},},
     },

    {
     ...
     {
         load = {tmpl = "move1",
             params = {"qcj","qcj.png",TR("全真道士")},},
     },

     {
         load = {tmpl = "talk",
             params = {"qcj",TR("小妖女，原来真的是你，我师弟不过多看了一眼，你便割了他的耳朵！"),196},},
     },

     {
         load = {tmpl = "talk",
             params = {"lws",TR("就是我割的，怎么样！谁让你们这些臭道士不开眼呢！"),197},},
     },

     {
         load = {tmpl = "talk",
             params = {"qcj",TR("好你个妖女，今天我就要为几个师弟讨个说法！"),198},},
     },
...

    {
     ...
     {
         load = {tmpl = "talk",
             params = {"zj",TR("这小美人——还真是泼辣，我还是帮她一把吧！"),41},},
     },
