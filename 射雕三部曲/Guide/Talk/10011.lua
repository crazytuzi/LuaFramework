...
--------------@@@@@@@@@@@@@@@
    ...
    loop2 = {
        {action = {tag  = "@1",sync = false,what = {loop = {sequence = {{move = {time = 18,by  = cc.p(-600, 0),},},
            {move = { time = 36,by   = cc.p(1200, 0),},},},},},},},
        },
...
----正式剧情
...

	{
     ...
     {
         load = {tmpl = "talk",
             params = {"zj",TR("师父，终南山上有个全真教，里面的道士不好相与，我怕他们会阻扰我们上山！"),3},},
     },
     ...
     {
         load = {tmpl = "talk",
             params = {"lby",TR("全真教！他们若敢阻拦，你便打上山去！正好看看你武功练得怎么样了！"),244},},
     },
