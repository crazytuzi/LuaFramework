...
----正式剧情
...

	{
     ...
     {
         load = {tmpl = "talk",
             params = {"gj",TR("过儿，你怎么来了？"),"10010.mp3"},},
     },
     ...
     {
         load = {tmpl = "talk1",
             params = {"yg",TR("郭伯伯，上次你对我说——侠之大者，为国为民！"),"10011.mp3"},},
     },

     {
         load = {tmpl = "talk2",
             params = {"yg",TR("虽然，我算不上什么大侠，但是国难当头，匹夫有责！"),"10012.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"gj",TR("好！今日就让我们并肩御敌！"),"10013.mp3"},},
     },
