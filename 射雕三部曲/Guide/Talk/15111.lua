...
-------------------------
...

	{
     ...
     {
         load = {tmpl = "zm",
             params = {TR("再一次与小龙女失之交臂，"),"900"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("美女师父好像很不高兴，"),"850"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("你心中不禁有些忐忑，"),"800"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("毕竟是你故意放走了小龙女……"),"750"},},
     },
...
----正式剧情
...

	{
     ...
     {
         load = {tmpl = "talk",
             params = {"zj",TR("师父，你不要生气了嘛！"),"5001.mp3"},},
     },
     ...
     {
         load = {tmpl = "talk",
             params = {"lby",TR("我没生气！"),"5002.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"zj",TR("嘿嘿，说得也是，师父疼我还来不及，怎么会生我的气呢！"),"5003.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"lby",TR("你……你是要气死我才甘心呢！"),"5004.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"zj",TR("师父，徒儿知道你是在恼我没看住小龙女……"),"5005.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"lby",TR("哼！"),"5006.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"zj",TR("不过——徒儿有个问题，不知道当不当问？"),"5007.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"lby",TR("你想问什么？"),"5008.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"zj",TR("师父你这么厉害，为什么要执着于一部玉女心经呢，那又不是大不了的武功……"),"5009.mp3"},},
     },

     {
         load = {tmpl = "talk1",
             params = {"lby",TR("我……哪有什么多为什么！既然青灵玉盘提到了这武功，那自然是有用！"),"5010.mp3"},},
     },

     {
         load = {tmpl = "talk2",
             params = {"lby",TR("还不快些走，不许再跑了小龙女……"),"5011.mp3"},},
     },
...

    {
     ...
     {
         load = {tmpl = "talk",
             params = {"zj",TR("哎，师父，你等等我啊！"),"5012.mp3"},},
     },
