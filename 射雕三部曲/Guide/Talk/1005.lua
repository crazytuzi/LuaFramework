...
----正式剧情
...

	{
     ...
     {
         load = {tmpl = "move2",
             params = {"zcs","zcs.png",TR("全真掌教弟子")},},
     },
	
	
     {
         load = {tmpl = "talk",
             params = {"zcs",TR("擅闯终南山者，杀无赦！"),144},},
     },
     ...
     {
         load = {tmpl = "talk",
             params = {"zj",TR("臭道士！终南山又不是你家开的，凭啥不让上！"),9},},
     },
	
	
     {
         load = {tmpl = "talk",
             params = {"zcs",TR("全真教乃名门正教，岂容你们这些宵小扰乱本门清修之地！"),145},},
     },

     {
         load = {tmpl = "talk",
             params = {"zj",TR("真是蛮不讲理！"),10},},
     },

     {
         load = {tmpl = "talk",
             params = {"zcs",TR("来人！拿下他们！"),146},},
     },
