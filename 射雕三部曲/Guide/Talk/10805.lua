...
----正式剧情
...

	{
     ...
     {
         load = {tmpl = "talk",
             params = {"zj",TR("可是师父您目前就只传授了我几套内功心法。"),80},},
     },

     {
         load = {tmpl = "talk",
             params = {"lby",TR("那是因为为师的武功偏向阴柔，比较适合女孩子，不过听说最近襄阳城外常有隐士出没，你可以去看看"),260},},
     },

     {
         load = {tmpl = "talk",
             params = {"zj",TR("那我去碰碰运气，看能否学个一招半式"),81},},
     },
     ...
     -- {
     --     load = {tmpl = "talk",
     --         params = {"lby",TR("——！快去快去，少来聒噪！"),"1047.mp3"},},
     -- },
