...
-------------------------
...

	{
     ...
     {
         load = {tmpl = "zm",
             params = {TR("解决掉几波前来寻仇的西域恶霸后，"),"800"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("你才发现自己回到了二十年前射雕的世界！"),"750"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("更让你吃惊的是——"),"650"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("粉衣少女一直默默跟着你，"),"600"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("见她娇弱无骨的模样，"),"550"},},
     },


     {
         load = {tmpl = "zm",
             params = {TR("不禁心生怜惜……"),"500"},},
     },


    {delay = {time = 3.0,},},

    {remove = { model = {"800", "750", "650","600", "550", "500",},},},
...
----正式剧情
...

	{
     ...
     {
         load = {tmpl = "talk",
             params = {"zj",TR("哎呀，我的小祖宗，被你害得还不够惨吗？求放过啊——！"),"1183.mp3"},},
     },
     ...
     {
         load = {tmpl = "talk",
             params = {"ysjl",TR("………………"),"1183.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"zj",TR("小祖宗，师父她现在有危险，你倒是赶紧送我回去啊！"),"1183.mp3"},},
     },
     ...
     {
         load = {tmpl = "talk",
             params = {"zj",TR("我说，被你随意地送来送去的，你有经过我的同意吗？你有问过我的感受吗？"),"1183.mp3"},},
     },
     ...
     {
         load = {tmpl = "talk",
             params = {"zj",TR("好吧……如果你还是一言不发的话，请不要再跟着我了！"),"1183.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"ysjl",TR("（哼，如今我功力耗尽，不能言语，待我恢复如初，要你好看！）"),"1183.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"ysjl",TR("陆无双安全……武穆遗书……岳州……铁掌山……"),"1183.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"zj",TR("……你还真是惜字如金……算了，我还是自己找回去的方法，至于什么武穆遗书……随它去吧！"),"1183.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"ysjl",TR("老女人……武穆遗书……世间危难……"),"1183.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"zj",TR("……你说那个神秘老妪抢了武穆遗书会祸害人间？恩，若是那样的话就不能坐视不理了！"),"1183.mp3"},},
     },
