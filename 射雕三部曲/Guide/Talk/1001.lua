...
----正式剧情
...

	{
     ...
     {
         load = {tmpl = "move2",
             params = {"cjsh","cjsh.png",TR("忽必烈")},},
     },
     {
         load = {tmpl = "talk",
             params = {"cjsh",TR("国师！请你带领我蒙古高手，前去刺杀郭靖！"),"10001.mp3"},},
     },
     ...
     {
         load = {tmpl = "talk",
             params = {"jlfw",TR("王爷！我一定不辱使命！"),"10002.mp3"},},
     },


     {
         load = {tmpl = "talk",
             params = {"cjsh",TR("只要杀了郭靖，攻破襄阳城便指日可待，到时我册封国师为蒙古国第一勇士！"),"10003.mp3"},},
     },


     {
         load = {tmpl = "talk",
             params = {"jlfw",TR("王爷！你放心！没有人是我的龙象波若功的对手！"),"10004.mp3"},},
     },
