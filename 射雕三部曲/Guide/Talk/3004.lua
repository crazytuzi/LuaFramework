...
-------------------------
...

	{
     ...
     {
         load = {tmpl = "zm",
             params = {TR("杨过离开以后"),"900"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("你们师徒二人也开始寻找小龙女"),"840"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("并来到了山下的一处小镇"),"780"},},
     },
...
----正式剧情
...

	{
     ...
     {
         load = {tmpl = "talk",
             params = {"zj",TR("这小龙女的腿脚可真快，一溜烟就不知道跑哪里去了，这都找好几天了，还是一点消息都没有？!"),35},},
     },
     ...
     {
         load = {tmpl = "talk",
             params = {"lby",TR("还不是都怪你，不然我早就逼她交出玉女心经了！"),191},},
     },

     {
         load = {tmpl = "talk",
             params = {"zj",TR("嘿嘿嘿，这不挺好的吗！刚好可以趁机闯荡一番，正所谓良辰美景三月天，美女师父共游玩……！"),36},},
     },
    ...
    {
        sound = {file = "skill_yingzhaogong.mp3",sync=false,},
    },	
	
	
    {   model = {
            tag  = "shouji",     type  = DEF.FIGURE,
            pos= cc.p(40,350),    order     = 80,
            file = "effect_wg_yingzhaogong",    animation = "animation",
            scale = 0.12,
            loop = false,   endRlease = true,  speed=2, rotation3D=cc.vec3(45,0,0),
        },},

    {
     ...
     {
         load = {tmpl = "talk",
             params = {"zj",TR("开个玩笑，开个玩笑啦！师父，你先放下剑，我这就去打听小龙女的下落！"),37},},
     },
