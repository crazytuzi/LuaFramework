...
--------------@@@@@@@@@@@@@@@
    ...
    talk = {
        ...
        {model = {tag  = "talk-tag",type  = DEF.LABEL, pos= cc.p(320, 200),order = 52, text = "@2",
    ...
    talk1 = {
        {action = {tag = "text-board",what = { fadein = {time = 0,},},},},
        {load = {tmpl = "scale_xl",params = {"@1"},},},
        {model = {tag  = "talk-tag",type  = DEF.LABEL, pos= cc.p(DEF.WIDTH / 2, 200),order = 52, text = "@2",
                    maxWidth = 550, size = 25, color = cc.c3b(244, 217, 174),sound= "@3", },},
        {remove = { model = {"talk-tag", }, },},},
    talk0 = {
        {action = {tag = "text-board",what = { fadein = {time = 0,},},},},
    ...
    talkzm = {
        ...
        {action = {tag = "text-board",what = { fadein = {time = 0,},},},},
        {model = {tag  = "talk-tag",type  = DEF.LABEL, pos= cc.p(DEF.WIDTH / 2, 200),order = 52, text = "@1",
    ...
    move3 = {
        ...
        {action = {tag  = "@4",what = {spawn = {{move = {time = 0.3,to = cc.p(DEF.WIDTH - 100, 320),},},},},},},
                {model = {tag  = "name-tag1",type  = DEF.LABEL, pos= cc.p(120, 245),order = 100, text = "@3",
                    size = 25, color = cc.c3b(255, 204, 124),time = 0.01,},},
        {model = {tag  = "name-tag2",type  = DEF.LABEL, pos= cc.p(520, 245),order = 100, text = "@3",
                    size = 25, color = cc.c3b(255, 204, 124),time = 0.01,},},
        {delay = {time = 0.5,},},
        },
    ...
    move1 = {
        {
            model = {tag  = "@1",type  = DEF.PIC,file  = "@2",scale = 0.7,
            order = 50,pos= cc.p(-140, 255),
            },
        },
        {load = {tmpl = "scale_xs1",params = {"@1"},},},
        {
            action = {tag  = "@1",what = {spawn = {{move = {time = 0.25,to = cc.p(100, 255),},},},},},
        },
                {model = {tag  = "name-tag1",type  = DEF.LABEL, pos= cc.p(120, 245),order = 100, text = "@3",
                    size = 25, color = cc.c3b(255, 204, 124),time = 0.01,},},
        },
    ...
    move2 = {
        {
            ...
            order = 50,pos= cc.p(DEF.WIDTH+140, 255),
           },
        },
        {load = {tmpl = "scale_xs1",params = {"@1"},},},
        {
            action = {tag  = "@1",what = {spawn = {{move = {time = 0.3,to = cc.p(DEF.WIDTH - 100, 255),},},},},},
        },
        {model = {tag  = "name-tag2",type  = DEF.LABEL, pos= cc.p(520, 245),order = 100, text = "@3",
                    size = 25, color = cc.c3b(255, 204, 124),time = 0.01,},},
        },
    ...
    out3= {
        ...
        {action = { tag  = "@1",sync = false,what = {spawn = {
                   {move = {time = 0.2,to = cc.p(-100, 255),},},
                   {fadeout = { time = 0.15,},},},},},},
        {action = { tag  = "@2",sync = true,what = {spawn = {
                   {move = {time = 0.2,to = cc.p(DEF.WIDTH+100, 255),},},
                   {fadeout = { time = 0.15,},},},},},},
        {remove = { model = {"@1", "@2", }, },},
        },
    ...
    bq12 = {
        ...
        {model = {tag= "@2",type= DEF.PIC,file= "@3",scale= 0.7,opacity= 0,rotation3D=cc.vec3(0,180,0),
                  order= 50,pos= cc.p(DEF.WIDTH+100, 255),name = "@4",nameBg = "jq_27.png",namePos = cc.p(0.48, 0.5),},},
        {action = {tag  = "@2",what = {spawn = {{fadein = { time = 0,},},},},},},
        {color = {tag   = "@2",color = cc.c3b(180, 180, 180),},},
        {action = {tag  = "@2",what = {spawn = {{scale = {time = 0,to   = 0.6,},},
            {move = {time = 0,to = cc.p(DEF.WIDTH -100, 255),},},},},},},
        {delay = {time = 0.1,},},
        },
    ...
    bq21 = {
        ...
        {model = {tag= "@2",type= DEF.PIC,file= "@3",scale= 0.7,opacity= 0,
                  order= 50,pos= cc.p(-140, 255),name = "@4",nameBg = "jq_27.png",namePos = cc.p(0.48, 0.5),},},
        {action = {tag  = "@2",what = {spawn = {{fadein = { time = 0,},},{move = {time = 0,to = cc.p(100, 255),},},},},},},
        {delay = {time = 0.1,},},
        },
    ...
    bq22 = {
        ...
        {remove = {model = {"@1",},},},
        {model = {tag= "@2",type= DEF.PIC,file= "@3",scale= 0.7,opacity= 0,rotation3D=cc.vec3(0,180,0),
                  order= 50,pos= cc.p(DEF.WIDTH+140, 255),name = "@4",nameBg = "jq_27.png",namePos = cc.p(0.48, 0.5),},},
        {action = {tag  = "@2",what = {spawn = {{fadein = { time = 0,},},{move = {time = 0,to = cc.p(DEF.WIDTH -100, 255),},},},},},},
        {delay = {time = 0.1,},},
        },
...
----正式剧情
...

	{
        model = { tag = "text-board",type  = DEF.PIC,
                  file  = "jq_281.png",order = 51,
                  pos   = cc.p(DEF.WIDTH / 2, 250),fadein = { time = 1,},},
    },
...

    {
     ...
     {
         load = {tmpl = "talk",
             params = {"zj",TR("金轮法王，还——有——我！"),"10020.mp3"},},
     },
     ...
     {
         load = {tmpl = "talk",
             params = {"jlfw",TR("又来一个送死的！"),"10021.mp3"},},
     },

     {
         load = {tmpl = "talk1",
             params = {"zj",TR("山河破碎风飘絮，我以我血荐轩辕！"),"10022.mp3"},},
     },

     {
         load = {tmpl = "talk2",
             params = {"zj",TR("金轮法王！就让你看看我们华夏儿女的忠肝义胆！"),"10023.mp3"},},
     },

    {
     ...
     {
         load = {tmpl = "talk1",
             params = {"gj",TR("好一个我以我血荐轩辕！"),"10024.mp3"},},
     },

     {
         load = {tmpl = "talk2",
             params = {"gj",TR("我郭靖生是华夏子孙，死——也是华夏之魂！"),"10025.mp3"},},
     },


     {
         load = {tmpl = "talk",
             params = {"zj",TR("郭大侠，就让我们把这些敌人统统赶出去！"),"10026.mp3"},},
     },
