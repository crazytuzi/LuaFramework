...
-------------------------
...

    {
     ...
     {
         load = {tmpl = "zm",
             params = {TR("你假装努力寻找小龙女，"),"900"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("想要讨回师父的欢心，"),"850"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("然而，你并不知道，"),"800"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("一个惊喜正等着你……"),"750"},},
     },
...
----正式剧情
...

	{
     ...
     {
         load = {tmpl = "talk",
             params = {"zj",TR("这位兄台，请问有没有见到一个美丽的白衣女子从这里经过……"),"5013.mp3"},},
     },

     {
         load = {tmpl = "move2",
             params = {"qlf","qlf.png",TR("某路人")},},
     },

     {
         load = {tmpl = "talk",
             params = {"qlf",TR("没有！滚！"),"5014.mp3"},},
     },

    {
     ...
     {
         load = {tmpl = "talk",
             params = {"zj",TR("没有就没有，发什么火嘛！真是晦气！"),"5015.mp3"},},
     },

     {
         load = {tmpl = "move2",
             params = {"wyp","wyp.png",TR("陌生少女")},},
     },


     {
         load = {tmpl = "talk",
             params = {"wyp",TR("喂！有位姓龙的姑娘找你，说是要好好谢谢你！跟我来吧！"),"5016.mp3"},},
     },


     {
         load = {tmpl = "talk",
             params = {"zj",TR("咦？龙姑娘？难道她还没走吗？"),"5017.mp3"},},
     },
...

    {
     ...
     {
         load = {tmpl = "zm",
             params = {TR("你跟着少女来到一个阴暗的小屋，"),"700"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("昏暗中，一个俏丽的背影恬静的站在那里，"),"650"},},
     },

     {
         load = {tmpl = "zm",
             params = {TR("你心有所动，不禁脱口而出……"),"600"},},
     },
...

    {
     ...
     {
         load = {tmpl = "talk1",
             params = {"zj",TR("龙姑娘！你怎么还没走啊？我不是让你去英雄大会找杨过吗？"),"5018.mp3"},},
     },


     {
         load = {tmpl = "talk2",
             params = {"zj",TR("我师父就在附近，她人虽然不坏，但是为了玉女心经，我真怕她会……"),"5019.mp3"},},
     },
     ...
     {
         load = {tmpl = "talk",
             params = {"lby",TR("哦！？你怕我会做什么……你这个——大——叛——徒！"),"5020.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"zj",TR("啊！？师父！怎么是你？你……居然装作小龙女诈我！"),"5021.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"lby",TR("哼！我要不这样做，只怕跟着你，这一辈子都找不到小龙女！"),"5022.mp3"},},
     },

     {
         load = {tmpl = "talk",
             params = {"zj",TR("嘿嘿！那哪能呢！"),"5023.mp3"},},
     },

     {
         load = {tmpl = "talk1",
             params = {"lby",TR("你还笑！我再给你一次机会，如果还找不到小龙女，我就把你逐出……"),"5024.mp3"},},
     },

     {
         load = {tmpl = "talk2",
             params = {"lby",TR("哼！我就自己去找小龙女，到时候，你怕什么——我就对她做什么！"),"5025.mp3"},},
     },
