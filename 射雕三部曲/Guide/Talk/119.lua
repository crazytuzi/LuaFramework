...
----正式剧情
...

	{
     ...
     {
         load = {tmpl = "talk",
             params = {"lby",TR("蒙古大军已经开始攻打襄阳，城危矣"),124},},
     },
     ...
     {
         load = {tmpl = "talk",
             params = {"zj",TR("蒙古大军人多势众，快随我速速前往襄阳助郭大侠一臂之力"),82},},
     },
     ...
     -- {
     --     load = {tmpl = "talk",
     --         params = {"zj",TR("◑ω◐唔，师父所言有理，大宋危急时刻是的团结一切可以团结的人，才能顺利度过难关！"),"1048.mp3"},},
     -- },
     ...
     -- {
     --     load = {tmpl = "talk",
     --         params = {"lby",TR("速速驰援襄阳去！"),"1047.mp3"},},
     -- },
