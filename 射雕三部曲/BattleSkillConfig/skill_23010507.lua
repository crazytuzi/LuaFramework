...
local function skill_func(params)
    ...
    local atkEffect = bd.interface.newEffect({
        parent = nodeParent,
        effectName = "effect_wg_youlongfuyingquan",
    ...
    bd.adapter.audio.playSound("skill_youlongfuyingquan.mp3")
end

local skillConfig = {
    zhua = true,
    res = {"effect_wg_youlongfuyingquan", },
    audio = {"skill_youlongfuyingquan.mp3"},    
