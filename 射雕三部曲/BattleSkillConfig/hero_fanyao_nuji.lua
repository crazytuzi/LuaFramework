...
local function skill_func(params)
    ...
    if params.dmgTimes == 1 then
        bd.adapter.audio.playSound("hero_fanyao_nuji1.mp3")
    elseif params.dmgTimes == 2 then
        bd.adapter.audio.playSound("hero_fanyao_nuji2.mp3")
    elseif params.dmgTimes == 3 then
        bd.adapter.audio.playSound("hero_fanyao_nuji3.mp3")
    end
end
...
local skill = {
    zhua = true,
    res = { },
    audio = {"hero_fanyao_nuji1.mp3", "hero_fanyao_nuji2.mp3", "hero_fanyao_nuji3.mp3"},
