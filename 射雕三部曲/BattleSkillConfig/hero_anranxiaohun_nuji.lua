...
local function skill_func(params)
    ...
    if params.dmgTimes == 6 then
        bd.adapter.audio.playSound("hero_anranxiaohun_nuji2.mp3")
    end
end
...
local skill = {
    zhua = true,
    res = { },
    audio = {"hero_anranxiaohun_nuji.mp3", "hero_anranxiaohun_nuji2.mp3"},
    audiofunc = function()
        bd.adapter.audio.playSound("hero_anranxiaohun_nuji.mp3")
    end,
