...
local function skill_func(params)
    ...
    local atkEffect = bd.interface.newEffect({
        parent = nodeParent,
        effectName = "effect_wg_yinyangdaoluanrenfa",
    ...
    bd.adapter.audio.playSound("skill_yinyangdaoluanrenfa.mp3")
end

local skillConfig = {
    res = {"effect_wg_yinyangdaoluanrenfa", },
    audio = {"skill_yinyangdaoluanrenfa.mp3"},    
