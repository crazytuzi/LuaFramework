...
local function skill_func(params)
    ...
    local atkEffect = bd.interface.newEffect({
        parent = nodeParent,
        effectName = "effect_wg_yunvjian",
        scale = bd.ui_config.MinScale*0.9,
        position3D = atkPos,
    ...
    bd.adapter.audio.playSound("skill_yunvsuxinjianfa.mp3")

end

local skillConfig = {
    zhua = true,
    res = {"effect_wg_yunvjian", },
    audio = {"skill_yunvsuxinjianfa.mp3"},
