...
local function skill_func(params)
    ...
    bd.adapter.audio.playSound("hero_luwushuang_pugong2.mp3")
end

local skill = {
    res = { },
    audio = {"hero_luwushuang_pugong1.mp3", "hero_luwushuang_pugong2.mp3"},
    audiofunc = function()
        bd.adapter.audio.playSound("hero_luwushuang_pugong1.mp3")
    end,
