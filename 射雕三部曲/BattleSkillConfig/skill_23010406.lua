...
local function skill_func(params)
    ...
    f_pos.y = f_pos.y - 150 * bd.ui_config.MinScale
    ...
    local atkEffect = bd.interface.newEffect({
        parent = nodeParent,
        effectName = "effect_wg_shihougong",
    ...
    bd.adapter.audio.playSound("skill_shihougong.mp3")
end

local skillConfig = {
    res = {"effect_wg_shihougong", },
    audio = {"skill_shihougong.mp3"},    
