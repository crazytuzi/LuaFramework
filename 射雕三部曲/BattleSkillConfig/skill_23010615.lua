...
local function skill_func(params)
    ...
    local atkEffect = bd.interface.newEffect({
        parent = nodeParent,
        effectName = "effect_wg_xiantianyiyanzhi",
    ...
    bd.adapter.audio.playSound("skill_xiantianyiyangzhi.mp3")
end

local skillConfig = {
    zhua = true,
    res = {"effect_wg_xiantianyiyanzhi", },
    audio = {"skill_xiantianyiyangzhi.mp3"},    
