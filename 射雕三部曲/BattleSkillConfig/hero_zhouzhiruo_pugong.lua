...
local function skill_func(params)
    ...
    if params.dmgTimes == 1 then
        bd.adapter.audio.playSound("hero_zhouzhiruo_pugong1.mp3")
    elseif params.dmgTimes == 2 then
        bd.adapter.audio.playSound("hero_zhouzhiruo_pugong2.mp3")
    end
end

local skill = {
    res = { },
    audio = {"hero_zhouzhiruo_pugong1.mp3", "hero_zhouzhiruo_pugong2.mp3"},
