...
local function skill_func(params)
    ...
    bd.adapter.audio.playSound("hero_ouyangfeng_nuji2.mp3")
end

local skill = {
    res = { },
    audio = {"hero_ouyangfeng_nuji1.mp3", "hero_ouyangfeng_nuji2.mp3"},
    audiofunc = function()
        bd.adapter.audio.playSound("hero_ouyangfeng_nuji1.mp3")
    end,
