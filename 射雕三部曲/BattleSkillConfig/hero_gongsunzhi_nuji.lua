...
local function skill_func(params)
    ...
    if params.dmgTimes == 3 then
        bd.adapter.audio.playSound("hero_gongsunzhi_nuji2.mp3")
    end
end
...
local skill = {
    zhua = true,
    res = { },
    audio = {"hero_gongsunzhi_nuji1.mp3", "hero_gongsunzhi_nuji2.mp3"},
    audiofunc = function()
        bd.adapter.audio.playSound("hero_gongsunzhi_nuji1.mp3")
    end,
