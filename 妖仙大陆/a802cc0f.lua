...
function start(api,...)
	...
	Helper.ComplexCamera(83.44,162.43,height -9.5, 83.44,162.43,height -9.5 , 0.2,0.3, height -7,height -7.5 , 7,5.5, 0,0, 4,0)
	
	

	Helper.ComplexCamera(83.44,162.43,height - 10,74.7,158.3,height - 8, -1.3,0, height - 5,height , 7,15, 0,0, 2,2) 
