...
function start(api,...)
	...
	api.World.RunAction(test_BpcA,test_BpcA_event)
	api.World.RunAction(test_BpcB,test_BpcB_event)
	api.World.RunAction(test_BpcC,test_BpcC_event)
	api.World.RunAction(test_BpcD,test_BpcD_event)
	api.World.RunAction(test_BpcE,test_BpcE_event)
	api.World.RunAction(test_BpcF,test_BpcF_event)
	api.World.RunAction(test_BpcG,test_BpcG_event)
	api.World.RunAction(test_BpcH,test_BpcH_event)
	api.World.RunAction(test_BpcI,test_BpcI_event)
	api.World.RunAction(test_BpcJ,test_BpcJ_event)
	api.World.RunAction(test_BpcK,test_BpcK_event)
	
	api.World.RunAction(test_CpcA,test_CpcA_event)
