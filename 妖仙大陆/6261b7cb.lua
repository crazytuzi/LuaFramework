...
local function InitChapter(sender)
  if sender.Enable == true then
    ...
    if index <=4 then
        ...
        self.sp_list.Scrollable:LookAt(Vector2.New(self.cvs_section.Width,0),true)
    end
  end
end
...
local function Init(params)
  self.menu = LuaMenuU.Create("xmds_ui/bestronger/growup.gui.xml", GlobalHooks.UITAG.GameUIStrongerAchievement)
