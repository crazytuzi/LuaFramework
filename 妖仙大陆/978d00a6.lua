...
function Quest_InProgress(api, id)
	btn_bag = api.UI.FindHudComponent('xmds_ui/hud/mainhud.gui.xml','btn_bag')
	api.Wait(Helper.TouchGuide(btn_bag,{force=true}))
	...
	local function Logic1()
		...
		cvs_weapon = api.UI.FindComponent('xmds_ui/character/ui_idol.gui.xml','cvs_weapon2')
