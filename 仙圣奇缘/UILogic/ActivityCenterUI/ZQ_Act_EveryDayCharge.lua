...
Act_EveryDayCharge = class("Act_EveryDayCharge",Act_Template)
Act_EveryDayCharge.__index = Act_Template
Act_EveryDayCharge.szImage_ChargeStatus = "Image_ChargeStatus"
Act_EveryDayCharge.szImage_RewardStatus = "Image_RewardStatus"


function Act_EveryDayCharge:updateStatus()
...
function Act_EveryDayCharge:onClickGainReward(pSender, eventType)
...
function Act_EveryDayCharge:setButtonState(buttonItem, state)
