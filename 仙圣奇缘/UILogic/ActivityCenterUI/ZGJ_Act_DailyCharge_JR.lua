...
--7天每日单笔充值返利
Act_DailyCharge_JR = class("Act_DailyCharge_JR",Act_Template)
Act_DailyCharge_JR.__index = Act_Template
Act_DailyCharge_JR.szImage_RewardStatus = "Image_ChargeStatus"

function Act_DailyCharge_JR:sortAndUpdateBySortRank()
...
--领取响应回调
function Act_DailyCharge_JR:gainRewardResponseCB()
...
function Act_DailyCharge_JR:updateStatus()
    self:sortAndUpdateBySortRank()
end

function Act_DailyCharge_JR:onClickGainReward(pSender, eventType)
...
function Act_DailyCharge_JR:setButtonState(buttonItem, state)
...
--初始化
function Act_DailyCharge_JR:init(panel, tbItemList)
	if not panel then
		return 
	end
    self.tbItemList = {}
...
--Act_DailyCharge_JR = class("Act_DailyCharge_JR",Act_Template2)
--Act_DailyCharge_JR.__index = Act_Template2

----override
--function Act_DailyCharge_JR:onClickGainReward(widget, nTag)
...
----override
--function Act_DailyCharge_JR:setButtonState(Button_Activety, nIndex)
...
--function Act_DailyCharge_JR:setCoolTime()
...
----override
--function Act_DailyCharge_JR:destroy()
