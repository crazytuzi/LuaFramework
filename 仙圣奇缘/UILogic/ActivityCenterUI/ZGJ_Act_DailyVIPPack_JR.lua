...
-- 应  用:  
---------------------------------------------------------------------------------------
Act_DailyVIPPack_JR = class("Act_DailyVIPPack_JR",Act_Template)
Act_DailyVIPPack_JR.__index = Act_Template

Act_DailyVIPPack_JR.prefix = "VIP"
Act_DailyVIPPack_JR.szImage_RewardStatus = "Image_BuyStatus"

--override
function Act_DailyVIPPack_JR:onClickGainReward(pSender, eventType)
...
--override
function Act_DailyVIPPack_JR:setPanelItem(widget, nIndex)
...
--override
function Act_DailyVIPPack_JR:isEnable(id)
	self.nActivetyID = id
