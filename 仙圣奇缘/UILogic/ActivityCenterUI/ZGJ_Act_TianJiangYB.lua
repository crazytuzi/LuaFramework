Act_TianJiangYB = class("Act_TianJiangYB",Act_Template2)
Act_TianJiangYB.__index = Act_Template2


--override
function Act_TianJiangYB:gainRewardResponseCB()
	--留空
end

function Act_TianJiangYB:setResult(info)
	for i =1, 6 do
...
function Act_TianJiangYB:onClickStart(widget, eventType)
...
function Act_TianJiangYB:onClickPanel(widget, eventType)
...
--重置
function Act_TianJiangYB:refreshTurntable()
...
function Act_TianJiangYB:init(panel, tbItemList)
	if not panel then
		return 
	end
	self.panel = panel
