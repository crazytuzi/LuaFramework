...
function TableLayout:addChildEx(child)
    ...
    child:setScale(0)
--    child:setPosition(CCPointMake(posX, -h + self._nodes[1 + (row - 1) * self._rowNum]:getContentSize().height / 2 + self._height))
--    child:setPosition(CCPointMake(posX, -h + self._viewH + self._nodes[1 + (row - 1) * self._rowNum]:getContentSize().height / 2))
