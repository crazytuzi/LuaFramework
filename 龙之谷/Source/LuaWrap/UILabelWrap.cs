...
public class UILabelWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("UpdateDefaultPrintedSize", UpdateDefaultPrintedSize),
			...
			new LuaMethod("SetFont", SetFont),
			new LuaMethod("DestroyTureTypeFont", DestroyTureTypeFont),
			new LuaMethod("DestroyUIFont", DestroyUIFont),
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("fontPath", get_fontPath, set_fontPath),
			new LuaField("fontSuffix", get_fontSuffix, set_fontSuffix),
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_fontPath(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UILabel obj = (UILabel)o;
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name fontPath");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index fontPath on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.fontPath);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_fontSuffix(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UILabel obj = (UILabel)o;
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name fontSuffix");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index fontSuffix on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.fontSuffix);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_fontPath(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UILabel obj = (UILabel)o;
		...
		obj.fontPath = LuaScriptMgr.GetString(L, 3);
		return 0;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_fontSuffix(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UILabel obj = (UILabel)o;
		...
		obj.fontSuffix = LuaScriptMgr.GetString(L, 3);
		return 0;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int UpdateDefaultPrintedSize(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		UILabel obj = (UILabel)LuaScriptMgr.GetUnityObjectSelf(L, 1, "UILabel");
		obj.UpdateDefaultPrintedSize();
		return 0;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int DestroyTureTypeFont(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		UILabel obj = (UILabel)LuaScriptMgr.GetUnityObjectSelf(L, 1, "UILabel");
		Font arg0 = (Font)LuaScriptMgr.GetUnityObject(L, 2, typeof(Font));
		obj.DestroyTureTypeFont(arg0);
		return 0;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int DestroyUIFont(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		UILabel obj = (UILabel)LuaScriptMgr.GetUnityObjectSelf(L, 1, "UILabel");
		UIFont arg0 = (UIFont)LuaScriptMgr.GetUnityObject(L, 2, typeof(UIFont));
		obj.DestroyUIFont(arg0);
		return 0;
	}
