local LJCZRebateView = classGc(view, function(self,_msg)
	self.msg = _msg
end)
...
function LJCZRebateView.create(self,_tag,_data)
	...
	local rechargeStr= _G.Util : createLabel("我的充值：", FONTSIZE)
...
function LJCZRebateView.ScrollView(self,_tag,_data)
...
function LJCZRebateView.Widgetreturn(self,_tag,msg)
	...
	local addupLab = _G.Util : createLabel("累计充值达到：", FONTSIZE)
...
function LJCZRebateView.onBtnCallBack(self, sender, eventType, _tag)
...
function LJCZRebateView.tagfullData(self, id_sub,state)
...
function LJCZRebateView.getTimeStr( self, _time)
...
function LJCZRebateView.__removeScheduler(self)
