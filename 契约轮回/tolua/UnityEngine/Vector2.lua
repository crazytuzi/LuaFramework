...
--[[
	@author LaoY
	@des	from作为坐标原点，to相对于from与Y轴的夹角
	@param1 from  point {x,y}
	@param1 to 	  point {x,y}
--]]
function Vector2.GetAngle(to,from)
	return GetAngeleByVector(to,from)
end
...
function Vector2.Distance(a, b)
	return sqrt(Vector2.DistanceNotSqrt(a, b))
end

-- 不开方距离运算
function Vector2.DistanceNotSqrt(a, b)
