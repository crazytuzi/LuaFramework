...
function Color.HSVToRGB(H, S, V, hdr)
  ...
  if not hdr then    
    white.r = Mathf.Clamp(white.r, 0, 255)
    white.g = Mathf.Clamp(white.g, 0, 255)
    white.b = Mathf.Clamp(white.b, 0, 255)
  end
...
get.red 	= function() return Color.New(255,0,0,255) end
get.green	= function() return Color.New(0,255,0,255) end
get.blue	= function() return Color.New(0,0,255,255) end
get.white	= function() return Color.New(255,255,255,255) end
get.black	= function() return Color.New(0,0,0,255) end
get.yellow	= function() return Color.New(255, 0.9215686*255, 0.01568628*255, 255) end
get.cyan	= function() return Color.New(0,255,255,255) end
get.magenta	= function() return Color.New(255,0,255,255) end
get.gray	= function() return Color.New(0.5*255,0.5*255,0.5*255,255) end
