...
---
GodCeleRushBuyItem = GodCeleRushBuyItem or class("GodCeleRushBuyItem", BaseCloneItem)
local this = GodCeleRushBuyItem

function GodCeleRushBuyItem:ctor(obj, parent_node, parent_panel)
    GodCeleRushBuyItem.super.Load(self)
    self.events = {}
    self.itemicon = {}
end

function GodCeleRushBuyItem:dctor()
...
function GodCeleRushBuyItem:LoadCallBack()
    self.nodes = {
...
function GodCeleRushBuyItem:InitUI()

end

function GodCeleRushBuyItem:AddEvent()
...
function GodCeleRushBuyItem:SetData(data,actid,stencilId)
...
function GodCeleRushBuyItem:SetInfo()
...
function GodCeleRushBuyItem:SetTitle(name)
    
end

function GodCeleRushBuyItem:SetPic(lastNum,curNum,lastId,curId)
...
function GodCeleRushBuyItem:CreateIcon()
    local index = 0
