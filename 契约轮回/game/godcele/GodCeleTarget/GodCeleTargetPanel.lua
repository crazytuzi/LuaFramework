...
---
GodCeleTargetPanel = GodCeleTargetPanel or class("GodCeleTargetPanel", BaseItem)
local this = GodCeleTargetPanel

function GodCeleTargetPanel:ctor(parent_node, parent_panel, actID)
    self.abName = "sevenDayActive"
    self.assetName = "GodCeleTargetPanel"
    self.layer = "UI"
    ...
    self.mEvents = {}
    self.rewardItems = {}
    GodCeleTargetPanel.super.Load(self)
end

function GodCeleTargetPanel:dctor()
...
function GodCeleTargetPanel:LoadCallBack()
    self.nodes = {
...
function GodCeleTargetPanel:InitDifference()
    --目标
...
function GodCeleTargetPanel:InitUI()
    --dump(self.data)
...
function GodCeleTargetPanel:AddEvent()
...
function GodCeleTargetPanel:HandlerRewardInfo(data)
...
function GodCeleTargetPanel:DLIVER_YY_INFO(data)
...
function GodCeleTargetPanel:PaySucc()
    -- print2("充值成功")
    --  dump(self.data)
    --self.data = OperateModel:GetInstance():GetActInfo(self.actID)
    --self:UpdateRewards(self.data.tasks)
...
function GodCeleTargetPanel:InitActTime()
...
function GodCeleTargetPanel:GetActTime(time)
...
function GodCeleTargetPanel:CountDown()
    local timeTab = nil;
    local timestr = "";
    local formatTime = "%d";
