SiegewarRewardPanel = SiegewarRewardPanel or class("SiegewarRewardPanel",BaseRewardPanel)
local SiegewarRewardPanel = SiegewarRewardPanel

function SiegewarRewardPanel:ctor()
	self.abName = "siegewar"
	self.assetName = "SiegewarRewardPanel"
	self.layer = "UI"
...
function SiegewarRewardPanel:dctor()
end

function SiegewarRewardPanel:Open(data, bossid, count)
	self.data = data
	self.bossid = bossid
	self.count = count
	SiegewarRewardPanel.super.Open(self)
end

function SiegewarRewardPanel:LoadCallBack()
	self.nodes = {
...
function SiegewarRewardPanel:AddEvent()
...
function SiegewarRewardPanel:OpenCallBack()
	self:UpdateView()
end

function SiegewarRewardPanel:UpdateView( )
	...
	local rewardcfg = Config.db_siegewar_box_reward[key]
	if rewardcfg then
...
function SiegewarRewardPanel:CloseCallBack(  )
...
function SiegewarRewardPanel:OkFunc()
	self:FinishEffect()
	self:Close()
end

function SiegewarRewardPanel:OpenBox()
	self:FinishEffect()
	self.model:Brocast(SiegewarEvent.RequstOpenBox, self.data.type)
end

--添加寻宝结果物品（创建UI）
function SiegewarRewardPanel:AddGoodsItem()
...
--显示剩下的奖励
function SiegewarRewardPanel:ShowLeftRewards()
...
--结束特效展示
function SiegewarRewardPanel:FinishEffect()
...
function SiegewarRewardPanel:SetMask()
