...
cc.Action = cc.Action or class("Action")

function cc.Action:ctor()
	self._originalTarget = nil
	self._target = nil
	self._tag = cc.Action.INVALID_TAG
	self._flags = 0
    self.is_use_lua_function = false
end

function cc.Action:dctor()
    self._target = nil
    self.real_target = nil
end
...
cc.FiniteTimeAction = cc.FiniteTimeAction or class('FiniteTimeAction',cc.Action)

function cc.FiniteTimeAction:ctor()
    self._duration = 0
