...
------------------------------------------------------
i3k_ai_network_auto_skill = i3k_class("i3k_ai_network_auto_skill", BASE);
function i3k_ai_network_auto_skill:ctor(entity)
	self._type	= eAType_NETWORK_SKILL;
end

function i3k_ai_network_auto_skill:IsValid()
	local entity = self._entity;

	return entity:CanUseSkill() and not entity._curSkill or entity._maunalSkill;
end

function i3k_ai_network_auto_skill:OnEnter()
...
function i3k_ai_network_auto_skill:OnLeave()
...
function i3k_ai_network_auto_skill:OnUpdate(dTime)
...
function i3k_ai_network_auto_skill:OnLogic(dTick)
...
function i3k_ai_network_auto_skill:SetSkill()
	local entity = self._entity;
...
function create_component(entity, priority)
	return i3k_ai_network_auto_skill.new(entity, priority);
end
