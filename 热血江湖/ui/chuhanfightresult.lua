...
-------------------------------------------------------
wnd_chuHanFightResult = i3k_class("wnd_chuHanFightResult", ui.wnd_base)

function wnd_chuHanFightResult:ctor()
	
end
 
function wnd_chuHanFightResult:configure()
...
function wnd_chuHanFightResult:onShow()
	
end

function wnd_chuHanFightResult:setData(index, teams)
	for i,v in ipairs(teams[index]) do
		...
		node.icon:setImage(g_i3k_db.i3k_db_get_role_head_icon(v.rid, v.headIcon, g_i3k_db.eHeadShapeCircie));
		--end
...
function wnd_chuHanFightResult:refresh(win, teams)
	local index = 2
...
--[[function wnd_chuHanFightResult:onClose(sender)
...
function wnd_chuHanFightResult:onUpdate(dTime)
...
function wnd_create(layout, ...)
	local wnd = wnd_chuHanFightResult.new()
	wnd:create(layout, ...)
	return wnd;
end
