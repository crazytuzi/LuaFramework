...
wnd_show_equip_tips = i3k_class("wnd_show_equip_tips",ui.wnd_base)

local LAYER_ZBTIPST = "ui/widgets/zbtipst"
local LAYER_ZBTIPST3 = "ui/widgets/zbtipst3"
local LAYER_ZBTIPST4 = "ui/widgets/zbtipst4"
local LegendsTab = {i3k_db_equips_legends_1, i3k_db_equips_legends_2, i3k_db_equips_legends_3}

function wnd_show_equip_tips:ctor()
	self._id = nil
end

function wnd_show_equip_tips:configure()
...
function wnd_show_equip_tips:refresh(id)
	self._id = id
	...
	self:setScrollLegends(cfg.legendsProp, cfg.partID)
	self:updateScroll(propertyData, id)
end

function wnd_show_equip_tips:setScrollLegends(legends, partID)
...
function wnd_show_equip_tips:updateScroll(propertyData, equipID)
...
function wnd_show_equip_tips:closeButton(sender)
	g_i3k_ui_mgr:CloseUI(eUIID_ShowEquipTips)
end

function wnd_create(layout)
	local wnd = wnd_show_equip_tips.new()
	wnd:create(layout)
	return wnd
end
