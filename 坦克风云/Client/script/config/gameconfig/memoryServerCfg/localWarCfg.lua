...
--区域战任务
	...
	taskreward={ -- 任务奖励
    t1={{p={{p982=30}}},{props_p982=30}},
    t2={{p={{p20=10}}},{props_p20=10}},
    t3={{p={{p3326=20}}},{props_p3326=20}},
    t4={{p={{p448=5}}},{props_p448=5}},
    t5={{p={{p819=5}}},{props_p819=5}},
    t6={{p={{p5001=20}}},{props_p5001=20}},
    t7={{p={{p705=20}}},{props_p705=20}},
    t8={{p={{p705=10}}},{props_p705=10}},
    t9={{p={{p819=5}}},{props_p819=5}},
	},
 
--胜利军团奖励
	winreward={reward={p={{p5001=20,index=1},{p3326=20,index=2},{p819=10,index=3},{p705=5,index=4}}},serverReward={props_p5001=20,props_p3326=20,props_p819=10,props_p705=5}},
 
--前端活跃奖励
	activeReward={reward={p={{p5001=20,index=1},{p982=30,index=2},{p20=10,index=3},{p705=30,index=4}}}},
