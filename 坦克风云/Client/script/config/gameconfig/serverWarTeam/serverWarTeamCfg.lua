serverWarTeamCfg=
{
    ...
    pShopItems={
        ...
        i4={id="i4",buynum=3,price=250,reward={p={{p362=1}}},serverReward={props_p362=1}},
        i5={id="i5",buynum=3,price=250,reward={p={{p370=1}}},serverReward={props_p370=1}},
        i6={id="i6",buynum=3,price=250,reward={p={{p378=1}}},serverReward={props_p378=1}},
        i7={id="i7",buynum=3,price=200,reward={p={{p269=1}}},serverReward={props_p269=1}},
        i8={id="i8",buynum=3,price=40,reward={p={{p268=1}}},serverReward={props_p268=1}},
        ...
        i17={id="i17",buynum=3,price=250,reward={p={{p192=1}}},serverReward={props_p192=1}},
        i18={id="i18",buynum=3,price=250,reward={p={{p204=1}}},serverReward={props_p204=1}},
        i19={id="i19",buynum=3,price=250,reward={p={{p216=1}}},serverReward={props_p216=1}},
        i20={id="i20",buynum=3,price=250,reward={p={{p228=1}}},serverReward={props_p228=1}},
        i21={id="i21",buynum=2,price=400,reward={p={{p4840=1}}},serverReward={props_p4840=1}},
        i22={id="i22",buynum=2,price=400,reward={p={{p4841=1}}},serverReward={props_p4841=1}},
    ...
    aShopItems={
        ...
        a8={id="a8",buynum=5,price=250,reward={p={{p354=1}}},serverReward={props_p354=1}},
        a9={id="a9",buynum=5,price=250,reward={p={{p362=1}}},serverReward={props_p362=1}},
        a10={id="a10",buynum=5,price=250,reward={p={{p370=1}}},serverReward={props_p370=1}},
        a11={id="a11",buynum=5,price=250,reward={p={{p378=1}}},serverReward={props_p378=1}},
        a12={id="a12",buynum=1,price=1000,reward={p={{p270=1}}},serverReward={props_p270=1}},
        a13={id="a13",buynum=1,price=500,reward={p={{p90=1}}},serverReward={props_p90=1}},
        a14={id="a14",buynum=5,price=250,reward={p={{p192=1}}},serverReward={props_p192=1}},
        a15={id="a15",buynum=5,price=250,reward={p={{p204=1}}},serverReward={props_p204=1}},
        a16={id="a16",buynum=5,price=250,reward={p={{p216=1}}},serverReward={props_p216=1}},
        a17={id="a17",buynum=5,price=250,reward={p={{p228=1}}},serverReward={props_p228=1}},
        a18={id="a18",buynum=8,price=400,reward={p={{p4840=1}}},serverReward={props_p4840=1}},
        a19={id="a19",buynum=8,price=400,reward={p={{p4841=1}}},serverReward={props_p4841=1}},
    ...
    baseFleetInfo={
        ...
        [90]={"a10007","a10017","a10027","a10037"},
    },
    baseFleetAttribute={
