allianceWar2Cfg={ -- 军团战 2016年 超豪华萌萌加强版本
    ...
    reward1={reward={e={{p4=2500,index=3},{p6=5,index=4}},p={{p975=0,index=1},{p448=1,index=2}}},serverReward={accessory_p4=2500,accessory_p6=5}},
    reward2={reward={e={{p4=1500,index=3},{p6=3,index=4}},p={{p976=0,index=1},{p447=3,index=2}}},serverReward={accessory_p4=1500,accessory_p6=3}},
