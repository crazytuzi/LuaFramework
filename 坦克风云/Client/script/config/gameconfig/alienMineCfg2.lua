...
r3=5,
 ...
 -- 个人排行榜的奖励
userRanking = {
needpoint=1000, --前台配置，后台不取
reward ={
{range={1,1},reward={r={{r2=5000}}},serverReward={alien_r2=5000}},
{range={2,2},reward={r={{r2=4000}}},serverReward={alien_r2=4000}},
{range={3,3},reward={r={{r2=3000}}},serverReward={alien_r2=3000}},
{range={4,5},reward={r={{r2=2000}}},serverReward={alien_r2=2000}},
{range={6,10},reward={r={{r2=1000}}},serverReward={alien_r2=1000}},
},
},

 --军团排行榜的奖励，今日之前加入且能进入该界面才可领取
allianceRanking={
needpoint=0, --前台配置，后台不取
reward={
{range={1,1},reward={r={{r1=10000}}},serverReward={alien_r1=10000}},
},
},
