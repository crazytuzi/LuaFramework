...
newGuidCfg={
    ...
    {stepId=7,clickRect=CCRectMake(396,106-170+i5_space,187,100),hasCloseBtn=true,hasPanle=true,panlePos=ccp(10,400+i5_space),clickToNext=false,arrowDirect=1,arrowPos=ccp(490,340-170+i5_space+10),toStepId=8},
    ...
    {stepId=11,clickRect=CCRectMake(30,570+i5_space,210,220),hasCloseBtn=true,hasPanle=true,panlePos=ccp(10,160+i5_space),clickToNext=false,arrowDirect=1,arrowPos=ccp(140,935+i5_space),delayTime=0.2,toStepId=12},
    {stepId=12,clickRect=CCRectMake(45,715+i5_space-160,150,122),hasCloseBtn=true,hasPanle=true,panlePos=ccp(10,260+i5_space-160),clickToNext=false,arrowDirect=1,arrowPos=ccp(120,1000+i5_space-15-160),toStepId=13},
    ...
    {stepId=16,clickRect=CCRectMake(219,182+i5_space+60,200,100),hasCloseBtn=true,hasPanle=true,panlePos=ccp(10,490+i5_space+60),clickToNext=false,arrowDirect=1,arrowPos=ccp(320,430+i5_space+60),toStepId=19},
    ...
    {stepId=19,clickRect=CCRectMake(-5,-5,160,150),hasCloseBtn=true,hasPanle=true,panlePos=ccp(10,400+i5_space),clickToNext=false,arrowDirect=1,arrowPos=ccp(84,288),toStepId=20},
    ...
    {stepId=26,clickRect=CCRectMake(390+60,688+100,200,100),hasCloseBtn=true,hasPanle=true,panlePos=ccp(10,200+105),clickToNext=false,arrowDirect=2,arrowPos=ccp(488+60,532+105),toStepId=27},
    ...
    {stepId=30,clickRect=CCRectMake(310,345+i5_space,330,250),hasCloseBtn=true,hasPanle=true,panlePos=ccp(10,600+i5_space),clickToNext=false,arrowDirect=2,arrowPos=ccp(480,200+i5_space),toStepId=31},
    {stepId=31,clickRect=CCRectMake(0,660,80,90),hasCloseBtn=true,hasPanle=true,panlePos=ccp(10,280),clickToNext=false,arrowDirect=4,arrowPos=ccp(140,720),toStepId=32},


    {stepId=32,clickRect=CCRectMake(464,636+80+i5_space,150,100),hasCloseBtn=true,hasPanle=true,panlePos=ccp(10,180+i5_space),clickToNext=false,arrowDirect=1,arrowPos=ccp(540,882+80+i5_space),toStepId=33},
    ...
    {stepId=34,clickRect=CCRectMake(464,636+80+i5_space,150,100),hasCloseBtn=true,hasPanle=true,panlePos=ccp(10,180+i5_space),clickToNext=false,arrowDirect=1,arrowPos=ccp(540,882+80+i5_space),toStepId=35},
    ...
    {stepId=38,clickRect=CCRectMake(495,210+65+i5_space-40,110,110),hasCloseBtn=true,hasPanle=true,panlePos=ccp(10,550+i5_space),clickToNext=false,arrowDirect=2,arrowPos=ccp(550,58+80+i5_space-40),toStepId=39},
    ...
    {stepId=40,clickRect=CCRectMake(494,635+90+i5_space,110,110),hasCloseBtn=true,hasPanle=true,panlePos=ccp(10,200+i5_space),clickToNext=false,arrowDirect=2,arrowPos=ccp(550,493+80+i5_space),toStepId=41},
    ...
    {stepId=43,clickRect=CCRectMake(0,814+i5_space*2,640,60),hasCloseBtn=true,hasPanle=true,panlePos=ccp(10,400+i5_space*2),clickToNext=false,arrowDirect=2,arrowPos=ccp(480,663+i5_space*2),toStepId=44},
    {stepId=44,clickRect=CCRectMake(20,380+80+i5_space,600,160),hasCloseBtn=true,hasPanle=true,panlePos=ccp(10,600+i5_space),clickToNext=false,arrowDirect=2,arrowPos=ccp(332,230+80+i5_space),toStepId=45},
    {stepId=45,clickRect=CCRectMake(430,294+88+i5_space,180,100),hasCloseBtn=true,hasPanle=true,panlePos=ccp(10,470+i5_space),clickToNext=false,arrowDirect=2,arrowPos=ccp(520,86+140+i5_space),toStepId=48},
    ...
    {stepId=48,clickRect=nil,hasCloseBtn=false,hasPanle=true,panlePos=ccp(10,400+i5_space),clickToNext=true,arrowDirect=1,arrowPos=ccp(100,100),toStepId=55},
        ...
        {stepId=53,clickRect=nil,hasCloseBtn=false,hasPanle=true,panlePos=ccp(10,400+i5_space),clickToNext=true,arrowDirect=1,arrowPos=ccp(100,100),showGirl=false,delayTime=3,toStepId=55},
        {stepId=54,clickRect=nil,hasCloseBtn=false,hasPanle=true,panlePos=ccp(10,400+i5_space),clickToNext=true,arrowDirect=1,arrowPos=ccp(100,100),showGirl=false,delayTime=0.2,toStepId=55},
