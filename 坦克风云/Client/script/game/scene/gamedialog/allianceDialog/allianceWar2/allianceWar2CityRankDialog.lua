allianceWar2CityRankDialog=smallDialog:new()

function allianceWar2CityRankDialog:new(cityData,type)
	local nc={}
...
function allianceWar2CityRankDialog:init(layerNum)
...
function allianceWar2CityRankDialog:initTableBg()
	local function nilFunc()
	end
...
function allianceWar2CityRankDialog:initTableView()
...
function allianceWar2CityRankDialog:eventHandler(handler,fn,idx,cel)
