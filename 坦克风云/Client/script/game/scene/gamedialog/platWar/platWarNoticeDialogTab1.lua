platWarNoticeDialogTab1={}

function platWarNoticeDialogTab1:new()
    local nc={}
    ...
    self.showNotice={}		--当前显示的消息
    -- self.firstShowNum=10	--刚打开板子显示公告条数
    return nc
end

function platWarNoticeDialogTab1:initShowNotice()
...
function platWarNoticeDialogTab1:init(layerNum,selectedTabIndex,chatDialog)
...
--设置对话框里的tableView
function platWarNoticeDialogTab1:initTableView()
...
function platWarNoticeDialogTab1:eventHandler(handler,fn,idx,cel)
...
function platWarNoticeDialogTab1:cellClick(noticeVo)--(idx,type)
...
function platWarNoticeDialogTab1:fastTick()
...
function platWarNoticeDialogTab1:checkUpdate()
...
function platWarNoticeDialogTab1:tick()
...
function platWarNoticeDialogTab1:resetTvPos()
	local recordPoint = self.tv:getRecordPoint()
...
function platWarNoticeDialogTab1:refresh()
...
--用户处理特殊需求,没有可以不写此方法
function platWarNoticeDialogTab1:doUserHandler()
	
end

function platWarNoticeDialogTab1:dispose()	
    self.tv=nil
    self.bgLayer=nil
    self.layerNum=nil
