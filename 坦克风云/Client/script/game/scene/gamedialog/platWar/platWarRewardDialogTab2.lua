platWarRewardDialogTab2={}
function platWarRewardDialogTab2:new()
    local nc={}
...
function platWarRewardDialogTab2:init(layerNum,parent)
...
function platWarRewardDialogTab2:initTableView()
...
function platWarRewardDialogTab2:eventHandler(handler,fn,idx,cel)
...
function platWarRewardDialogTab2:doUserHandler()
	...
	if self.valueLabel==nil then
		self.valueLabel=GetTTFLabel(getlocal("plat_war_fight_point"),25)
	...
	if self.myRankLb==nil then
		...
		if myRank==0 then
			if platWarCfg and platWarCfg.battleRank and platWarCfg.battleRank.maxNum then
				myRank=platWarCfg.battleRank.maxNum.."+"
			end
		end
...
function platWarRewardDialogTab2:setColor(color)
...
function platWarRewardDialogTab2:cellClick(idx)
...
function platWarRewardDialogTab2:tick()
	if self then
...
function platWarRewardDialogTab2:dispose()
	self.rewardBtn=nil
	self.rankLabel=nil
	self.nameLabel=nil
	self.serverLabel=nil
