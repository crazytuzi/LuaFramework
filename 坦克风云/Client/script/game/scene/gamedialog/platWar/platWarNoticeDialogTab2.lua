platWarNoticeDialogTab2={}

function platWarNoticeDialogTab2:new()
    local nc={}
...
function platWarNoticeDialogTab2:initShowNotice()
...
function platWarNoticeDialogTab2:init(layerNum,selectedTabIndex,chatDialog)
...
--设置对话框里的tableView
function platWarNoticeDialogTab2:initTableView()
...
function platWarNoticeDialogTab2:eventHandler(handler,fn,idx,cel)
...
function platWarNoticeDialogTab2:cellClick(noticeVo)--(idx,type)
...
function platWarNoticeDialogTab2:fastTick()
...
function platWarNoticeDialogTab2:checkUpdate()
	if self.showNotice then
		...
		-- print("lastVo.index,showVo.index",lastVo.index,showVo.index)
...
function platWarNoticeDialogTab2:tick()
	...
	if flag==-1 or base.serverTime-lastNoticeTime>=platWarCfg.noticeInterval  then
...
function platWarNoticeDialogTab2:resetTvPos()
	local recordPoint = self.tv:getRecordPoint()
...
function platWarNoticeDialogTab2:refresh()
...
--用户处理特殊需求,没有可以不写此方法
function platWarNoticeDialogTab2:doUserHandler()
	
end

function platWarNoticeDialogTab2:dispose()	
    self.tv=nil
    self.bgLayer=nil
    self.layerNum=nil
