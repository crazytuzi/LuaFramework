acSlotMachineExchange2Dialog={}

function acSlotMachineExchange2Dialog:new()
    local nc={}
...
function acSlotMachineExchange2Dialog:initInfoLayer()
...
function acSlotMachineExchange2Dialog:init(layerNum)
...
function acSlotMachineExchange2Dialog:eventHandler(handler,fn,idx,cel)
    ...
    elseif fn=="tableCellAtIndex" then
        ...
        local cfgByNum = acSlotMachine2VoApi:getCfgConversionTableByNum(3 - idx)
        local index = 1
        for k,v in pairs(cfgByNum) do
            ...
            for i=1,iconNum do
                ...
                pic = acSlotMachine2VoApi:getPicById(id)
...
function acSlotMachineExchange2Dialog:close()
    self.bgLayer:removeFromParentAndCleanup(true)
    self:dispose()
end
function acSlotMachineExchange2Dialog:dispose()
    self.bgLayer=nil
    self.closeBtn=nil
    self.tv=nil
    self.topforbidSp = nil --顶端遮挡层
