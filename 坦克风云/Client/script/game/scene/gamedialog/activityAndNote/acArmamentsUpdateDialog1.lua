acArmamentsUpdateDialog1=acArmamentsUpdateDialog:new()

function acArmamentsUpdateDialog1:new()
    local nc={}
...
function acArmamentsUpdateDialog1:initmaterialsSprite()
...
function acArmamentsUpdateDialog1:initRefitSprie( ... )
    ...
    local refitIcon = CCSprite:createWithSpriteFrameName("TankLv6.png")
...
function acArmamentsUpdateDialog1:eventHandler1(handler,fn,idx,cel)
...
function acArmamentsUpdateDialog1:eventHandler2(handler,fn,idx,cel)
    if fn=="numberOfCellsInTableView" then
        return 1
    elseif fn=="tableCellSizeForIndex" then
        local tmpSize
...
function acArmamentsUpdateDialog1:dispose()
    self.cellHeight=nil
