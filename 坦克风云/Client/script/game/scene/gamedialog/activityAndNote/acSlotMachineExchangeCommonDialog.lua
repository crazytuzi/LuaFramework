acSlotMachineExchangeCommonDialog={}

function acSlotMachineExchangeCommonDialog:new()
    local nc={}
...
function acSlotMachineExchangeCommonDialog:initInfoLayer()
...
function acSlotMachineExchangeCommonDialog:init(layerNum)
...
function acSlotMachineExchangeCommonDialog:eventHandler(handler,fn,idx,cel)
    ...
    elseif fn=="tableCellAtIndex" then
        ...
        local cfgByNum = acSlotMachineCommonVoApi:getCfgConversionTableByNum(3 - idx)
        local index = 1
        for k,v in pairs(cfgByNum) do
            ...
            for i=1,iconNum do
                ...
                pic = acSlotMachineCommonVoApi:getPicById(id)
...
function acSlotMachineExchangeCommonDialog:close()
    self.bgLayer:removeFromParentAndCleanup(true)
    self:dispose()
end
function acSlotMachineExchangeCommonDialog:dispose()
    self.bgLayer=nil
    self.closeBtn=nil
    self.tv=nil
    self.topforbidSp = nil --顶端遮挡层
