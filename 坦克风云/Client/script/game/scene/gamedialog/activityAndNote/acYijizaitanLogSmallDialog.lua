acYijizaitanLogSmallDialog=smallDialog:new()

function acYijizaitanLogSmallDialog:new()
    local nc={}
...
-- rewardList  列表信息
function acYijizaitanLogSmallDialog:init(bgSrc,size,tmpFunc,istouch,isuseami,layerNum,rewardList,title,desStr,nojilu)
...
function acYijizaitanLogSmallDialog:eventHandler(handler,fn,idx,cel)
...
function acYijizaitanLogSmallDialog:dispose()
    self.rewardList=nil
end