acRoulette2DialogTab3={}

function acRoulette2DialogTab3:new()
    local nc={}
...
function acRoulette2DialogTab3:init(layerNum,selectedTabIndex,acRouletteDialog)
...
function acRoulette2DialogTab3:doUserHandler()
    ...
    rewardDesc2:setColor(G_ColorRed)
 	...
 	local function rewardHandler()
            ...
            if ret==true then
                ...
                if rPoint and point>=rPoint and pointRewardNum==0 then
                    if self and self.bgLayer then
                        ...
                        acRoulette2VoApi:pointRewardUpdate(newNum)
        ...
        socketHelper:activeWheelfortune2(3,wheelfortuneCallback)
    end
...
function acRoulette2DialogTab3:tick()
end

function acRoulette2DialogTab3:subtick()
end

function acRoulette2DialogTab3:refresh()
    if self and self.bgLayer then
        local vo=acRoulette2VoApi:getAcVo()
        local point=vo.point or 0
        local pointRewardNum=vo.pointRewardNum or 0
...
function acRoulette2DialogTab3:dispose()
    self.tv=nil
    self.bgLayer=nil
    self.layerNum=nil
    self.selectedTabIndex=nil
