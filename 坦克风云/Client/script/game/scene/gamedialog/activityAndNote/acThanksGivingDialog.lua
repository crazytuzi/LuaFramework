acThanksGivingDialog=commonDialog:new()

function acThanksGivingDialog:new(layerNum)
    local nc={}
...
function acThanksGivingDialog:resetTab()
    local index=0
...
--设置对话框里的tableView
function acThanksGivingDialog:initTableView()
...
function acThanksGivingDialog:eventHandler(handler,fn,idx,cel)
...
--点击tab页签 idx:索引
function acThanksGivingDialog:tabClick(idx)
...
function acThanksGivingDialog:getDataByType(type)
    if(type==nil)then
        type=1
    end    
    if type==2 then
        ...
        if self.tabLayer2==nil then
            self.tab2=acThanksGivingTab2:new()
    ...
    elseif type==1 then            
        ...
        if self.tabLayer1==nil then
            ...
            socketHelper:thanksGivingYou(callback,"1")
        else
...
function acThanksGivingDialog:tick()
  local vo=acThanksGivingVoApi:getAcVo()
...
function acThanksGivingDialog:update()

end

function acThanksGivingDialog:dispose()
