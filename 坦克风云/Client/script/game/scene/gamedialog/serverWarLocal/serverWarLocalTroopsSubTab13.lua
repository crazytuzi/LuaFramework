serverWarLocalTroopsSubTab13 = {}

function serverWarLocalTroopsSubTab13:new()
    local nc = {}
...
function serverWarLocalTroopsSubTab13:init(layerNum, parent)
...
function serverWarLocalTroopsSubTab13:initTabLayer()
...
function serverWarLocalTroopsSubTab13:initDesc()
...
function serverWarLocalTroopsSubTab13:initRepair()
    local rect = CCRect(0, 0, 50, 50)
    local capInSet = CCRect(20, 20, 10, 10)
    local function cellClick(hd, fn, idx)
    end
...
function serverWarLocalTroopsSubTab13:tick()
    if self then
...
function serverWarLocalTroopsSubTab13:updateData()
...
function serverWarLocalTroopsSubTab13:refresh()
...
function serverWarLocalTroopsSubTab13:dispose()
    self.selectedTabIndex = 2
    self.type = 27
    self.bgLayer = nil
    self.currentShow = {1, 1, 1}
