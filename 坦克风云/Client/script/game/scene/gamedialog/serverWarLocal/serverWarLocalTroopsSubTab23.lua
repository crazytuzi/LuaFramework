serverWarLocalTroopsSubTab23 = {}

function serverWarLocalTroopsSubTab23:new()
    local nc = {}
...
function serverWarLocalTroopsSubTab23:init(layerNum, parent)
...
function serverWarLocalTroopsSubTab23:initTabLayer()
...
function serverWarLocalTroopsSubTab23:initSaveBtn()
    local function save()
...
function serverWarLocalTroopsSubTab23:saveHandler(callback)
...
function serverWarLocalTroopsSubTab23:isChangeFleet()
    local btype = self.type + self.selectedTabIndex
    local troopsIndex = self.selectedTabIndex + 1
    local fleetInfo = tankVoApi:getTanksTbByType(btype)
...
function serverWarLocalTroopsSubTab23:initFormationBtn()
...
function serverWarLocalTroopsSubTab23:initDesc()
...
-- function serverWarLocalTroopsSubTab23:judgeFight()
--     local bestTab2={}
--     local allfight1=0
--     local allfight2=0
...
function serverWarLocalTroopsSubTab23:doUserHandler()
...
function serverWarLocalTroopsSubTab23:tick()
    -- if self then
    --     local setFleetStatus=serverWarLocalVoApi:getSetFleetStatus()
...
function serverWarLocalTroopsSubTab23:setTanksRestore()
...
function serverWarLocalTroopsSubTab23:updateData()
    heroVoApi:clearTroops()
    AITroopsFleetVoApi:clearAITroops()
    self:setTanksRestore()
end
function serverWarLocalTroopsSubTab23:refresh()
    self:updateData()
    local tType = self.type + self.selectedTabIndex
...
function serverWarLocalTroopsSubTab23:dispose()
    self:setTanksRestore()
