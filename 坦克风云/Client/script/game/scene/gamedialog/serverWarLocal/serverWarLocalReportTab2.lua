serverWarLocalReportTab2={}

function serverWarLocalReportTab2:new()
    local nc={}
...
function serverWarLocalReportTab2:init(layerNum,parent)
...
function serverWarLocalReportTab2:initLayer()
...
function serverWarLocalReportTab2:initTableView()
...
function serverWarLocalReportTab2:eventHandler(handler,fn,idx,cel)
...
--点击了cell或cell上某个按钮
function serverWarLocalReportTab2:cellClick(idx)
...
function serverWarLocalReportTab2:refresh()

end

function serverWarLocalReportTab2:tick()
    -- if self and self.mailClick and self.mailClick>0 then
 --        self.mailClick=0
 --    end
    if self.callbackNum<3 and base.serverTime>serverWarLocalVoApi:getReportExpireTime(self.reportType) then
...
function serverWarLocalReportTab2:dispose()
    self.bgLayer=nil
    self.layerNum=nil
    self.cellHeight=200
    self.moreCellHeight=100
