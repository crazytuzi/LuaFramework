worldWarDialogSubTab33={}

function worldWarDialogSubTab33:new()
    local nc={}
...
function worldWarDialogSubTab33:init(layerNum,parent)
...
function worldWarDialogSubTab33:initDesc()
	local str=getlocal("world_war_shop_desc3")
...
function worldWarDialogSubTab33:initTableView()
...
function worldWarDialogSubTab33:eventHandler(handler,fn,idx,cel)
	if fn=="numberOfCellsInTableView" then
        local pointDetail=worldWarVoApi:getPointDetail()
        local num=SizeOfTable(pointDetail)
        -- local isHasMore=worldWarVoApi:isHasMore()
        -- if isHasMore then
        --     num=num+1
        -- end
        return num
    ...
    elseif fn=="tableCellAtIndex" then
        ...
        local function cellClick(hd,fn,idx)
            if self.tv:getScrollEnable()==true and self.tv:getIsScrolled()==false then
                ...
                --             local addHeight=worldWarVoApi:formatData(sData.data.alliance.events)
                --             local newHasMore=worldWarVoApi:isHasMore()
                --             if worldWarVoApi:getPage()>=1 then
                ...
                --     end
                -- end
                -- local page=worldWarVoApi:getPage()
        ...
        local timeStr=worldWarVoApi:getTimeStr(time)
...
function worldWarDialogSubTab33:doUserHandler()
...
function worldWarDialogSubTab33:tick()
...
function worldWarDialogSubTab33:refresh()

end

function worldWarDialogSubTab33:dispose()
    self.tv=nil
    self.bgLayer=nil
    self.layerNum=nil
    self.cellHeght=nil
