worldWarRewardInfoDialogTab2={}

function worldWarRewardInfoDialogTab2:new()
	local nc={}
...
function worldWarRewardInfoDialogTab2:init(layerNum,parent)
...
function worldWarRewardInfoDialogTab2:initTableView()
	...
	local iiSize=100
	local icon=CCSprite:createWithSpriteFrameName("ww_logo_2.png")
...
function worldWarRewardInfoDialogTab2:eventHandler(handler,fn,idx,cel)
...
function worldWarRewardInfoDialogTab2:tick()

end

function worldWarRewardInfoDialogTab2:dispose()
