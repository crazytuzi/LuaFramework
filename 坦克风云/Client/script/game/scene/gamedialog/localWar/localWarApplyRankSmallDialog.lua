localWarApplyRankSmallDialog=smallDialog:new()

function localWarApplyRankSmallDialog:new()
	local nc={}
...
function localWarApplyRankSmallDialog:init(layerNum)
...
function localWarApplyRankSmallDialog:initTableBg()
	local function nilFunc()
	end
...
function localWarApplyRankSmallDialog:initTableView()
...
function localWarApplyRankSmallDialog:eventHandler(handler,fn,idx,cel)
	if fn=="numberOfCellsInTableView" then
		local num=(#localWarVoApi:getApplyRank())
	...
	elseif fn=="tableCellAtIndex" then
    	...
    	local applyList=localWarVoApi:getApplyRank()
    	local cellData=applyList[idx+1]
        local rankSign
        if(idx>2)then
