localWarOfficeDialog=commonDialog:new()
function localWarOfficeDialog:new()
    local nc={}
...
-- function localWarOfficeDialog:init(layerNum,parent)
...
function localWarOfficeDialog:initTableView()
    localWarVoApi:updateOffice()
    ...
    self.tv=LuaCCTableView:createWithEventHandler(hd,CCSizeMake(G_VisibleSizeWidth-40,G_VisibleSizeHeight-195+75),nil)
...
function localWarOfficeDialog:eventHandler(handler,fn,idx,cel)
...
function localWarOfficeDialog:refresh()

end

function localWarOfficeDialog:tick()
    localWarVoApi:updateOffice()
...
function localWarOfficeDialog:dispose()
    self.bgLayer=nil
    self.layerNum=nil
end
