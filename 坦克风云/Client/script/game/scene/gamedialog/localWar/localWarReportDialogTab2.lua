localWarReportDialogTab2={}

function localWarReportDialogTab2:new()
    local nc={}
...
function localWarReportDialogTab2:init(layerNum,parent)
...
function localWarReportDialogTab2:initLayer()
...
function localWarReportDialogTab2:initTableView()
    ...
    local list=localWarVoApi:getReportList(2)
    if list and SizeOfTable(list)>0 then
    else
        local noReportLb=GetTTFLabelWrap(getlocal("local_war_self_no_report"),30,CCSizeMake(self.bgLayer:getContentSize().width-40,0),kCCTextAlignmentCenter,kCCVerticalTextAlignmentCenter)
...
function localWarReportDialogTab2:eventHandler(handler,fn,idx,cel)
    if fn=="numberOfCellsInTableView" then
        local reportList=localWarVoApi:getReportList(2)
...
function localWarReportDialogTab2:refresh()

end

function localWarReportDialogTab2:tick()
    
end

function localWarReportDialogTab2:dispose()
    self.bgLayer=nil
    self.layerNum=nil
    self.cellHeight=200
end
