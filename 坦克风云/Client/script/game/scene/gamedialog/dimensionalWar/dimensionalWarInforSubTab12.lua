dimensionalWarInforSubTab12 = {}

function dimensionalWarInforSubTab12:new()
    local nc={}
...
function dimensionalWarInforSubTab12:init(layerNum)
...
function dimensionalWarInforSubTab12:initLayer()
    ...
    local tLb3 = GetTTFLabelWrap(getlocal("city_info_power"),tlbSize,CCSizeMake(150,0),kCCTextAlignmentLeft,kCCVerticalTextAlignmentCenter);
    ...
    -- local tLb4 = GetTTFLabel(getlocal("dimensionalWar_survive_round"),tlbSize);
    ...
    local function touchInfoItem(idx)
        ...
        local tabStr={"\n",getlocal("dimensionalWar_death_desc3"),"\n",getlocal("dimensionalWar_death_desc2"),"\n",getlocal("dimensionalWar_death_desc1"),"\n"}
        local tabColor={nil,G_ColorWhite,nil,G_ColorWhite,nil,G_ColorYellowPro,nil}
        local tabAlignment={nil,nil,nil,nil,nil,kCCTextAlignmentCenter,nil}
...
function dimensionalWarInforSubTab12:initTableView()
...
function dimensionalWarInforSubTab12:eventHandler1(handler,fn,idx,cel)
    ...
    elseif fn=="tableCellAtIndex" then
        ...
        if idx==0 then
            ...
            point=dimensionalWarVoApi.point2 or 0
            round=dimensionalWarVoApi.round2 or 0
            rank=dimensionalWarVoApi:getSelfRank(2) or 0
        else
...
function dimensionalWarInforSubTab12:getRankList()
    local rankList=dimensionalWarVoApi:getRankList(2)
    return rankList
end

function dimensionalWarInforSubTab12:tick()
end


function dimensionalWarInforSubTab12:refresh()
end

function dimensionalWarInforSubTab12:dispose()
    self.bgLayer=nil
    self.layerNum=nil
    self.tv=nil
