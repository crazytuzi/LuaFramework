...
flagBuildCD=30,
 ...
 --坦克消耗兑换的比例
tankeTransRate=25, --100比1的消耗比例,足的部分向上取整
 --战报最大数量
reportMaxNum=50,
...
i12={id="i12",buynum=10,price=200,reward={p={{p275=5}}},serverReward={props_p275=5}},
    ...
    -- probability 升级成功概率
buffSkill={
b1={maxLv=10,cost=38,per=0.05,probability={100,95,90,85,80,75,70,65,60,55},donate=5,icon="WarBuffSmeltExpert.png",name="serverwarteam_buffName1",des="serverwarteam_buffDesc1"},
b2={maxLv=10,cost=38,per=5,probability={100,95,90,85,80,75,70,65,60,55},donate=5,icon="WarBuffCommander.png",name="serverwarteam_buffName2",des="serverwarteam_buffDesc2"},
b3={maxLv=10,cost=38,per=0.03,probability={100,95,90,85,80,75,70,65,60,55},donate=5,icon="WarBuffNetget.png",name="serverwarteam_buffName3",des="serverwarteam_buffDesc3"},
b4={maxLv=5,cost=38,per=0.1,probability={100,95,90,85,80,75,70,65,60,55},donate=5,icon="WarBuffStatistician.png",name="serverwarteam_buffName4",des="serverwarteam_buffDesc4"},
},
