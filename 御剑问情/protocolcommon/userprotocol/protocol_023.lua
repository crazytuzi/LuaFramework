...
function SCTradeState:Decode()
	...
	self.other_avatar_key_big = MsgAdapter.ReadUInt()
	self.other_avatar_key_small = MsgAdapter.ReadUInt()
	self.other_sex = MsgAdapter.ReadChar()
	self.other_prof = MsgAdapter.ReadChar()
	MsgAdapter.ReadChar()
	MsgAdapter.ReadChar()
end
