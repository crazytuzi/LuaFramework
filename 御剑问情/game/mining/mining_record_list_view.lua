...
function MiningRecordListView:__init()
	self.ui_config = {"uis/views/mining_prefab","MiningRecordView"}
	self.cell_list = {}
	self.view_type = 0
end
...
function RecordListItem:OnFlush()
	...
	if info_data ~= nil then
		-- name = info_data.name
		if self.data.cur_type == 0 then
			name = string.format(Language.Mining.DanYaocolor, info_data.name)
		elseif self.data.cur_type == 1 then
			name = string.format(Language.Mining.DanYaocolor1, info_data.name)
		elseif self.data.cur_type == 2 then
			name = string.format(Language.Mining.DanYaocolor2, info_data.name)
		elseif self.data.cur_type == 3 then
			name = string.format(Language.Mining.DanYaocolor3, info_data.name)
		end
	end
