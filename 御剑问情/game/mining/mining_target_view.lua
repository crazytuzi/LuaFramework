...
function MiningTargetView:__init()
    self.ui_config = {"uis/views/mining_prefab","MiningTargetView"}
    self.view_data = {}
...
function MiningTargetView:SetTargetPanel()
    ...
    if power >= self.view_data.capability then
        ...
        self.text_player_name:SetValue(string.format(Language.Mining.TargetPlayNameText, name))
        self.text_player_zhanli:SetValue(string.format(Language.Mining.TargetPlayCapabilityText2, self.view_data.capability))
    end
