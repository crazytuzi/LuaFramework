...
function TeamFbCtrl:__init()
	...
	self.tower = TowerSelectView.New(ViewName.TowerSelectView)
...
function TeamFbCtrl:RegisterAllProtocols()
	...
	self:RegisterProtocol(SCTeamTowerInfo, "OnTeamTowerInfo")
...
function TeamFbCtrl:OnTeamTowerInfo(protocol)
...
function TeamFbCtrl:SendTeamTowerDefendSetAttrType(uid, attr_type)
