...
local Effect_Name =
{
	[1] = {bundle_name = "effects2/prefab/w2_changjing/w2_yw_04_xuejianya_prefab", assst_name = "Xddt01_xeu"},
	[2] = {bundle_name = "effects2/prefab/w2_changjing/tongyong_prefab", assst_name = "zhuye"},
	[3] = {bundle_name = "effects2/prefab/w2_changjing/tongyong_prefab", assst_name = "xiayu", voice = "thunder"},
}
