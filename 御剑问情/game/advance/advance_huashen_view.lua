...
function AdvanceHuashenView:OnClickCanCelIamge()
	...
	if not huashen_info or not next(huashen_info) then return end
...
function AdvanceHuashenView:SwitchGradeAndName(index)
	...
	if not huashen_info or not next(image_info) then return end
...
function AdvanceHuashenView:SetAdvanceButtonState()
	...
	if not level_info or not next(level_info) then return end
