...
function FirstChargeCtrl:__init()
	...
	self.open_view_level_list = {128, 149, 165}
...
function FirstChargeCtrl:GetSecondView()
					...
					for i,v in ipairs(IndexList) do
						if v == 1 then
							...
							if open then
								...
								ViewManager.Instance:Open(ViewName.SecondChargeView,v)
								break
							end
						else
...
function FirstChargeCtrl:RemoveDelayTime()
