...
function LuckyChessData:LuckyChessPoindRemind()
	local remind_num = self:GetLuckyChessRemind()
	ActivityData.Instance:SetActivityRedPointState(ACTIVITY_TYPE.RAND_ACTIVITY_TYPE_DAY_DAY_UP,remind_num > 0)
end
