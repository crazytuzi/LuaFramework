...
function KuaFu1v1ViewFight:FlushBaseInfo()
	...
	local vo = GameVoManager.Instance:GetMainRoleVo()
	self.my_hp:SetValue(string.format(Language.Common.HpBiLi, vo.hp, vo.max_hp))
...
function KuaFu1v1ViewFight:TimerCallback()
	...
	if self.target_obj then
		...
		self.target_hp:SetValue(string.format(Language.Common.HpBiLi, target_hp1, target_hp2))
