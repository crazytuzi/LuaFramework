...
_dofile (ClientConfigPath .. "config/questScript/wuqipreviewguide.lua")
_dofile (ClientConfigPath .. "config/questScript/yuanBaopreviewguide.lua")
_dofile (ClientConfigPath .. "config/questScript/wingfuncguide.lua")
_dofile (ClientConfigPath .. "config/questScript/wingGetguide.lua")
_dofile (ClientConfigPath .. "config/questScript/wuqifuncguide.lua")
_dofile (ClientConfigPath .. "config/questScript/yuanBaofuncguide.lua")
...
_dofile (ClientConfigPath .. "config/questScript/transforchangeguide.lua")
