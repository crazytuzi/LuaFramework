...
_G.CUICardConfig = 
{
	...
	[999] = 
	{
		...
		-- npc名字的颜色
		npc_name_textcolor = 0xFF2b94f6;--名字颜色
		...
		-- monster名字的颜色
		monster_name_txtcolor = 0xFFfc3232;--名字颜色
		...
		monster_title_textcolor = 0xFFc827fd;--称号颜色
		monster_title_edgecolor = 0xFF000000;--称号边框颜色
		monster_title_textcolor_mouseover = 0xFFc827fd;--称号颜色(鼠标指向时)
	...
	[1] = 
	{
		...
		---------------------------------------
		size = 0.07;  --怪物名字大小
		textcolor = 0xFFd7d6d5;--怪物名字颜色
		edgeColor = 0xFF000000;--怪物名字边框颜色
		_textcolor = 0xFFd7d6d5;--怪物名字颜色(鼠标指向时)
		_edgeColor = 0xFF000000;--怪物名字边框颜色(鼠标指向时)
	};

	--主角的名字颜色
	nameColor = {
		self_textcolor = 0xffe5e5e5;                --自己名字颜色/字体0xFF228B22
        other_textcolor = 0xffe5e5e5;               --别人名字颜色/字体
		self_edgeColor = 0xFF000000;                --自己名字颜色描边/边框 0xFF000000 
		other_edgeColor = 0xFF000000;               --别人名字颜色描边/边框
		
		selfGuild_textcolor = 0xFFffc333;           --自己帮派名字颜色/字体0xFF228B22
        otherGuild_textcolor = 0xFFffc333;          --别人帮派名字颜色/字体
		selfGuild_edgeColor = 0xFF000000;           --自己帮派名字颜色/边框 0xFF000000
		otherGuild_edgeColor = 0xFF000000;          --别人帮派名字颜色/边框
		
		self_readcolor = 0xFFfc3232;                --自己PK的颜色
		self_graycolor = 0xFF000000;                --别人PK的颜色
		
		self_mgraycolor = 0xff6f6e6e;               --自己挑衅的颜色
