...
function CurrentSceneScript:Startup()
  ...
  _RegSceneEventHandler(SceneEvents.MonsterKilled,"OnBossKilled",{param1 = 10201012})
  _RegSceneEventHandler(SceneEvents.MonsterKilled,"OnBossKilled",{param2 = 10201015})
...
function CurrentSceneScript:OnHumanStoryStep(id)
   ...
   if id == 3701011 then
      ...
      data[1] = "10201011"  --怪物id  或者boss id
      data[2] = "5,5"		--随机数量
   ...
   if id == 3701013 then
      ...
      data[1] = "10201013"  --怪物id  或者boss id
      data[2] = "5,5"		--随机数量
   ...
   if id == 3701014 then
      ...
      data[1] = "10201014"  --怪物id  或者boss id
      data[2] = "10,10"		--随机数量
