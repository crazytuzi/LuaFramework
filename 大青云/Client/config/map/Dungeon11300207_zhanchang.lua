...
function CurrentSceneScript:Startup()
  ...
  _RegSceneEventHandler(SceneEvents.MonsterKilled,"OnBossKilled",{param1 = 10202022})
  _RegSceneEventHandler(SceneEvents.MonsterKilled,"OnBossKilled",{param2 = 10202025})
...
function CurrentSceneScript:OnHumanStoryStep(id)
   ...
   if id == 3601021 then
      ...
      data[1] = "10202021"  --怪物id  或者boss id
      data[2] = "5,5"		--随机数量
   ...
   if id == 3601023 then
      ...
      data[1] = "10202023"  --怪物id  或者boss id
      data[2] = "5,5"		--随机数量
   ...
   if id == 3601024 then
      ...
      data[1] = "10202024"  --怪物id  或者boss id
      data[2] = "10,10"		--随机数量
