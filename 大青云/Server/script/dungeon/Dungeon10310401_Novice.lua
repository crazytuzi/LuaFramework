...
function CurrentSceneScript:OnBossKilled(boss,killer,id)
    --击杀boss事件
    if id == 10200401 or id == 10200402 or id == 10200403 then
        --boss隐藏BOSS星级界面
    ...
    if id == 10200404 then
        ...
        if self.monster_hold_num >= self.monster_hold_first_max then
            if self.monster_hold_flag == 0 then
               ...
               self.SModScript:SpawnMonsterBit(10200413,false)
            end
        end
...
function CurrentSceneScript:OnHumanStoryStep(id)
    ...
    if id == 3101001 then
        self.SModScript:SpawnMonsterBit(10200413,true)
    ...
    if id == 3101003 then
        ...
        local data = {}
        local monster_id = "10200406" --怪物id
    ...
    if id == 3101010 then
        --self.Scene:GetModScript():DungeonBlock("block006",false)
    end
    if id == 2101010 then
        local data = {}
        local monster_dir = 3.09
        data[1] = 10200402 --半血刷小怪
        data[2] = 1
        data[3] = 131
        data[4] = -66
		self.SModScript:SpawnMonster(data,monster_dir)
    ...
    if id == 10200407 then -- 分裂小怪id
        self.SModScript:SpawnMonsterBit(10200402,false)
        self.split_flag = 2
    end
    if id == 3101012 then
...
function CurrentSceneScript:GetDropBloodPer(id)
    local result = 0
    if self.split_flag == 1 and id == 10200402 then
        result = 1
    end
