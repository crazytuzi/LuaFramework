...
function CurrentSceneScript:Startup()
  ...
  _RegSceneEventHandler(SceneEvents.MonsterKilled,"OnBossKilled",{param1 = 10201002})
  _RegSceneEventHandler(SceneEvents.MonsterKilled,"OnBossKilled",{param2 = 10201005})
...
function CurrentSceneScript:OnHumanStoryStep(id)
   ...
   if id == 3701001 then
      ...
      data[1] = "10201001"  --怪物id  或者boss id
      data[2] = "5,5"		--随机数量
   ...
   if id == 3701003 then
      ...
      data[1] = "10201003"  --怪物id  或者boss id
      data[2] = "5,5"		--随机数量
   ...
   if id == 3701004 then
      ...
      data[1] = "10201004"  --怪物id  或者boss id
      data[2] = "10,10"		--随机数量
