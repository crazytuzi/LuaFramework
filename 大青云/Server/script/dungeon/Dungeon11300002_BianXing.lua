...
CurrentSceneScript.BornInfo = {
	[1] = {x=305, y=-93, r=50, num=10, id=10203000}, 	-- 第1关怪物出生点信息
	[2] = {x=305, y=-93, r=50, num=10, id=10203001},	-- 第1关怪物出生点信息
	[3] = {x=305, y=-93, r=50, num=10, id=10203002}, 		-- 第1关怪物出生点信息
	[4] = {num=4, id=10203004,x1=95, y1=-160,x2=12, y2=-158, x3=9, y3=-73, x4=94, y4=-73}, -- 第2关怪物出生点信息
	[5] = {x=70, y=-110, r=50, num=2, id=10203005},		-- 第2关怪物出生点信息
	[6] = {x=70, y=-110, r=0, num=1, id=10203006}, 	-- 第2关怪物出生点信息
	[7] = {x=-432, y=179, r=0, num=1, id=10203003}, -- 第3关怪物出生点信息
}
