...
function CurrentSceneScript:OnBossKilled(boss,killer,id)
    --击杀boss事件
    if id == 10200101 or id == 10200102 or id == 10200103 then
        --boss隐藏BOSS星级界面
    ...
    if id == 10200104 then
        ...
        if self.monster_hold_num >= self.monster_hold_first_max then
            if self.monster_hold_flag == 0 then
               ...
               self.SModScript:SpawnMonsterBit(10200113,false)
            end
        end
...
function CurrentSceneScript:OnHumanStoryStep(id)
    ...
    if id == 3101001 then
        self.SModScript:SpawnMonsterBit(10200113,true)
    ...
    if id == 3101003 then
        ...
        local data = {}
        local monster_id = "10200106" --怪物id
    ...
    if id == 10200107 then -- 分裂小怪id
        self.SModScript:SpawnMonsterBit(10200102,false)
        self.split_flag = 2
    end
    if id == 3101012 then
...
function CurrentSceneScript:GetDropBloodPer(id)
    local result = 0
    if self.split_flag == 1 and id == 10200102 then
        result = 1 --boss是否已经分裂小怪
    end
    return result
end
