...
function CurrentSceneScript:Startup()
  ...
  _RegSceneEventHandler(SceneEvents.MonsterKilled,"OnBossKilled",{param1 = 10213002})
  _RegSceneEventHandler(SceneEvents.MonsterKilled,"OnBossKilled",{param2 = 10213005})
  ...
  -- 对话Npc后   刷第一波怪
   if id == 3801001 then
    local data = {}
      ...
      data[1] = "10213001"  --怪物id  或者boss id
      data[2] = "5,5"   --随机数量
  ...
  --第一波小怪被杀  打开第一个空气墙  刷第一波boss
   ...
   if id == 3801003 then
    ...
    local data = {}
      ...
      data[1] = "10213003"  --怪物id  或者boss id
      data[2] = "5,5"   --随机数量
   ...
   if id == 3801004 then
    ...
    local data = {}
      ...
      data[1] = "10213004"  --怪物id  或者boss id
      data[2] = "10,10"   --随机数量
