...
function CurrentSceneScript:OnBossKilled(boss,killer,id)
    --击杀boss事件
    if id == 10200301 or id == 10200302 or id == 10200303 then
        --boss隐藏BOSS星级界面
    ...
    if id == 10200304 then
        ...
        if self.monster_hold_num >= self.monster_hold_first_max then
            if self.monster_hold_flag == 0 then
               ...
               self.SModScript:SpawnMonsterBit(10200313,false)
            end
        end
...
function CurrentSceneScript:OnHumanStoryStep(id)
    ...
    if id == 3101001 then
        self.SModScript:SpawnMonsterBit(10200313,true)
    ...
    if id == 3101003 then
        ...
        local data = {}
        local monster_id = "10200306" --怪物id
    ...
    if id == 10200307 then -- 分裂小怪id
        self.SModScript:SpawnMonsterBit(10200302,false)
        self.split_flag = 2
    end
    if id == 3101012 then
...
function CurrentSceneScript:GetDropBloodPer(id)
    local result = 0
    if self.split_flag == 1 and id == 10200302 then
        result = 1
    end
    return result
end
