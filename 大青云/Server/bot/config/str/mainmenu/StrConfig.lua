...
StrConfig:Add(
{
	...
	['mainmenuMap11'] = "<font color='#ffcc33'>音效</font>",
	...
	-- ["mainmenuRevive02"] = "%s秒后自动回城复活",
	["mainmenuRevive02"] = "%s秒后未操作自动选择安全复活",
	["mainmenuRevive03"] = "金钱不足",
	["mainmenuRevive04"] = "道具不足",

	["mainmenuRevive05"] = "复活点复活",
	...
	["mainmenuHead002"] = "礼金：%s",
	["mainmenuHead003"] = "绑银：%s",
	["mainmenuHead004"] = "<font size='16' color='#ffcc33'>登录器登录</font><br/><font color='#e56a10'>点击安装登录器</font><br/><font color='#dcdcdc'>杀怪经验+%s%%<font color = '#ff0000'>（未达成）</font></font>",
	["mainmenuHead005"] = "<font size='16' color='#ffcc33'>登录器登录</font><br/><font color='#dcdcdc'>杀怪经验永久<font color = '#00ff00'>+%s%%</font></font>",
	...
	['mainmenuRevive11'] = "复活丹价格：%s礼金/个 或%s元宝/个。优先扣礼金",
