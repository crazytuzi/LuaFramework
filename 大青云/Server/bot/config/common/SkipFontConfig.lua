_G.SkipFontConfig =
{
	...
	[1001] =					--这个是敌人掉血的跳字配置
	{
		PfxName ="pfx_beijishuzi.pfx"; --对应的轨迹特效名
	...
	[1002] =					--这个是敌人掉血的暴击配置
	{
		PfxName ="pfx_baoji.pfx";--对应的轨迹特效名
		BindPos = 'bip01 spine1';--启动的绑点，人用这个
		Num={};
		NetNumFunc = function(self) 		
	...
	[1003] =			     	--这个是自己未命中时
	{
        PfxName ="pfx_weimingzhong.pfx";--对应的轨迹特效名
		BindPos = 'bip01 spine1';--启动的绑点，人用这个
		Num={};
		NetNumFunc = function(self) 		
	...
	[1004] =					--这个是格挡了伤害的
	{
		PfxName ="pfx_gedang.pfx";--对应的轨迹特效名
		BindPos = 'bip01 spine1';--启动的绑点，人用这个
		Num={};
		NetNumFunc = function(self) 		
	...
	[1005] =					--这个是闪避了伤害的
	{
		PfxName ="pfx_shanbi.pfx";--对应的轨迹特效名
		BindPos = 'bip01 spine1';--启动的绑点，人用这个
		Num={};
		NetNumFunc = function(self) 		
	...
	[1006] =					--这个是自己掉血的跳字配置
	{
		PfxName ="renwu_beijishuzi.pfx"; --对应的轨迹特效名
	...
	[1007] =					--这个是自己掉血的暴击配置
	{
		PfxName ="renwu_baoji.pfx";--对应的轨迹特效名
		BindPos = 'awc';--启动的绑点，人用这个
		Num={};
		NetNumFunc = function(self) 		
	...
	{
		PfxName ="duoduan_shanghai.pfx"; --对应的轨迹特效名
		BindPos = 'bip01 spine1';--启动的绑点，人用这个
		Num={};
	...
	{
		PfxName ="duoduan_baoji.pfx";--对应的轨迹特效名
		BindPos = 'bip01 spine1';--启动的绑点，人用这个
		Num={};
		NetNumFunc = function(self) 		
			self.Num["crit"] = CResStation:GetImage( "baoji-.png" );
	...
	[1013] =					--回血
	{
		PfxName ="renwu_hpmpshuzi.pfx"; --对应的轨迹特效名
		BindPos = 'awc';--启动的绑点，人用这个
		Num={};
	...
	[1019] =					--神兵技能普通伤害
	{
		...
		Num={};
		NetNumFunc = function(self)
			self.Num["down"] = CResStation:GetImage( "shenbingbeiji-.png" );
			self.Num["0"] =	CResStation:GetImage( 'shenbingbeiji0.png' );
			self.Num["1"] =	CResStation:GetImage( 'shenbingbeiji1.png' );
			self.Num["2"] =	CResStation:GetImage( 'shenbingbeiji2.png' );
			self.Num["3"] =	CResStation:GetImage( 'shenbingbeiji3.png' );
			self.Num["4"] =	CResStation:GetImage( 'shenbingbeiji4.png' );
			self.Num["5"] =	CResStation:GetImage( 'shenbingbeiji5.png' );
			self.Num["6"] =	CResStation:GetImage( 'shenbingbeiji6.png' );
			self.Num["7"] =	CResStation:GetImage( 'shenbingbeiji7.png' );
			self.Num["8"] =	CResStation:GetImage( 'shenbingbeiji8.png' );
			self.Num["9"] =	CResStation:GetImage( 'shenbingbeiji9.png' );
	...
	[1020] =					--神兵技能暴击伤害
	{
		...
		Num={};
		NetNumFunc = function(self) 		
			self.Num["crit"] = CResStation:GetImage( "shenbingbaoji-.png" );
			self.Num["0"] =	CResStation:GetImage( 'shenbingbaoji0.png' );
			self.Num["1"] =	CResStation:GetImage( 'shenbingbaoji1.png' );
			self.Num["2"] =	CResStation:GetImage( 'shenbingbaoji2.png' );
			self.Num["3"] =	CResStation:GetImage( 'shenbingbaoji3.png' );
			self.Num["4"] =	CResStation:GetImage( 'shenbingbaoji4.png' );
			self.Num["5"] =	CResStation:GetImage( 'shenbingbaoji5.png' );
			self.Num["6"] =	CResStation:GetImage( 'shenbingbaoji6.png' );
			self.Num["7"] =	CResStation:GetImage( 'shenbingbaoji7.png' );
			self.Num["8"] =	CResStation:GetImage( 'shenbingbaoji8.png' );
			self.Num["9"] =	CResStation:GetImage( 'shenbingbaoji9.png' );
