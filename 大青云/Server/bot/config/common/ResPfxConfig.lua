...
-------------------------------标配、示例----------------------------
   --[ID] = { ----------标准配置，下面参数，如果没有则直接不填  或者值填nil，减少服务器判断时间，提高效率
	...
	[1] = { 
	    delay=nil,		--特效延迟时间
		bBind = false;  --特效不追尾
		pfxName = "chuansongmen_ditu_12a.pfx",
	...
	[90002] = { 
	    delay=nil,		--特效延迟时间
		bBind = false;  --特效不追尾
		pfxName = "shubiaodiandi_hong.pfx",
		MoveStart=_Vector3.new(0,0,2),--特效起始偏移
		MoveStop =nil,--技能结束偏移
		MoveTime = nil,		--技能偏移时间
		ScalingStart = nil, --放缩
	...
	[10016] = { 
	    delay=nil,		--特效延迟时间
		bBind = false;  --特效不追尾
		pfxName = "guai_xuanzhong_xiaoguai_07.pfx",
	...
	[10018] = {
		bBind = false;  --特效不追尾
	    delay=nil,		--特效延迟时间
		pfxName = "guai_xuanzhong_boss_07.pfx",
		--MoveStart=_Vector3.new(0, 0, 0),--特效起始偏移
		-- MoveStop =nil,--技能结束偏移
		-- MoveTime = nil,		--技能偏移时间
		-- ScalingStart = nil, --放缩
	...
	[10030] = {
		bBind = false;  --特效不追尾
	    delay=nil,		--特效延迟时间
		pfxName = "pfx_xuanzhong_difang.pfx",
		--MoveStart=_Vector3.new(0, 0, 0),--特效起始偏移
		-- MoveStop =nil,--技能结束偏移
		-- MoveTime = nil,		--技能偏移时间
		-- ScalingStart = nil, --放缩
	...
	[10032] = {
		bBind = false;  --特效不追尾
	    delay=nil,		--特效延迟时间
		pfxName = "pfx_xuanzhong_youfang.pfx",
		--MoveStart=_Vector3.new(0, 0, 0),--特效起始偏移
		-- MoveStop =nil,--技能结束偏移
		-- MoveTime = nil,		--技能偏移时间
		-- ScalingStart = nil, --放缩
