...
function cca.splineTo(dt, points, tension)
   return cc.CardinalSplineTo:create(dt, points, tension)
end

function cca.splineBy(dt, points, tension)
   return cc.CardinalSplineBy:create(dt, points, tension)
end
