...
function QUIDialogSkillData:initData()
    local maxValue = 0
...
function QUIDialogSkillData:initListView()
...
function QUIDialogSkillData:_renderItemCallBack(list, index, info )
...
function QUIDialogSkillData:getDescNode()
...
function QUIDialogSkillData:_onTriggerClose()
    app.sound:playSound("common_cancel")
    self:playEffectOut()
end

return QUIDialogSkillData