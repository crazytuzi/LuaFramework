...
local QUIDialogCrystalHelp = class("QUIDialogCrystalHelp", QUIDialogBaseHelp)
local QListView = import("...views.QListView")
local QUIWidgetHelpDescribe = import("..widgets.QUIWidgetHelpDescribe")
local QStaticDatabase = import("...controllers.QStaticDatabase")
--初始化
function QUIDialogCrystalHelp:ctor(options)
	QUIDialogCrystalHelp.super.ctor(self, options)
end


function QUIDialogCrystalHelp:initData(  )
	-- body
	local data = {}
...
function QUIDialogCrystalHelp:initListView( ... )
	-- body
