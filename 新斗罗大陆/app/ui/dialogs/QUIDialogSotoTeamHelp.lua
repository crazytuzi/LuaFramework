-- @Author: zhouxiaoshu
-- @Date:   2019-09-09 11:37:25
-- @Last Modified by:   liaoxianbo
-- @Last Modified time: 2019-12-09 15:51:22
local QUIDialogBaseHelp = import(".QUIDialogBaseHelp")
local QUIDialogSotoTeamHelp = class("QUIDialogSotoTeamHelp", QUIDialogBaseHelp)
...
--初始化
function QUIDialogSotoTeamHelp:ctor(options)
	QUIDialogSotoTeamHelp.super.ctor(self,options)
    self:setShowRule(true)
end
 
function QUIDialogSotoTeamHelp:initData()
	-- body
 ...
 --    end
	...
	table.insert(data, {oType = "describe", info = {helpType = "soto_team_8"}})	
...
function QUIDialogSotoTeamHelp:initListView( )
	-- body
...
function QUIDialogSotoTeamHelp:getRankNode()
...
function QUIDialogSotoTeamHelp:showRule()
    app.sound:playSound("common_cancel")
    app:getNavigationManager():pushViewController(app.middleLayer, {uiType = QUIViewController.TYPE_DIALOG, uiClass = "QUIDialogSotoTeamTutorialDialog", options = {}}, {isPopCurrentDialog = false})
end

return QUIDialogSotoTeamHelp
