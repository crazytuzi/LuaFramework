...
local QUIDialogSilvesArenaShare = class("QUIDialogSilvesArenaShare", QUIDialog)

local QNavigationController = import("...controllers.QNavigationController")
local QRichText = import("...utils.QRichText")

function QUIDialogSilvesArenaShare:ctor(options) 
	...
	local callBacks = {
	    ...
	    {ccbCallbackName = "onTriggerCancelRed", callback = handler(self, self._onTriggerCancelRed)},
	    {ccbCallbackName = "onTriggerConfirm", callback = handler(self, self._onTriggerConfirm)},
	    {ccbCallbackName = "onTriggerConfirmRed", callback = handler(self, self._onTriggerConfirmRed)},
	}
	QUIDialogSilvesArenaShare.super.ctor(self, ccbFile, callBacks, options)
...
function QUIDialogSilvesArenaShare:close()
...
function QUIDialogSilvesArenaShare:viewAnimationOutHandler()
	local options = self:getOptions()
...
return QUIDialogSilvesArenaShare