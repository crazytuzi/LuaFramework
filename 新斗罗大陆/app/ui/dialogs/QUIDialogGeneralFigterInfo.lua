...
local QUIDialogGeneralFigterInfo = class("QUIDialogGeneralFigterInfo", QUIDialog)
...
function QUIDialogGeneralFigterInfo:ctor(options)
 	local ccbFile = "ccb/Dialog_ArenaPrompt.ccbi"
    local callBacks = {}
    QUIDialogGeneralFigterInfo.super.ctor(self, ccbFile, callBacks, options)
...
function QUIDialogGeneralFigterInfo:_backClickHandler()
    self:_onTriggerClose()
end

-- 关闭对话框
function QUIDialogGeneralFigterInfo:_onTriggerClose()
    self:playEffectOut()
end

function QUIDialogGeneralFigterInfo:viewAnimationOutHandler()
    app:getNavigationManager():popViewController(app.middleLayer, QNavigationController.POP_TOP_CONTROLLER)
end

return QUIDialogGeneralFigterInfo