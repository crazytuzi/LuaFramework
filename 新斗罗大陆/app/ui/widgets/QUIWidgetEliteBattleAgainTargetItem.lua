...
local QUIWidgetEliteBattleAgainTargetItem = class("QUIWidgetEliteBattleAgainTargetItem", QUIWidget)
local QStaticDatabase = import("...controllers.QStaticDatabase")

function QUIWidgetEliteBattleAgainTargetItem:ctor(options)
	local ccbFile = "ccb/Widget_EliteBattleAgain_NoticeTips.ccbi"
	local callbacks = {}
	QUIWidgetEliteBattleAgainTargetItem.super.ctor(self, ccbFile, callbacks, options)
...
function QUIWidgetEliteBattleAgainTargetItem:setInfo(id, packNum, targetNum)
	self._ccbOwner.root:setVisible(false)
	self._ccbOwner.complete:setVisible(false)
	self._ccbOwner.incomplete:setVisible(false)
...
function QUIWidgetEliteBattleAgainTargetItem:nodeEffect(node)
	if node ~= nil then
...
return QUIWidgetEliteBattleAgainTargetItem
