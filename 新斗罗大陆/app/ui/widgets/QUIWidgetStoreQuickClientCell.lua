-- @Author: xurui
-- @Date:   2017-02-24 11:21:21
-- @Last Modified by:   zhouxiaoshu
-- @Last Modified time: 2019-09-07 15:20:30
local QUIWidget = import("..widgets.QUIWidget")
local QUIWidgetStoreQuickClientCell = class("QUIWidgetStoreQuickClientCell", QUIWidget)
...
function QUIWidgetStoreQuickClientCell:ctor(options)
	local ccbFile = "ccb/Widget_EliteBattleAgain_yijiangoumai.ccbi"
	local callBack = {
		-- {ccbCallbackName = "", callback = handler(self, self._)},
	}
	QUIWidgetStoreQuickClientCell.super.ctor(self, ccbFile, callBack, options)
...
function QUIWidgetStoreQuickClientCell:onEnter()
end

function QUIWidgetStoreQuickClientCell:onExit()
end

function QUIWidgetStoreQuickClientCell:resetAll()
...
function QUIWidgetStoreQuickClientCell:setStopState(state)
	self._state = state 
...
function QUIWidgetStoreQuickClientCell:setInfo(shopId,items, index, currencyInfo, refreshMoney, refreshItemNum,buyToken, buyCurrency, isAll, callback)
	...
	elseif isAll then
		...
		if shopId == SHOP_ID.soulShop and refreshItemNum > 0 then
			...
			self._ccbOwner.tf_have_refresh_num:setString(0)
...
function QUIWidgetStoreQuickClientCell:setItemBox()
	if self.items == nil or next(self.items) == nil then
...
function QUIWidgetStoreQuickClientCell:setCurrencyIcon(node, iconPath)
...
function QUIWidgetStoreQuickClientCell:setItemPrompt()
...
function QUIWidgetStoreQuickClientCell:getContentSize()
...
return QUIWidgetStoreQuickClientCell