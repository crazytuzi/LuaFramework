-- @Author: liaoxianbo
-- @Date:   2020-04-09 11:37:44
-- @Last Modified by:   DELL
-- @Last Modified time: 2020-04-20 18:40:45
local QBaseRank = import(".QBaseRank")
local QSoulTowerCurServerRank = class("QSoulTowerCurServerRank", QBaseRank)
...
function QSoulTowerCurServerRank:ctor(options)
	QSoulTowerCurServerRank.super.ctor(self, options)
end

function QSoulTowerCurServerRank:needsUpdate( ... )
	return true
end

function QSoulTowerCurServerRank:update(success, fail)
...
function QSoulTowerCurServerRank:getRankItem()
...
function QSoulTowerCurServerRank:renderItem(item, index)
...
function QSoulTowerCurServerRank:getSelfItem()
...
return QSoulTowerCurServerRank
