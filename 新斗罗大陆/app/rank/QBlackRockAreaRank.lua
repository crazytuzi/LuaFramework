-- @Author: xurui
-- @Date:   2016-11-24 10:37:02
-- @Last Modified by:   zhouxiaoshu
-- @Last Modified time: 2019-10-16 18:44:11
local QBaseRank = import(".QBaseRank")
local QBlackRockAreaRank = class("QBlackRockAreaRank", QBaseRank)
...
function QBlackRockAreaRank:ctor(options)
	QBlackRockAreaRank.super.ctor(self, options)
end

function QBlackRockAreaRank:needsUpdate( ... )
	return true
end

function QBlackRockAreaRank:update(success, fail)
	app:getClient():top50RankRequest("BLACK_ROCK_ENV_REALTIME_TOP_50", remote.user.userId, function (data)
...
function QBlackRockAreaRank:getRankItem()
...
function QBlackRockAreaRank:renderItem(item, index)
...
function QBlackRockAreaRank:getSelfItem()
