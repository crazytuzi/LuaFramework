                    ...
                    ARGS = {
                        {
                            ...
                            OPTIONS = {buff_id = {"hl_qingyufenghuang_dazhao_yishangdebuff_6_jiance"}, multiple_target_with_skill=true},
                        },
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = {"hl_qingyufenghuang_dazhao_yishangdebuff_6_remove1"}, multiple_target_with_skill=true},
                        },
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = {"hl_qingyufenghuang_dazhao_yishangdebuff_6_remove2"}, multiple_target_with_skill=true},
                        },
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = {"hl_qingyufenghuang_dazhao_yishangdebuff_6_plus"}, multiple_target_with_skill=true},
                        },
                    },
                },
            },
