                ...
                -- },
                {
                    ...
                    ARGS = 
                    {
                        ...
                        -- }, 
                        {
                            ...
                            OPTIONS = {actor_id = 3714 , life_span = 21,number = 1, appear_skill = 50897 , enablehp = true,hp_percent = 0.02, relative_pos = {x = 0, y = -50}, no_fog = false,is_attacked_ghost = true},
                        },
                        {
