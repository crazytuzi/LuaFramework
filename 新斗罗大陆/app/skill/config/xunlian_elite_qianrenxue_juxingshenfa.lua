            ...
            ARGS = 
            {
                ...
                -----地面花火9点-3点--中
                        {
                            ...
                            OPTIONS = 
                            { 
                                trapId = "xunlian_elite_qianrenxue_shengyan",
                                args = 
                                {
                        ...
                        },
                        {
                            ...
                            OPTIONS = 
                            { 
                                trapId = "xunlian_elite_qianrenxue_xuangao2",
                                args = 
                                {
                                    {delay_time = 30 / 24 , pos = { x = 40, y = 290}} ,
                                    {delay_time = 30 / 24 , pos = { x = 1240, y = 290}} ,
                        ...
                        },
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                },
                                {
                                    ...
                                    OPTIONS = 
                                    { 
                                        trapId = "xunlian_elite_qianrenxue_zhongjie1",
                                        args = 
                                        {
                ...
                -----地面花火9点-3点--中
                        ...
                        },      
                        {
                            ...
                            OPTIONS = 
                            { 
                                trapId = "xunlian_elite_qianrenxue_zhongjie2",
                                args = 
                                {
                ...
                ------地面火花12至6左1
                        ...
                        },
                        {
                            ...
                            OPTIONS = 
                            { 
                                trapId = "xunlian_elite_qianrenxue_xuangao",
                                args = 
                                {
                                    {delay_time = 24 / 24 , pos = { x = 40, y = 477.4}} ,
                                    {delay_time = 24 / 24 , pos = { x = 40, y = 208}} ,
