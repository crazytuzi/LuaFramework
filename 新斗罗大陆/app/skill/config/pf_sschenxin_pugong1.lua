...
local ssmahongjun_pugong1 = 
{
    ...
    ARGS = {
        ...
        },
        {
            ...
            OPTIONS = {
                failed_select = 2,
                {expression = "self:has_buff:pf_sschenxin_shenji_qianghua_buff1", select = 1},
                {expression = "self:has_buff:pf_sschenxin_shenji_qianghua_buff2", select = 1},
                {expression = "self:has_buff:pf_sschenxin_shenji_qianghua_buff3", select = 1},
                {expression = "self:has_buff:pf_sschenxin_shenji_qianghua_buff4", select = 1},
                {expression = "self:has_buff:pf_sschenxin_shenji_qianghua_buff5", select = 1},
                {expression = "self:has_buff:pf_sschenxin_shenji_qianghua_buff6", select = 1},
            }
        },
        {
            CLASS = "composite.QSBSelector",
                    ...
                    ARGS = 
                    {
                        ...
                        },
                        {
                            ...
                            ARGS = {
                                ...
                                {
                                    CLASS = "action.QSBPlayEffect",
                                    OPTIONS = {effect_id = "pf_sschenxin01_attack01_1", is_hit_effect = false},
                                },
                            },
                        },
                        {
                            ...
                            ARGS = {
                                ...
                                {
                                    CLASS = "action.QSBBullet",
                                    OPTIONS = {start_pos = {x = 125,y = 250}, effect_id = "pf_sschenxin01_attack01_2", speed = 1500, hit_effect_id = "pf_sschenxin01_attack01_3_1"},
                                },
                                {
                                    CLASS = "action.QSBArgsConditionSelector",
                                    OPTIONS = {
