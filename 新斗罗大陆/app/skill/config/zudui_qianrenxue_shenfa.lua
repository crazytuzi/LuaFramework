				...
				},
				{
					...
					ARGS = 
					{
		                ...
		                },
		                {
				            ...
				            OPTIONS = {trapId = "jinshu_qianrenxue_shenfayujing",count = 1, pass_key = {"pos"}},
				        },
				        {
		                    CLASS = "action.QSBDelayTime",
						...
						{
				            CLASS = "action.QSBMultipleTrap",
				            OPTIONS = {trapId = "jinshu_qianrenxue_shenfa",count = 1, pass_key = {"pos"}},
				        },				       
			        },
		        },
		        {
		            ...
		            ARGS = 
		            {
		                ...
		                },                   
        		        {
		                    ...
		                    OPTIONS = {skill_id = 51140, wait_finish = true}, --放置另一个trap
		                },
		            },
		        },
		        {
