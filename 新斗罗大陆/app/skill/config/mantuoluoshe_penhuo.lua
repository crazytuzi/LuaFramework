...
local mantuoluoshe_penhuo = {
    CLASS = "composite.QSBSequence",
    OPTIONS = {forward_mode = true},
    ARGS = {
	--	{
    --                CLASS = "action.QSBPlayLoopEffect",
    --                OPTIONS = {effect_id = "mantuoluoshe_penhuo_hongkuang",is_hit_effect = false},
    --    },
        {
		...
		{
          CLASS = "action.QSBPlayLoopEffect",
           OPTIONS = {effect_id = "matuoluoshe_penhuo",is_hit_effect = false},
       },
        {
