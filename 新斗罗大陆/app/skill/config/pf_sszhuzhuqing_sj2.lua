    ...
    {
        {
            ...
            ARGS = 
            {
                ...
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {is_hit_effect = false, effect_id = "pf_sszzq_sj_cf2"},
                },
                {
                ...
                },
                {
                    ...
                    OPTIONS = {is_target = false, buff_id = "pf_sszhuzhuqing_sj_cf2"}
                },
                {
                    CLASS = "action.QSBApplyBuff",
                ...
                },
                {
                    ...
                    OPTIONS = 
                    {
                        ...
                        tick_inrange_debuff_id = "pf_sszhuzhuqing_sj1_youmming" ,
                        out_range_debuff_id = "pf_sszhuzhuqing_sj2_stun",                  
                    },
                }, 
                {
