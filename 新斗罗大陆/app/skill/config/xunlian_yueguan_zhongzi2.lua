                    ...
                    ARGS = {
                        {
                            ...
                            OPTIONS = {interval_time = 0, count = 1, distance = 0, trapId = "xunlian_yueguan_zhongzi_huanghua1"} ,
                        },
                        {
                            CLASS = "action.QSBMultipleTrap", --连续放置多个陷阱
                            OPTIONS = {interval_time = 0, count = 1, distance = 0, trapId = "xunlian_yueguan_zhongzi_zihua2"} ,
                        },
                        {
                            CLASS = "action.QSBMultipleTrap", --连续放置多个陷阱
                            OPTIONS = {interval_time = 0, count = 1, distance = 0, trapId = "xunlian_yueguan_zhongzi_zihua3"} ,
                        },
                        {
                            CLASS = "action.QSBMultipleTrap", --连续放置多个陷阱
                            OPTIONS = {interval_time = 0, count = 1, distance = 0, trapId = "xunlian_yueguan_zhongzi_huanghua4"} ,
                        },
                        {
                            CLASS = "action.QSBMultipleTrap", --连续放置多个陷阱
                            OPTIONS = {interval_time = 0, count = 1, distance = 0, trapId = "xunlian_yueguan_zhongzi_huanghua5"} ,
                        },
                    },
                },
            },
