...
local npc_niugao_chidunchongzhuang = {
				...
				},
				{
					...
					ARGS = 
					{
						...
						},
						{
							...
							OPTIONS = {speed = 800 ,move_time = 1.5 ,interval_time = 0.3 ,is_hit_target = true ,bound_height = 50},
						},
						-- {
							-- CLASS = "composite.QSBSequence",
							-- ARGS = 
...
return npc_niugao_chidunchongzhuang
