	    ...
	    ARGS = {
         ...
         -- 	},
          ...
          --   },
            {
                CLASS = "action.QSBApplyBuff",
                OPTIONS = {buff_id = "anqi_baihubi_hudun4",is_target = false},
            },
            {
                CLASS = "action.QSBApplyBuff",
                OPTIONS = {buff_id = "anqi_baihubi_xixue_1_4",is_target = false},
            },
            {
                CLASS = "action.QSBApplyBuff",
                OPTIONS = {buff_id = "anqi_baihubi_xixue_2_4",is_target = false},
            },
         {
