                    ...
                    {
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = true, buff_id = "ssptangchen_fumo3_debuff"},
                                },
                            },
                        },
                        {
                    ...
                    {
                        {
                            ...
                            OPTIONS = {damage_scale = 2.25,check_target_by_skill = true},
                        },
                        {
                            CLASS = "action.QSBHitTarget",
                        ...
                        {
                            CLASS = "action.QSBHitTarget",
                            OPTIONS = {damage_scale = 2.95,check_target_by_skill = true},
                        },
                        {
                            CLASS = "action.QSBHitTarget",
                            OPTIONS = {damage_scale = 3.05,check_target_by_skill = true},
                        },
                    },
                },
            },
