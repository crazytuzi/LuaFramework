...
local pf_ssniutian02_beidong1 = {
    ...
    ARGS = {
        ...
        },
        {
            ...
            OPTIONS = {buff_id = {"pf_sstianqingniumang02_chongfeng", "mianyi_suoyou_zhuangtai"}},
        },
        {
        ...
        -- },
        {
            ...
            OPTIONS = {buff_id = "pf_sstianqingniumang02_chongfeng"},
        },
        {
            CLASS = "action.QSBRemoveBuff",     --去除加速
...
return pf_ssniutian02_beidong1