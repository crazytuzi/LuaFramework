                            ...
                            ARGS = {
                                {
                                    ...
                                    ARGS = {  
                                        ...
                                        },
                                        {
                                            ...
                                            OPTIONS = {buff_id = {"gudouluo_fumo3_p", "gudouluo_fumo3_m", "gudouluo_dazhao_cuihua;y", "gudouluo_dazhao_hetiji"}, is_target = true, no_cancel = true},
                                        },
                                        {
                                            CLASS = "action.QSBApplyBuff",
