            ...
            ARGS = {
                {
                    ...
                    OPTIONS = {effect_id = "sschenxin_attack11_3_13", is_hit_effect = true},
                },
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {effect_id = "sschenxin_attack11_3_12", is_hit_effect = true},
                },
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {effect_id = "sschenxin_attack11_3_11", is_hit_effect = true},
                },
            },
        },
        {
