    ...
    {
        {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    OPTIONS = {change_cofficient_name = "beattack_coefficient",change_cofficient_value = 0.75},
                },
            },
        },
        {
                    ...
                    {
                        {
                            ...
                            OPTIONS = 
                            {
                                ...
                                damage_percent = "6.5;26", --攻击力最高的魂师施放伤害等同于当前攻击力的百分比（PVP/PVE）
                                convert_treat_percent = 0.5, --根据造成伤害恢复的生命值百分比
                                change_rage_value = -250, --降低的敌方全体怒气
                                rage_increase_coefficient_final_value = -0.5,--降低怒气最高的魂师的怒气获取
                                max_rage_enemy_buff_id = "sq_tianshishenjian_huifu"--恢复怒气降低获取buff
                            },
                        },
                        {
                            CLASS = "action.QSBTianShiShengJian",
                            OPTIONS = 
                            {
                                ...
                                right_effect2_pos = {x=900,y=340},
                                right_effect3_pos = {x=640,y=340},
                                damage_percent = "6.5;78", --攻击力最高的魂师施放伤害等同于当前攻击力的百分比（PVP/PVE）
                                convert_treat_percent = 0.5, --根据造成伤害恢复的生命值百分比
                                change_rage_value = -250, --降低的敌方全体怒气
                                rage_increase_coefficient_final_value = -0.5,--降低怒气最高的魂师的怒气获取
                                max_rage_enemy_buff_id = "sq_tianshishenjian_huifu"--恢复怒气降低获取buff
        ...
        },
        {
            ...
            OPTIONS = { buff_id = "sq_tianshishenjian_chufa5_buff"},
        },
    },
}
