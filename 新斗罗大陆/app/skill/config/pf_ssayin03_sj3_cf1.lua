local ssqianshitangsan_pugong1 = 
{
    ...
    {               
        ...
        },
        {
            ...
            OPTIONS = {buff_id = "pf_ssayin03_sj3_jt1",is_target = false},
        }, 
        {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    OPTIONS = {buff_id = "pf_ssayin03_sj3_buff1",pass_key = {"selectTarget"}},
                },
                {
                    CLASS = "action.QSBApplyBuff",
                ...
                {
                    CLASS = "action.QSBApplyBuff",
                    OPTIONS = {buff_id = "pf_ssayin03_sj3_jt3",pass_key = {"selectTarget"}},
                },
                {
                    CLASS = "action.QSBApplyBuff",
                    OPTIONS = {buff_id = "pf_ssayin03_sj_buff",pass_key = {"selectTarget"}},
