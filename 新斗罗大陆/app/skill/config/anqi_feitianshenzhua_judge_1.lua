...
local liuerlong_zhenji_trigger = 
{
	...
	ARGS =
	{
        ...
        },
		{
            ...
            OPTIONS = {buff_id = "anqi_feitianshenzhua_diecen_buff1",attacker_target = true},
        },
        {
            CLASS = "action.QSBApplyBuff",
            OPTIONS = {buff_id = "anqi_feitianshenzhua_jishu_buff1"},
        },
        {
			CLASS = "action.QSBAttackByBuffNum",
			OPTIONS = { buff_id = "anqi_feitianshenzhua_diecen_buff1",num_pre_stack_count = 4, trigger_skill_id = 40342,target_type = "actor_target" }
		},
        {
