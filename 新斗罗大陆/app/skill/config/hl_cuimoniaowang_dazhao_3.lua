        ...
        },
		{
            ...
            ARGS = {
                ...
                },
				{
					...
					OPTIONS = {buff_id = "hl_cuimoniaowang_buff_3"},--
                },
				{
					CLASS = "composite.QSBParallel",
					ARGS = {
				...
				},
				{
					...
					OPTIONS = {buff_id = "hl_cuimoniaowang_dazhao_buff1_3"},--
				},
				{
					CLASS = "action.QSBRemoveBuff",
					OPTIONS = {buff_id = "hl_cuimoniaowang_dazhao_buff2_3"},--
				},
        ...
        },
		{
            ...
            ARGS = {
                ...
                },
				{
					...
					OPTIONS = {
						failed_select = 2,
						{expression = "self:has_buff:hl_cuimoniaowang_dazhao_buff1_3=1", select = 1},
					}
				},
				{
					...
					ARGS = {
						{
							...
							ARGS = {
								...
								{
									CLASS = "action.QSBShowStorage",
									OPTIONS = {enter = true, limit = 40,offset={x=-18,y=10},buff_id="hl_cuimoniaowang_buff_3",revertable = true},
								},
							},
						},
						{
