                                            ...
                                            { 
                                                {
                                                    ...
                                                    ARGS = 
                                                    {
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            OPTIONS = {trapId = "zsdaimubai_liuxing2a_1",count = 1},
                                                        },
                                                        {
                                                            CLASS = "action.QSBDelayTime",
                                                        ...
                                                        {
                                                            CLASS = "action.QSBMultipleTrap",
                                                            OPTIONS = {trapId = "zsdaimubai_liuxing2a_2",count = 1},
                                                        },
                                                        {
                                                            CLASS = "action.QSBDelayTime",
                                                        ...
                                                        {
                                                            CLASS = "action.QSBMultipleTrap",
                                                            OPTIONS = {trapId = "zsdaimubai_liuxing2a_3",count = 1},
                                                        },
                                                    },
                                                },
                                                {
                                            ...
                                            { 
                                                {
                                                    ...
                                                    ARGS = 
                                                    {
                                                        ...
                                                        {
                                                            CLASS = "action.QSBMultipleTrap",
                                                            OPTIONS = {trapId = "zsdaimubai_liuxing2b_1",count = 1},
                                                        },
                                                        {
                                                            CLASS = "action.QSBDelayTime",
                                                            OPTIONS = {delay_time = 3 / 30 ,pass_key = {"pos"}},
                                                        ...
                                                        {
                                                            CLASS = "action.QSBMultipleTrap",
                                                            OPTIONS = {trapId = "zsdaimubai_liuxing2b_2",count = 1},
                                                        },
                                                        {
                                                            CLASS = "action.QSBDelayTime",
                                                            OPTIONS = {delay_time = 6 / 30 ,pass_key = {"pos"}},
                                                        ...
                                                        {
                                                            CLASS = "action.QSBMultipleTrap",
                                                            OPTIONS = {trapId = "zsdaimubai_liuxing2b_3",count = 1},
                                                        },
                                                    },
                                                },
                                                {
