...
local tianshishengkai_shengguang = 
{
    ...
    ARGS = 
    {
        ...
        },
        {
            ...
            OPTIONS = {buff_id = "sq_tianshishengkai_pve_buff5",teammate_and_self = true},
        },
        {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    OPTIONS = {rage_value = -200,all_enemy = true},
                },
            },
        },
        --降低受击回怒系数
        {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    OPTIONS = {change_cofficient_name = "beattack_coefficient",change_cofficient_value = 0.8},
                },
            },
        },
        {
                    ...
                    {   
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = "sq_tianshishengkai_shengguang2_5_buff",teammate_and_self = true},
                                },
                            },                              
                        },
                        {
