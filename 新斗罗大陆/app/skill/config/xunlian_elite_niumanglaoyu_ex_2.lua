local xunlian_elite_niumanglaoyu_ex_2 = 
{
                ...
                },
                {
                    ...
                    ARGS = 
                    {
                        ...
                        },
                        {
                            ...
                            OPTIONS = {count = 1, trapId = "xunlian_shuilao_hongquan_2",pass_key = {"pos"}} ,
                        },
                        {
                            CLASS = "action.QSBMultipleTrap",
                            OPTIONS = {trapId = "niumang_ruchang_shuibo4",count = 1, pass_key = {"pos"}},
                        }, 
                        {
                            CLASS = "action.QSBDelayTime",
                ...
                },
                {
                    ...
                    ARGS = 
                    {
                        ...
                        },
                        {
                            ...
                            OPTIONS = {is_attackee = true,status = "laoyujt2"},
                        },
                        {
                            ...
                            {
                                {
                                    ...
                                    ARGS = 
                                    {
                                        {
                                            CLASS = "action.QSBApplyBuff",
                                            OPTIONS = {is_target = true, buff_id = "xunlina_shuipao_dingshendebuff2"},
                                        }, 
                                        {
                                            CLASS = "action.QSBSummonGhosts",
                                            OPTIONS = {actor_id = 3985 , life_span = 500,number = 1, relative_pos = {x = 0, y = -30}, appear_skill = 50897 ,enablehp = true,hp_percent = 0.04,no_fog = false,is_attacked_ghost = true},
                                        },
                                        {
...
return xunlian_elite_niumanglaoyu_ex_2