                    ...
                    ARGS = {
                        {
                            ...
                            ARGS = {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = {"pf_sschenxin03_zhenji_debuff_2","pf_sschenxin03_zhenji_debuff_3","sschenxin_select_enemy_debuff"}},
                                },
                                ---======
                                -- {
                        ...
                        },
                        {
                            ...
                            ARGS = {
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = true, buff_id = {"pf_sschenxin03_zhenji_debuff_2","pf_sschenxin03_zhenji_debuff_3","sschenxin_select_enemy_debuff"}},
                                },
                            },
                        },
                    },
