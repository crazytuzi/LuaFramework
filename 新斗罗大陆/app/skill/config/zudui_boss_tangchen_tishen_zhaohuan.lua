...
local zudui_boss_tangchen_tishen_zhaohuan = {
    ...
    ARGS = {
		...
		},
		{
			...
			OPTIONS = {buff_id = "boss_tangchen_tishen_zhaohuan_debuff",trigger_skill_id = 50825,target_type = "self"},
		},
		{
...
return zudui_boss_tangchen_tishen_zhaohuan