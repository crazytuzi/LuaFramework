            ...
            ARGS = {
                {
                    ...
                    OPTIONS = {buff_id = "pf1_sspqianrenxue_bd2_teammate_buff",remove_all_same_buff_id = true, is_target = false},
                },
                {
                    CLASS = "action.QSBRemoveBuff",
                    OPTIONS = {buff_id = "pf1_sspqianrenxue_bd2_teammate_buff1",remove_all_same_buff_id = true, is_target = false},
                },
                {
                    CLASS = "action.QSBRemoveBuff",
                    OPTIONS = {buff_id = "pf1_sspqianrenxue_bd2_teammate_buff2",remove_all_same_buff_id = true, is_target = false},
                },
                {
                    CLASS = "action.QSBRemoveBuff",
                    OPTIONS = {buff_id = "pf1_sspqianrenxue_bd2_teammate_buff3",remove_all_same_buff_id = true, is_target = false},
                },
            }, 
        },       
        {
