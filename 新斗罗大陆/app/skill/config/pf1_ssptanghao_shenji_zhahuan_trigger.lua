...
local ZHAHUAN = 
{
    ...
    ARGS = {
        ...
        },
        {
            ...
            OPTIONS = {buff_id = {"ssptanghao_shenji_wudi_buff","pf1_ssptanghao_shenji_zhahuan_debuff"}},
        },
        {
            ...
            {
                {
                    ...
                    OPTIONS = {effect_id = "pf_ssptanghao01_shenji_3", is_hit_effect = false},
                },
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {effect_id = "pf_ssptanghao01_shenji_3_1", is_hit_effect = false},
                },
            },
        },
        {
        ...
        },
        {
            ...
            OPTIONS = {skill_id = 2439132, skill_level =1},
        },
    },
}
