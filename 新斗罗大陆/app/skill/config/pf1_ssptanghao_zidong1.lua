                                ...
                                ARGS = {             
                                    {
                                        ...
                                        ARGS = 
                                        {
                                            ...
                                            {CLASS = "action.QSBApplyBuff",OPTIONS = {buff_id = {"pf01_ssptanghao_zhenji_debuff_1","pf01_ssptanghao_zhenji_slow_debuff"}, is_target = true},}, 
                                        },
                                    },
                                    {
                                        CLASS = "composite.QSBParallel",
                                        ...
                                        {
                                            HIT_ZIDONG1(0.7,0.5),
                                            {CLASS = "action.QSBApplyBuff",OPTIONS = {buff_id = {"pf01_ssptanghao_zhenji_debuff_2","pf01_ssptanghao_zhenji_slow_debuff"}, is_target = true},}, 
                                        },
                                    },
                                    {
                                        CLASS = "composite.QSBParallel",
                                        ...
                                        {
                                            HIT_ZIDONG1(1,0.7),
                                            {CLASS = "action.QSBApplyBuff",OPTIONS = {buff_id = {"pf01_ssptanghao_zhenji_debuff_3","pf01_ssptanghao_zhenji_slow_debuff"}, is_target = true},}, 
                                        },
                                    },
                                },
                            }, 
                            {
                                CLASS = "action.QSBApplyBuff",OPTIONS = {buff_id = "pf01_ssptanghao_zhenji_count", is_target = false},
                            }, 
                        },
                    },
                    HIT_ZIDONG1(0),
                ...
                ARGS = {    
                    {
                        ...
                        OPTIONS = {skill_id = 190384, wait_finish = false},
                    },
                },
            },
            --目标位面失衡:
    ...
    ARGS = 
    {
                    ...
                    {
                        {
                            ...
                            OPTIONS = {effect_id = "pf_ssptanghao01_attack13_1", is_hit_effect = false},
                        },
                        {
                            CLASS = "action.QSBPlayEffect",
                            OPTIONS = {effect_id = "pf_ssptanghao01_attack13_1_1", is_hit_effect = false},
                        },
                    },
                },
            },
        ...
        HIT_WITH_ZHENJI_SHENJI_ZIDONG1(38),
        {
            ...
            ARGS = {
                ...
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {effect_id = "pf_ssptanghao01_attack01_3", is_hit_effect = true},
                },
            },
        },
    },
