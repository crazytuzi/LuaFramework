                ...
                },
                {
                    ...
                    ARGS = 
                    {
                        ...
                        },
                        {
                            ...
                            OPTIONS = {sound_id ="pf_sstangsan01_skill"},
                        },
                    },
                },
                {
                ...
                },
                {
                    ...
                    ARGS = 
                    {
                        ...
                        },
                        {
                            ...
                            OPTIONS = {effect_id = "pf_ssqianshitangsan_attack11_1_1", is_hit_effect = false},
                        },
                    },
                },
                {
                    ...
                    ARGS = 
                    {
                        ...
                        {
                            CLASS = "action.QSBPlayEffect",
                            OPTIONS = {effect_id = "pf_ssqianshitangsan_attack11_1_2", is_hit_effect = false},
                        },
                    },
                },
                {
                    ...
                    ARGS = 
                    {
                        ...
                        },
                        {
                            ...
                            ARGS = 
                            {
                                {
                                    CLASS = "action.QSBPlayEffect",
                                    OPTIONS = {is_hit_effect = true, effect_id = "pf_ssqianshitangsan_attack11_1_3"},
                                }, 
                                {
                                    CLASS = "action.QSBPlayEffect",
                                    OPTIONS = {is_hit_effect = true, effect_id = "pf_ssqianshitangsan_attack11_1_4"},
                                },
                            },
                        },
                    },
