...
local ZHAHUAN = 
{
    ...
    ARGS = {
        ...
        },
        {
            ...
            OPTIONS = {buff_id = {"ssptanghao_shenji_wudi_buff","pf2_ssptanghao_shenji_zhahuan_debuff"}},
        },
        {
            ...
            {
                {
                    ...
                    OPTIONS = {effect_id = "pf_ssptanghao02_shenji_3", is_hit_effect = false},
                },
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {effect_id = "pf_ssptanghao02_shenji_3_1", is_hit_effect = false},
                },
            },
        },
        {
        ...
        },
        {
            ...
            OPTIONS = {skill_id = 2539132, skill_level =1},
        },
    },
}
    ...
    ARGS = {
        {
            ...
            OPTIONS = {
                ...
                {expression = "self:has_buff:ssptanghao_shenji_zhahuan_buff1", select = 1},
            }
        },
        {
