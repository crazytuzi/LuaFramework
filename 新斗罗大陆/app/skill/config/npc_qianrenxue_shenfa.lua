				...
				},
				{
					...
					ARGS = 
					{
		                ...
		                },
		                {
				            ...
				            OPTIONS = {trapId = "qianrenxue_shenfayujing",count = 1, pass_key = {"pos"}},
				        },
				        {
		                    CLASS = "action.QSBDelayTime",
						...
						{
				            CLASS = "action.QSBMultipleTrap",
				            OPTIONS = {trapId = "qianrenxue_shenfa",count = 1, pass_key = {"pos"}},
				        },				       
			        },
		        },
		        {
		            ...
		            ARGS = 
		            {
		                ...
		                },                   
        		        {
		                    ...
		                    OPTIONS = {skill_id = 50887, wait_finish = true}, --放置另一个trap
		                },
		            },
		        },
		        {
