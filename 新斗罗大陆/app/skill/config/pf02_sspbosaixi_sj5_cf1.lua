                    ...
                    {
                        {
                            ...
                            ARGS = 
                            {
                                {
                                    CLASS = "action.QSBRemoveBuff",
                                    OPTIONS = {is_target = false, buff_id = "pf02_sspbosaixi_sj5_jt1",no_cancel = true},
                                },
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = false, buff_id = "pf02_sspbosaixi_sj5_jt2", no_cancel = true},
                                },
                            },
                        },
                        {
        ...
        },
         {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    apply_buffIds = {"sspbosaixi_sj5_debuff1","sspbosaixi_sj_jiance","pf02_sspbosaixi_sj5_debuff2","pf02_sspbosaixi_sj5_debuff3"}},
                },
            },
        },         
        {
