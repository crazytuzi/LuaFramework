                    ...
                    ARGS = 
                    {
                        ...
                        },
                        {
                            ...
                            ARGS = 
                            {
                                            ...
                                            {
                                               {
                                                    ...
                                                    OPTIONS = {is_hit_effect = false, effect_id = "pf1_sspqianrenxue_attack21_1"},
                                                }, 
                                                {
                                                    CLASS = "action.QSBPlayEffect",
                                                    OPTIONS = {is_hit_effect = false, effect_id = "pf1_sspqianrenxue_attack21_2"},
                                                },                                                
                                ...
                                --         {
                                --             CLASS = "action.QSBPlayEffect",
                                --             OPTIONS = {is_hit_effect = false, effect_id = "sspqianrenxue_attack21_2"},
                                --         }, 
                                --     },
                                -- },   
                            },
