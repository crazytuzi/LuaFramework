                    ...
                    ARGS = {
                        --奥斯卡召唤的Ghost牛天
                        {
                            ...
                            ARGS = {
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = "ssniutian_dazhao_ghost_buff"},
                                },
                                {
                            ...
                            ARGS = {
                                ...
                                },
                                {
                                    ...
                                    ARGS = {
                                        {
                                            CLASS = "action.QSBApplyBuff",
                                            OPTIONS = {is_target = false, buff_id = "ssniutian_dazhao_buff1;y"},
                                        },
                                        {
                                            CLASS = "action.QSBApplyBuff",
                                            OPTIONS = {is_target = false, buff_id = "ssniutian_dazhao_buff2;y"},
                                        },
                                        {
                                            CLASS = "action.QSBApplyBuff",
                                            OPTIONS = {is_target = false, buff_id = "ssniutian_dazhao_buff3;y"},
                                        },
                                        {
                                            CLASS = "action.QSBApplyBuff",
                                            OPTIONS = {is_target = false, buff_id = "ssniutian_dazhao_buff4;y"},
                                        },
                                    },
                                },            
                            },
                    ...
                    ARGS = {
                        {
                            ...
                            OPTIONS = {effect_id = "ssniutian_attack11_1", is_hit_effect = false},
                        }, 
                        {
                            CLASS = "action.QSBPlayEffect",
                            OPTIONS = {effect_id = "ssniutian_attack11_1_1", is_hit_effect = false},
                        },
                    },
                },
            },
