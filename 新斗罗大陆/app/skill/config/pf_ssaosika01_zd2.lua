                            ...
                            {
                                {
                                    ...
                                    OPTIONS = {is_hit_effect = false, effect_id = "pf_ssaosika01_attack13_1"},
                                },
                                {
                                    CLASS = "action.QSBPlayEffect",
                                    OPTIONS = {is_hit_effect = false,effect_id = "pf_ssaosika01_attack13_2"},
                                },
                            },
                        },
                    },
                    ...
                    ARGS = 
                    {
                        ...
                        },
                        {
                            ...
                            ARGS = 
                            {
                                {
                                    CLASS = "action.QSBPlayEffect",
                                    OPTIONS = {is_hit_effect = false, effect_id = "pf_ssaosika01_attack13_3"},
                                },
                                {
