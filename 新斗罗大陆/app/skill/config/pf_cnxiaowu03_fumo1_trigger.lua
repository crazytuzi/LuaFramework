...
local pf_cnxiaowu03_fumo1_trigge = {
				...
				----有残血标记时
				{
					...
					ARGS = 
					{
						...
						},
						{
							...
							OPTIONS = 
							{
							   { "target:role==boss_or_elite_boss","target:trigger_skill_as_target:281129","not_under_status"},
							}
						},
						{
...
return pf_cnxiaowu03_fumo1_trigge