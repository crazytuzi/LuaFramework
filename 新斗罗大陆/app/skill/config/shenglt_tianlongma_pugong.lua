...
local shenglt_tianlongma_pugong = {
                    ...
                    ARGS = {
                        {
							...
							hit_effect_id = "shenglt_tianlongma_attack01_3",effect_width = 300, jump_num = 3,move_time = 0.1,duration = 0.2},
						},
                    },
                },
            },
...
return shenglt_tianlongma_pugong