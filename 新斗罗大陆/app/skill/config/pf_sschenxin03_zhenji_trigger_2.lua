        ...
        ARGS = {
            {
                ...
                OPTIONS = {damage_scale = ds, property_promotion = {critical_chance = -0.15}},
            },
            {
            ...
            },
            {
                ...
                OPTIONS = {coef_type = "attack_max_hp",type = "beattack_rage",coefficient = 5.6*0.25,min = 24,max =60}
            },
            -- {
    ...
    {	
                    ...
                    ARGS = {
                        {
                            ...
                            ARGS = {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = {"pf_sschenxin03_zhenji_debuff_2","sschenxin_select_enemy_debuff"}},
                                },
                                ---======
                                -- {
                        ...
                        },
                        {
                            ...
                            ARGS = {
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = true, buff_id = {"pf_sschenxin03_zhenji_debuff_2","sschenxin_select_enemy_debuff"}},
                                },
                            },
                        },
                    },
        ...
        },
        {
            ...
            ARGS = {
                ...
                {
                    CLASS = "action.QSBApplyBuff",
                    OPTIONS = {buff_id = "pf_sschenxin03_rage_buff",pass_key = {"selectTargets"}},
                },
                {
                    CLASS = "action.QSBAddRage",
                    OPTIONS = {coef_type = "attack_max_hp",type = "beattack_rage",coefficient = 5,max = 80}
                },
                QISHAZHENSHEN(0.5),
                {
