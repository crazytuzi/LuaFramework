                            ...
                            ARGS = {
                                {
                                    ...
                                    OPTIONS = {effect_id = "zhuzhuqing_attack14_1",is_hit_effect = false},--该特效自带延迟
                                },
                                {
                                    ...
                                    ARGS = {
                                        ...
                                        },
                                        {
                                            ...
                                            ARGS = {
                                                {
                                                    CLASS = "action.QSBPlayEffect",
                                                    OPTIONS = {effect_id = "zhuzhuqing_attack14_1_1",is_hit_effect = false},
                                                },
                                                {
                    ...
                    ARGS = {
                        ...
                        },
                        {
                            ...
                            ARGS = {
                                {
                                    CLASS = "action.QSBPlayEffect",
                                    OPTIONS = {effect_id = "zhuzhuqing_attack14_1",is_hit_effect = false},
                                },
                                {
                                    CLASS = "action.QSBPlayAnimation",
                                },
