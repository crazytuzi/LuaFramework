...
local pf_ssniutian02_dazhao = 
{
    ...
    ARGS = 
    {
        ...
        },
        {
            ...
            OPTIONS = {sound_id ="ssniutian_skill"},
        },
        {
                    ...
                    ARGS = {
                        --奥斯卡召唤的Ghost牛天
                        {
                            ...
                            ARGS = {
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = "pf_sstianqingniumang02_dazhao_ghost_buff"},
                                },
                                {
                            ...
                            ARGS = {
                                ...
                                },
                                {
                                    ...
                                    ARGS = {
                                        {
                                            CLASS = "action.QSBApplyBuff",
                                            OPTIONS = {is_target = false, buff_id = "pf_sstianqingniumang02_dazhao_buff1;y"},
                                        },
                                        {
                                            CLASS = "action.QSBApplyBuff",
                                            OPTIONS = {is_target = false, buff_id = "pf_sstianqingniumang02_dazhao_buff2;y"},
                                        },
                                        {
                                            CLASS = "action.QSBApplyBuff",
                                            OPTIONS = {is_target = false, buff_id = "pf_sstianqingniumang02_dazhao_buff3;y"},
                                        },
                                        {
                                            CLASS = "action.QSBApplyBuff",
                                            OPTIONS = {is_target = false, buff_id = "pf_sstianqingniumang02_dazhao_buff4;y"},
                                        },
                                    },
                                },            
                            },
                    ...
                    ARGS = {
                        {
                            ...
                            OPTIONS = {effect_id = "pf_ssniutian02_attack11_1", is_hit_effect = false},
                        }, 
                        {
                            CLASS = "action.QSBPlayEffect",
                            OPTIONS = {effect_id = "pf_ssniutian02_attack11_1_1", is_hit_effect = false},
                        },
                    },
                },
            },
                    ...
                    ARGS = {
                        {
                            ...
                            OPTIONS = {
                                failed_select = 4,
                                {expression = "self:has_buff:ssniutian_fumo_buff1_1", select = 1},
                                {expression = "self:has_buff:ssniutian_fumo_buff1_2", select = 2},
                                {expression = "self:has_buff:ssniutian_fumo_buff1_3", select = 3},
                            }
                        },
                        {
                            CLASS = "composite.QSBSelector",
                            ARGS = {
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = false, buff_id = "ssniutian_fumo_buff2_1"},
                                },
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = false, buff_id = "ssniutian_fumo_buff2_2"},
                                },
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = false, buff_id = "ssniutian_fumo_buff2_3"},
                                },
                            },
                        },   
                        {
