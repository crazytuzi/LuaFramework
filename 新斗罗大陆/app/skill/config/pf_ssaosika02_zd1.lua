                            ...
                            {
                                {
                                    ...
                                    OPTIONS = {is_hit_effect = false, effect_id = "pf_ssaosika02_attack12_1"},
                                },
                                {
                                    CLASS = "action.QSBPlayEffect",
                                    OPTIONS = {is_hit_effect = true, except_attacker = true,effect_id = "pf_ssaosika02_attack12_3"},
                                },
                            },
                        },
                    },
                    ...
                    ARGS = 
                    {
                        ...
                        },
                        {
                            ...
                            ARGS = 
                            {
                                {
                                    CLASS = "action.QSBPlayEffect",
                                    OPTIONS = {is_hit_effect = false, effect_id = "pf_ssaosika02_attack12_2"},
                                },
                                {
                                    CLASS = "action.QSBPlayEffect",
                                    OPTIONS = {is_hit_effect = true,effect_id = "pf_ssaosika02_attack12_4"},
                                },
                                {
                                    CLASS = "action.QSBPlayEffect",
                                    OPTIONS = {is_hit_effect = true, effect_id = "pf_ssaosika02_attack01_3"},
                                },
                                {
