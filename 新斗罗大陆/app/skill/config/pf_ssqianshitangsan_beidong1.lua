                    ...
                    {
                        {
                            ...
                            OPTIONS = {is_hit_effect = false,effect_id = "pf_ssqianshitangsan_attack06"},
                        },
                        {
                            CLASS = "action.QSBPlayEffect",
                            OPTIONS = {is_hit_effect = false,effect_id = "pf_ssqianshitangsan_attack06_2"},
                        },
                        {
                    ...
                    ARGS = 
                    {
                        ...
                        },
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                {
                                    CLASS = "action.QSBPlayEffect",
                                    OPTIONS = {is_hit_effect = false,effect_id = "pf_ssqianshitangsan_attack06_3"},
                                },
                                {
