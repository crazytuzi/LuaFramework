            ...
            ARGS = {
                {
                    ...
                    ARGS = {
                        ...
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = {"pf3_ssptanghao_shenji_debuff_5","ssptanghao_shenji_debuff2_5"}, is_target = true},
                        },
                        {
                            CLASS = "action.QSBApplyBuff",
                                    ...
                                    ARGS = {
                                        {
                                            ...
                                            OPTIONS = {buff_id = "pf3_ssptanghao_shenji_debuff_5", is_target = true},
                                        },
                                        {
                                            CLASS = "action.QSBRemoveBuff",
                                            OPTIONS = {buff_id = {"pf3_ssptanghao_shenji_buff","pf3_ssptanghao_shenji3_buff1","pf3_ssptanghao_shenji3_buff2"}, is_target = false},
