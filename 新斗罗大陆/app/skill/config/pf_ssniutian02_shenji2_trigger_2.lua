...
local pf_ssniutian02_shenji2_trigger_2 = {
    ...
    ARGS = {
		...
		},
		{
			...
			OPTIONS = {buff_id = "",  is_max_hp_percent = true, coefficient = 0.25, single_max_percent = 0.5},
		},
        {
...
return pf_ssniutian02_shenji2_trigger_2