                                            ...
                                            ARGS = {
                                                {
                                                    ...
                                                    OPTIONS = {effect_id = "zhuzhuqing_attack13_1", is_hit_effect = false},
                                                },
                                                {
                                    ...
                                    ARGS = {
                                        ...
                                        },
                                        {
                                            ...
                                            ARGS = {
                                                {
                                                    CLASS = "action.QSBPlayEffect",
                                                    OPTIONS = {effect_id = "zhuzhuqing_attack13_2", is_hit_effect = false},
                                                },
                                                {
                                                    CLASS = "action.QSBHitTarget",
                                                },
                                    ...
                                    ARGS = {
                                        ...
                                        },
                                        {
                                            ...
                                            ARGS = {
                                                {
                                                    CLASS = "action.QSBPlayEffect",
                                                    OPTIONS = {effect_id = "zhuzhuqing_attack13_3", is_hit_effect = false},
                                                },
                                                {
                                                    CLASS = "action.QSBHitTarget",
                                                },
                                            ...
                                            {
                                                {
                                                    ...
                                                    OPTIONS = {
                                                        actor_id = 1040, life_span = 10,number = 1, no_fog = true,relative_pos = {x = -80, y = 0}, 
