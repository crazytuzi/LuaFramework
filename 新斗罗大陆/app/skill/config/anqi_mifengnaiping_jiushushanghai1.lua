...
local anqi_mifengnaiping_jiushushanghai1 = 
{
    ...
    ARGS = 
    {
        ...
        },
        {
            ...
            OPTIONS = {coefficient = 1, in_skill_range = true, buff_id = "anqi_mifengnaiping_chucun_buff1"},
        },
        {
...
return anqi_mifengnaiping_jiushushanghai1
