    ...
    ARGS = {
        {
			...
			ARGS = {
				...
				},
				{
					...
					OPTIONS = {is_hit_effect = false, effect_id = "guimei_attack11_1",haste = true},
				}, 
				{
					...
					ARGS = {
						...
						},
						{
							...
							OPTIONS = {buff_id = "guimei_fumo_2", all_enemy = true},
						},
						{
							CLASS = "action.QSBApplyBuff",
							OPTIONS = {buff_id = "guimei_fumo_2x", all_enemy = true},
						},
					},
				},
				{
        ...
        },
        {
            ...
            ARGS = {
                ...
                {
                    CLASS = "action.QSBPlaySceneEffect",
                    OPTIONS = {effect_id = "guimei_attack11_1_3", pos  = {x = 640 , y = 360}, ground_layer = true},
                },
            },
        },
        -- {
        ...
        -- },
        {
            ...
            ARGS = {
                ...
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {is_hit_effect = true, effect_id = "guimei_attack11_1_2"},
                }, 
            },
        },
    },
