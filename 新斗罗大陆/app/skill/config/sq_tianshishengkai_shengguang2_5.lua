        ...
        --根据自身剩余血量，配置的上下限，提升反伤和治疗倍数
        {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    OPTIONS = {absorb_buff_id = "sq_tianshishengkai_buff5",hp_percent = 0.25, just_hero = true, absorb_on_every_target = true,pass_key = {"selectTargets"}},
                },
                {
                    CLASS = "action.QSBChangeHealAndRevertDamageByHP",
                    OPTIONS = {absorb_buff_id = "sq_tianshishengkai_buff5", heal_revert_min_cofficient = 1.0, heal_revert_max_cofficient = 1.5,render_damage_limit = 0.25,absorb_render_damage_percent=0.5,absorb_render_heal_percent=0.8},
                },
            },
        },
    },
