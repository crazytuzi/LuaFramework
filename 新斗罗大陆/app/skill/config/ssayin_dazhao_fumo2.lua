            ...
            ARGS = 
            {
                ...
                }, 
                {
                    ...
                    ARGS = 
                    {
                        ...
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = "ssayin_dazhao_buff2_3",teammate_and_self = true},
                        },
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = "ssayin_dazhao_buff2_3_2",teammate_and_self = true},
                        },
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = "ssayin_dazhao_buff2_5",teammate = true},
                        },
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = "ssayin_dazhao_mahongjun_jc",teammate = true, no_cancel = true},
                        },                         
                    },
                },                              
            },
