	local anqi_kongjuzhiyan_shanghai6 ={
	    ...
	    ARGS = { 
				...
				},
				{
					...
					OPTIONS = {buff_id = "anqi_kongjuzhiyan_kaiju_jianshang3"},
				},
				{
					CLASS = "action.QSBDelayTime",
				...
				{
					CLASS = "action.QSBRemoveBuff",	
					OPTIONS = {buff_id = "anqi_kongjuzhiyan_jianshang3_1"},
				},
				{
					CLASS = "action.QSBRemoveBuff",	
					OPTIONS = {buff_id = "anqi_kongjuzhiyan_jianshang3_2"},
				},
				{
					CLASS = "action.QSBRemoveBuff",	
					OPTIONS = {buff_id = "anqi_kongjuzhiyan_jianshang3_3"},
				},
				{
					CLASS = "action.QSBRemoveBuff",	
					OPTIONS = {buff_id = "anqi_kongjuzhiyan_jianshang3_4"},
				},
				{
					...
					{       
						-- {
                            ...
                            -- ARGS = {
								-- {
									-- CLASS = "action.QSBApplyBuff",
									-- OPTIONS = {buff_id = "anqi_kongjuzhiyan_jianshang3_0"},
								-- },	
							-- },
						-- },
						{
