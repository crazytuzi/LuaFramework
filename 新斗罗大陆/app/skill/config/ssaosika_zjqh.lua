                            ...
                            {
                                {
                                    ...
                                    OPTIONS = {is_hit_effect = false, effect_id = "ssaosika_attack22_1"},
                                },
                                {
                                    CLASS = "action.QSBPlayEffect",
                                    OPTIONS = {is_hit_effect = false, effect_id = "ssaosika_attack22_2"},
                                },
                                {
                                    CLASS = "action.QSBPlayEffect",
                                    OPTIONS = {is_hit_effect = false, effect_id = "ssaosika_attack22_3"},
                                },
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {all_enemy = true, buff_id = "ssaosika_zjqh_buff"},
                                },
                            },
                        },
                    },
