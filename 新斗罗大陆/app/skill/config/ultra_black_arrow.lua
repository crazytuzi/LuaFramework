                            ...
                            ARGS = {
                                {
                                    ...
                                    OPTIONS = {effect_id = "darkness_meteor_fletch_2", speed = 2360, time = 0.266 / 2, hit_effect_id = "darkness_meteor_fletch_3", shake = {amplitude = 4, duration = 0.1, count = 1},
                                ...
                                {
                                    CLASS = "action.QSBBullet",
                                    OPTIONS = {effect_id = "darkness_meteor_fletch_2", speed = 2360, time = 0.266 / 2, hit_effect_id = "darkness_meteor_fletch_3_2", shake = {amplitude = 4, duration = 0.1, count = 1},
                                ...
                                {
                                    CLASS = "action.QSBBullet",
                                    OPTIONS = {effect_id = "darkness_meteor_fletch_2", speed = 2360, time = 0.266 / 2, hit_effect_id = "darkness_meteor_fletch_3_3", shake = {amplitude = 4, duration = 0.1, count = 1},
