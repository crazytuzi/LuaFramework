...
local tianshishengkai_shengguang = 
{
    ...
    ARGS = 
    {
        ...
        },
        {
            ...
            OPTIONS = {buff_id = "sq_tianshishengkai_pve_buff4",teammate_and_self = true},
        },
        {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    OPTIONS = {rage_value = -170,all_enemy = true},
                },
            },
        },
        --降低受击回怒系数
                    ...
                    {   
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = "sq_tianshishengkai_shengguang2_4_buff",teammate_and_self = true},
                                },
                            },                              
                        },
                        {
