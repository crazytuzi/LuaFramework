        ...
        },
        {
            ...
            ARGS = {              
                ...
                },
                {
					...
					OPTIONS = {effect_id = "bibidong_attack13_1_1", is_hit_effect = false},
				},
            },
        },
    --     {
					...
					ARGS = {
							...
							ARGS = {
								{
									...
									OPTIONS = {buff_id = "bibidong_zidong1_buff;y"},
								},
								{
									CLASS = "action.QSBApplyBuff",
									OPTIONS = {buff_id = "bibidong_zidong1_buff;y"},
						...
						},
						{
							...
							ARGS = {
								...
								{
									CLASS = "action.QSBApplyBuffMultiple",	
									OPTIONS = {target_type = "teammate",buff_id = "bibidong_zidong1_buff;y"}
								},
							},
						},
					},
