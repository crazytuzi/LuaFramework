            ...
            ARGS = {
                {
                    ...
                    ARGS = {
                        ...
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = {"ssptanghao_shenji_debuff_3","ssptanghao_shenji_debuff2_3"}, is_target = true},
                        },
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = {"ssptanghao_shenji_buff","ssptanghao_shenji3_buff1","ssptanghao_shenji3_buff2"}, is_target = false},
                        },
                    },
                },
                {
                                    ...
                                    ARGS = {
                                        {
                                            ...
                                            OPTIONS = {buff_id = "ssptanghao_shenji_debuff_3", is_target = true},
                                        },
                                        {
                                            CLASS = "action.QSBRemoveBuff",
                                            OPTIONS = {buff_id = {"ssptanghao_shenji_buff","ssptanghao_shenji3_buff1","ssptanghao_shenji3_buff2"}, is_target = false},
