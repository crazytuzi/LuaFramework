        ...
        },
        {
            ...
            ARGS = {
                ...
                },
                {
                    ...
                    OPTIONS = {split_percent = 0.43, on = true, pass_key = {"selectTargets"}},
                },
                {
                    CLASS = "action.QSBDelayTime",
                ...
                },
                {
                    ...
                    OPTIONS = {buff_id = "hl_bianyijinshu_dazhao_buff4", teammate_and_self = true},
                },
                {
...
return hl_bianyijinshu_fentan4