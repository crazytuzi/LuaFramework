                    ...
                    ARGS = { 
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                },
                                {
                                    ...
                                    OPTIONS = {effect_id = "pf_qiandaoliu_whzs_3", is_hit_effect = false},
                                },         
                            },
                        },

                        {
                            ...
                            ARGS = {
                                ...
                                {
                                    CLASS = "action.QSBPlayEffect",
                                    OPTIONS = {effect_id = "pf_qiandaoliu_attack11_3",is_hit_effect = false},
                                },
                            },
                        },
                        {
                            ...
                            ARGS = 
                            {
                                {
                                    CLASS = "action.QSBDelayTime",
                                    OPTIONS = {delay_time = 1.12},
                                },
                                {
                                    CLASS = "action.QSBPlayEffect",
                                    OPTIONS = {effect_id = "qiandaoliu_wuhun_spine", is_hit_effect = false},
                                },         
                            },
                        },
                        {
