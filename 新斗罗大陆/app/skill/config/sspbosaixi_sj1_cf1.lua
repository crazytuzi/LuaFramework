                            ...
                            {
                                {
                                    ...
                                    OPTIONS = {is_target = false, buff_id = "sspbosaixi_sj1_jt1",no_cancel = true},
                                },
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = false, buff_id = "sspbosaixi_sj1_jt2", no_cancel = true},
                                },
                            },
                        },
                        {
        ...
        },
         {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    apply_buffIds ={"sspbosaixi_sj1_debuff1","sspbosaixi_sj_jiance","sspbosaixi_sj1_debuff2","sspbosaixi_sj1_debuff3"}},
                },
            },
        },         
        {
