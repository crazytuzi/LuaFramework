...
local chenxin_dazhao = {
    ...
    ARGS = {
            ...
            ARGS = {
                ...
                },
                {
                    ...
                    ARGS = {
                        ...
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = {"pf_gudouluo02_fumo3_p", "pf_gudouluo02_fumo3_m", "pf_gudouluo02_dazhao_cuihua;y", "pf_gudouluo02_dazhao_hetiji"}, is_target = true, no_cancel = true},
                        },
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = "gudouluo_fumo3_chuandi", is_target = true, no_cancel = true},
                        },
                        {
                            CLASS = "action.QSBDelayTime",
        ...
        --                     OPTIONS = {start_pos = {x = 125,y = 115}, effect_id = "pf_gudouluo02_attack1_2", speed = 2000, hit_effect_id = "pf_gudouluo02_attack1_3"},
        --                 },
        --                 {
        --                     CLASS = "action.QSBDelayTime",
