			...
			{
				{
					...
					ARGS = {
						...
						},
						{
							...
							OPTIONS = {actor_id = 9999, life_span = 0.001,number = 1, no_fog = false, 
							effect_id = "pf_juhuaguai_attack01_3" , use_render_texture = false,pass_key = {"absolute_pos"}},
						},
						{
						...
						},
						{
							CLASS = "action.QSBSummonGhosts",
							OPTIONS = {
								actor_id = 40001,skin_id = 20, life_span = 10.5,number = 1, no_fog = true, use_render_texture = false,
								is_attacked_ghost = false,--[[不能被选中和攻击]] appear_skill = 200268,--[[入场技能]] ai_name = "ghost_yueguan_juhuaguai1", dead_skill = 290078,
				...
				},
				{
					...
					ARGS = {
						...
						},
						{
							CLASS = "action.QSBSummonGhosts",
							OPTIONS = {
								actor_id = 9999, life_span = 0.001,number = 1, no_fog = false, 
								effect_id = "pf_juhuaguai_attack01_3" , use_render_texture = false,pass_key = {"absolute_pos"}
							},
						},
						{
