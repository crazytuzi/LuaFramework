local ssqianshitangsan_pugong1 = 
{
    ...
    ARGS = 
    {
        ...
        },
        {
            ...
            OPTIONS = {buff_id = "pf1_sspqianrenxue_zj2_jt2", is_target = false},
        },
        {
            CLASS = "action.QSBRemoveBuff",
        ...
        {
            CLASS = "action.QSBApplyBuff",
            OPTIONS = {buff_id = "pf1_sspqianrenxue_zj2_buff", is_target = false},
        },
        {
            CLASS = "action.QSBApplyBuff",
            OPTIONS = {buff_id = "pf1_sspqianrenxue_zj2_buff2", is_target = false},
        },
        {
