								...
								},
								{
									...
									ARGS = {
										...
										-- },
										{
											CLASS = "action.QSBSummonGhosts",
											OPTIONS = {
												actor_id = 40001, life_span = 10.5,number = 1, no_fog = true,absolute_pos = {x = 125, y = 325}, use_render_texture = false,
										...
										},
										{
											CLASS = "action.QSBSummonGhosts",
											OPTIONS = {
												actor_id = 40001, life_span = 10.5,number = 1, no_fog = true,absolute_pos = {x = 400, y = 200}, use_render_texture = false,
												is_attacked_ghost = false,--[[不能被旋转和攻击]] appear_skill = 268,--[[入场技能]]  dead_skill = 190078,
												percents = {attack = 0.67, physical_damage_percent_attack = 1, magic_damage_percent_attack = 1}, --[[属性基于召唤者属性的百分比系数]]
												extends_level_skills = {268}
											},
										},
										{
											CLASS = "action.QSBSummonGhosts",
											OPTIONS = {
												actor_id = 40001, life_span = 10.5,number = 1, no_fog = true ,absolute_pos = {x = 400, y = 450}, use_render_texture = false,
												is_attacked_ghost = false,--[[不能被旋转和攻击]] appear_skill = 268,--[[入场技能]] dead_skill = 190078,
												percents = {attack = 0.67, physical_damage_percent_attack = 1, magic_damage_percent_attack = 1}, --[[属性基于召唤者属性的百分比系数]]
												extends_level_skills = {268}
											},
								...
								},
								{
									...
									ARGS = {
										...
										-- },
										{
											CLASS = "action.QSBSummonGhosts",
											OPTIONS = {
												actor_id = 40001, life_span = 10.5,number = 1, no_fog = true ,absolute_pos = {x = 1275, y = 325}, use_render_texture = false,
												is_attacked_ghost = false,--[[不能被旋转和攻击]] appear_skill = 268,--[[入场技能]]  dead_skill = 190078,
												percents = {attack = 0.67, physical_damage_percent_attack = 1, magic_damage_percent_attack = 1}, --[[属性基于召唤者属性的百分比系数]]
												extends_level_skills = {268}
											},
										},
										{
											CLASS = "action.QSBSummonGhosts",
											OPTIONS = {
												actor_id = 40001, life_span = 10.5,number = 1, no_fog = true ,absolute_pos = {x = 1000, y = 200}, use_render_texture = false,
												is_attacked_ghost = false,--[[不能被旋转和攻击]] appear_skill = 268,--[[入场技能]]  dead_skill = 190078,
												percents = {attack = 0.67, physical_damage_percent_attack = 1, magic_damage_percent_attack = 1}, --[[属性基于召唤者属性的百分比系数]]
												extends_level_skills = {268}
											},
										},
										{
											CLASS = "action.QSBSummonGhosts",
											OPTIONS = {
												actor_id = 40001, life_span = 10.5,number = 1, no_fog = true,absolute_pos = {x = 1000, y = 450}, use_render_texture = false,
												is_attacked_ghost = false,--[[不能被旋转和攻击]] appear_skill = 268,--[[入场技能]]  dead_skill = 190078,
												percents = {attack = 0.67, physical_damage_percent_attack = 1, magic_damage_percent_attack = 1}, --[[属性基于召唤者属性的百分比系数]]
												extends_level_skills = {268}
											},
