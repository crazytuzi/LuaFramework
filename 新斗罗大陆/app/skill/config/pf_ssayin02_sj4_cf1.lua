local ssqianshitangsan_pugong1 = 
{
    ...
    {               
        ...
        },
        {
            ...
            OPTIONS = {buff_id = "pf_ssayin02_sj4_jt1",is_target = false},
        }, 
        {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    OPTIONS = {buff_id = "pf_ssayin02_sj4_buff1",pass_key = {"selectTarget"}},
                },
                {
                    CLASS = "action.QSBApplyBuff",
                ...
                {
                    CLASS = "action.QSBApplyBuff",
                    OPTIONS = {buff_id = "pf_ssayin02_sj4_jt3",pass_key = {"selectTarget"}},
                },                
