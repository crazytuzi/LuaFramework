            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    ARGS = 
                    {
                        ...
                        { 
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {is_target = false, buff_id = "ssayin_dazhao_fumo1"},
                        },
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {is_target = true, buff_id = "ssayin_dazhao_fumo1"},
                        },
                    },
                },
                {
                ...
                },
                {
                    ...
                    ARGS = 
                    {
                        ...
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = "pf_ssayin_dazhao_buff2_2",teammate_and_self = true},
                        }, 
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = "pf_ssayin_dazhao_buff2_2_2",teammate_and_self = true},
                        },                        
                    },
                },                              
            },
