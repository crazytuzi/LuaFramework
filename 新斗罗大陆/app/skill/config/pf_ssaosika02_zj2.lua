    ...
    {
        {
            ...
            ARGS = 
            {
				...
				},
				{
				    ...
				    OPTIONS = {pos = {x = 2, y = 4.5}, copy_slots = {1, 3, 5, 6}, percent = 0.7, buff_id = "pf_ssaosika02_zhenji_dot_jt",
                    appear_skill = 291280,is_visible = false, ai_name = "ssaosika_zj2_ai",ai_name_health = "ssaosika_zj2_ai",has_god_skill = false, has_enchat_skill = false,
