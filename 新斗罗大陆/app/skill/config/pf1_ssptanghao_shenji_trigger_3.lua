...
local ssptanghao_shenji_trigger_3 = {
    ...
    ARGS = {
            ...
            ARGS = {
                 {
                    ...
                    OPTIONS = {buff_id = "ssptanghao_shenji_debuff1_3", is_target = true},
                },
                {
                    CLASS = "action.QSBDecreaseAbsorbByProp",
                    OPTIONS = {max_hp_percent  = 1,attacker_current_hp_percent_limit = 0.17},
                }, 
                {
                    CLASS = "action.QSBActorStatus",
                    OPTIONS = 
                    {
                        { "target:is_pvp==false","target:decrease_hp:self:hp*13.1"},
                        -- { "target:is_pvp==false","target:decrease_hp:self:maxAttack*30"},
                        { "target:is_pvp==true","target:decrease_hp:self:hp*0.17"},
                    }
                },
                {
                    CLASS = "composite.QSBSequence",
 ...
 
        {
            ...
            OPTIONS = {
                ...
                {expression = "self:max_hp*0.30>target:hp", select = 1},
            }
        },
        {
            CLASS = "composite.QSBSelector",
            ARGS = {
                {
                    ...
                    ARGS = {
                        ...
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = {"pf1_ssptanghao_shenji_debuff_3","ssptanghao_shenji_debuff2_3"}, is_target = true},
                        },
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = {"pf1_ssptanghao_shenji_buff","pf1_ssptanghao_shenji3_buff1","pf1_ssptanghao_shenji3_buff2"}, is_target = false},
                        },
                    },
                },
                {
                                    ...
                                    ARGS = {
                                        {
                                            ...
                                            OPTIONS = {buff_id = "pf1_ssptanghao_shenji_debuff_3", is_target = true},
                                        },
                                        {
                                            CLASS = "action.QSBRemoveBuff",
                                            OPTIONS = {buff_id = {"pf1_ssptanghao_shenji_buff","pf1_ssptanghao_shenji3_buff1","pf1_ssptanghao_shenji3_buff2"}, is_target = false},
...
return ssptanghao_shenji_trigger_3