                            ...
                            {
                                {
                                    ...
                                    OPTIONS = {teammate = true, just_hero = true, no_support = true, select_name = "max_battle_force", select_num = 2},
                                },
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = {"hl_qingyufenghuang_chuancheng_hot_trigger_5"}},
                                },
                            },
                        },
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = {"hl_qingyufenghuang_chuancheng_hot_remove_5"}},
                                },
                            },
                        },
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = {"hl_qingyufenghuang_chuancheng_hot_5_remove"}},
                                },
                            },
                        },
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = {"hl_qingyufenghuang_chuancheng_buff_trigger_5"}},
                                },
                            },
                        },
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = {"hl_qingyufenghuang_chuancheng_buff_remove_5"}},
                                },
                            },
                        },
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = {"hl_qingyufenghuang_chuancheng_buff_5_remove"}},
                                },
                            },
                        },
                        {
