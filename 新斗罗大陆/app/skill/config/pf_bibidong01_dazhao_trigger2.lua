...
local bibidong_dazhao_trigger2 = 
{
            ...
            ARGS = {
                ...
                },
				{
					...
					ARGS = 
					{
						...
						-- {
							-- CLASS = "action.QSBRemoveBuff",
							-- OPTIONS = {buff_id = "bibidong_shihun_gem3"},b
						-- },
					},
				},
				{
            ...
            ARGS = {
            	{
					...
					OPTIONS = {effect_id = "pf_bibidong01_attack11_1_1b", is_hit_effect = false},
				},
                {
                    CLASS = "action.QSBDelayTime",
				...
				{
					CLASS = "action.QSBPlayEffect",
					OPTIONS = {effect_id = "pf_bibidong01_attack11_3_1b", is_hit_effect = true},
				},
				{
					CLASS = "action.QSBApplyBuff",
					OPTIONS = {buff_id = "pf_bibidong01_dazao2_shouji_buff", is_target = true},
				},
            },
        },
		-- {
  ...
  --               {
		...
		-- 				{
		-- 					CLASS = "action.QSBPlayEffect",
		-- 					OPTIONS = {effect_id = "bibidong_attack11_1_3b", is_hit_effect = true},
		-- 				},
		-- 			},
		-- 		},
  --           },
  --       },
        {
            ...
            ARGS = {
                ...
                },
                {
					...
					OPTIONS = {
						effect_id = "tmzd_2", speed = 9999, hit_effect_id = "pf_bibidong01_attack14_3",
		...
		--真技
		{
            ...
            ARGS = {
                ...
                },
				{
					...
					OPTIONS = {
						failed_select = 4,
						{expression = "self:buff_num:pf_bibidong01_zhenji_plus_buff=1", select = 1},
						{expression = "self:buff_num:pf_bibidong01_zhenji_plus_buff=2", select = 2},
						{expression = "self:buff_num:pf_bibidong01_zhenji_plus_buff=3", select = 3},
					}
				},
				{
