                    ...
                    {
                        {
                            ...
                            ARGS = 
                            {
                                {
                                    CLASS = "action.QSBRemoveBuff",
                                    OPTIONS = {is_target = false, buff_id = "sspbosaixi_sj4_jt1",no_cancel = true},
                                },
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = false, buff_id = "sspbosaixi_sj4_jt2", no_cancel = true},
                                },
                            },
                        },
                        {
        ...
        },
        {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    apply_buffIds ={"sspbosaixi_sj4_debuff1","sspbosaixi_sj_jiance","sspbosaixi_sj4_debuff2","sspbosaixi_sj4_debuff3"}},
                },
            },
        },        
        {
