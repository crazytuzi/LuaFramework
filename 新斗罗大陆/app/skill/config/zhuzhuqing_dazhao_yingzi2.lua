                    ...
                    ARGS = {
                        ...
                        },
                        {
                            ...
                            ARGS = {
                                {
                                    CLASS = "action.QSBPlayEffect",
                                    OPTIONS = {effect_id = "zhuzhuqingyingz_attack11_5_1",is_hit_effect = false, haste = true},
                                },
                                {
                                    CLASS = "action.QSBPlayEffect",
                                    OPTIONS = {effect_id = "zhuzhuqingyingz_attack11_5",is_hit_effect = false, haste = true},
                                },  
                                {
