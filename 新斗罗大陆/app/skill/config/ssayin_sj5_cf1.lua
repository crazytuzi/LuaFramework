local ssqianshitangsan_pugong1 = 
{
    ...
    {               
        ...
        },
        {
            ...
            OPTIONS = {buff_id = "ssayin_sj5_jt1",is_target = false},
        },         
        {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    OPTIONS = {buff_id = "ssayin_sj5_buff1",pass_key = {"selectTarget"}},
                },
                {
                    CLASS = "action.QSBApplyBuff",
                ...
                {
                    CLASS = "action.QSBApplyBuff",
                    OPTIONS = {buff_id = "ssayin_sj5_jt3",pass_key = {"selectTarget"}},
                },
                {
