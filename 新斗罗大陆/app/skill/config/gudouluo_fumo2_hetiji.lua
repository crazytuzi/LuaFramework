                            ...
                            ARGS = {
                                {
                                    ...
                                    ARGS = {  
                                        ...
                                        },
                                        {
                                            ...
                                            OPTIONS = {buff_id = {"gudouluo_fumo2_p", "gudouluo_fumo2_m", "gudouluo_dazhao_cuihua;y", "gudouluo_dazhao_hetiji"}, is_target = true, no_cancel = true},
                                        },
                                        {
                                            CLASS = "action.QSBApplyBuff",
