...
local sq_haishensanchaji_shifang5 = 
{
    ...
    {
        {
            ...
            ARGS = {
                ...
                {
                    CLASS = "action.QSBRemoveBuff",
                    OPTIONS = {buff_id = "sq_haishensanchaji_chufa5", is_target = false},
                },
                {
                    CLASS = "action.QSBRemoveBuff",
                    OPTIONS = {buff_id = "sq_haishensanchaji_shunjian_chufa5", teammate_and_self = true},
                },
                {
                    CLASS = "action.QSBRemoveBuff",
            ...
            ARGS = {
                {
                    ...
                    ARGS = {
                        ...
                        },
                        {
                            ...
                            OPTIONS = {buff_id = "sq_haishensanchaji_hudun5", teammate_and_self = true},
                        },
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = "2S_stun", enemy = true},
                        },
                        {
...
return sq_haishensanchaji_shifang5
