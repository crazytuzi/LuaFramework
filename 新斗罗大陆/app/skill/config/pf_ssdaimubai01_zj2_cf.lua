                                                    ...
                                                    {
                                                        {
                                                            ...
                                                            OPTIONS = {trapId = "pf_ssdaimubai01_liuxing1",count = 1},
                                                        },
                                                    },
                                                },
                                                {
                                            ...
                                            ARGS = 
                                            {
                                                ...
                                                },
                                                {
                                                    ...
                                                    ARGS =
                                                    {
                                                        {
                                                            CLASS = "action.QSBMultipleTrap",
                                                            OPTIONS = {trapId = "pf_ssdaimubai01_liuxing1_1",count = 1},
                                                        },
                                                    },
                                                },
                                                {
