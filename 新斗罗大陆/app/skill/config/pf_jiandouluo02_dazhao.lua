...
local chenxin_dazhao = {
    ...
    ARGS = {
		...
		},
		{
			...
			OPTIONS = {is_hit_effect = false, effect_id = "pf_jiandouluo02_attack11_1",haste = true},
		}, 	
		{
			CLASS = "action.QSBPlayEffect",
			OPTIONS = {is_hit_effect = false, effect_id = "pf_jiandouluo02_attack11_1_1",haste =true},
		}, 
        {
            CLASS = "composite.QSBParallel",
            ARGS = {
				
				{
                    ...
                    ARGS = {
						...
						{
							CLASS = "action.QSBPlayEffect",
							OPTIONS = {is_hit_effect = true, effect_id = "pf_jiandouluo02_attack11_3"},
						}, 
						{
