            ...
            ARGS = {
                {
                    ...
                    OPTIONS = {skill_id = 2439129, wait_finish = true},
                },
                {
                    CLASS = "action.QSBTriggerSkill",	
                    OPTIONS = {skill_id = 2439128, wait_finish = true},
                },
                {
                    CLASS = "action.QSBTriggerSkill",	
                    OPTIONS = {skill_id = 2439127, wait_finish = true},
                },
                {
                    CLASS = "action.QSBTriggerSkill",	
                    OPTIONS = {skill_id = 2439126, wait_finish = true},
                },
                {
                    CLASS = "action.QSBTriggerSkill",	
                    OPTIONS = {skill_id = 2439125, wait_finish = true},
                },
                {
                    CLASS = "action.QSBTriggerSkill",	
                    OPTIONS = {skill_id = 2439124, wait_finish = true},
                },
            },
        },
        {
