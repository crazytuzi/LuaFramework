        ...
        },
        {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    OPTIONS = {absorb_buff_id = "sq_tianshishengkai_buff4",hp_percent = 0.2, just_hero = true, absorb_on_every_target = true,pass_key = {"selectTargets"}},
                },
                {
                    CLASS = "action.QSBChangeHealAndRevertDamageByHP",
                    OPTIONS = {absorb_buff_id = "sq_tianshishengkai_buff4", heal_revert_min_cofficient = 1.0, heal_revert_max_cofficient = 1.0,render_damage_limit = 0.2,absorb_render_damage_percent=0.4,absorb_render_heal_percent=0.7},
                },
            },
        },
    },
