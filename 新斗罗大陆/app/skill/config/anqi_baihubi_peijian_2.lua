	    ...
	    ARGS = {
         ...
         -- 	},
          ...
          --   },
            {
                CLASS = "action.QSBApplyBuff",
                OPTIONS = {buff_id = "anqi_baihubi_hudun2",is_target = false},
            },
            {
                CLASS = "action.QSBApplyBuff",
                OPTIONS = {buff_id = "anqi_baihubi_xixue_1_2",is_target = false},
            },
            {
                CLASS = "action.QSBApplyBuff",
                OPTIONS = {buff_id = "anqi_baihubi_xixue_2_2",is_target = false},
            },
         {
