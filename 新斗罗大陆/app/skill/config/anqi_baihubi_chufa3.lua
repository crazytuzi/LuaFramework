	                    ...
	                    ARGS = {
					        ...
					        },
                    		{
				                CLASS = "action.QSBApplyBuff",
				             	OPTIONS = {buff_id = "anqi_baihubi_buff5_1",is_target = true},
				         	},
					        {
						        CLASS = "action.QSBRemoveBuff",
									                    ...
									                    ARGS = {
									                        ...
									                        },
									                        {
									                            ...
									                            ARGS = {
									                                ...
									                                {
									                                    CLASS = "action.QSBHitTarget",
									                                    OPTIONS = {damage_scale = 14,check_target_by_skill = true},
									                                },
									                                {
									                                    CLASS = "action.QSBHitTarget",
									                                    OPTIONS = {damage_scale = 15,check_target_by_skill = true},
									                                },
									                                {
									                                    CLASS = "action.QSBHitTarget",
									                                    OPTIONS = {check_target_by_skill = true},
