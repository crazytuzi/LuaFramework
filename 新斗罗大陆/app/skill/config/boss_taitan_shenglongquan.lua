...
local boss_taitan_shenglongquan = {
                   ...
                   CLASS = "composite.QSBSequence",
                    ...
                    ARGS = {
                       ...
                       },
                       {
                           ...
                           OPTIONS = {effect_id = "taitan_attack11_1",is_hit_effect = false},
                       },
                       {
                           CLASS = "action.QSBPlayEffect",
                           OPTIONS = {effect_id = "taitan_attack11_1_1",is_hit_effect = false},
                       },
                       {
                           CLASS = "action.QSBDelayTime",
...
return boss_taitan_shenglongquan