...
local function HP_DAMAGE(num_min) 
	...
	hp_damge ={
		...
		OPTIONS = {is_max_hp_percent = true, hp_percent = 0.21 * num_min, attacker_attack_limit = 10.25 * num_min,test = num_min},
	}
	return hp_damge
end
					...
					ARGS = 
					{
						...
						},
						{
							...
							ARGS = {
								...
								{
									CLASS = "action.QSBHitTarget",
									OPTIONS = {damage_scale = 1.5,property_promotion = { critical_chance = 0.05}},
								},
							},
						},
						YUE_DAMAGE(1), 
					...
					ARGS = 
					{
						...
						},
						{
							...
							ARGS = {
								...
								{
									CLASS = "action.QSBHitTarget",
									OPTIONS = {damage_scale = 3,property_promotion = { critical_chance = 0.05}},
								},
							},
						},
						YUE_DAMAGE(2), 
					...
					ARGS = 
					{
						...
						},
						{
							...
							ARGS = {
								...
								{
									CLASS = "action.QSBHitTarget",
									OPTIONS = {damage_scale = 4.5,property_promotion = { critical_chance = 0.05}},
								},
							},
						},
						YUE_DAMAGE(3), 
