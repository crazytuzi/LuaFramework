...
local yueguan_beidong2_huabao_zhaohuan = 
{
	...
	ARGS = {
		...
		},
		{
			...
			OPTIONS = {
				actor_id = 40002, life_span = 9.5,number = 1, no_fog = true, use_render_texture = false, --入场动作1.2+0.3秒,数值持续8秒,共9.5秒
				relative_pos = {x=0,y=0},
				is_attacked_ghost = false,trace_to_the_source = true,--[[Ghost召唤的Ghost从属于最初召唤者]] appear_skill = 276, dead_skill = 190078,
				percents = {attack = 0.5, physical_damage_percent_attack = 1, magic_damage_percent_attack = 1},
				extends_level_skills = {276}
			},
		},
		{
