                    ...
                    ARGS = {
                        {
                            ...
                            OPTIONS = {buff_id = {"hl_qingyufenghuang_dazhao_yishangdebuff_4_jiance"}, multiple_target_with_skill=true},
                        },
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = {"hl_qingyufenghuang_dazhao_yishangdebuff_4_remove1"}, multiple_target_with_skill=true},
                        },
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = {"hl_qingyufenghuang_dazhao_yishangdebuff_4_remove2"}, multiple_target_with_skill=true},
                        },
                    },
                },
            },
