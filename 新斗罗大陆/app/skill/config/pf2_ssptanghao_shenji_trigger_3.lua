            ...
            ARGS = {
                {
                    ...
                    ARGS = {
                        ...
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = {"pf2_ssptanghao_shenji_debuff_3","ssptanghao_shenji_debuff2_3"}, is_target = true},
                        },
                        {
                            CLASS = "action.QSBApplyBuff",
                                    ...
                                    ARGS = {
                                        {
                                            ...
                                            OPTIONS = {buff_id = "pf2_ssptanghao_shenji_debuff_3", is_target = true},
                                        },
                                        {
                                            CLASS = "action.QSBRemoveBuff",
                                            OPTIONS = {buff_id = {"pf2_ssptanghao_shenji_buff","pf2_ssptanghao_shenji3_buff1","pf2_ssptanghao_shenji3_buff2"}, is_target = false},
