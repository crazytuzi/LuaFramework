	    ...
	    ARGS = {
         ...
         -- 	},
          ...
          --   },
            {
                CLASS = "action.QSBApplyBuff",
                OPTIONS = {buff_id = "anqi_baihubi_hudun3",is_target = false},
            },
            {
                CLASS = "action.QSBApplyBuff",
                OPTIONS = {buff_id = "anqi_baihubi_xixue_1_3",is_target = false},
            },
            {
                CLASS = "action.QSBApplyBuff",
                OPTIONS = {buff_id = "anqi_baihubi_xixue_2_3",is_target = false},
            },
         {
