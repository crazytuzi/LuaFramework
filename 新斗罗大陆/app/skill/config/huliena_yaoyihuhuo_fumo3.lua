--这是播放特效的子弹通用
local huliena_yaoyihuhuo_fumo3 = 
{
    ...
    ARGS = 
    {
        ...
        },
        {
            ...
            ARGS = 
            {
                ...
                {
                    CLASS = "action.QSBBullet",
                    OPTIONS = {target_random = true,start_pos = {x = 100,y = 100}},------第9束狐火-----
                },
                -- {
                --     CLASS = "action.QSBDelayTime",
                ...
                -- {
                --     CLASS = "action.QSBBullet",
                --     OPTIONS = {target_random = true,start_pos = {x = 240,y = 20}},------第六束狐火-----
                -- },
                {
...
return huliena_yaoyihuhuo_fumo3
