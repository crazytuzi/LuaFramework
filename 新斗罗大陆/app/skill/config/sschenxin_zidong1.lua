...
local sschenxin_zidong1 = 
{
    ...
    ARGS = 
    {
        ...
        },
        {
            ...
            OPTIONS = {effect_id = "sschenxin_attack13_1", is_hit_effect = false},
        },
        {
            CLASS = "composite.QSBSequence",
            ARGS = {
                ...
                },
                {
                    ...
                    OPTIONS = {start_pos = {x = 125,y = 115}, effect_id = "sschenxin_attack13_2", speed = 1500, hit_effect_id = "sschenxin_attack01_3"},
                },
                {
                    CLASS = "action.QSBArgsConditionSelector",
                    OPTIONS = {
