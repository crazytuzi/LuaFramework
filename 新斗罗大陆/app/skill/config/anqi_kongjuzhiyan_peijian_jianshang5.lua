	local anqi_kongjuzhiyan_shanghai6 ={
	    ...
	    ARGS = { 
				...
				},
				{
					...
					OPTIONS = {buff_id = "anqi_kongjuzhiyan_kaiju_jianshang5"},
				},
				{
					CLASS = "action.QSBDelayTime",
				...
				{
					CLASS = "action.QSBRemoveBuff",	
					OPTIONS = {buff_id = "anqi_kongjuzhiyan_jianshang5_1"},
				},
				{
					CLASS = "action.QSBRemoveBuff",	
					OPTIONS = {buff_id = "anqi_kongjuzhiyan_jianshang5_2"},
				},
				{
					CLASS = "action.QSBRemoveBuff",	
					OPTIONS = {buff_id = "anqi_kongjuzhiyan_jianshang5_3"},
				},
				{
					CLASS = "action.QSBRemoveBuff",	
					OPTIONS = {buff_id = "anqi_kongjuzhiyan_jianshang5_4"},
				},
				{
