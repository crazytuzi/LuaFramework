...
local ZHAHUAN = 
{
    ...
    ARGS = {
            ...
            {
                {
                    ...
                    OPTIONS = {effect_id = "ssptanghao_shenji_3", is_hit_effect = false},
                },
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {effect_id = "ssptanghao_shenji_3_1", is_hit_effect = false},
                },
            },
        },
        {
		...
		},
        {
            ...
            OPTIONS = {skill_id = 39132, skill_level =1},
        },
    },
}
