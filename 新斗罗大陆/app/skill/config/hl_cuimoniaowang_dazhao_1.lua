        ...
        },
		{
            ...
            ARGS = {
                ...
                },
				{
					...
					OPTIONS = {buff_id = "hl_cuimoniaowang_buff_1"},--
                },
				{
					CLASS = "composite.QSBParallel",
					ARGS = {
				...
				},
				{
					...
					OPTIONS = {buff_id = "hl_cuimoniaowang_dazhao_buff1_1"},--
				},
				{
					CLASS = "action.QSBRemoveBuff",
					OPTIONS = {buff_id = "hl_cuimoniaowang_dazhao_buff2_1"},--
				},
        ...
        },
		{
            ...
            ARGS = {
                ...
                },
				{
					...
					OPTIONS = {
						failed_select = 2,
						{expression = "self:has_buff:hl_cuimoniaowang_dazhao_buff1_1=1", select = 1},
					}
				},
				{
					...
					ARGS = {
						{
							...
							ARGS = {
								...
								{
									CLASS = "action.QSBShowStorage",
									OPTIONS = {enter = true, limit = 40,offset={x=-18,y=10},buff_id="hl_cuimoniaowang_buff_1",revertable = true},
								},
							},
						},
						{
