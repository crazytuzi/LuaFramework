    ...
    {
        {
            ...
            OPTIONS = {buff_id = "ssayin_zj2_cfbuff1", is_target = false},
        },
        {
            CLASS = "action.QSBApplyBuff",
                    ...
                    ARGS = 
                    {
                        ...
                        },
                        {
                            ...
                            ARGS = 
                            {
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = "ssayin_zj2_jt", is_target = false},
                                },
                                {
                                    CLASS = "action.QSBAttackFinish",
                                },
        ...
        },
        {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    OPTIONS = {is_strike_agreement = true, percent = 0.1,time = 7,hp_threshold = 0.3,pass_key = {"selectTarget"}},
                },
            },
        },
        {
