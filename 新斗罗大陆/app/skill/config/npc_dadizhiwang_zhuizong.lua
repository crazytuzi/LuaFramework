			...
			{
				{
		            ...
		            OPTIONS = {trapId = "lieyanzhuizong_yujing",count = 1, pass_key = {"pos"}},
		        },
		        {
				...
				},
				{
					...
					ARGS = 
					{
						...
						{
				            CLASS = "action.QSBMultipleTrap",
				            OPTIONS = {trapId = "lieyanzhuizong_baozha",count = 1, pass_key = {"pos"}},
				        },
				        {
		                    CLASS = "action.QSBDelayTime",
		                ...
		                {
				            CLASS = "action.QSBMultipleTrap",
				            OPTIONS = {trapId = "lieyanzhuizong_chixu",count = 1, pass_key = {"pos"}},
				        },
			        },
		        },
				{
