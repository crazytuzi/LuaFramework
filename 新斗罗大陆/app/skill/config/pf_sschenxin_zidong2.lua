...
local sschenxin_pugong1 = 
{
    ...
    ARGS = 
    {
        ...
        },
        {
            ...
            OPTIONS = {effect_id = "pf_sschenxin01_attack14_1", is_hit_effect = false},
        },
        {
            CLASS = "composite.QSBSequence",
            ARGS = {
                ...
                {
					CLASS = "action.QSBPlayEffect",
					OPTIONS = {effect_id = "pf_sschenxin01_attack14_3", is_hit_effect = false},
                },
                {
                                    ...
                                    ARGS = {
                                        {
                                            ...
                                            OPTIONS = {skill_id = 139090, wait_finish = false},
                                        },
                                        {
                                            CLASS = "action.QSBTriggerSkill",
                                            OPTIONS = {skill_id = 139091, wait_finish = false},
                                        },
                                        {
                                            CLASS = "action.QSBTriggerSkill",
                                            OPTIONS = {skill_id = 139092, wait_finish = false},
                                        },
                                        {
                                            CLASS = "action.QSBTriggerSkill",
                                            OPTIONS = {skill_id = 139093, wait_finish = false},
                                        },
                                        {
                                            CLASS = "action.QSBTriggerSkill",
                                            OPTIONS = {skill_id = 139094, wait_finish = false},
                                        },
                                    },
                                }, 
                            },
