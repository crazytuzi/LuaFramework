...
local ssmahongjun_pugong1 = 
{
    ...
    ARGS = {
        ...
        },
        {
            ...
            OPTIONS = {
                failed_select = 2,
                {expression = "self:has_buff:pf_sschenxin03_shenji_qianghua_buff1", select = 1},
                {expression = "self:has_buff:pf_sschenxin03_shenji_qianghua_buff2", select = 1},
                {expression = "self:has_buff:pf_sschenxin03_shenji_qianghua_buff3", select = 1},
                {expression = "self:has_buff:pf_sschenxin03_shenji_qianghua_buff4", select = 1},
                {expression = "self:has_buff:pf_sschenxin03_shenji_qianghua_buff5", select = 1},
                {expression = "self:has_buff:pf_sschenxin03_shenji_qianghua_buff6", select = 1},
            }
        },
        {
            CLASS = "composite.QSBSelector",
                ...
                --神技普攻
                {
                    ...
                    ARGS = 
                    {
                        ...
                        },
                        {
                            ...
                            OPTIONS = {effect_id = "pf_sschenxin03_attack02_1", is_hit_effect = false},
                        },
                        {
                            CLASS = "composite.QSBSequence",
                            ARGS = {
                                    ...
                                    ARGS = {
                                        {
                                            ...
                                            ARGS = {
                                                ...
                                                },
                                                {
                                                    ...
                                                    OPTIONS = {start_pos = {x = -50,y = 210}, effect_id = "pf_sschenxin03_attack01_2", speed = 1500, hit_effect_id = "pf_sschenxin03_attack01_3"},
                                                },
                                                {
                                        ...
                                        },
                                        {
                                            ...
                                            ARGS = {
                                                ...
                                                },
                                                {
                                                    ...
                                                    OPTIONS = {skill_id = 339085, wait_finish = false},
                                                },
                                                {
                                                    CLASS = "action.QSBPlayGodSkillAnimation",
                                        ...
                                        },
                                        {
                                            ...
                                            ARGS = {
                                                ...
                                                {
                                                    CLASS = "action.QSBTriggerSkill",
                                                    OPTIONS = {skill_id = 339086, wait_finish = false},
                                                },
                                                {
                                                    CLASS = "action.QSBPlayGodSkillAnimation",
                                                },
                                        ...
                                        },
                                        {
                                            ...
                                            ARGS = {
                                                ...
                                                {
                                                    CLASS = "action.QSBTriggerSkill",
                                                    OPTIONS = {skill_id = 339087, wait_finish = false},
                                                },
                                                {
                                                    CLASS = "action.QSBPlayGodSkillAnimation",
                                                },
                                        ...
                                        },
                                        {
                                            ...
                                            ARGS = {
                                                ...
                                                {
                                                    CLASS = "action.QSBTriggerSkill",
                                                    OPTIONS = {skill_id = 339088, wait_finish = false},
                                                },
                                                {
                                                    CLASS = "action.QSBPlayGodSkillAnimation",
                                                },
                    ...
                    ARGS = 
                    {
                        ...
                        },
                        {
                            ...
                            ARGS = {
                                ...
                                {
                                    CLASS = "action.QSBPlayEffect",
                                    OPTIONS = {effect_id = "pf_sschenxin03_attack01_1", is_hit_effect = false},
                                },
                            },
                        },
                        {
