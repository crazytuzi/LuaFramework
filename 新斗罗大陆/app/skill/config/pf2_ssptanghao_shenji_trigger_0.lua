...
local ssptanghao_shenji_trigger_0 = {
    ...
    ARGS = {
            ...
            ARGS = {
                 {
                    ...
                    OPTIONS = {buff_id = "ssptanghao_shenji_debuff1_0", is_target = true},
                },
                {
                    CLASS = "action.QSBDecreaseAbsorbByProp",
                    OPTIONS = {max_hp_percent  = 1,attacker_current_hp_percent_limit = 0.07},
                },
                {
                    CLASS = "action.QSBActorStatus",
                    OPTIONS = 
                    {
                        { "target:is_pvp==false","target:decrease_hp:self:hp*5.9"},
                        -- { "target:is_pvp==false","target:decrease_hp:self:maxAttack*16"},
                        { "target:is_pvp==true","target:decrease_hp:self:hp*0.08"},     
                    }
                }, 
                {
                    CLASS = "composite.QSBSequence",
...

        {
            ...
            OPTIONS = {
                ...
                {expression = "self:max_hp*0.12>target:hp", select = 1},
            }
        },
        {
            CLASS = "composite.QSBSelector",
            ARGS = {
                {
                    ...
                    ARGS = {
                        ...
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = "pf2_ssptanghao_shenji_debuff_0", is_target = true},
                        },
                    },
                },
                {
...
return ssptanghao_shenji_trigger_0
