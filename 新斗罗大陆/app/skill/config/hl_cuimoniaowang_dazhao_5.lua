    ...
    ARGS = {
        ...
        },
		{
            ...
            ARGS = {
                ...
                },
				{
					...
					OPTIONS = {buff_id = "hl_cuimoniaowang_buff_5"},--
                },
				{
					CLASS = "composite.QSBParallel",
					ARGS = {
				...
				},
				{
					...
					OPTIONS = {buff_id = "hl_cuimoniaowang_dazhao_buff1_5"},--
				},
				{
					CLASS = "action.QSBRemoveBuff",
					OPTIONS = {buff_id = "hl_cuimoniaowang_dazhao_buff2_5"},--
				},
				{
                    CLASS = "action.QSBDelayTime",
        ...
        },
		{
            ...
            ARGS = {
                ...
                },
				{
					...
					OPTIONS = {
						failed_select = 2,
						{expression = "self:has_buff:hl_cuimoniaowang_dazhao_buff1_5=1", select = 1},
					}
				},
				{
		...
		--------------
        {
            ...
            ARGS = {
				...
				{
					CLASS = "action.QSBPlayEffect",
					OPTIONS = {effect_id = "hl_cuimoniaowang_attack11_1_1",is_hit_effect = false, haste = true,revertable = true},
				},
            },
        },
		{
            ...
            ARGS = {
				...
				{
					CLASS = "action.QSBPlayEffect",
					OPTIONS = {effect_id = "hl_cuimoniaowang_attack11_2_1",is_hit_effect = false, haste = true,revertable = true},
				},
            },
        },
		{
					...
					ARGS = {
						{
							...
							ARGS = {
								...
								{
									CLASS = "action.QSBShowStorage",
									OPTIONS = {enter = true, limit = 40,offset={x=-18,y=10},buff_id="hl_cuimoniaowang_buff_5",revertable = true},
								},
							},
						},
						{
