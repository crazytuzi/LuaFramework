local zudui_boss_xiemohujing_jiguang3 = {
    ...
    ARGS = {
		     ...
		     },
		     {
				...
				---
						  ...
						  },
						  {
							...
							OPTIONS = {pos={x = 1250,y = 120},verify_flip = true},
						  },
						  {
							CLASS = "composite.QSBParallel",
							ARGS = {
             ...
             },				-- 放激光
			 {
							     ...
							     ARGS = {
                                             {
                                                 ...
                                                 OPTIONS = {effect_id = "xiemohujingboss_jiguang", pos  = {x = 1020 , y = 200}, ground_layer = true},
                                             },
                                             {
				...
				---
						                                  ...
						                                  {
							                                  CLASS = "action.QSBTeleportToAbsolutePosition",
							                                  OPTIONS = {pos={x = 1200,y = 460},verify_flip = true},
						                                  },
						                                  {
							                                  CLASS = "composite.QSBParallel",
							                                  ARGS = {
...
return zudui_boss_xiemohujing_jiguang3