...
local ssniutian_shenji2_trigger = {
    CLASS = "composite.QSBSequence",
    ARGS = {
		{
			CLASS = "action.QSBClearBuffSaveValue",
			OPTIONS = {buff_id = "ssniutian_shenji2_buff_4", is_save_damage = true},
		},
		{
		...
		},
		{
			...
			{ 
				args = 
				{
					{trapId = "ssniutian_shenji2_trap", relative_pos = { x = 0, y = 0}} ,
				},
...
return ssniutian_shenji2_trigger