local sspbosaixi_zj_cf3 = 
{
    ...
    {   
        ...
        {
            CLASS = "action.QSBRemoveBuff",
            OPTIONS = {is_target = false ,buff_id = "sspbosaixi_zj3_jt1"},      --真技3监听1？？？？？
        },
        {
                    ...
                    ARGS = 
                    {
                        ...
                        },
                        {
                            ...
                            ARGS = 
                            {
                                {
                                    CLASS = "action.QSBRemoveBuff",
                                    OPTIONS = {is_target = false, buff_id = "sspbosaixi_zj3_jt1",no_cancel = true},
                                },
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = false, buff_id = "sspbosaixi_zj3_jt2", no_cancel = true},
                                },
                                {
                                    CLASS = "action.QSBAttackFinish",
                                },
        ...
        {                                           --真技3上护盾，伤害转护盾，优先抵消伤害，无视穿盾
            CLASS = "action.QSBApplyBuff",
            OPTIONS = {is_target = false, buff_id = "sspbosaixi_zj3_buff1", no_cancel = true},
        },
        {
            CLASS = "composite.QSBSequence",
            ARGS = 
