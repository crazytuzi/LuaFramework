                            ...
                            {
                                {
                                    ...
                                    OPTIONS = {is_target = false, buff_id = "sspbosaixi_sj0_jt1",no_cancel = true},
                                },
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = false, buff_id = "sspbosaixi_sj0_jt2", no_cancel = true},
                                },
                            },
                        },
                        {
        ...
        },
        {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    apply_buffIds ={"sspbosaixi_sj0_debuff1","sspbosaixi_sj_jiance","sspbosaixi_sj0_debuff2"}},
                },
            },
        },        
        {
