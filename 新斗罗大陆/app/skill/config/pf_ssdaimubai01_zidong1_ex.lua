local pf_ssdaimubai01_zidong1_ex = 
{
                            ...
                            ARGS =
                            {
                                ...
                                },
                                {
                                    ...
                                    ARGS = 
                                    {
                                        ...
                                        {
                                            CLASS = "action.QSBMultipleTrap", --连续放置多个陷阱
                                            OPTIONS = {interval_time = 0.1, attacker_face = true,attacker_underfoot = true,count = 1, distance = 0, trapId = "pf_ssdaimubai01_bhpms_ex"},
                                        },
                                    },
                                },
                            },
...
return pf_ssdaimubai01_zidong1_ex