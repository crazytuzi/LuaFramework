...
local zmwh_boss_zhuanshuji_fenghuang = {
							...
							ARGS = { 
								{
									...
									OPTIONS = {effect_id = "zmwh_boss_shouwuhun_attack05_3_3", pos  = {x = 640 , y = 410}, scale_actor_face = -1, front_layer = true},
								},
								{
...
return zmwh_boss_zhuanshuji_fenghuang