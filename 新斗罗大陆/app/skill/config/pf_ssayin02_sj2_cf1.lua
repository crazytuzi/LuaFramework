local ssqianshitangsan_pugong1 = 
{
    ...
    {               
        ...
        },
        {
            ...
            OPTIONS = {buff_id = "pf_ssayin02_sj2_jt1",is_target = false},
        }, 
        {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    OPTIONS = {buff_id = "pf_ssayin02_sj2_buff1",pass_key = {"selectTarget"}},
                },
                {
                    CLASS = "action.QSBApplyBuff",
                ...
                {
                    CLASS = "action.QSBApplyBuff",
                    OPTIONS = {buff_id = "pf_ssayin02_sj2_jt3",pass_key = {"selectTarget"}},
                },                
                {
                    CLASS = "action.QSBApplyBuff",
                    OPTIONS = {buff_id = "",pass_key = {"selectTarget"}},
                },
                {
                    CLASS = "action.QSBDelayTime",
                    OPTIONS = {delay_time = 1 ,pass_key = {"selectTarget"}},
                },
                {
                    CLASS = "action.QSBAddRage",
                    OPTIONS = {type = "value",value = 60,pass_key = {"selectTarget"}},
                }, 
                {
                    CLASS = "action.QSBDelayTime",
                    OPTIONS = {delay_time = 1 ,pass_key = {"selectTarget"}},
        ...
        },
        {
            ...
            ARGS = 
            {
                ...
                },
               {
                ...
                {
                    CLASS = "action.QSBAddRage",
                    OPTIONS = {type = "value",value = 50,pass_key = {"selectTarget"}},
                }, 
                 {
                    CLASS = "action.QSBDelayTime",
                    OPTIONS = {delay_time = 1.5 ,pass_key = {"selectTarget"}},
