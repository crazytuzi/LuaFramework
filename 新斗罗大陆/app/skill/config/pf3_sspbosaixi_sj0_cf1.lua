                            ...
                            {
                                {
                                    ...
                                    OPTIONS = {is_target = false, buff_id = "pf3_sspbosaixi_sj0_jt1",no_cancel = true},
                                },
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = false, buff_id = "pf3_sspbosaixi_sj0_jt2", no_cancel = true},
                                },
                            },
                        },
                        {
        ...
        },
        {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    apply_buffIds ={"pf3_sspbosaixi_sj0_debuff1","pf3_sspbosaixi_sj_jiance","pf3_sspbosaixi_sj0_debuff2"}},
                },
            },
        },        
        {
