									...
									ARGS = {
										...
										},
										{
											...
											ARGS = {
												{
													CLASS = "action.QSBSummonGhosts",
													OPTIONS = {actor_id = 1019, life_span = 10.0,number = 1, no_fog = true,relative_pos = {x = -50, y = 200}, use_render_texture = false},
												},
												{
													CLASS = "action.QSBSummonGhosts",
													OPTIONS = {actor_id = 1019, life_span = 10.0,number = 1, no_fog = true,relative_pos = {x = 180, y = 150}, use_render_texture = false},
												},
												{
													CLASS = "action.QSBSummonGhosts",
													OPTIONS = {actor_id = 1019, life_span = 10.0,number = 1, no_fog = true,relative_pos = {x = 250, y = 0}, use_render_texture = false},
												},
												{
													CLASS = "action.QSBSummonGhosts",
													OPTIONS = {actor_id = 1019, life_span = 10.0,number = 1, no_fog = true,relative_pos = {x = 180, y = -150}, use_render_texture = false},
