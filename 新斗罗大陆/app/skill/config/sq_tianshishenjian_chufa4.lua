    ...
    {
        {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    OPTIONS = {change_cofficient_name = "beattack_coefficient",change_cofficient_value = 0.79},
                },
            },
        },
        {
                    ...
                    {
                        {
                            ...
                            OPTIONS = 
                            {
                                ...
                                damage_percent = "5.5;11", --攻击力最高的魂师施放伤害等同于当前攻击力的百分比（PVP/PVE）
                                convert_treat_percent = 0.3, --根据造成伤害恢复的生命值百分比
                                change_rage_value = -210, --降低的敌方全体怒气
                        ...
                        },
                        {
                            ...
                            OPTIONS = 
                            {
                                ...
                                right_effect2_pos = {x=900,y=340},
                                right_effect3_pos = {x=640,y=340},
                                damage_percent = "5.5;33", --攻击力最高的魂师施放伤害等同于当前攻击力的百分比（PVP/PVE）
                                convert_treat_percent = 0.3, --根据造成伤害恢复的生命值百分比
                                change_rage_value = -210, --降低的敌方全体怒气
                                rage_increase_coefficient_final_value = -0--降低怒气最高的魂师的怒气获取
                            },
        ...
        },
        {
            ...
            OPTIONS = { buff_id = "sq_tianshishenjian_chufa4_buff"},
        },
    },
}
