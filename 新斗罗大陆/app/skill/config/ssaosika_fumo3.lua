                                            ...
                                            { 
                                                {
                                                    ...
                                                    OPTIONS = {is_hit_effect = false, effect_id = "ssaosika_attack11_1"},
                                                }, 
                                                {
                                                    CLASS = "action.QSBPlayEffect",
                                                    OPTIONS = {is_hit_effect = false, effect_id = "ssaosika_attack11_5"},
                                                },    
                                            },
                                        },  
                                    },
                                    ...
                                    ARGS = 
                                    {
                                        ...
                                        },
                                        {
                                            ...
                                            ARGS = 
                                            {
                                                {
                                                    CLASS = "action.QSBPlayEffect",
                                                    OPTIONS = {is_hit_effect = false, effect_id = "ssaosika_attack11_4"},
                                                },  
                                            },
                                        },  
                                    },
                                    ...
                                    ARGS = 
                                    {
                                        ...
                                        },
                                        {
                                            ...
                                            ARGS = 
                                            {
                                                {
                                                    CLASS = "action.QSBPlayEffect",
                                                    OPTIONS = {is_hit_effect = true, except_attacker = true,effect_id = "ssaosika_attack11_3"},
                                                },
                                                {
                                                    CLASS = "action.QSBPlayEffect",
                                                    OPTIONS = {is_hit_effect = true, except_attacker = true,effect_id = "ssaosika_attack11_2"},
                                                },
                                                {
                                                    CLASS = "action.QSBRemoveStatusByCast",
                                                    ...
                                                    {
                                                        {
                                                            ...
                                                            OPTIONS = 
                                                            {
                                                                ...
                                                                {expression = "self:has_buff:ssaosika_bd2&target:has_buff:ssaosika_bd2_debuff=false&(target:hp/target:max_hp<0.35)", select = 1}
                                                            },
                                                        },
                                                        {
                                                            ...
                                                            {
                                                                {
                                                                    ...
                                                                    ARGS = 
                                                                    {
                                                                        {
                                                                            CLASS = "action.QSBApplyBuff",
                                                                            OPTIONS = {is_target = true, buff_id = "ssaosika_bd2_buff"}
                                                                        },
                                                                        {
                                                                            CLASS = "action.QSBApplyBuff",
                                                                            OPTIONS = {is_target = true, buff_id = "ssaosika_bd2_debuff"}
                                                                        },
                                                                    },
                                                                },
                                                            },
