...
local mahongjun_zhenji_plus_trigger = {
    ...
    ARGS = {
			...
			ARGS = {
				{
					...
					OPTIONS = {
						actor_id = 40007, life_span = 180,number = 1, no_fog = true, use_render_texture = false, 
		...
		},
		{
			...
			OPTIONS = {buff_id = "pf_mahongjun01_zhenji_plus_buff",no_cancel = true},
		},
		{
...
return mahongjun_zhenji_plus_trigger
