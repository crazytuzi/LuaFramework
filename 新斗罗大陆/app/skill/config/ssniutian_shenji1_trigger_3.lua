    ...
    ARGS = {
		{
			...
			OPTIONS = {buff_id = "ssniutian_shenji1_buff_3", is_save_treat = true},
		},
		{
		...
		},
        {
			...
			OPTIONS = {buff_id = "", hp_percent = 0.5, absorb_buff_id = "ssniutian_shenji1_shield_buff_3", just_hero = true,single_max_percent = 0.5},
		},
        {
