...
local anqi_mifengnaiping_jiushushanghai3 = 
{
    ...
    ARGS = 
    {
        ...
        },
        {
            ...
            OPTIONS = {ignore_damage_percent_attack = true, coefficient = 1, in_skill_range = true, buff_id = "anqi_mifengnaiping_chucun_buff3"},
        },
        {
...
return anqi_mifengnaiping_jiushushanghai3
