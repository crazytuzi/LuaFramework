    ...
    ARGS = {
		{
			...
			OPTIONS = {buff_id = "pf_sstianqingniumang01_shenji1_buff_4", is_save_treat = true},
		},
		{
		...
		},
        {
			...
			OPTIONS = {buff_id = "", hp_percent = 0.65, absorb_buff_id = "pf_sstianqingniumang01_shenji1_shield_buff_4", just_hero = true,single_max_percent = 0.5},
		},
        {
