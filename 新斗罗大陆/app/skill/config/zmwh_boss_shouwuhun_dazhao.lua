...
local zmwh_boss_shouwuhun_dazhao = 
{
								...
								},
								{
									...
									ARGS = {
										...
										},
										{
											...
											OPTIONS = {actor_id = 61033 , life_span = 10,number = 1, appear_skill = 51378 , enablehp = true,
											hp_percent = 0.0003 , no_fog = false,is_attacked_ghost = true,absolute_position = {x=300,y=200} --[[args_translate = {pos = "absolute_pos"}]]},
										},
									},
								},
								{
									...
									ARGS = {
										...
										},
										{
											CLASS = "action.QSBSummonGhosts",
											OPTIONS = {actor_id = 61033 , life_span = 10,number = 1, appear_skill = 51378 , enablehp = true,
											hp_percent = 0.0003 , no_fog = false,is_attacked_ghost = true,absolute_position = {x=600,y=450} --[[args_translate = {pos = "absolute_pos"}]]},
										},
									},
								},
							},
...
return zmwh_boss_shouwuhun_dazhao