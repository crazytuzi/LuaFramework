            ...
            {
                {
                    ...
                    OPTIONS = {is_attacker = true,status = "sspbosaixi_sj2_jt1"},
                },
                {
                            ...
                            {
                                {
                                    ...
                                    OPTIONS = {is_target = false, buff_id = "pf3_sspbosaixi_sj2_jt1",no_cancel = true},
                                },
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = false, buff_id = "pf3_sspbosaixi_sj2_jt2", no_cancel = true},
                                },
                            },
                        },
                        {
        ...
        },
        {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    apply_buffIds ={"pf3_sspbosaixi_sj2_debuff1","pf3_sspbosaixi_sj_jiance","pf3_sspbosaixi_sj2_debuff2","pf3_sspbosaixi_sj2_debuff3"}},
                },
            },
        },    
        {
