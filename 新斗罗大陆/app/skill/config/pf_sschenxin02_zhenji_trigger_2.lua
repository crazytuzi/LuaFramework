                    ...
                    ARGS = {
                        {
                            ...
                            ARGS = {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = {"pf_sschenxin02_zhenji_debuff_2","sschenxin_select_enemy_debuff"}},
                                },
                                ---======
                                -- {
                        ...
                        },
                        {
                            ...
                            ARGS = {
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = true, buff_id = {"pf_sschenxin02_zhenji_debuff_2","sschenxin_select_enemy_debuff"}},
                                },
                            },
                        },
                    },
