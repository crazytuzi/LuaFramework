					...
					CLASS = "composite.QSBSequence",
					 ARGS = {
						-- {
							...
							-- OPTIONS = { skill_id = 289,wait_finish = true},
						-- },
						{
						...
						},
						{
							...
							ARGS = {
								...
								{
									CLASS = "action.QSBPlayAnimation",
									OPTIONS = {animation = "attack11_2_1",no_stand = true},
								},
								{
									CLASS = "composite.QSBSequence",
									ARGS = {
										...
										},
										{
											...
											OPTIONS = 
											{ 
												trapId = "qianrenxue_dazhao_treat_trap_fumo1",
												args = 
												{
...
return qianrenxue_dazhao_fumo1