local ssqianshitangsan_pugong1 = 
{
    ...
    {   
                            ...
                            {
                                {
                                    ...
                                    OPTIONS = {is_target = false, buff_id = "pf2_sspqianrenxue_sj5_jt1",no_cancel = true},
                                },
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = false, buff_id = "pf2_sspqianrenxue_sj5_jt2", no_cancel = true},
                                },
                            },
                        },
                        {
        ...
        {
            CLASS = "action.QSBApplyBuff",
            OPTIONS = {buff_id = "pf2_sspqianrenxue_sj5_buff1",teammate_and_self = true},
        }, 
        {
            CLASS = "action.QSBApplyBuff",
            OPTIONS = {buff_id = "pf2_sspqianrenxue_sj5_buff2",teammate_and_self = true},
        },
        {
            CLASS = "action.QSBApplyBuff",
            OPTIONS = {buff_id = "pf2_sspqianrenxue_sj5_buff4",teammate_and_self = true},
        },
        {
            CLASS = "action.QSBApplyBuff",
            OPTIONS = {buff_id = "pf2_sspqianrenxue_sj5_debuff1",enemy = true},
        },
         {
            CLASS = "action.QSBApplyBuff",
            OPTIONS = {buff_id = "pf2_sspqianrenxue_sj5_js1",is_target = false},
        },       
        {
