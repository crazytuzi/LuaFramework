...
local pf_sstianqingniumang01_zhenji_trigger1_3 = {
            ...
            ARGS = {
                --初始化BUFF
                {
                    ...
                    ARGS = 
                    {
                        ...
                        {
                            CLASS = "action.QSBRemoveBuff",
                            OPTIONS = {buff_id = "pf_sstianqingniumang01_zhenji_init_buff_3"},
                        },
                        {
                            ...
                            ARGS = {
                                {
                                    ...
                                    ARGS = 
                                    {
                                        {
                                            CLASS = "action.QSBRemoveBuff",
                                            OPTIONS = {buff_id = "pf_sstianqingniumang01_zhenji_niutian_buff_2"},
                                        },
                                        {
                                            CLASS = "action.QSBRemoveBuff",
                                        ...
                                        },
                                        {
                                            ...
                                            OPTIONS = {buff_id = "pf_sstianqingniumang01_zhenji_niutian_buff_3"}
                                        },
                                        {
                                            CLASS = "action.QSBApplyBuff",
                                            OPTIONS = {buff_id = "pf_sstianqingniumang01_zhenji_buff_3"}
                                        },
                                    },
                                },
                            },
                        },
                        {
                            ...
                            OPTIONS = {buff_id = "pf_sstianqingniumang01_zhenji_buff_3",start_percent = 0.2,reduction_percent = 0.2,end_percent = 2.8}
                        },
                    },
                },
                --BUFF结束效果
                                    ...
                                    ARGS = {
                                        {
                                            ...
                                            ARGS = 
                                            {
                                                ...
                                                {
                                                    CLASS = "action.QSBApplyBuff",
                                                    OPTIONS = {lowest_hp_teammate = true, just_hero = true, buff_id = {"pf_sstianqingniumang01_zhenji_start_buff","pf_sstianqingniumang01_zhenji_buff_3","pf_sstianqingniumang01_zhenji_init_buff_3"}},
                                                },
                                            },
                                        },
...
return pf_sstianqingniumang01_zhenji_trigger1_3