        ...
        },
        {
            ...
            ARGS = {
                ...
                },
                {
					...
					OPTIONS = {effect_id = "pf_bibidong01_attack01_1", is_hit_effect = false},
				},
            },
        },
        {
            ...
            ARGS = {
				...
				},
                {
                    ...
                    OPTIONS = {start_pos = {x = 125,y = 115}, effect_id = "pf_bibidong01_attack01_2", speed = 1500, hit_effect_id = "pf_bibidong01_attack01_3"},
                },
				{
					CLASS = "action.QSBActorStatus",
					OPTIONS = 
