                    ...
                    {
                        {
                            ...
                            OPTIONS = {is_hit_effect = false, effect_id = "pf1_sspqianrenxue_attack05_2"},--冲锋拖尾特效
                        },
                        {
                        ...
                        },
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                },
                                {
                                    ...
                                    OPTIONS = {is_target = false, buff_id = "pf1_sspqianrenxue_beidong1_buff2"},
                                },
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = false, buff_id = "pf1_sspqianrenxue_beidong1_buff"},
                                },
                                {
                                    CLASS = "action.QSBPlayAnimation",
                                ...
                                },
                                {
                                    ...
                                    ARGS = 
                                    {
                                        ...
                                        {
                                            CLASS = "action.QSBPlayEffect",
                                            OPTIONS = {is_hit_effect = false, effect_id = "pf1_sspqianrenxue_attack05_1"},--挥剑特效
                                        },
                                    },   
                                },
                                {
                                    CLASS = "action.QSBPlayEffect",
                                    OPTIONS = {is_hit_effect = false, effect_id = "pf1_sspqianrenxue_attack05_3"},--前层特效
                                },
                                {
