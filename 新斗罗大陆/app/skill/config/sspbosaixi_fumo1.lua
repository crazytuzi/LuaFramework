    ...
    ARGS = 
    {
        ...
        {                                           --大招伤害+神技Debuff提升伤害？？？？
            ...
            ARGS = 
            {
                ...
                {                           --固定生命%护盾
                    CLASS = "action.QSBApplyBuff",
                    OPTIONS = {is_target = false ,buff_id = "sspbosaixi_dazhao_buff1_1"},
                },
                {
                    ...
                    {
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = false ,buff_id = "sspbosaixi_dazhao_buff2_1_1"},
                                },
                            },
                        },
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = false ,buff_id = "sspbosaixi_dazhao_buff2_1_2"},
                                },
                            },
                        },
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = false ,buff_id = "sspbosaixi_dazhao_buff2_1_3"},
                                },
                            },
                        },                                                        
                        {
