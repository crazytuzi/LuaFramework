                            ...
                            {
                                {
                                    ...
                                    ARGS = 
                                    {
                                        ...
                                        },
                                        {
                                            ...
                                            OPTIONS = {effect_id = "pf_ssqianshitangsan_shenji_1", is_hit_effect = true},
                                        },
                                        -- {
                                        --     CLASS = "action.QSBPlayEffect",
                                        --     OPTIONS = {effect_id = "pf_ssqianshitangsan_shenji_2", is_hit_effect = true},
                                        -- },
                                        {
                                ...
                                },
                                {
                                    ...
                                    ARGS = 
                                    {
                                        ...
                                        -- {
                                        --     CLASS = "action.QSBPlayEffect",
                                        --     OPTIONS = {effect_id = "ssqianshitangsan_shenji_2", is_hit_effect = true},
                                        -- },
                                        {
                                            CLASS = "action.QSBHitTarget",                                                                                    
                                        },
