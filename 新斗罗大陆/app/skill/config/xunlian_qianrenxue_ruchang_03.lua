...
---入场动作+震屏
        ...
        },
        {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    OPTIONS = {interval_time = 0, attacker_face = false,attacker_underfoot = true,count = 1, distance = 0, trapId = "xunlian_qianrenxue_tianshilingyu_03_2"},
                },
            },
        },
        {
                ...
                -----地面花火11点-4点
        {
            ...
            OPTIONS = 
            { 
                trapId = "xunlian_elite_qianrenxue_ruchang03",
                args = 
                {
