local ssqianshitangsan_pugong1 = 
{
    ...
    ARGS = 
    {
        ...
        {
            CLASS = "action.QSBRemoveBuff",
            OPTIONS = {buff_id = "sspqianrenxue_zj3_jt", is_target = false},
        },
        {
            CLASS = "action.QSBApplyBuff",
            OPTIONS = {buff_id = "sspqianrenxue_zj3_jt2", is_target = false},
        },
        {
            CLASS = "action.QSBApplyBuff",
            OPTIONS = {buff_id = "sspqianrenxue_zj3_buff", is_target = false},
        },
        {
            CLASS = "action.QSBApplyBuff",
            OPTIONS = {buff_id = "sspqianrenxue_zj3_buff2", is_target = false},
        },
        {
