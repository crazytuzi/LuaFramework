        ...
        -- 特效部分
    	{
            ...
            ARGS = {
                ...
                },
                {
                    ...
                    OPTIONS = {is_hit_effect = false, effect_id = "npc_Sok_horror_tread_1"},
                }, 
        	},
    	},
        {
            ...
            ARGS = {
                ...
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {is_hit_effect = false, effect_id = "npc_Sok_horror_tread_3"},
                }, 
            },
        },
        {
            ...
            ARGS = {
                ...
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {is_hit_effect = false, effect_id = "npc_Sok_horror_tread_2"},
                }, 
            },
        },
        {
            ...
            ARGS = {
                ...
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {is_hit_effect = false, effect_id = "npc_Sok_horror_tread_5"},
                }, 
            },
        },
        {
            ...
            ARGS = {
                ...
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {is_hit_effect = false, effect_id = "npc_Sok_horror_tread_4"},
                }, 
            },
        },
