local daimubai_pugong1 = 
{
    ...
    ARGS = 
    {
        ...
        },
        {
            ...
            OPTIONS = {effect_id = "sszzq_zd2_1", is_hit_effect = false},
        }, 
        {
            CLASS = "composite.QSBSequence",
            ARGS = 
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    ARGS = 
                    {
                        {
                            CLASS = "action.QSBPlayEffect",
                            OPTIONS = {effect_id = "sszzq_zd2_2", is_hit_effect = true},
                        },
                        {
                            CLASS = "action.QSBMultipleTrap", --连续放置多个陷阱
                            OPTIONS = {interval_time = 0, attacker_face = false,attacker_underfoot = true,count = 1, distance = 0, trapId = "sszhuzhuqing_zd2_xuruo"},
                        },
                        {
