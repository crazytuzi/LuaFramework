                            ...
                            {
                                {
                                    ...
                                    OPTIONS = {is_target = false, buff_id = "pf3_sspbosaixi_sj1_jt1",no_cancel = true},
                                },
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = false, buff_id = "pf3_sspbosaixi_sj1_jt2", no_cancel = true},
                                },
                            },
                        },
                        {
        ...
        },
         {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    apply_buffIds ={"pf3_sspbosaixi_sj1_debuff1","pf3_sspbosaixi_sj_jiance","pf3_sspbosaixi_sj1_debuff2","pf3_sspbosaixi_sj1_debuff3"}},
                },
            },
        },         
        {
