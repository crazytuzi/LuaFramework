    ...
    ARGS = 
    {
        ...
        },
        {
            ...
            ARGS = 
            {
                ...
                {
                    CLASS = "action.QSBApplyBuff",
                    OPTIONS = {is_target = false ,buff_id = "sspbosaixi_dazhao_buff1_3"},
                },
                {
                    CLASS = "composite.QSBSequence",
                    ARGS = 
                            ...
                            {
                                {
                                    ...
                                    ARGS = 
                                    {
                                        ...
                                        {
                                            CLASS = "action.QSBApplyBuff",
                                            OPTIONS = {is_target = false ,buff_id = "sspbosaixi_dazhao_buff2_3_1"},
                                        },
                                    },
                                },
                                {
                                    ...
                                    ARGS = 
                                    {
                                        ...
                                        {
                                            CLASS = "action.QSBApplyBuff",
                                            OPTIONS = {is_target = false ,buff_id = "sspbosaixi_dazhao_buff2_3_2"},
                                        },
                                    },
                                },
                                {
                                    ...
                                    ARGS = 
                                    {
                                        ...
                                        {
                                            CLASS = "action.QSBApplyBuff",
                                            OPTIONS = {is_target = false ,buff_id = "sspbosaixi_dazhao_buff2_3_3"},
                                        },
                                    },
                                },                                                        
                                {
