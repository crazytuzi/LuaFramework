                            ...
                            {
                                {
                                    ...
                                    OPTIONS = {is_hit_effect = false, effect_id = "pf_ssaosika02_attack23_1"},
                                },
                                {
                                    CLASS = "action.QSBPlayEffect",
                                    OPTIONS = {is_hit_effect = false, effect_id = "pf_ssaosika02_attack23_2"},
                                },
                                {
                                    CLASS = "action.QSBPlayEffect",
                                    OPTIONS = {is_hit_effect = false, effect_id = "pf_ssaosika02_attack23_3"},
                                },
                            },
                        },
                    },
