            ...
            ARGS = 
            {
                ...
                },                                                                         
                {
                    ...
                    ARGS = 
                    {
                        ...
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = "pf_ssayin03_dazhao_buff2_4",teammate_and_self = true},
                        },
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = "pf_ssayin03_dazhao_buff2_4_2",teammate_and_self = true},
                        },
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = "pf_ssayin03_dazhao_buff2_6",teammate = true},
                        },                         
                    },
                },                              
            },
