        ...
        },
        {
            ...
            ARGS = {
                ...
                },
                {
                    ...
                    OPTIONS = {split_percent = 0.3, on = true, pass_key = {"selectTargets"}},
                },
                {
                    CLASS = "action.QSBDelayTime",
                ...
                },
                {
                    ...
                    OPTIONS = {buff_id = "hl_bianyijinshu_dazhao_buff1", teammate_and_self = true},
                },
                {
...
return hl_bianyijinshu_fentan1