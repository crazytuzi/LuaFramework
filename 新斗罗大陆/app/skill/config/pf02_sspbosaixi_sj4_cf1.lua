                    ...
                    {
                        {
                            ...
                            ARGS = 
                            {
                                {
                                    CLASS = "action.QSBRemoveBuff",
                                    OPTIONS = {is_target = false, buff_id = "pf02_sspbosaixi_sj4_jt1",no_cancel = true},
                                },
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = false, buff_id = "pf02_sspbosaixi_sj4_jt2", no_cancel = true},
                                },
                            },
                        },
                        {
        ...
        },
        {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    apply_buffIds ={"sspbosaixi_sj4_debuff1","sspbosaixi_sj_jiance","pf02_sspbosaixi_sj4_debuff2","pf02_sspbosaixi_sj4_debuff3"}},
                },
            },
        },        
        {
