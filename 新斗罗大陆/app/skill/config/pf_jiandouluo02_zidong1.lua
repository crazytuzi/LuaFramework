            ...
            ARGS = {
                ...
                },
				{
					...
					OPTIONS = {
						...
						effect_id = "pf_jiandouluo02_attack13_2", speed = 1800, rail_number = 2, rail_delay = 0.033, 
						hit_effect_id = "pf_jiandouluo02_attack01_3", is_bezier = true, bullet_delay = 0.07, 
						set_points = { 
