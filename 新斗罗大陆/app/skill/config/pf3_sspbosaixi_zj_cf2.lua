local sspbosaixi_zj_cf2 = 
{
    ...
    {   
                    ...
                    ARGS = 
                    {
                        ...
                        },
                        {
                            ...
                            ARGS = 
                            {
                                {
                                    CLASS = "action.QSBRemoveBuff",
                                    OPTIONS = {is_target = false, buff_id = "pf3_sspbosaixi_zj2_jt1",no_cancel = true},
                                },
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = false, buff_id = "pf3_sspbosaixi_zj2_jt2", no_cancel = true},
                                },
                                {
                                    CLASS = "action.QSBAttackFinish",
                                },
        ...
        {
            CLASS = "action.QSBApplyBuff",
            OPTIONS = {is_target = false, buff_id = "pf3_sspbosaixi_zj2_buff1", no_cancel = true},
        },
        {
            CLASS = "composite.QSBSequence",
            ARGS = 
            {
                ...
                },
                {
                    ...
                    OPTIONS = 
                    {
                        target_buff_id = "pf3_sspbosaixi_zj2_debuff1", --[[每次弹射命中时目标上的buff]]                                          
