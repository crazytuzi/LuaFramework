    ...
    {  
        {
            ...
            OPTIONS = 
            {
                ...
                shelter_coefficient = 0.25, --庇护产生护盾相当于期间受到的伤害系数
                ...
                near_death_coefficient = 1.5, --濒死护盾吸收系数
                trigger_damage_count = 3,--每几次产生一个会爆炸的护盾
                shelter_damage_coefficient = 1.2,--爆炸护盾伤害系数，取决于吸收量
        ...
        },
        {
            ...
            OPTIONS = {is_target = true, buff_id = "sq_haishentaozhuang_bihu2_buff"},
        },
    },
