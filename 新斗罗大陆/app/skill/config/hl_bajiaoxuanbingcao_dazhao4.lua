        ...
        },
        {
             ...
             ARGS = 
             {
                ...
                },
                {
                    ...
                    OPTIONS = {teammate=true, buff_id = {"hl_bajiaoxuanbingcao_dazhao_buff_5"}},
                },
            },
        },
        {
             ...
             ARGS = 
             {
                ...
                {
                    CLASS = "action.QSBApplyBuff",
                    OPTIONS = {teammate=true, buff_id = {"hl_bajiaoxuanbingcao_dazhao_dun_buff_5"}},
                },
            },
        },
        {
             ...
             ARGS = 
             {
                ...
                {
                    CLASS = "action.QSBApplyBuff",
                    OPTIONS = {pass_key={"selectTarget"},buff_id = {"hl_bajiaoxuanbingcao_dazhao_trigger_buff_5"},check_selectTarget = true},
                },
                {
                    CLASS = "action.QSBApplyBuff",
                    OPTIONS = {pass_key={"selectTarget"},buff_id = {"hl_bajiaoxuanbingcao_dazhao_trigger_buff_5"},check_selectTarget = true},
