...
local function PER_SEC_BIJIAN(_ds)
        ...
        ARGS = {
            {
                ...
                OPTIONS = {
                    failed_select = 3,
                    {expression = "target:has_buff:pf_sschenxin03_dazhao_debuff&self:has_buff:sschenxin_dazhao_lose_count", select = 1},
                                        ...
                                        {
                                            {
                                                ...
                                                OPTIONS = {skill_id = 203574, wait_finish = true},
                                            },
                                            {
                                                CLASS = "action.QSBArgsConditionSelector",
                                                OPTIONS = {
    ...
    ARGS = {
        ...
        },
        {
            ...
            ARGS = {
                ...
                {
                    CLASS = "action.QSBRemoveBuff",
                    OPTIONS = {enemy = true, buff_id = "pf_sschenxin03_dazhao_debuff",no_cancel = true},
                },
                {
                    CLASS = "action.QSBRemoveBuff",
                    ...
                    ARGS = {
                        ...
                        --------====
                        {
                            ...
                            ARGS = {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = {"pf_sschenxin03_dazhao_debuff","sschenxin_dazhao_stun_debuff",
                        ...
                        ---======
                        {
                            ...
                            ARGS = {
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = true, buff_id = {"pf_sschenxin03_dazhao_debuff","sschenxin_dazhao_stun_debuff",
                                    "sschenxin_select_enemy_debuff"}, revertable = true},
                                },
                                {
                                    CLASS = "action.QSBLockTarget",
