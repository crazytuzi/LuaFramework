            ...
            ARGS = {
                ...
                },
                {
                    ...
                    ARGS = {
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = {"pf1_ssptanghao_zidong2_plus_buff;y","pf1_ssptanghao_zidong2_buff1"}, is_target = false},
                        },
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = {"pf1_ssptanghao_zidong2_buff;y","pf1_ssptanghao_zidong2_buff1"}, is_target = false},
                        },
                    },
                },
            },
