...
local ssmahongjun_pugong1 = 
{
    ...
    ARGS = {
        ...
        },
        {
            ...
            OPTIONS = {
                failed_select = 2,
                {expression = "self:has_buff:pf_sschenxin02_shenji_qianghua_buff1", select = 1},
                {expression = "self:has_buff:pf_sschenxin02_shenji_qianghua_buff2", select = 1},
                {expression = "self:has_buff:pf_sschenxin02_shenji_qianghua_buff3", select = 1},
                {expression = "self:has_buff:pf_sschenxin02_shenji_qianghua_buff4", select = 1},
                {expression = "self:has_buff:pf_sschenxin02_shenji_qianghua_buff5", select = 1},
                {expression = "self:has_buff:pf_sschenxin02_shenji_qianghua_buff6", select = 1},
            }
        },
        {
            CLASS = "composite.QSBSelector",
                ...
                --神技普攻
                {
                    ...
                    ARGS = 
                    {
                        ...
                        },
                        {
                            ...
                            OPTIONS = {effect_id = "pf_sschenxin02_attack02_1", is_hit_effect = false},
                        },
                        {
                            CLASS = "composite.QSBSequence",
                            ARGS = {
                                ...
                                },
                                {
                                    ...
                                    OPTIONS = {
                                        failed_select = 1,
                                        {expression = "self:has_buff:pf_sschenxin02_shenji_buff_5", select = 5},
                                        {expression = "self:has_buff:pf_sschenxin02_shenji_buff_4", select = 4},
                                        {expression = "self:has_buff:pf_sschenxin02_shenji_buff_3", select = 3},
                                        {expression = "self:has_buff:pf_sschenxin02_shenji_buff_2", select = 2},
                                    }
                                },
                                {
                                    CLASS = "composite.QSBSelector",
                                    ARGS = {
                                        {
                                            ...
                                            ARGS = {
                                                ...
                                                },
                                                {
                                                    ...
                                                    OPTIONS = {start_pos = {x = -50,y = 210}, effect_id = "pf_sschenxin02_attack01_2", speed = 1500, hit_effect_id = "pf_sschenxin02_attack01_3"},
                                                },
                                                {
                                        ...
                                        },
                                        {
                                            ...
                                            ARGS = {
                                                ...
                                                },
                                                {
                                                    ...
                                                    OPTIONS = {skill_id = 240085, wait_finish = false},
                                                },
                                                {
                                                    CLASS = "action.QSBPlayGodSkillAnimation",
                                        ...
                                        },
                                        {
                                            ...
                                            ARGS = {
                                                ...
                                                {
                                                    CLASS = "action.QSBTriggerSkill",
                                                    OPTIONS = {skill_id = 240086, wait_finish = false},
                                                },
                                                {
                                                    CLASS = "action.QSBPlayGodSkillAnimation",
                                                },
                                        ...
                                        },
                                        {
                                            ...
                                            ARGS = {
                                                ...
                                                {
                                                    CLASS = "action.QSBTriggerSkill",
                                                    OPTIONS = {skill_id = 240087, wait_finish = false},
                                                },
                                                {
                                                    CLASS = "action.QSBPlayGodSkillAnimation",
                                                },
                                        ...
                                        },
                                        {
                                            ...
                                            ARGS = {
                                                ...
                                                {
                                                    CLASS = "action.QSBTriggerSkill",
                                                    OPTIONS = {skill_id = 240088, wait_finish = false},
                                                },
                                                {
                                                    CLASS = "action.QSBPlayGodSkillAnimation",
                                                },
                    ...
                    ARGS = 
                    {
                        ...
                        },
                        {
                            ...
                            ARGS = {
                                ...
                                {
                                    CLASS = "action.QSBPlayEffect",
                                    OPTIONS = {effect_id = "pf_sschenxin02_attack01_1", is_hit_effect = false},
                                },
                            },
                        },
                        {
