								...
								},
								{
									...
									ARGS = 
									{
										...
										}, 
										{
											...
											OPTIONS = {actor_id = 61031 , life_span = 4.2,number = 1, appear_skill = 51369 ,dead_skill = 51370, enablehp = true,hp_percent = 0.0001 , relative_pos = {x = 0, y = -25}, no_fog = false,is_attacked_ghost = true},
										},
										{
