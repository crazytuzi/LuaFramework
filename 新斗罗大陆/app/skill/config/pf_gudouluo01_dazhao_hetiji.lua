    ...
    ARGS = {
        {
            ...
            OPTIONS = {sound_id ="pf_gudouluo01_skill"},
        },
		{
            CLASS = "composite.QSBParallel",
            ARGS = {
                ...
                },   
                {
                    ...
                    ARGS = {
                                    ...
                                    {   
                                        {
                                            ...
                                            OPTIONS = {effect_id = "pf_gudouluo01_attack11_2_1", is_hit_effect = true},
                                        },
                                        {
                                            CLASS = "action.QSBPlayEffect",
                                            OPTIONS = {effect_id = "pf_gudouluo01_attack11_2_2", is_hit_effect = true},
                                        },
                                    },
                                },
                            },
                        ...
                        {
                            CLASS = "action.QSBPlayEffect",
                            OPTIONS = {effect_id = "pf_gudouluo01_attack11_3", is_hit_effect = true},
                        },
                        {
                            CLASS = "action.QSBDelayTime",
                        ...
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = {"pf_gudouluo01_dazhao_cuihua;y", "pf_gudouluo01_dazhao_hetiji"}, is_target = true},
                        },
                        {
                            CLASS = "action.QSBDelayTime",
        ...
        },
        {
            ...
            ARGS = {
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {is_hit_effect = false, effect_id = "pf_gudouluo01_attack11_1_1"},
                }, 
            },
        }, 
        {
