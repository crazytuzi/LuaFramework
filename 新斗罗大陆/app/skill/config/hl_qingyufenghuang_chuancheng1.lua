local hl_qingyufenghuang_chuancheng1 = 
{
                    ...
                    {
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                },
                                {
                                    ...
                                    OPTIONS = {buff_id = {"hl_qingyufenghuang_chuancheng_hot_trigger_1"}},
                                },
                            },
                        },
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = {"hl_qingyufenghuang_chuancheng_hot_remove_1"}},
                                },
                            },
                        },
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = {"hl_qingyufenghuang_chuancheng_hot_1_remove"}},
                                },
                            },
                        },
                        {
...
return hl_qingyufenghuang_chuancheng1