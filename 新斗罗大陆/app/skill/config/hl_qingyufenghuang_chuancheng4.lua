local hl_qingyufenghuang_chuancheng4 = 
{
                    ...
                    {
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                },
                                {
                                    ...
                                    OPTIONS = {buff_id = {"hl_qingyufenghuang_chuancheng_hot_trigger_4"}},
                                },
                            },
                        },
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = {"hl_qingyufenghuang_chuancheng_hot_remove_4"}},
                                },
                            },
                        },
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = {"hl_qingyufenghuang_chuancheng_hot_4_remove"}},
                                },
                            },
                        },
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = {"hl_qingyufenghuang_chuancheng_buff_trigger_4"}},
                                },
                            },
                        },
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = {"hl_qingyufenghuang_chuancheng_buff_remove_4"}},
                                },
                            },
                        },
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = {"hl_qingyufenghuang_chuancheng_buff_4_remove"}},
                                },
                            },
                        },
                        {
...
return hl_qingyufenghuang_chuancheng4