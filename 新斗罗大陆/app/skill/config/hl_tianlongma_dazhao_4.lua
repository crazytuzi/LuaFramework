                ...
                },
                {
                    ...
                    ARGS = {
                        ...
                        },
						{
							...
							OPTIONS = {skill_id = 35059, target_type = "skill_target", wait_finish = true},
						},
						{
							CLASS = "action.QSBAttackByBuffNum",
							OPTIONS = { buff_id = "hl_tianlongma_pugong_debuff",num_pre_stack_count = 1,attackMaxNum = 4, trigger_skill_id = 35074,target_type = "enemy" }
						},
                    },
                },
				{
