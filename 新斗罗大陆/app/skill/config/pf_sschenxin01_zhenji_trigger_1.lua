                    ...
                    ARGS = {
                        {
                            ...
                            ARGS = {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = {"pf_sschenxin_zhenji_debuff_1","sschenxin_select_enemy_debuff"}},
                                },
                                ---======
                                -- {
                        ...
                        },
                        {
                            ...
                            ARGS = {
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = true, buff_id = {"pf_sschenxin_zhenji_debuff_1","sschenxin_select_enemy_debuff"}},
                                },
                            },
                        },
                    },
