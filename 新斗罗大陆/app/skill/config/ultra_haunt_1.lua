local guiyingchongchong = {				-- 鬼影重重
    ...
    --                 OPTIONS = {effect_id = "haunt_2"},
				...
				},
				{
		            ...
		            OPTIONS = {buff_id = "heti_haunt_buff", teammate = true}, -- target_type 填 "enemy"、"teammate"、"teammate_and_self"
		        },
		        {
		             CLASS = "action.QSBApplyBuff",
		            OPTIONS = {buff_id = "heti_haunt_buff"},
		        },
		        {
