...
local pf_ssniutian02_shenji2_trigger_3 = {
    CLASS = "composite.QSBSequence",
    ARGS = {
		{
			CLASS = "action.QSBClearBuffSaveValue",
			OPTIONS = {buff_id = "pf_sstianqingniumang02_shenji2_buff_3", is_save_damage = true},
		},
		{
...
return pf_ssniutian02_shenji2_trigger_3