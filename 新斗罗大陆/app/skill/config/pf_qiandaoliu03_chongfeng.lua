...
local qiandaoliu_chongfeng = {
    ...
    ARGS = {
        ...
        },
        {
            ...
            OPTIONS = {buff_id = {"pf_qiandaoliu_chongfeng", "mianyi_suoyou_zhuangtai"}},
        },
        {
        ...
        -- },
        {
            ...
            OPTIONS = {buff_id = "pf_qiandaoliu_chongfeng"},
        },
        {
            CLASS = "action.QSBRemoveBuff",     --去除加速
