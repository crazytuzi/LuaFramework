            ...
            ARGS = {
                {
                    ...
                    OPTIONS = {effect_id = "pf_sschenxin02_attack11_3_13", is_hit_effect = true},
                },
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {effect_id = "pf_sschenxin02_attack11_3_12", is_hit_effect = true},
                },
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {effect_id = "pf_sschenxin02_attack11_3_11", is_hit_effect = true},
                },
            },
        },
        {
