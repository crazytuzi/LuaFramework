         ...
         -- 	},
            {
                ...
                OPTIONS = {buff_id = "anqi_baihubi_hudun1",is_target = false},
            },	 
         	{
                CLASS = "action.QSBApplyBuff",
             	OPTIONS = {buff_id = "anqi_baihubi_xixue_1_1",is_target = false},
         	},
         	{
                CLASS = "action.QSBApplyBuff",
             	OPTIONS = {buff_id = "anqi_baihubi_xixue_2_1",is_target = false},
         	},
         	-- {
