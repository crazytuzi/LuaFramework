                ...
                },
                {
                    ...
                    ARGS = 
                    {
                        ...
                        },
                        {
                            ...
                            OPTIONS = {is_target = false, buff_id = "ssaosika_jxwd"}
                        },
                    },
                },
                {
                            ...
                            {
                                {
                                    ...
                                    OPTIONS = {is_hit_effect = false, effect_id = "ssaosika_attack23_1"},
                                },
                                {
                                    CLASS = "action.QSBPlayEffect",
                                    OPTIONS = {is_hit_effect = false, effect_id = "ssaosika_attack23_2"},
                                },
                                {
                                    CLASS = "action.QSBPlayEffect",
                                    OPTIONS = {is_hit_effect = false, effect_id = "ssaosika_attack23_3"},
                                },
                            },
                        },
                    },
