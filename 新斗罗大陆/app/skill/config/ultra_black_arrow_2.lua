            ...
            ARGS = {
                {
                    ...
                    OPTIONS = {effect_id = "darkness_meteor_fletch_1_xinshou", is_hit_effect = false},
                },
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {effect_id = "darkness_meteor_fletch_1_2_xinshou", is_hit_effect = false},
                },
            },
        },
        -- bullet
                            ...
                            ARGS = {
                                {
                                    ...
                                    OPTIONS = {effect_id = "darkness_meteor_fletch_2_xinshou", speed = 2360, time = 0.266, hit_effect_id = "darkness_meteor_fletch_3_xinshou", shake = {amplitude = 4, duration = 0.1, count = 1},
                                            start_pos = {x = 1280 - 400, y = 600 + 80, global = true}, dead_ok = true, single = true, end_pos = {x = 0, y = 0}, hit_dummy = "dummy_body"},
                                },
                                {
                                    CLASS = "action.QSBDelayTime",
                                    OPTIONS = {delay_time = 0.133},
                                },
                                {
                                    CLASS = "action.QSBBullet",
                                    OPTIONS = {effect_id = "darkness_meteor_fletch_2_xinshou", speed = 2360, time = 0.266, hit_effect_id = "darkness_meteor_fletch_3_2_xinshou", shake = {amplitude = 4, duration = 0.1, count = 1},
                                ...
                                {
                                    CLASS = "action.QSBBullet",
                                    OPTIONS = {effect_id = "darkness_meteor_fletch_2_xinshou", speed = 2360, time = 0.266, hit_effect_id = "darkness_meteor_fletch_3_3_xinshou", shake = {amplitude = 4, duration = 0.1, count = 1},
