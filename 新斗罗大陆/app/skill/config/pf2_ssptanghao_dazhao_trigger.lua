            ...
            ARGS = {
                {
                    ...
                    OPTIONS = {skill_id = 2539129, wait_finish = true},
                },
                {
                    CLASS = "action.QSBTriggerSkill",	
                    OPTIONS = {skill_id = 2539128, wait_finish = true},
                },
                {
                    CLASS = "action.QSBTriggerSkill",	
                    OPTIONS = {skill_id = 2539127, wait_finish = true},
                },
                {
                    CLASS = "action.QSBTriggerSkill",	
                    OPTIONS = {skill_id = 2539126, wait_finish = true},
                },
                {
                    CLASS = "action.QSBTriggerSkill",	
                    OPTIONS = {skill_id = 2539125, wait_finish = true},
                },
                {
                    CLASS = "action.QSBTriggerSkill",	
                    OPTIONS = {skill_id = 2539124, wait_finish = true},
                },
            },
        },
        {
