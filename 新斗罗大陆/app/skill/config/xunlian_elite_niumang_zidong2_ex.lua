local xunlian_elite_niumang_zidong2_ex = 
{
                            ...
                            {
                                {
                                    ...
                                    OPTIONS = {interval_time = 0, count = 1, distance = 0, trapId = "xunlian_elite_niumang_shuiyux"} ,
                                },
                                {
                                    CLASS = "composite.QSBSequence",
                                    ARGS = 
                                    {
                                        ...
                                        },
                                        {
                                            ...
                                            OPTIONS = {trapId = "xunlian_elite_niumang_shuizhux",count = 1},
                                        },
                                    },
                                },
                                {
...
return xunlian_elite_niumang_zidong2_ex