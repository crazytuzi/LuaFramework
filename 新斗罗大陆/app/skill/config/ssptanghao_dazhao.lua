                ...
                ARGS = {   
                    {
                        ...
                        { 
                            ...
                            }, 
                            {
                                ...
                                OPTIONS = {skill_id = 610, wait_finish = false},
                            },
                            {
...
local SECOND_HIT =
{
    ...
    ARGS = 
    {
        ...
        {
            CLASS = "action.QSBPlayEffect",
            OPTIONS = {effect_id = "ssptanghao_attack11_1_2", is_hit_effect = false},
        }, 
        {
            CLASS = "composite.QSBSequence",
            ARGS = {
                ...
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {effect_id = "ssptanghao_attack11_1_2_1", is_hit_effect = false},
                }, 
            },
        },
    },
            ...
            ARGS = {
                ...
                },  
                {
                    ...
                    ARGS = 
                    {
                        {
                            CLASS = "action.QSBPlayEffect",
                            OPTIONS = {effect_id = "ssptanghao_attack11_1_3", is_hit_effect = false},
                        }, 
                        {
                            CLASS = "action.QSBPlayEffect",
                            OPTIONS = {effect_id = "ssptanghao_attack11_1_3_1", is_hit_effect = false},
                        }, 
                        {
    ...
    ARGS = 
    {
        ...
        HIT_WITH_SHENJI(16,1),
        {
            ...
            ARGS = {
                ...
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {effect_id = "ssptanghao_attack11_1_1", is_hit_effect = false},
                }, 
            },
        },
        ----------------------
