                                ...
                                ARGS = {             
                                    {
                                        ...
                                        ARGS = 
                                        {
                                            ...
                                            {CLASS = "action.QSBApplyBuff",OPTIONS = {buff_id = {"pf02_ssptanghao_zhenji_debuff_1","pf02_ssptanghao_zhenji_slow_debuff"}, is_target = true},}, 
                                        },
                                    },
                                    {
                                        CLASS = "composite.QSBParallel",
                                        ...
                                        {
                                            HIT_ZIDONG1(0.7,0.5),
                                            {CLASS = "action.QSBApplyBuff",OPTIONS = {buff_id = {"pf02_ssptanghao_zhenji_debuff_2","pf02_ssptanghao_zhenji_slow_debuff"}, is_target = true},}, 
                                        },
                                    },
                                    {
                                        CLASS = "composite.QSBParallel",
                                        ...
                                        {
                                            HIT_ZIDONG1(1,0.7),
                                            {CLASS = "action.QSBApplyBuff",OPTIONS = {buff_id = {"pf02_ssptanghao_zhenji_debuff_3","pf02_ssptanghao_zhenji_slow_debuff"}, is_target = true},}, 
                                        },
                                    },
                                },
                            }, 
                            {
                                CLASS = "action.QSBApplyBuff",OPTIONS = {buff_id = "pf02_ssptanghao_zhenji_count", is_target = false},
                            }, 
                        },
                    },
                    HIT_ZIDONG1(0),
                ...
                ARGS = {    
                    {
                        ...
                        OPTIONS = {skill_id = 490384, wait_finish = false},
                    },
                },
            },
            --目标位面失衡:
                    ...
                    {
                        {
                            ...
                            OPTIONS = {effect_id = "pf_ssptanghao02_attack13_1", is_hit_effect = false},
                        },
                        {
                            CLASS = "action.QSBPlayEffect",
                            OPTIONS = {effect_id = "pf_ssptanghao02_attack13_1_1", is_hit_effect = false},
                        },
                        {
                            CLASS = "composite.QSBSequence",
                            ARGS = {
                                    ...
                                    {
                                        CLASS = "action.QSBPlayEffect",
                                        OPTIONS = {effect_id = "pf_ssptanghao02_attack13_2", is_hit_effect = false},
                                    },                                  
                                     {
                                         CLASS = "action.QSBDelayTime",
                                    ...
                                    {
                                        CLASS = "action.QSBPlayEffect",
                                        OPTIONS = {effect_id = "pf_ssptanghao02_attack13_2_1", is_hit_effect = false},
                                    },
