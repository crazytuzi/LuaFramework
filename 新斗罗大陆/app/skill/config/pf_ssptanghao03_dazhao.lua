                ...
                ARGS = {   
                    {
                        ...
                        { 
                            ...
                            }, 
                            {
                                ...
                                OPTIONS = {skill_id = 401610, wait_finish = false},
                            },
                            {
                                CLASS = "action.QSBPlayEffect",
                                OPTIONS = {effect_id = "pf_ssptanghao03_attack01_3", is_hit_effect = true},--普攻受击
                            }, 
                        },
                    },
                },
...
local SECOND_HIT =
{
    ...
    ARGS = 
    {
        ...
        {
            CLASS = "action.QSBPlayEffect",
            OPTIONS = {effect_id = "pf_ssptanghao03_attack11_1_2", is_hit_effect = false},--从左向右抡
        }, 
        {
            CLASS = "composite.QSBSequence",
            ARGS = {
                ...
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {effect_id = "pf_ssptanghao03_attack11_1_2_1", is_hit_effect = false},--巨大透明锤子砸地
                }, 
            },
        },
        {
            ...
            ARGS = {
                ...
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {effect_id = "pf_ssptanghao03_attack11_1_3", is_hit_effect = false},--头顶巨大透明锤子
                }, 
            },
        },
    },
            ...
            ARGS = {
                ...
                },  
                {
                    ...
                    ARGS = 
                    {
                        ...
                        {
                            CLASS = "action.QSBPlayEffect",
                            OPTIONS = {effect_id = "pf_ssptanghao03_attack11_1_3_1", is_hit_effect = false},--砸地石头受击
                        }, 
                        {
...
local ssptanghao_dazhao = 
{
    ...
    ARGS = 
    {
        ...
        },
        {
            ...
            OPTIONS = {sound_id ="ssptanghao_skill"},
        },
        {
            CLASS = "action.QSBLockTarget",
            OPTIONS = {is_lock_target = true, revertable = true},
        ...
        HIT_WITH_SHENJI(16,1),
        {
            ...
            ARGS = {
                ...
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {effect_id = "pf_ssptanghao03_attack11_1_1", is_hit_effect = false},--从右向左抡
                }, 
            },
        },
        ----------------------
