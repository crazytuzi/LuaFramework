local hl_qingyufenghuang_chuancheng2 = 
{
                    ...
                    {
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                },
                                {
                                    ...
                                    OPTIONS = {buff_id = {"hl_qingyufenghuang_chuancheng_hot_trigger_2"}},
                                },
                            },
                        },
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = {"hl_qingyufenghuang_chuancheng_hot_remove_2"}},
                                },
                            },
                        },
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = {"hl_qingyufenghuang_chuancheng_hot_2_remove"}},
                                },
                            },
                        },
                        {
...
return hl_qingyufenghuang_chuancheng2