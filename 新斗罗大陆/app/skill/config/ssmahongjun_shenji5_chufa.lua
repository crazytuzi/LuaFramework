...
local ssmahongjun_shenji5_chufa = 
{
                            ...
                            ARGS = {
                                {
                                    ...
                                    OPTIONS = {buff_id = "ssmahongjun_zhuoshao", base_percent = 0.02, coefficient = 0.03},
                                },
                                {
                                    CLASS = "action.QSBRemoveBuff",
                                    OPTIONS = {buff_id = "ssmahongjun_zhuoshao", is_target = true, remove_all_same_buff_id = true},
                                },
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = "ssmahongjun_shenji_dot", is_target = true},
                                },
                            },
                        },
                        {
...
return ssmahongjun_shenji5_chufa
