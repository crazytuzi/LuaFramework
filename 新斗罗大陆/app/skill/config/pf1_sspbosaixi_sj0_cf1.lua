                            ...
                            {
                                {
                                    ...
                                    OPTIONS = {is_target = false, buff_id = "pf1_sspbosaixi_sj0_jt1",no_cancel = true},
                                },
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = false, buff_id = "pf1_sspbosaixi_sj0_jt2", no_cancel = true},
                                },
                            },
                        },
                        {
        ...
        },
        {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    apply_buffIds ={"pf1_sspbosaixi_sj0_debuff1","pf1_sspbosaixi_sj_jiance","pf1_sspbosaixi_sj0_debuff2"}},
                },
            },
        },        
        {
