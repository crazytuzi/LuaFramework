        ...
        ARGS = {
            {
                ...
                OPTIONS = {
                    failed_select = 3,
                    {expression = "target:has_buff:pf_sschenxin_dazhao_debuff&self:has_buff:sschenxin_dazhao_lose_count", select = 1},
                                ...
                                ARGS = {
                                    {
                                        ...
                                        ARGS = 
                                        {
                                            ...
                                            },
                                            {
                                                ...
                                                OPTIONS = {damage_scale = _ds, test =1},
                                            },
                                        },
                                    },
                                    {
                                        ...
                                        {
                                            {
                                                ...
                                                OPTIONS = {skill_id = 200574, wait_finish = true},
                                            },
                                            {
                                                CLASS = "action.QSBArgsConditionSelector",
                                                OPTIONS = {
    ...
    ARGS = {
        ...
        },
        {
            ...
            ARGS = {
                ...
                {
                    CLASS = "action.QSBRemoveBuff",
                    OPTIONS = {enemy = false, buff_id = "sschenxin_dazhao_buff"},
                },
                {
                    CLASS = "action.QSBRemoveBuff",
                    OPTIONS = {enemy = true, buff_id = "pf_sschenxin_dazhao_debuff"},
                },
                {
                    CLASS = "action.QSBRemoveBuff",
                    OPTIONS = {enemy = true, buff_id = "sschenxin_dazhao_stun_debuff"},
                },
            },
        },
        {
    ...
    ARGS = {
        ...
        },
        {
            ...
            ARGS = {
                    ...
                    ARGS = {
                        ...
                        --------====
                        {
                            ...
                            ARGS = {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = {"pf_sschenxin_dazhao_debuff","sschenxin_dazhao_stun_debuff",
                        ...
                        ---======
                        {
                            ...
                            ARGS = {
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = true, buff_id = {"pf_sschenxin_dazhao_debuff","sschenxin_dazhao_stun_debuff",
                                    "sschenxin_select_enemy_debuff"}, revertable = true},
                                },
                                {
                                    CLASS = "action.QSBLockTarget",
                ...
                PER_SEC_BIJIAN("pf_sschenxin01_attack11_3_01",1),
                {
                    CLASS = "action.QSBDelayTime",
                    OPTIONS = {delay_time = 0.8},
                },
                PER_SEC_BIJIAN("pf_sschenxin01_attack11_3_02",1.1), 
                {
                    CLASS = "action.QSBDelayTime",
                    OPTIONS = {delay_time = 0.8},
                },
                PER_SEC_BIJIAN("pf_sschenxin01_attack11_3_03",1.2), 
                {
                    CLASS = "action.QSBDelayTime",
                    OPTIONS = {delay_time = 0.8},
                },
                PER_SEC_BIJIAN("pf_sschenxin01_attack11_3_02",1.3), 
                {
                    CLASS = "action.QSBDelayTime",
                    OPTIONS = {delay_time = 0.8},
                },
                    ...
                    ARGS = {
                        PER_SEC_BIJIAN("pf_sschenxin01_attack11_3_01",1), 
                        {
                            ...
                            ARGS = {
                                ...
                                PER_SEC_BIJIAN("pf_sschenxin01_attack11_3_02",1), 
                            },
                        },
                        {
                            CLASS = "composite.QSBSequence",
                            ARGS = {
                                ...
                                PER_SEC_BIJIAN("pf_sschenxin01_attack11_3_03",1), 
                            },
                        },
                    },
                }, 
