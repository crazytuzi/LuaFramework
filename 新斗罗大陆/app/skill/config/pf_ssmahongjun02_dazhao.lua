...
local ssmahongjun_dazhao = {
    ...
    ARGS = {
        ...
        },
        {
            ...
            OPTIONS = {sound_id ="pf_ssmahongjun01_skill"},
        },
        {
        ...
        },
        {
            ...
            ARGS = {
                {
                    CLASS = "action.QSBDelayTime",
                    OPTIONS = {delay_frame = 0},--跳过黑屏卡帧
                },
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {effect_id = "pf_ssmahongjun_attack11_2", is_hit_effect = false},
                },
            },
        },
        {
            ...
            ARGS = {
                ...
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {effect_id = "pf_ssmahongjun_attack11_3", is_hit_effect = false},
                },
            },
        },
        {
                            ...
                            ARGS = {
                                ...
                                },
                                {
                                    ...
                                    OPTIONS = {
                                        ...
                                        effect_id = "pf_ssmahongjun_attack11_1", speed = 1800, rail_number = 4, rail_delay = 0.07, length_threshold = 0,
                                ...
                                },
                                {
                                    ...
                                    OPTIONS = {
                                        ...
                                        effect_id = "pf_ssmahongjun_attack11_1", speed = 1800, rail_number = 2, rail_delay = 0.07, length_threshold = 0,
                                        hit_effect_id = "ssmahongjun_attack11_4", is_bezier = true, bullet_delay = 0.07, follow_target_pos = true,
                                        set_points = { 
                        ...
                        },
                        {
                            ...
                            ARGS = {
                                ...
                                },
                                {
                                    ...
                                    OPTIONS = {
                                        start_pos = {x = 125,y = 350},
                                        effect_id = "pf_ssmahongjun_attack11_1", speed = 1800, rail_number = 4, rail_delay = 0.07, 
                                ...
                                },
                                {
                                    ...
                                    OPTIONS = {
                                        start_pos = {x = -35,y = 125},
                                        effect_id = "pf_ssmahongjun_attack11_1", speed = 1800, rail_number = 2, rail_delay = 0.07, 
                                        hit_effect_id = "ssmahongjun_attack11_4" 
                                    },
                                },
                                {
