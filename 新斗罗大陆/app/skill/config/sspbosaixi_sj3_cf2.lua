            ...
            {                
                {
                    ...
                    OPTIONS = {is_target = false, buff_id = "sspbosaixi_sj3_debuff1"},
                },
                {
                    CLASS = "action.QSBApplyBuff",
                    OPTIONS = {is_target = false, buff_id = "sspbosaixi_sj3_debuff2"},
                },
                {
                            ...
                            {
                                {
                                    ...
                                    OPTIONS = {is_max_hp_percent = true, current_hp_percent = true, hp_percent = 0.15},
                                },
                                {
                                    CLASS = "action.QSBDecreaseHpByTargetProp", --造成自身攻击力30%伤害
                                    OPTIONS = {attack_percent = 5},
                                },
                            },
                        },
                    },
