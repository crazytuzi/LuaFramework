                    ...
                    ARGS = 
                    {
                        ...
                        },
                        {
                            ...
                            ARGS =
                            {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = true, buff_id = "boss_chaoxuemuzhu_chanrao1"},
                                }, 
                                {
                                    CLASS = "action.QSBApplyBuff",
                ...
                -- },
                {
                    ...
                    ARGS = 
                    {
...

                        {
                            ...
                            OPTIONS = {actor_id = 4186, life_span = 21,number = 1, relative_pos = {x = 0, y = -50}, appear_skill = 50897 , enablehp = true,hp_percent = 0.02,no_fog = false,is_attacked_ghost = true},
                        },
