local ssqianshitangsan_pugong1 = 
{
    ...
    {               
        ...
        },
        {
            ...
            OPTIONS = {buff_id = "pf_ssayin02_sj3_jt1",is_target = false},
        }, 
        {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    OPTIONS = {buff_id = "pf_ssayin02_sj3_buff1",pass_key = {"selectTarget"}},
                },
                {
                    CLASS = "action.QSBApplyBuff",
                ...
                {
                    CLASS = "action.QSBApplyBuff",
                    OPTIONS = {buff_id = "pf_ssayin02_sj3_jt3",pass_key = {"selectTarget"}},
                },
                {
                    CLASS = "action.QSBApplyBuff",
                ...
                },
                {
                    ...
                    OPTIONS = {type = "value",value = 150,pass_key = {"selectTarget"}},
                }, 
                 {
                    CLASS = "action.QSBDelayTime",
                    OPTIONS = {delay_time = 1.5 ,pass_key = {"selectTarget"}},
        ...
        },
        {
            ...
            ARGS = 
            {
                ...
                {
                    CLASS = "action.QSBDelayTime",
                    OPTIONS = {delay_time = 2 ,pass_key = {"selectTarget"}},
                },
                {
                    CLASS = "action.QSBAddRage",
