	local anqi_kongjuzhiyan_shanghai6 ={
	    ...
	    ARGS = { 
				...
				},
				{
					...
					OPTIONS = {buff_id = "anqi_kongjuzhiyan_kaiju_jianshang4"},
				},
				{
					CLASS = "action.QSBDelayTime",
				...
				{
					CLASS = "action.QSBRemoveBuff",	
					OPTIONS = {buff_id = "anqi_kongjuzhiyan_jianshang4_1"},
				},
				{
					CLASS = "action.QSBRemoveBuff",	
					OPTIONS = {buff_id = "anqi_kongjuzhiyan_jianshang4_2"},
				},
				{
					CLASS = "action.QSBRemoveBuff",	
					OPTIONS = {buff_id = "anqi_kongjuzhiyan_jianshang4_3"},
				},
				{
					CLASS = "action.QSBRemoveBuff",	
					OPTIONS = {buff_id = "anqi_kongjuzhiyan_jianshang4_4"},
				},
				{
					...
					{       
						-- {
                            ...
                            -- ARGS = {
								-- {
									-- CLASS = "action.QSBApplyBuff",
									-- OPTIONS = {buff_id = "anqi_kongjuzhiyan_jianshang4_0"},
								-- },	
							-- },
						-- },
						{
