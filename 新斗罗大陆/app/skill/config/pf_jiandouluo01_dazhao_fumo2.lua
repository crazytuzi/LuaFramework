...
local chenxin_dazhao_fumo2 = {
    CLASS = "composite.QSBParallel",
    ARGS = {
		{
            CLASS = "action.QSBPlaySound",
            OPTIONS = {sound_id ="pf_jiandouluo01_skill",sound_delay = 0},
        },
		{
            ...
            ARGS = {
				{
                    ...
                    ARGS = {
						...
						},
						{
							...
							OPTIONS = {is_hit_effect = true, effect_id = "pf_jiandouluo01_attack11_3"},
						}, 	
						{
						...
						{
							CLASS = "action.QSBApplyBuff",
							OPTIONS = {buff_id = "fumo_pf_jiandouluo01_buff_2"}
						},
                    },
                },			
				{
