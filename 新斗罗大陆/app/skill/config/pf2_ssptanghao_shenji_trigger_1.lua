...
local ssptanghao_shenji_trigger_1 = {
    ...
    ARGS = {
            ...
            ARGS = {
                 {
                    ...
                    OPTIONS = {buff_id = "ssptanghao_shenji_debuff1_1", is_target = true},
                },
                {
                    CLASS = "action.QSBDecreaseAbsorbByProp",
                    OPTIONS = {max_hp_percent  = 1,attacker_current_hp_percent_limit = 0.12},
                }, 
                {
                    CLASS = "action.QSBActorStatus",
                    OPTIONS = 
                    {
                        { "target:is_pvp==false","target:decrease_hp:self:hp*9.2"},
                        -- { "target:is_pvp==false","target:decrease_hp:self:maxAttack*20"},
                        { "target:is_pvp==true","target:decrease_hp:self:hp*0.12"},
                    }
                },  
                {
                    CLASS = "composite.QSBSequence",
...

        {
            ...
            OPTIONS = {
                ...
                {expression = "self:max_hp*0.20>target:hp", select = 1},
            }
        },
        {
            CLASS = "composite.QSBSelector",
            ARGS = {
                {
                    ...
                    ARGS = {
                        ...
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = "pf2_ssptanghao_shenji_debuff_1", is_target = true},
                        },
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {buff_id = "pf2_ssptanghao_shenji_buff", is_target = false},
                        },
                    },
                },
                {
...
return ssptanghao_shenji_trigger_1
