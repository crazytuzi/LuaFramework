    ...
    {
        {
            ...
            OPTIONS = 
            {
                ...
                shelter_coefficient = 0.4, --庇护产生护盾相当于期间受到的伤害系数
                ...
                near_death_coefficient = 2.5, --濒死护盾吸收系数
                trigger_damage_count = 2,--每几次产生一个会爆炸的护盾
                shelter_damage_coefficient = 2.5,--爆炸护盾伤害系数，取决于吸收量
                shelter_damage_effect_id = "sq_hstz_attack2_1", --爆炸特效
                shelter_damage_effect_id2 = "sq_hstz_attack2_2", --爆炸特效
                debuff_id = "sq_haishentaozhuang_gongsu_debuff2", --被地方普攻给予地方的debuff
            },
        },
        {
            CLASS = "action.QSBRemoveBuff",
            OPTIONS = {is_target = true, buff_id = "sq_haishentaozhuang_bihu5_buff"},
        },
    },
