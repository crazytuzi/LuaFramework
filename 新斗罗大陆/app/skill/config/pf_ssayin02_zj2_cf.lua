    ...
    {
        {
            ...
            OPTIONS = {buff_id = "pf_ssayin02_zj2_cfbuff1", is_target = false},
        },
        {
            CLASS = "action.QSBApplyBuff",
                    ...
                    ARGS = 
                    {
                        ...
                        },
                        {
                            ...
                            ARGS = 
                            {
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {buff_id = "pf_ssayin02_zj2_jt", is_target = false},
                                },
                                {
                                    CLASS = "action.QSBAttackFinish",
                                },
        ...
        },
        {
            ...
            ARGS = {
                ...
                },
                {
                    ...
                    OPTIONS = {effect_id = "pf_ssayin02_lianjie", dummy = "dummy_center", duration = 7, effect_width = 298},
                },
            },
        },
        {
