                ...
                },
                {
                    ...
                    ARGS = {
                        ...
                        },
						{
							...
							OPTIONS = {skill_id = 35058, target_type = "skill_target", wait_finish = true},
						},
						{
							CLASS = "action.QSBAttackByBuffNum",
							OPTIONS = { buff_id = "hl_tianlongma_pugong_debuff",num_pre_stack_count = 1,attackMaxNum = 4, trigger_skill_id = 35073,target_type = "enemy" }
						},
                    },
                },
				{
