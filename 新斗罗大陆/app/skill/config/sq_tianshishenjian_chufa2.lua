...
local anqi_hongchenbiyou_baohu1 = 
{
    ...
    ARGS = 
    {
                    ...
                    {
                        {
                            ...
                            OPTIONS = 
                            {
                                ...
                                damage_percent = "4.5;9", --攻击力最高的魂师施放伤害等同于当前攻击力的百分比（PVP/PVE）
                                convert_treat_percent = 0, --根据造成伤害恢复的生命值百分比
                                change_rage_value = -150, --降低的敌方全体怒气
                        ...
                        },
                        {
                            ...
                            OPTIONS = 
                            {
                                ...
                                right_effect2_pos = {x=900,y=340},
                                right_effect3_pos = {x=640,y=340},
                                damage_percent = "4.5;27", --攻击力最高的魂师施放伤害等同于当前攻击力的百分比（PVP/PVE）
                                convert_treat_percent = 0, --根据造成伤害恢复的生命值百分比
                                change_rage_value = -150, --降低的敌方全体怒气
                                rage_increase_coefficient_final_value = -0--降低怒气最高的魂师的怒气获取
                            },
        ...
        },
        {
            ...
            OPTIONS = { buff_id = "sq_tianshishenjian_chufa2_buff"},
        },
    },
}
