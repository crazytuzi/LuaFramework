local pf_tangchen_zhenji_zidong1 = {
     ...
     ARGS = {
        ...
        },
        {
            ...
            OPTIONS = {buff_id = "tangchen_zhenji_huifu", is_target = false},
        },
        {
                ...
                },
                {
                    ...
                    ARGS = {
                        ...
                        },
                        {
                            ...
                            OPTIONS = {effect_id = "pl_tangcheng_attack13_1", is_hit_effect = false},
                        },
                    },
                },
                {
...
return pf_tangchen_zhenji_zidong1