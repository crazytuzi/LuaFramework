...
local pf_ssniutian02_shenji1_trigger_2 = {
    CLASS = "composite.QSBSequence",
    ARGS = {
		{
			CLASS = "action.QSBClearBuffSaveValue",
			OPTIONS = {buff_id = "pf_sstianqingniumang02_shenji1_buff_2", is_save_treat = true},
		},
		{
		...
		},
        {
			...
			OPTIONS = {buff_id = "", hp_percent = 0.4, absorb_buff_id = "pf_sstianqingniumang02_shenji1_shield_buff_2", just_hero = true,single_max_percent = 0.5},
		},
        {
...
return pf_ssniutian02_shenji1_trigger_2