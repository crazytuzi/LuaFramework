            ...
            {
                {
					...
					OPTIONS = {effect_id = "pf02_sspbosaixi_attack13_1", is_hit_effect = false},
				},
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {effect_id = "pf02_sspbosaixi_attack13_2", is_hit_effect = false},
                },
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {effect_id = "pf02_sspbosaixi_attack13_3", is_hit_effect = false},
                },
            },
        },
        {
            ...
            ARGS = 
            {
                ...
                {
                    CLASS = "action.QSBPlayEffect",
                    OPTIONS = {effect_id = "pf02_sspbosaixi_attack13_4", is_hit_effect = false},
                },
                -- {
                --     CLASS = "action.QSBDelayTime",
