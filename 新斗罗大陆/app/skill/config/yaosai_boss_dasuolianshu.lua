                            ...
                            ARGS = {
                                {
                                    ...
                                    OPTIONS = {effect_id = "suolian_1", pos  = {x = 640 , y = 340}},
                                },
                                {
                                    CLASS = "action.QSBDelayTime",
                                ...
                                {
                                    CLASS = "action.QSBPlaySceneEffect",
                                    OPTIONS = {effect_id = "suolian_1", pos  = {x = 440 , y = 440}},
                                },
                                {
                                    CLASS = "action.QSBDelayTime",
                                    OPTIONS = {delay_time = 0.15},
                                ...
                                {
                                    CLASS = "action.QSBPlaySceneEffect",
                                    OPTIONS = {effect_id = "suolian_1", pos  = {x = 360 , y = 150}},
                                },
                                {
                                    CLASS = "action.QSBDelayTime",
                                    OPTIONS = {delay_time = 0.15},
                                ...
                                {
                                    CLASS = "action.QSBPlaySceneEffect",
                                    OPTIONS = {effect_id = "suolian_1", pos  = {x = 860 , y = 240}},
                                },
                            },
                        },
                        {
