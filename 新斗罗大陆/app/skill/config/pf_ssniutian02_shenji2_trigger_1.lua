...
local pf_ssniutian02_shenji2_trigger_1 = {
    ...
    ARGS = {
		...
		},
		{
			...
			OPTIONS = {buff_id = "",  is_max_hp_percent = true, coefficient = 0.2, single_max_percent = 0.5},
		},
        {
...
return pf_ssniutian02_shenji2_trigger_1