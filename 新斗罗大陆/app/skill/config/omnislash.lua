    ...
    ARGS = 
    {
        ...
        -- },
        {
            ...
            ARGS = 
            {
                {
                    CLASS = "action.QSBShuttle",
                    OPTIONS = {rotation = -rotation, effect_id = "weilitaen_chop_1_1", cancel_if_not_found = true, original_target = true, 
                            in_range = true, is_flip_x = true, revertable = true},
                },
                {
                    CLASS = "composite.QSBSequence",
                    ARGS = 
        ...
        },
        {
            ...
            ARGS = 
            {
                {
                    CLASS = "action.QSBShuttle",
                    OPTIONS = {rotation = rotation, effect_id = "weilitaen_chop_1_1", cancel_if_not_found = true,
                            in_range = true, is_flip_x = true, revertable = true, always = true},
                },
                {
                    CLASS = "composite.QSBSequence",
                    ARGS = 
        ...
        },
        {
            ...
            ARGS = 
            {
                {
                    CLASS = "action.QSBShuttle",
                    OPTIONS = {rotation = 0, effect_id = "weilitaen_chop_1_1", cancel_if_not_found = true,
                            in_range = true, is_flip_x = true, revertable = true, always = true, last_one = false},
                },
                {
                    CLASS = "composite.QSBSequence",
                    ARGS = 
