...
local xunlian_terminal_gaishilongshe_tiaozadi = {
		...
		},
		{
			...
			ARGS = 
			{
                ...
                },
                {
					...
					OPTIONS = {is_target = true, buff_id = "gaishilongshe_biaoji", pass_key = {"pos"}},
				},
				{
...
return xunlian_terminal_gaishilongshe_tiaozadi
