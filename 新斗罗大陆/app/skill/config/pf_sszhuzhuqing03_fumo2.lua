                                                    ...
                                                    ARGS = 
                                                    {
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            ARGS = 
                                                            {
                                                                ...
                                                                {
                                                                    CLASS = "action.QSBPlayEffect",
                                                                    OPTIONS = {effect_id = "pf_sszzq03_sj_cf5" ,is_hit_effect = false},
                                                                },
                                                                {
                                                                ...
                                                                },
                                                                {
                                                                    ...
                                                                    ARGS = 
                                                                    {
                                                                        ...
                                                                        {
                                                                            CLASS = "action.QSBApplyBuff",
                                                                            OPTIONS = {is_target = true, buff_id = "dazhao_fumo_debuff1_2"},
                                                                        },                                                                        
                                                                    },
                                                                },
                                                            },
                                                                    ...
                                                                    {   
                                                                        {
                                                                            ...
                                                                            ARGS = 
                                                                            {
                                                                                {
                                                                                    CLASS = "action.QSBPlayEffect",
                                                                                    OPTIONS = {effect_id = "pf_sszzq03_dz_1_l" ,is_hit_effect = false},
                                                                                },
                                                                            },
                                                                        },
                                                                        {
                                                                            ...
                                                                            ARGS = 
                                                                            {
                                                                                {
                                                                                    CLASS = "action.QSBPlayEffect",
                                                                                    OPTIONS = {effect_id = "pf_sszzq03_dz_1_r" ,is_hit_effect = false },
                                                                                },
                                                                            },
                                                                        },
                                                                    },
                                                    ...
                                                    ARGS = 
                                                    {
                                                        ...
                                                        },                                                        
                                                        {
                                                            ...
                                                            { 
                                                                {
                                                                    CLASS = "action.QSBPlayEffect",
                                                                    OPTIONS = {is_hit_effect = true, effect_id = "pf_sszzq03_dz_2"},
                                                                }, 
                                                                {
                                                                    CLASS = "composite.QSBSequence",
                                                                    ARGS = {
                                                                        {
                                                                            ...
                                                                            {
                                                                                failed_select = 1,
                                                                                {expression = "target:buff_num:pf_sszhuzhuqing03_sj1_youmming=0", select = 1},
                                                                                {expression = "target:buff_num:pf_sszhuzhuqing03_sj1_youmming=1", select = 2},
                                                                                {expression = "target:buff_num:pf_sszhuzhuqing03_sj1_youmming=2", select = 3},
                                                                                {expression = "target:buff_num:pf_sszhuzhuqing03_sj1_youmming=3", select = 4},
                                                                                {expression = "target:buff_num:pf_sszhuzhuqing03_sj1_youmming=4", select = 5},
                                                                                {expression = "target:buff_num:pf_sszhuzhuqing03_sj1_youmming=5", select = 6},
                                                                            }
                                                                        },
                                                                        {
                                                                            CLASS = "composite.QSBSelector",
                                                                            ...
                                                                            {   
                                                                                {
                                                                                    ...
                                                                                    ARGS = 
                                                                                    {
                                                                                        {
                                                                                            CLASS = "action.QSBPlayEffect",
                                                                                            OPTIONS = {effect_id = "pf_sszzq03_dz_3_r" ,is_hit_effect = false},
                                                                                        },
                                                                                    },
                                                                                },
                                                                                {
                                                                                    ...
                                                                                    ARGS = 
                                                                                    {
                                                                                        {
                                                                                            CLASS = "action.QSBPlayEffect",
                                                                                            OPTIONS = {effect_id = "pf_sszzq03_dz_3_l" ,is_hit_effect = false },
                                                                                        },
                                                                                    },
                                                                                },
                                                                            },
