                        ...
                        },
                        {
                            ...
                            ARGS = 
                            {
                                ...
                                },
                                {
                                    ...
                                    OPTIONS = {interval_time = 0.1, attacker_face = false,attacker_underfoot = true,count = 1, distance = 0, trapId = "jixiezhizhu_dianjiang2"},
                                },
                            },
                        },
                        {
                                    ...
                                    {
                                        {
                                            ...
                                            OPTIONS = { pos = {x=1150,y=435} , move_time = 15 / 24},
                                        },
                                        {
                                            CLASS = "composite.QSBSequence",
                                            ARGS = 
