                                                                            ...
                                                                            {
                                                                                {
                                                                                    ...
                                                                                    OPTIONS = {effect_id = "zzq_yypf_attack11_1_1" ,is_hit_effect = true},
                                                                                },
                                                                                {
                                                                                    CLASS = "action.QSBPlayEffect",
                                                                                    OPTIONS = {effect_id = "zzq_yypf_attack11_1_2" ,is_hit_effect = true},
                                                                                },
                                                                            },
                                                                        },
                                                                        {
                                                                    ...
                                                                    ARGS = {
                                                                        {
                                                                            ...
                                                                            {
                                                                                failed_select = 1,
                                                                                {expression = "target:buff_num:pf_sszhuzhuqing02_sj1_youmming=0", select = 1},
                                                                                {expression = "target:buff_num:pf_sszhuzhuqing02_sj1_youmming=1", select = 2},
                                                                                {expression = "target:buff_num:pf_sszhuzhuqing02_sj1_youmming=2", select = 3},
                                                                                {expression = "target:buff_num:pf_sszhuzhuqing02_sj1_youmming=3", select = 4},
                                                                                {expression = "target:buff_num:pf_sszhuzhuqing02_sj1_youmming=4", select = 5},
                                                                                {expression = "target:buff_num:pf_sszhuzhuqing02_sj1_youmming=5", select = 6},
                                                                            }
                                                                        },
                                                                        {
                                                                            CLASS = "composite.QSBSelector",
                                                        ...
                                                        },                                                        
                                                        {
                                                            ...
                                                            { 
                                                                ...
                                                                -- },                                                                
                                                                {
                                                                    ...
                                                                    OPTIONS = {amplitude = 4, duration = 0.35, count = 4,},
                                                                },
                                                                {
                                                                    CLASS = "composite.QSBSequence",
                                                                    ARGS = {
