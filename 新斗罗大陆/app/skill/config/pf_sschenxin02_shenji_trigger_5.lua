                    ...
                    ARGS = {
                        {
                            ...
                            ARGS = {
                                ...
                                {
                                    CLASS = "action.QSBApplyBuff",
                                    OPTIONS = {is_target = false, buff_id = "pf_sschenxin02_shenji_buff1"},
                                },
                            },
                        },
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {is_target = false, buff_id = "pf_sschenxin02_shenji_buff2"},
                        },
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {is_target = false, buff_id = "pf_sschenxin02_shenji_buff3"},
                        },
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {is_target = false, buff_id = "pf_sschenxin02_shenji_buff4"},
                        },
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {is_target = false, buff_id = "pf_sschenxin02_shenji_buff5"},
                        },
                        {
                            CLASS = "action.QSBApplyBuff",
                            OPTIONS = {is_target = false, buff_id = "pf_sschenxin02_shenji_buff6"},
                        },
                        {
                            CLASS = "composite.QSBSequence",
                            ARGS = {
