local npc_chaoxuezhuhou_ai = {
    ...
    { 
        ...
        --         {
        --             CLASS = "action.QAITimer",
        --             OPTIONS = {interval = 1000,first_interval=5},
        --         },
        --         {
        --             CLASS = "action.QAIUseSkill",
        ...
        -- },
        {
            ...
            ARGS = 
            {
                ...
                {
                    CLASS = "action.QAITimer",
                    OPTIONS = {interval = 1000,first_interval=24},
                },
                {
                    CLASS = "action.QAIAttackByRole",
                    OPTIONS = {role = "dps"},
...

        {
            ...
            ARGS = 
            {
                {
                    CLASS = "action.QAITimer",
                    OPTIONS = {interval = 1000,first_interval=20},
                },
                {
                    CLASS = "action.QAIUseSkill",
            ...
            {
                {
                    ...
                    OPTIONS = {hp_less_then = {0.30},only_trigger_once = true},
                },
                {
                    CLASS = "action.QAIUseSkill",
