    ...
    ARGS = 
    {
        ...
        },
        {
            ...
            ARGS = 
            {
                ...
                {
                    CLASS = "action.QAIUseSkill",
                    OPTIONS = {skill_id = 51160},  -- 召唤破盾三叉戟
                },
            },
        },
        {
            ...
            ARGS = 
            {
                ...
                {
                    CLASS = "action.QAIUseSkill",
                    OPTIONS = {skill_id = 51161},  -- 召唤破盾三叉戟
                },
            },
        },
        {
            ...
            ARGS = 
            {
                ...
                {
                    CLASS = "action.QAIUseSkill",
                    OPTIONS = {skill_id = 51162},  -- 召唤破盾三叉戟
                },
            },
        },
        {
