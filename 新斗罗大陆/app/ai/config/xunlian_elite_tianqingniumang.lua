    ...
    ARGS = 
    {
		...
		},
		{
			...
			ARGS = 
			{
				...
				{
					CLASS = "action.QAIIsUsingSkill",
					OPTIONS = {reverse_result = true , check_skill_id = 53171},
				}, 
				{
					CLASS = "action.QAIAttackEnemyOutOfDistance",
					OPTIONS = {distance = 3},
