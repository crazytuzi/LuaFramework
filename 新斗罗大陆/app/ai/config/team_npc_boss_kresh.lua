       ...
       -------------------   阶段二血量降低到50%的技能  -----------------------------------
        ...
        },
        {
            ...
            ARGS = 
            {
                {
                    CLASS = "action.QAIHPLost",
                    OPTIONS = {hp_less_then = {0.75},only_trigger_once = false},        -- 多少血量一下触发一次,only_trigger_once是否重复触发
                },
                -- {
                --     CLASS = "action.QAIAttackEnemyOutOfDistance",       --选择一个多少距离之外的目标执行某个行为
       ...
       
	   {
		...
		
		{
            ...
            ARGS = 
            {
                {
                    CLASS = "action.QAIHPLost",
                    OPTIONS = {hp_less_then = {0.25},only_trigger_once = false},        -- 多少血量一下触发一次,only_trigger_once是否重复触发
                },
                -- {
                --     CLASS = "action.QAIAttackEnemyOutOfDistance",       --选择一个多少距离之外的目标执行某个行为
                --     OPTIONS = {current_target_excluded = true},         --current_target_excluded：当前目标排除在外
