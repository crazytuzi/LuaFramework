        ...
        },
        {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    OPTIONS = {skill_id = 50587},          --检查是否使用能量倾泻
                },
                {
                    CLASS = "action.QAIUseSkill",
                    OPTIONS = {skill_id = 50586},          --推波
                },
            },
        },
        {
