			...
			ARGS =
			{
				...
				},
				{
					...
					ARGS = 
					{
						{
							CLASS = "action.QAITimer",
							OPTIONS = {interval = 300,first_interval=40},
						},
						{
							CLASS = "action.QAIAttackClosestEnemy",
							OPTIONS = {always = true},
				...
				},
				{
					...
					ARGS = 
					{
						{
							CLASS = "action.QAITimer",
							OPTIONS = {interval = 300,first_interval=65},
						},
						{
							CLASS = "action.QAIAttackClosestEnemy",
							OPTIONS = {always = true},
