    ...
    { 
        ...
        },
        {
            ...
            ARGS = 
            {
                {
                    CLASS = "action.QAITimer",
                    OPTIONS = {interval = 500,first_interval=24},
                },
                {
        ...
        },
        {
            ...
            ARGS = 
            {
                {
                    CLASS = "action.QAITimer",
                    OPTIONS = {interval = 500,first_interval=48},
                },
                {
                    CLASS = "action.QAIUseSkill",
