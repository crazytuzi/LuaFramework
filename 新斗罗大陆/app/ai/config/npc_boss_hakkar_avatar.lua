    ...
    ARGS =
	{
        ...
        },
        {
            ...
            ARGS = 
            {
                {
                    CLASS = "action.QAITimer",
                    OPTIONS = {interval = 35,first_interval=8},
                },
                {
        ...
        },
        {
            ...
            ARGS = 
            {
                {
                    CLASS = "action.QAITimer",
                    OPTIONS = {interval = 60,first_interval=15},
                },
                {
                    CLASS = "action.QAIAttackAnyEnemy",
                    OPTIONS = {always = true},
        ...
        },
        {
            ...
            ARGS = 
            {
                {
                    CLASS = "action.QAITimer",
                    OPTIONS = {interval = 35,first_interval=23},
                },
                {
                    CLASS = "action.QAIUseSkill",
