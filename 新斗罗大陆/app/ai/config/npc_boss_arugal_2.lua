        ...
        },
        {
            ...
            ARGS = 
            {
                ...
                },
                {
                    ...
                    OPTIONS = {check_skill_id = 101401, reverse_result = true}--------------------变羊
                },
                {
                    CLASS = "action.QAIUseSkill",
                    OPTIONS = {skill_id = 200702},----------------------------------------------暗影箭
                },
            },
        },
        {
