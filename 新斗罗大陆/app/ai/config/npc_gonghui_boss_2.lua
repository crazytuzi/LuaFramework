                    ...
                    {
                        {
                            ...
                            ARGS = 
                            {
                                {
                                    CLASS = "action.QAITimer",
                                    OPTIONS = {interval = 14, first_interval=64},
                                },
                                {
                                    CLASS = "action.QAIAttackAnyEnemy",
                                    OPTIONS = {always = true},
                        ...
                        },
                        {
                            ...
                            ARGS = 
                            {
                                {
                                    CLASS = "action.QAITimer",
                                    OPTIONS = {interval = 7, first_interval=66},
                                },
                                {
                                    CLASS = "action.QAIAttackAnyEnemy",
                                    OPTIONS = {always = true},
                        ...
                        },
                        {
                            ...
                            ARGS = 
                            {
                                {
                                    CLASS = "action.QAITimer",
                                    OPTIONS = {interval = 11, first_interval=68},
                                },
                                {
                                    CLASS = "action.QAIAttackByHitlog",
                                    OPTIONS = {always = true},
                    ...
                    {
                        {
                            ...
                            ARGS = 
                            {
                                {
                                    CLASS = "action.QAITimer",
                                    OPTIONS = {interval = 13, first_interval=95},
                                },
                                {
                                    CLASS = "action.QAIAttackAnyEnemy",
                                    OPTIONS = {always = true},
                        ...
                        },
                        {
                            ...
                            ARGS = 
                            {
                                {
                                    CLASS = "action.QAITimer",
                                    OPTIONS = {interval = 5, first_interval=92},
                                },
                                {
                                    CLASS = "action.QAIAttackAnyEnemy",
                                    OPTIONS = {always = true},
                        ...
                        },
                        {
                            ...
                            ARGS = 
                            {
                                {
                                    CLASS = "action.QAITimer",
                                    OPTIONS = {interval = 15, first_interval=99},
                                },
                                {
                                    CLASS = "action.QAIAttackByHitlog",
                                    OPTIONS = {always = true},
