...
AgentAdapter = {
    ...
    login_verify_url = "bg02xyapi.988973.com/agent/xy/login_verify.php",
    pay_verify_url = "bg02xyapi.988973.com/agent/xy/pay_verify.php",
	uid = "",
	token = "",
}
...
-- function AgentAdapter:GetLoadingbgName()
-- 	return string.format("agentres/loading_bg.jpg")
-- end
