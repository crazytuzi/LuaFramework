...
AgentAdapter = {
    ...
    login_verify_url = "http://tlzjapi.6pmgame.com/agent/yiyou/login_verify.php",
    pay_verify_url = "http://tlzjapi.6pmgame.com/agent/yiyou/pay_verify.php",
	uid = "",
	token = "",
}
...
function AgentAdapter:Pay(role_id, role_name, amount, server_id, callback)--购买
	...
	param_obj.goods_desc = "购买后，可获得"..amount*rate.."元宝"
