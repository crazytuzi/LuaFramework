...
drops=
{
	{ type = 6, id = 0, count = 2000, propability = 25000, group = 1 },
	{ type = 6, id = 0, count = 20000, propability = 3000, group = 1 },
	{ type = 20, id = 3, count = 100, propability = 18000, group = 1 },
	{ type = 20, id = 3, count = 150, propability = 4000, group = 1 },
	{ type = 0, id = 276, count = 1, propability = 30, group = 1,broadcast =true },
	{ type = 0, id = 277, count = 1, propability = 3000, group = 1 },
	{ type = 0, id = 278, count = 1, propability = 80, group = 1,broadcast =true },
	{ type = 0, id = 279, count = 1, propability = 30, group = 1,broadcast =true },
	{ type = 0, id = 531, count = 1, propability = 2000, group = 1 },
	{ type = 0, id = 665, count = 1, propability = 10, group = 1,broadcast =true },
	{ type = 0, id = 280, count = 1, propability = 33, group = 1,broadcast =true },
