return {
{
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=1,id=594, rate=-1000, rateType=2, delay=400},
						{mj=0,timeParam=1,type=1,id=595, rate=-1000, rateType=2, delay=400},
						{mj=0,timeParam=60,type=1,id=596, rate=-200, rateType=2, delay=400},
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=1,id=594, rate=-1000, rateType=2, delay=400},
						{mj=0,timeParam=1,type=1,id=595, rate=-1000, rateType=2, delay=400},
						{mj=0,timeParam=10,type=1,id=596, rate=-200, rateType=2, delay=400},
					},
					specialEffects=
					{
					},
	...
	trainConds=
	{
		...
		{cond = 3, value = 2546, consume = true},
	},
	spellConds=
	{
