			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=1,id=35, rate=-1200, rateType=2, delay=400},
						{mj=0,timeParam=1,type=1,id=36, rate=-1200, rateType=2, delay=400},
						{mj=0,timeParam=40,type=1,id=34, rate=-220, rateType=2, delay=400},
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=1,id=35, rate=-1200, rateType=2, delay=400},
						{mj=0,timeParam=1,type=1,id=36, rate=-1200, rateType=2, delay=400},
						{mj=0,timeParam=10,type=1,id=34, rate=-220, rateType=2, delay=400},
					},
					specialEffects=
					{
					},
