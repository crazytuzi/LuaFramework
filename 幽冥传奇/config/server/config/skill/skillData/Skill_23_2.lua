			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=1,id=32, rate=-1100, rateType=2, delay=400},
						{mj=0,timeParam=1,type=1,id=33, rate=-1100, rateType=2, delay=400},
						{mj=0,timeParam=40,type=1,id=31, rate=-210, rateType=2, delay=400},
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=1,id=32, rate=-1100, rateType=2, delay=400},
						{mj=0,timeParam=1,type=1,id=33, rate=-1100, rateType=2, delay=400},
						{mj=0,timeParam=10,type=1,id=31, rate=-210, rateType=2, delay=400},
					},
					specialEffects=
					{
					},
