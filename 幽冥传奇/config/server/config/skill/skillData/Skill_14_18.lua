			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=0,interval=70000,type=35,delay=0,rate=64000,value=10800,id=5},
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=0,interval=70000,type=35,delay=0,rate=6400,value=10800,id=5},
					},
					specialEffects=
					{
							{type=4,mj=0,id=5,keepTime=1500,delay=200,always=false},
