return {
{
		...
		acts=
            ...
            acts = {
                ...
                },
                {
                    ...
                    { mj = 0, timeParam = 1, type = 1, id = 847, rate = -5000, rateType = 0, delay = 100 },
                    },
                    specialEffects={
                    },
                },
            ...
            acts = {
                {
                    ...
                    { mj = 0, timeParam = 1, type = 1, id = 796, rate = 0, rateType = 0, delay = 300 },
                    },
                    specialEffects={    },
                },
                {
	...
	trainConds=
	{
		{cond=1,value= 1230,consume=true},
