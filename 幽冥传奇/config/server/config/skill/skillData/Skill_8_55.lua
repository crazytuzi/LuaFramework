return {
{
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=300, rate=39000,value=0},
	...
	trainConds=
	{
		...
		{cond=3,value= 1630, count = 10,consume=true},
		{cond=21,value=187500,consume=false},
	},
	spellConds=
	{
