return {
{
		...
		acts=
			{
				...
				},
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=1,id=757,rate=0, rateType=0, delay=200},
					},
					specialEffects=
					{
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=200,rate=17000,  delay=400},
					},
					specialEffects=
					{
					},
	...
	trainConds=
	{
		{cond=1,value= 940,consume=true},
		{cond=3,value= 3067, count = 2,consume=true},
		{cond=21,value=62000,consume=false},
	},
	spellConds=
	{
