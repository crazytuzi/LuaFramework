            ...
            acts = {
                {
                    ...
                    { mj = 0, timeParam = 1, type = 1, id = 449, rate = 0, rateType = 2, delay = 200 },
                    { mj = 0, timeParam = 1, type = 1, id = 469, rate = 0, rateType = 2, delay = 200 },
                    { mj = 0, timeParam = 1, type = 1, id = 489, rate = 0, rateType = 2, delay = 200 },
                    },
                    specialEffects={
            ...
            acts = {
                {
                    ...
                    results = {
                    { mj = 0, timeParam = 1, type = 33, delay = 200, rate = 20500, value = 0 },
                    { mj = 0, timeParam = 200, type = 20, delay = 0, id = 21, value = 1, vt = 0 },
                    { mj = 0, timeParam = 200, type = 20, delay = 0, id = 21, value = 1, vt = 1 },
                    { mj = 0, timeParam = 1, type = 1, id = 449, rate = 0, rateType = 2, delay = 200 },
                    { mj = 0, timeParam = 1, type = 1, id = 469, rate = 0, rateType = 2, delay = 200 },
