            ...
            acts = {
                {
                    ...
                    results = {
                    { mj = 0, timeParam = 1, type =3, delay = 300, rate = 75000, intervalRate =  75000,value = 0 },
            ...
            acts = {
                {
                    ...
                    results = {
                    { mj = 0, timeParam = 1, type = 3, delay = 300, rate = 6000,intervalRate= 6000,value = 0 },
                    { mj = 0, timeParam = 200, type = 20, delay = 0, id = 81, value = 1, vt = 0 },
                    },
                    specialEffects={
                    },
            ...
            acts = {
                {
                    ...
                    results = {
{ mj = 0, timeParam = 1, type = 1, id = 935, rate = 0, rateType = 0, delay = 200 },
                    },
                    specialEffects={
                    },
                },
