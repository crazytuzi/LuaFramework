            ...
            acts = {
                {
                    ...
                    results = {
                    { mj = 0, timeParam = 1, type =33, delay = 300, rate = 77500, intervalRate = 77500,value = 0 },
            ...
            acts = {
                {
                    ...
                    results = {
                    { mj = 0, timeParam = 1, type =33, delay = 300, rate = 6200, intervalRate = 6200,value = 0 },
                    { mj = 0, timeParam = 200, type = 20, delay = 0, id = 101, value = 1, vt = 0 },
                    },
                    specialEffects={
                    },
            ...
            acts = {
                {
                    ...
                    results = {
{ mj = 0, timeParam = 20, type = 1, id = 976, rate = -4100, rateType = 2, delay = 200 },
                    },
                    specialEffects={
                    },
                },
	...
	trainConds = {
            { cond = 21, value = 25000, consume = false },
	},
	spellConds = {
