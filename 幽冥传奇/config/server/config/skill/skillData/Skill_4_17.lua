return {
{
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=300, rate=11800,value=0},
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=300, rate=11300,value=0},
					},
					specialEffects=
					{
					},
	...
	trainConds=
	{
		...
		{cond=21,value=12500,consume=true},
