return {
{
			...
			{
				{
					...
					results=
					{
						...
						{mj=0,timeParam=1,type=32,id=924,ignoreTargetDis=1,rate=10000, rateType=0, delay=400},
	...
	trainConds=
	{
		...
		{cond=21,value=480000,consume=false},
		{cond=3,value= 449, count = 20,consume=true},
	},
	spellConds=
	{
