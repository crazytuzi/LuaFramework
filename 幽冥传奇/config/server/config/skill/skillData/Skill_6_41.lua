return {
{
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=300, rate=26000,value=0},
					},
					specialEffects=
					{
					},
	...
	trainConds=
	{
			{cond=1,value=500,consume=false},
		{cond=21,value=105000,consume=true},
		{cond=3,value= 447, count = 5,consume=true},
	},
	spellConds=
	{
