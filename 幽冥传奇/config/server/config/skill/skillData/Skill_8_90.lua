return {
{
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=300, rate=56500,value=0},
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=300, rate=51500,value=0},
					},
					specialEffects=
					{
					},
	...
	trainConds=
	{
		...
		{cond=3,value= 1630, count = 50,consume=true},
		{cond=21,value=1200000,consume=false},
	},
	spellConds=
	{
