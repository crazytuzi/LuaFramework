return {
{
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=300, rate=57500,value=0},
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=300, rate=52500,value=0},
					},
					specialEffects=
					{
					},
	...
	trainConds=
	{
		...
		{cond=21,value=1400000,consume=false},
	},
	spellConds=
	{
