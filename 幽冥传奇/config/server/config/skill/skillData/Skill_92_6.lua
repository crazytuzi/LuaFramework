            ...
            acts = {
                {
                    ...
                    results = {
                    { mj = 0, delay = 300, timeParam = 1, type = 4, rate = 11500, value = 0 },
                    { mj = 0, timeParam = 1, type = 1, id = 304, rate = 0, rateType = 2, delay = 200 },
                    { mj = 0, timeParam = 1, type = 1, id = 324, rate = 0, rateType = 2, delay = 200 },
                    },
                    specialEffects={    },
                },
            },
