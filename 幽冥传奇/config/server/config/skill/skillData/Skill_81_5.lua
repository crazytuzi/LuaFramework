            ...
            acts = {
                {
                    ...
                    results = {
                    { mj = 0, timeParam = 1, type =3, delay = 300, rate = 62500, intervalRate =  62500,value = 0 },
            ...
            acts = {
                {
                    ...
                    results = {
                    { mj = 0, timeParam = 1, type = 3, delay = 300, rate = 5000,intervalRate= 5000,value = 0 },
                    { mj = 0, timeParam = 200, type = 20, delay = 0, id = 81, value = 1, vt = 0 },
                    },
                    specialEffects={
                    },
            ...
            acts = {
                {
                    ...
                    results = {
{ mj = 0, timeParam = 1, type = 1, id = 930, rate = 0, rateType = 0, delay = 200 },
                    },
                    specialEffects={
                    },
                },
