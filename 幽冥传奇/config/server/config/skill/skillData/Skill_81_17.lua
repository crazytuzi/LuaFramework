            ...
            acts = {
                {
                    ...
                    results = {
                    { mj = 0, timeParam = 1, type =3, delay = 300, rate = 92500, intervalRate =  92500,value = 0 },
            ...
            acts = {
                {
                    ...
                    results = {
                    { mj = 0, timeParam = 1, type = 3, delay = 300, rate = 7200,intervalRate= 7200,value = 0 },
                    { mj = 0, timeParam = 200, type = 20, delay = 0, id = 81, value = 1, vt = 0 },
                    },
                    specialEffects={
                    },
            ...
            acts = {
                {
                    ...
                    results = {
{ mj = 0, timeParam = 1, type = 1, id = 942, rate = 0, rateType = 0, delay = 200 },
                    },
                    specialEffects={
                    },
                },
