return {
{
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=300, rate=35500,value=0},
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=300, rate=30500,value=0},
					},
					specialEffects=
					{
					},
	...
	trainConds=
	{
		{cond=1,value=500,consume=true},
		{cond=3,value= 1630, count = 5,consume=true},
		{cond=21,value=140000,consume=false},
	},
	spellConds=
	{
