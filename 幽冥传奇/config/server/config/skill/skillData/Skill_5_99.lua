return {
{
			...
			{
				{
					...
					results=
					{
						...
						{mj=0,timeParam=1,type=32,id=955,ignoreTargetDis=1,rate=10000, rateType=0, delay=400},
	...
	trainConds=
	{
		...
		{cond=21,value=2500000,consume=false},
		{cond=3,value= 449, count = 120,consume=true},
