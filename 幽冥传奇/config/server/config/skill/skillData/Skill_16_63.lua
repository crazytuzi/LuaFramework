return {
{
			...
			{
				{
					...
					results=
					{
						{timeParam=1,type=1,delay=300,id=968,rate=0,intervalRate=3000,maxDur=300,intervalAddType=0,rateType=4},
					},
					specialEffects=
					{
	...
	trainConds=
	{
		...
		{cond=21,value=460000,consume=true},
