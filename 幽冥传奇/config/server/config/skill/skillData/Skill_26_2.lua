			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=4,type=1,delay=500, rate=500, rateType=2, id=24,},
						{mj=0,timeParam=4,type=1,delay=500, rate=500, rateType=2, id=25,},
