return {
{
		...
		acts=
            ...
            acts = {
                ...
                },
                {
                    ...
                    { mj = 0, timeParam = 1, type = 1, id = 893, rate = -5000, rateType = 0, delay = 100 },
                    },
                    specialEffects={
                    },
                },
            ...
            acts = {
                {
                    ...
                    { mj = 0, timeParam = 1, type = 1, id = 842, rate = 0, rateType = 0, delay = 300 },
                    },
                    specialEffects={    },
                },
                {
	...
	trainConds=
	{
		{cond=1,value= 1690,consume=true},
		{cond=3,value= 3068, count = 5,consume=true},
		{cond=21,value=550000,consume=false},
		{cond=43,value=51,consume=false},
	},
	spellConds=
	{
