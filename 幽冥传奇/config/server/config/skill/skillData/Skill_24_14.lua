return {
{
            ...
            acts = {
                {
                    ...
                    results = {
                    { timeParam = 10, type = 1, delay = 100, id = 532, rate = 0, value = 0, interval = 1, },
                    },
                    specialEffects={
            ...
            acts = {
                {
                    ...
                    results = {
                    { timeParam = 1, type = 13, delay = 100, rate = 1900, value = 0, },
                    },
                },
            },
            },
	...
	spellConds = {
            { cond = 8, value = 2243, consume = true },
	},
},
}