return {
{
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=1,id=99, rate=-1200, rateType=2, delay=400},
						{mj=0,timeParam=1,type=1,id=100, rate=-1200, rateType=2, delay=400},
						{mj=0,timeParam=40,type=1,id=101, rate=-220, rateType=2, delay=400},
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=1,id=99, rate=-1200, rateType=2, delay=400},
						{mj=0,timeParam=1,type=1,id=100, rate=-1200, rateType=2, delay=400},
						{mj=0,timeParam=10,type=1,id=101, rate=-220, rateType=2, delay=400},
					},
					specialEffects=
					{
					},
	...
	trainConds=
	{
		{cond=1,value=85,consume=false},
		{cond=21,value=7500,consume=false},
	},
	spellConds=
	{
