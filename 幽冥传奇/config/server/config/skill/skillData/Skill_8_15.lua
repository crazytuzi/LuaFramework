return {
{
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=300, rate=19000,value=0},
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=300, rate=14000,value=0},
					},
					specialEffects=
					{
					},
	...
	trainConds=
	{
		{cond=1,value=200,consume=true},
		{cond=3,value= 1630, count = 2,consume=true},
