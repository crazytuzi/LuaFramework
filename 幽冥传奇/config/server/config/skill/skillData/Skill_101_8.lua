            ...
            acts = {
                {
                    ...
                    results = {
                    { mj = 0, timeParam = 1, type =33, delay = 300, rate = 70000, intervalRate = 70000,value = 0 },
            ...
            acts = {
                {
                    ...
                    results = {
                    { mj = 0, timeParam = 1, type =33, delay = 300, rate = 5600, intervalRate = 5600,value = 0 },
                    { mj = 0, timeParam = 200, type = 20, delay = 0, id = 101, value = 1, vt = 0 },
                    },
                    specialEffects={
                    },
            ...
            acts = {
                {
                    ...
                    results = {
{ mj = 0, timeParam = 20, type = 1, id = 973, rate = -3800, rateType = 2, delay = 200 },
                    },
                    specialEffects={
                    },
                },
	...
	trainConds = {
            { cond = 21, value = 10000, consume = false },
	},
	spellConds = {
