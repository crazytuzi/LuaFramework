return {
{
		...
		acts=
			{
				...
				},
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=1,id=756,rate=0, rateType=0, delay=200},
					},
					specialEffects=
					{
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=200,rate=16500,  delay=400},
					},
					specialEffects=
					{
					},
	...
	trainConds=
	{
		{cond=1,value= 930,consume=true},
		{cond=3,value= 3067, count = 2,consume=true},
		{cond=21,value=56000,consume=false},
	},
	spellConds=
	{
