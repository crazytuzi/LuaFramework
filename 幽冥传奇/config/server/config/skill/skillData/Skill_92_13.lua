            ...
            acts = {
                {
                    ...
                    results = {
                    { mj = 0, delay = 300, timeParam = 1, type = 4, rate = 15000, value = 0 },
                    { mj = 0, timeParam = 1, type = 1, id = 311, rate = 0, rateType = 2, delay = 200 },
                    { mj = 0, timeParam = 1, type = 1, id = 331, rate = 0, rateType = 2, delay = 200 },
                    },
                    specialEffects={    },
                },
            },
