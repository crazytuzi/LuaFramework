            ...
            acts = {
                {
                    ...
                    results = {
                    { mj = 0, timeParam = 1, type =3, delay = 300, rate = 80000, intervalRate =  80000,value = 0 },
            ...
            acts = {
                {
                    ...
                    results = {
                    { mj = 0, timeParam = 1, type = 3, delay = 300, rate = 6400,intervalRate= 6400,value = 0 },
                    { mj = 0, timeParam = 200, type = 20, delay = 0, id = 81, value = 1, vt = 0 },
                    },
                    specialEffects={
                    },
            ...
            acts = {
                {
                    ...
                    results = {
{ mj = 0, timeParam = 1, type = 1, id = 937, rate = 0, rateType = 0, delay = 200 },
                    },
                    specialEffects={
                    },
                },
