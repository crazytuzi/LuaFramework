return {
{
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=300, rate=47500,value=0},
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=300, rate=42500,value=0},
					},
					specialEffects=
					{
					},
	...
	trainConds=
	{
		...
		{cond=3,value= 1630, count = 35,consume=true},
		{cond=21,value=425000,consume=false},
	},
	spellConds=
	{
