			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=1,id=29, rate=-1000, rateType=2, delay=400},
						{mj=0,timeParam=1,type=1,id=30, rate=-1000, rateType=2, delay=400},
						{mj=0,timeParam=40,type=1,id=28, rate=-200, rateType=2, delay=400},
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=1,id=29, rate=-1000, rateType=2, delay=400},
						{mj=0,timeParam=1,type=1,id=30, rate=-1000, rateType=2, delay=400},
						{mj=0,timeParam=10,type=1,id=28, rate=-200, rateType=2, delay=400},
					},
					specialEffects=
					{
					},
