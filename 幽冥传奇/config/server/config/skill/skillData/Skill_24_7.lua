            ...
            acts = {
                {
                    ...
                    results = {
                    { timeParam = 10, type = 1, delay = 100, id = 525, rate = 0, value = 0, interval = 1, },
                    },
                    specialEffects={
            ...
            acts = {
                {
                    ...
                    results = {
                    { timeParam = 1, type = 13, delay = 100, rate = 1200, value = 0, },
                    },
                },
            },
            },
