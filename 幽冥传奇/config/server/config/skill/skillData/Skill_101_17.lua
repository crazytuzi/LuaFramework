            ...
            acts = {
                {
                    ...
                    results = {
                    { mj = 0, timeParam = 1, type =33, delay = 300, rate = 92500, intervalRate = 92500,value = 0 },
            ...
            acts = {
                {
                    ...
                    results = {
                    { mj = 0, timeParam = 1, type =33, delay = 300, rate = 7200, intervalRate = 7200,value = 0 },
                    { mj = 0, timeParam = 200, type = 20, delay = 0, id = 101, value = 1, vt = 0 },
                    },
                    specialEffects={
                    },
            ...
            acts = {
                {
                    ...
                    results = {
{ mj = 0, timeParam = 20, type = 1, id = 982, rate = -4700, rateType = 2, delay = 200 },
                    },
                    specialEffects={
                    },
                },
	...
	trainConds = {
            { cond = 21, value = 55000, consume = false },
	},
	spellConds = {
