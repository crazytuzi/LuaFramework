return {
{
			...
			{
				{
					...
					results=
					{
						...
						{mj=0,timeParam=1,type=32,id=910,ignoreTargetDis=1,rate=10000, rateType=0, delay=400},
	...
	trainConds=
	{
		...
		{cond=21,value=260000,consume=false},
		{cond=3,value= 449, count = 10,consume=true},
	},
	spellConds=
	{
