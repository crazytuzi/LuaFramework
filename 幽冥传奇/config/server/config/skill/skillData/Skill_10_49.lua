return {
{
		...
		acts=
            ...
            acts = {
                ...
                },
                {
                    ...
                    { mj = 0, timeParam = 1, type = 1, id = 892, rate = -5000, rateType = 0, delay = 100 },
                    },
                    specialEffects={
                    },
                },
            ...
            acts = {
                {
                    ...
                    { mj = 0, timeParam = 1, type = 1, id = 841, rate = 0, rateType = 0, delay = 300 },
                    },
                    specialEffects={    },
                },
                {
	...
	trainConds=
	{
		{cond=1,value= 1680,consume=true},
		{cond=3,value= 3068, count = 5,consume=true},
		{cond=21,value=533000,consume=false},
	},
	spellConds=
	{
