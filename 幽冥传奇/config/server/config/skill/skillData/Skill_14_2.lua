			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=0,interval=40000,type=35,delay=0,rate=3200,value=1200,id=5},
					...
					specialEffects=
					{
						{type=4,mj=0,id=5,keepTime=1200,delay=200,always=false},
					},
				},
			},
		},
