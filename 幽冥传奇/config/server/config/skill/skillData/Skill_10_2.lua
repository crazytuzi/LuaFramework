return {
{
		...
		acts=
            ...
            acts = {
                ...
                },
                {
                    ...
                    { mj = 0, timeParam = 1, type = 1, id = 845, rate = -5000, rateType = 0, delay = 100 },
                    },
                    specialEffects={
                    },
                },
            ...
            acts = {
                {
                    ...
                    { mj = 0, timeParam = 1, type = 1, id = 794, rate = 0, rateType = 0, delay = 300 },
                    },
                    specialEffects={    },
                },
                {
	...
	trainConds=
	{
		{cond=1,value= 1210,consume=true},
