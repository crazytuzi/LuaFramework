return {
{
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=300, rate=7900,value=0},
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=300, rate=7400,value=0},
					},
					specialEffects=
					{
					},
	...
	trainConds=
	{
		...
		{cond=21,value=2500,consume=true},
