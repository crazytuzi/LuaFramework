return {
{
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=300, rate=9100,value=0},
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=300, rate=8600,value=0},
					},
					specialEffects=
					{
					},
	...
	trainConds=
	{
		...
		{cond=21,value=4500,consume=true},
