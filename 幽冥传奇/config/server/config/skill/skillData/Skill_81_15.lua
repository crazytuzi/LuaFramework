            ...
            acts = {
                {
                    ...
                    results = {
                    { mj = 0, timeParam = 1, type =3, delay = 300, rate = 87500, intervalRate =  87500,value = 0 },
            ...
            acts = {
                {
                    ...
                    results = {
                    { mj = 0, timeParam = 1, type = 3, delay = 300, rate = 7000,intervalRate= 7000,value = 0 },
                    { mj = 0, timeParam = 200, type = 20, delay = 0, id = 81, value = 1, vt = 0 },
                    },
                    specialEffects={
                    },
            ...
            acts = {
                {
                    ...
                    results = {
{ mj = 0, timeParam = 1, type = 1, id = 940, rate = 0, rateType = 0, delay = 200 },
                    },
                    specialEffects={
                    },
                },
