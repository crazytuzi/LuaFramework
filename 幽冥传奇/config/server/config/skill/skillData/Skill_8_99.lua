return {
{
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=300, rate=61000,value=0},
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=300, rate=56000,value=0},
					},
					specialEffects=
					{
					},
	...
	trainConds=
	{
		...
		{cond=3,value= 1630, count = 120,consume=true},
		{cond=21,value=2200000,consume=false},
		{cond=43,value=100,consume=false},
	},
	spellConds=
	{
