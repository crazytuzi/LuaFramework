            ...
            acts = {
                {
                    ...
                    { mj = 0, timeParam = 1, type = 1, id = 445, rate = 0, rateType = 2, delay = 200 },
                    { mj = 0, timeParam = 1, type = 1, id = 465, rate = 0, rateType = 2, delay = 200 },
                    { mj = 0, timeParam = 1, type = 1, id = 485, rate = 0, rateType = 2, delay = 200 },
                    },
                    specialEffects={
            ...
            acts = {
                {
                    ...
                    results = {
                    { mj = 0, timeParam = 1, type = 33, delay = 200, rate = 10500, value = 0 },
                    },
                    specialEffects={
                    },
                },
