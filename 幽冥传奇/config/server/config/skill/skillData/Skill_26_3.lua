			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=6,type=1,delay=500, rate=500, rateType=2, id=26,},
						{mj=0,timeParam=6,type=1,delay=500, rate=500, rateType=2, id=27,},
