return {
{
			...
			{
				{
					...
					results=
					{
						...
						{mj=0,timeParam=1,type=32,id=941,ignoreTargetDis=1,rate=10000, rateType=0, delay=400},
	...
	trainConds=
	{
		...
		{cond=21,value=1070000,consume=false},
		{cond=3,value= 449, count = 50,consume=true},
	},
	spellConds=
	{
