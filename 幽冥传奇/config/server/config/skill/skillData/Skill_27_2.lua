return {
{
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=1,id=96, rate=-1100, rateType=2, delay=400},
						{mj=0,timeParam=1,type=1,id=97, rate=-1100, rateType=2, delay=400},
						{mj=0,timeParam=40,type=1,id=98, rate=-210, rateType=2, delay=400},
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=1,id=96, rate=-1100, rateType=2, delay=400},
						{mj=0,timeParam=1,type=1,id=97, rate=-1100, rateType=2, delay=400},
						{mj=0,timeParam=10,type=1,id=98, rate=-210, rateType=2, delay=400},
					},
					specialEffects=
					{
					},
	...
	trainConds=
	{
		{cond=1,value=83,consume=false},
		{cond=21,value=2500,consume=false},
	},
	spellConds=
	{
		{cond=8,value=455,consume=true},
