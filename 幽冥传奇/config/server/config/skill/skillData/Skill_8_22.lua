return {
{
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=300, rate=22500,value=0},
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=300, rate=17500,value=0},
					},
					specialEffects=
					{
					},
	...
	trainConds=
	{
		{cond=1,value=300,consume=true},
		{cond=3,value= 1630, count = 3,consume=true},
		{cond=21,value=36000,consume=false},
	},
	spellConds=
	{
