            ...
            acts = {
                {
                    ...
                    results = {
                    { mj = 0, timeParam = 1, type =33, delay = 300, rate = 85000, intervalRate = 85000,value = 0 },
            ...
            acts = {
                {
                    ...
                    results = {
                    { mj = 0, timeParam = 1, type =33, delay = 300, rate = 6800, intervalRate = 6800,value = 0 },
                    { mj = 0, timeParam = 200, type = 20, delay = 0, id = 101, value = 1, vt = 0 },
                    },
                    specialEffects={
                    },
            ...
            acts = {
                {
                    ...
                    results = {
{ mj = 0, timeParam = 20, type = 1, id = 979, rate = -4400, rateType = 2, delay = 200 },
                    },
                    specialEffects={
                    },
                },
	...
	trainConds = {
            { cond = 21, value = 40000, consume = false },
	},
	spellConds = {
