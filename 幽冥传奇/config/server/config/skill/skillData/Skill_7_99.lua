return {
{
			...
			{
				{
					...
					results=
					{
						{mj=0,timeParam=1,type=3,delay=300, rate=38400,value=0},
	...
	trainConds=
	{
		...
		{cond=21,value=2200000,consume=true},
		{cond=3,value= 448, count = 120,consume=true},
