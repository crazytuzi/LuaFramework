            ...
            acts = {
                {
                    ...
                    results = {
                    { mj = 0, timeParam = 1, type =33, delay = 300, rate = 95000, intervalRate = 95000,value = 0 },
            ...
            acts = {
                {
                    ...
                    results = {
                    { mj = 0, timeParam = 1, type =33, delay = 300, rate = 7300, intervalRate = 7300,value = 0 },
                    { mj = 0, timeParam = 200, type = 20, delay = 0, id = 101, value = 1, vt = 0 },
                    },
                    specialEffects={
                    },
            ...
            acts = {
                {
                    ...
                    results = {
{ mj = 0, timeParam = 20, type = 1, id = 983, rate = -4800, rateType = 2, delay = 200 },
                    },
                    specialEffects={
                    },
                },
