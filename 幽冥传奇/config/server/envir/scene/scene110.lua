return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50 }, center = { 65,36  },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
		...
		{
			name = Lang.SceneName.a00001, range = { 51,43,51,24,72,24,72,43 }, center = { 65,36  },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
				{type=1,value = {}},
				{type=46,value = {62,28,70,38}},	--安全复活区"，即复活点，无参数,如果是表示沙巴克战是复活，第五个参数表示复活的地图id
...
--				{type=49,value = {}},	--PK死亡允许原地复活"，无参数,注：暂未实现
	...
	npc =
	{
			{id = 201, posx = 69, posy = 42},
			{id = 250, posx = 63, posy = 42},
			{id = 202, posx = 57, posy = 42},
			{id = 251, posx = 52, posy = 41},
			{id = 204, posx = 51, posy = 35},
			{id = 253, posx = 51, posy = 30},
			{id = 203, posx = 51, posy = 24},
			{id = 252, posx = 63, posy = 26},
			{id = 205, posx = 66, posy = 30},
			{id = 254, posx = 69, posy = 34},
			{id = 229, posx = 59, posy = 35},--n00229="第五大陆",
	},
	teleport =
	{
			{ posx = 9, posy = 23,toSceneid =  2,toPosx = 111, toPosy = 93,effect_ui = 999,name = Lang.SceneName.s00002 },
	},
	landscape=
	{
	},
