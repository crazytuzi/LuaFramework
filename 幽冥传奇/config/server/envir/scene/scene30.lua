return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50 }, center = { 37,7 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
				--{type=46,value = {6,12,10,19}},	--安全复活区"，即复活点，无参数,如果是表示沙巴克战是复活，第五个参数表示复活的地图id
...
--#include "refresh30.lua"
	...
	teleport =
	{
			{ posx = 39, posy = 5,toSceneid =  2,toPosx = 111, toPosy = 93,effect_ui = 999,name = Lang.SceneName.s00002 },
	},
	landscape=
	{
	},
