return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50 }, center = { 24,45 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
				--{type=46,value = {71,15,76,20}},	--安全复活区"，即复活点，无参数,如果是表示沙巴克战是复活，第五个参数表示复活的地图id
...
--				{type=49,value = {}},	--PK死亡允许原地复活"，无参数,注：暂未实现
	...
	refresh =
	{
--#include "refresh10.lua"
	},
	npc =
	{
			{id = 31, posx = 49, posy = 36},
			{id = 32, posx = 93, posy = 28},
			{id = 33, posx = 55, posy = 82},
	},
	teleport =
	{
			{ posx = 22, posy = 47,toSceneid =  2,toPosx = 111, toPosy = 93,effect_ui = 999,name = Lang.SceneName.s00002 },
	},
	landscape=
	{
	},
