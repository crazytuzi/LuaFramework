return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 79,55,79,73,96,73,96,55 }, center = { 49,8 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
...
--				{type=49,value = {}},	--PK死亡允许原地复活"，无参数,注：暂未实现
		...
		{
			name = Lang.SceneName.a00001, range = { 19,46,19,42,24,42,24,46 }, center = { 22,44 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
