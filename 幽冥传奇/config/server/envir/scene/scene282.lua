return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50 }, center = { 33,27 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
...
--#include "refresh282.lua"
	...
	teleport =
	{
			{ posx = 47, posy = 41,toSceneid =  2,toPosx = 96, toPosy = 88,effect_ui = 999,name = Lang.SceneName.s00002 },
	},
	landscape=
	{
	},
