return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50}, center = { 37,8 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
...
--				{type=49,value = {}},	--PK死亡允许原地复活"，无参数,注：暂未实现
	...
	teleport =
	{
			{ posx = 49, posy = 70,toSceneid = 113,toPosx = 51, toPosy = 8,effect_ui = 999,name = Lang.SceneName.s00113 },
	},
	landscape=
	{
	},
