return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50 }, center = { 102,15 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
				--{type=46,value = {17,15,19,20}},	--安全复活区"，即复活点，无参数,如果是表示沙巴克战是复活，第五个参数表示复活的地图id
...
--#include "refresh20.lua"
	...
	teleport =
	{
			{ posx = 105, posy = 11,toSceneid =  2,toPosx = 111, toPosy = 93,effect_ui = 999,name = Lang.SceneName.s00002 },
	},
	landscape=
	{
	},
