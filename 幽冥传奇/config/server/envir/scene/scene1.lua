return {
{
	...
	{
		{
			name = Lang.SceneName.a00001, range = { 10,10,20,20,60,50 }, center = { 65,56 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
				{type=1,value = {}},
				--{type=46,value = {107,63,112,68}},	--安全复活区"，即复活点，无参数,如果是表示沙巴克战是复活，第五个参数表示复活的地图id
...
--				{type=49,value = {}},	--PK死亡允许原地复活"，无参数,注：暂未实现
	...
	refresh =
	{
--#include "refresh1.lua"
	},
	npc =
	{
			{id = 1, posx = 58, posy = 56},
			{id = 2, posx = 85, posy = 56},
			{id = 3, posx = 97, posy = 43},
			{id = 4, posx = 76, posy = 15},
			{id = 5, posx = 30, posy = 32},
	},
	teleport =
	{
		 { posx =6, posy = 66,toSceneid =  2,toPosx = 182, toPosy = 18,effect_ui = 999,name = Lang.SceneName.s00002 },
	},
	landscape=
	{
	},
