return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50 }, center = { 66,10 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
...
--#include "refresh35.lua"
	...
	teleport =
	{
	{ posx = 67, posy = 8,toSceneid =  2,toPosx = 111, toPosy = 93,effect_ui = 999,name = Lang.SceneName.s00002 },
	},
	landscape=
	{
	},
