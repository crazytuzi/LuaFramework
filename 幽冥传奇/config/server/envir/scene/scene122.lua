...
--				{type=49,value = {}},	--PK死亡允许原地复活"，无参数,注：暂未实现
	...
	npc =
	{
			--{id = 255, posx = 58, posy = 82},--n00255="真云仙宫(Lv.1500)",
			--{id = 256, posx = 53, posy = 79},--n00256="仙宫后阁(Lv.1600)",
			--{id = 257, posx = 49, posy = 76},--n00257="仙宫东阁(Lv.1700)",
			--{id = 258, posx = 44, posy = 72},--n00258="仙宫西阁(Lv.1800)",
	},
	teleport =
	{
