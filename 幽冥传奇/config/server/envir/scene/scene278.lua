return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50 }, center = {43,10},
			attri =
			{
				{type=19,value = {}},
...
--#include "refresh278.lua"
	...
	teleport =
	{
			{ posx = 45, posy = 8,toSceneid =  2,toPosx = 110, toPosy = 85,effect_ui = 999,name = Lang.SceneName.s00002 },
	},
	landscape=
	{
	},
