return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50 }, center = {110,7},
			attri =
			{
				{type=19,value = {}},
				--{type=46,value = {}},	--安全复活区"，即复活点，无参数,如果是表示沙巴克战是复活，第五个参数表示复活的地图id
...
--				{type=33,value = {}},	--限制技能使用"，[技能1，技能2，技能3...],技能id
				{type=34,value = {515,682,501}},	--限制物品使用"[物品1，物品2，物品3...]，都是指物品id
...
--				{type=49,value = {}},	--PK死亡允许原地复活"，无参数,注：暂未实现
	...
	refresh =
	{
--#include "refresh4.lua"
	},
	npc =
	{
			{id = 42, posx = 112, posy = 57},
	},
	teleport =
	{
			{ posx = 118, posy = 5,toSceneid =  3,toPosx = 106, toPosy = 76,effect_ui = 999,name = Lang.SceneName.s00003 },
			{ posx = 28, posy = 76,toSceneid =  5,toPosx = 5, toPosy = 13,effect_ui = 999,name = Lang.SceneName.s00005 },
			{ posx = 45, posy = 80,toSceneid =  5,toPosx = 35, toPosy = 11,effect_ui = 999,name = Lang.SceneName.s00005 },
			{ posx = 54, posy = 96,toSceneid =  5,toPosx = 40, toPosy = 26,effect_ui = 999,name = Lang.SceneName.s00005 },
	},
	landscape=
	{
	},
