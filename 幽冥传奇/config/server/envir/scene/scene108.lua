return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50 }, center = { 56,65},
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
		...
		{
			name = Lang.SceneName.a00001, range = { 58,83,37,67,68,44,88,60 }, center = { 56,65 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
				{type=1,value = {}},
				{type=46,value = {68,53,75,60}},	--安全复活区"，即复活点，无参数,如果是表示沙巴克战是复活，第五个参数表示复活的地图id
...
--				{type=49,value = {}},	--PK死亡允许原地复活"，无参数,注：暂未实现
	...
	npc =
	{
			{id = 191, posx = 58, posy = 82},
			{id = 192, posx = 46, posy = 74},
			{id = 193, posx = 42, posy = 61},
			{id = 194, posx = 59, posy = 48},
			{id = 195, posx = 73, posy = 47},
			{id = 196, posx = 84, posy = 55},
			{id = 237, posx = 52, posy = 78},
			{id = 238, posx = 40, posy = 70},
			{id = 239, posx = 48, posy = 57},
			{id = 240, posx = 65, posy = 44},
			{id = 241, posx = 79, posy = 51},
			{id = 242, posx = 89, posy = 59},
			{id = 227, posx = 63, posy = 65},
			{id = 228, posx = 100, posy = 100},
	},
	teleport =
	{
			{ posx = 28, posy = 91,toSceneid =  2,toPosx = 111, toPosy = 93,effect_ui = 999,name = Lang.SceneName.s00002 },
	},
	landscape=
	{
	},
