return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50 }, center = { 32,17 },
			attri =
			{
				{type=19,value = {}},
				...
				{type=50,value = {6,}},	--强制攻击模式",[PK模式]，注意：注意：只接受一个参数。0和平模式，1团队模式，2帮派模式，3善恶模式，4杀戮模式，5联盟模式, 6阵营模式
				{type=44,value = {}},
				{type=33,value = {13}},	--限制技能使用"，[技能1，技能2，技能3...],技能id
				{type=34,value = {3520,3552}},	--限制物品使用"[物品1，物品2，物品3...]，都是指物品id
