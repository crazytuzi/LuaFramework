return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50 }, center = { 72,64 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
--				{type=46,value = {67,57,77,68}},	--安全复活区"，即复活点，无参数,如果是表示沙巴克战是复活，第五个参数表示复活的地图id
...
--				{type=49,value = {}},	--PK死亡允许原地复活"，无参数,注：暂未实现
	...
	teleport =
	{
			{ posx =59, posy = 90,toSceneid =  218,toPosx = 10, toPosy = 170,effect_ui = 999,name = Lang.SceneName.s00218 },
           { posx =5, posy = 64,toSceneid =  219,toPosx = 7, toPosy = 131,effect_ui = 999,name = Lang.SceneName.s00219 },
	},
	landscape=
	{
	},
