return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50 }, center = { 15,27 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
				--{type=46,value = {12,64,18,68}},	--安全复活区"，即复活点，无参数,如果是表示沙巴克战是复活，第五个参数表示复活的地图id
...
--				{type=34,value = {680}},	--限制物品使用"[物品1，物品2，物品3...]，都是指物品id
...
--				{type=49,value = {}},	--PK死亡允许原地复活"，无参数,注：暂未实现
	...
	refresh =
	{
--#include "refresh6.lua"
	},
	npc =
	{
			{id = 13, posx = 13, posy = 35},
			{id = 14, posx = 11, posy = 58},
			{id = 15, posx = 49, posy = 80},
			{id = 16, posx = 72, posy = 69},
			{id = 17, posx = 53, posy = 26},
	},
	teleport =
	{
			{ posx = 12, posy = 24,toSceneid =  2,toPosx = 111, toPosy = 93,effect_ui = 999,name = Lang.SceneName.s00002 },
	},
	landscape=
	{
	},
