return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50 }, center = { 74,13 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
...
--				{type=33,value = {}},	--限制技能使用"，[技能1，技能2，技能3...],技能id
				{type=34,value = {515}},	--限制物品使用"[物品1，物品2，物品3...]，都是指物品id
...
--				{type=49,value = {}},	--PK死亡允许原地复活"，无参数,注：暂未实现
	...
	refresh =
	{
--#include "refresh117.lua"
	},
	npc =
	{
			{id = 116, posx = 42, posy = 48},--巨魔引导者",
	},
	teleport =
	{
	},
