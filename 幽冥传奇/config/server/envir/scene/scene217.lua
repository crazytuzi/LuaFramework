return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = {  10,10,20,20,60,50 }, center = { 60,7 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
...
--				{type=33,value = {}},	--限制技能使用"，[技能1，技能2，技能3...],技能id
				{type=34,value = {3520}},	--限制物品使用"[物品1，物品2，物品3...]，都是指物品id
...
--				{type=49,value = {}},	--PK死亡允许原地复活"，无参数,注：暂未实现
		...
		{
			name = Lang.SceneName.a00001, range = { 21,30,0,52,49,101,68,81 }, center = { 63,59 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
		...
		{
			name = Lang.SceneName.a00001, range = { 49,98,73,76,84,87,60,108 }, center = { 63,59 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
		...
		{
			name = Lang.SceneName.a00001, range = { 37,19,61,41,84,18,61,0 }, center = { 111,58 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
		...
		{
			name = Lang.SceneName.a00001, range = { 60,42,103,76,124,54,86,14 }, center = { 111,58 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
...
--#include "refresh217.lua"
	...
	teleport =
	{
			{ posx = 35, posy = 86,toSceneid =  2,toPosx = 93, toPosy = 92,effect_ui = 999,name = Lang.SceneName.s00002 },
	},
	landscape=
	{
	},
