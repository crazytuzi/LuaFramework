return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50 }, center = { 32,8 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
...
--#include "refresh34.lua"
	...
	teleport =
	{
	{ posx = 34, posy = 6,toSceneid =  2,toPosx = 111, toPosy = 93,effect_ui = 999,name = Lang.SceneName.s00002 },
	},
	landscape=
	{
	},
