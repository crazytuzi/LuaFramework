return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50 }, center = { 58,75 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
		...
		{
			name = Lang.SceneName.a00001, range = { 58,83,37,67,68,44,88,60 }, center = { 58,75 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
				{type=1,value = {}},
				{type=46,value = {51,63,61,75}},	--安全复活区"，即复活点，无参数,如果是表示沙巴克战是复活，第五个参数表示复活的地图id
