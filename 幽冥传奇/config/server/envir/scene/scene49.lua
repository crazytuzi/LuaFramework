return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50 }, center = { 37,18 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
...
--#include "refresh49.lua"
	...
	teleport =
	{
	{ posx = 38, posy = 12,toSceneid =  2,toPosx = 111, toPosy = 93,effect_ui = 999,name = Lang.SceneName.s00002 },
	},
	landscape=
	{
	},
