return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50 }, center = { 63,12 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
...
--#include "refresh31.lua"
	...
	teleport =
	{
	{ posx = 65, posy = 10,toSceneid =  2,toPosx = 111, toPosy = 93,effect_ui = 999,name = Lang.SceneName.s00002 },
	},
	landscape=
	{
	},
