return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50 }, center = { 12,10 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
...
--#include "refresh44.lua"
	...
	teleport =
	{
	{ posx = 7, posy = 10,toSceneid =  2,toPosx = 111, toPosy = 93,effect_ui = 999,name = Lang.SceneName.s00002 },
	},
	landscape=
	{
	},
