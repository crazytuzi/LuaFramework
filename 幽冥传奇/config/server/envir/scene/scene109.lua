return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50 }, center = {98,74 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
		...
		{
			name = Lang.SceneName.a00001, range = { 94,92,84,82,107,59,117,70 }, center = { 98,74 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
				{type=1,value = {}},
				{type=46,value = {101,67,108,73}},	--安全复活区"，即复活点，无参数,如果是表示沙巴克战是复活，第五个参数表示复活的地图id
...
--				{type=49,value = {}},	--PK死亡允许原地复活"，无参数,注：暂未实现
	...
	npc =
	{
              {id = 197, posx = 91, posy = 82},
			  {id = 243, posx = 86, posy = 77},
			  {id = 198, posx = 86, posy = 71},
			  {id = 244, posx = 90, posy = 67},
			  {id = 199, posx = 94, posy = 63},
			  {id = 245, posx = 99, posy = 58},
			  {id = 200, posx = 104, posy = 63},
			  {id = 246, posx = 109, posy = 68},
			{id = 228, posx = 102, posy = 78},
	},
	teleport =
	{
			{ posx = 61, posy = 106,toSceneid =  2,toPosx = 111, toPosy = 93,effect_ui = 999,name = Lang.SceneName.s00002 },
	},
	landscape=
	{
	},
