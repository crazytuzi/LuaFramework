return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50 }, center = { 77,179 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
				--{type=46,value = {16,16,22,16}},	--安全复活区"，即复活点，无参数,如果是表示沙巴克战是复活，第五个参数表示复活的地图id
...
--				{type=49,value = {}},	--PK死亡允许原地复活"，无参数,注：暂未实现
	...
	refresh =
	{
--#include "refresh8.lua"
	},
	npc =
	{
			{id = 20, posx = 37, posy = 132},
			{id = 21, posx = 99, posy = 132},
			{id = 22, posx = 71, posy = 74},
	},
	teleport =
	{
			{ posx = 79, posy = 182,toSceneid =  2,toPosx = 111, toPosy = 93,effect_ui = 999,name = Lang.SceneName.s00002 },
	},
	landscape=
	{
	},
