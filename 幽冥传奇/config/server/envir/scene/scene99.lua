return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50 }, center = { 55,54 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
				{type=46,value = {50,51,57,60}},	--安全复活区"，即复活点，无参数,如果是表示沙巴克战是复活，第五个参数表示复活的地图id
