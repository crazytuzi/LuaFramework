return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50 }, center = {63,106},
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
				...
				{type=50,value = {1}},	--强制攻击模式",[PK模式]，注意：只接受一个参数。0和平模式，1团队模式，2帮派模式，3阵营模式，4杀戮模式，5联盟模式
				{type=44,value = {}},
				{type=85,value = {}},
				{type=98,value = {}},
