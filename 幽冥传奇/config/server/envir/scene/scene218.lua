return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50}, center = { 138,93 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
--				{type=46,value = {91,89,95,93}},	--安全复活区"，即复活点，无参数,如果是表示沙巴克战是复活，第五个参数表示复活的地图id
...
--				{type=49,value = {}},	--PK死亡允许原地复活"，无参数,注：暂未实现
	...
	npc =
	{
            {id = 81, posx = 178, posy = 115},
	},
	teleport =
	{
			{ posx = 8, posy = 173,toSceneid =  223,toPosx = 63, toPosy = 86,effect_ui = 999,name = Lang.SceneName.s00223 },
	},
	landscape=
	{
	},
