return {
{
	...
	{
		{
			name = Lang.SceneName.a00000, range = { 10,10,20,20,60,50 }, center = { 24,13 },
			attri =
			{
				{type=18,value = {}},
				{type=19,value = {}},
...
--#include "refresh281.lua"
	...
	teleport =
	{
			{ posx = 37, posy = 19,toSceneid =  2,toPosx = 96, toPosy = 88,effect_ui = 999,name = Lang.SceneName.s00002 },
	},
	landscape=
	{
	},
