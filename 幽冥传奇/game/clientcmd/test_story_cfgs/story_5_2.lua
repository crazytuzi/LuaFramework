...
return 
		{
 		...
 		{next_time = 0, actor = "10000##camera", action = "donothing"},
		{next_time = 0, actor = "400##patting", action = "born##0.5##215##xui/word/word_city_1.png"},
        {next_time = 1.5, actor = "400##patting", action = "run_action##ScaleFadeIn;1.4;1;1#Shake;2;10#"},
		{next_time = 5, actor = "9999##main_role", action = "move##32##38"},
        {next_time = 8, actor = "9999##main_role", action = "auto_fight"}, 
		{next_time = 1, actor = "400##patting", action = "disappear##2##0##1"},
		{next_time = 0, actor = "401##patting", action = "born##0.5##215##xui/word/word_city_2.png"},
        {next_time = 8, actor = "401##patting", action = "run_action##ScaleFadeIn;1.4;1;1#Shake;2;10#"},
		{next_time = 1, actor = "401##patting", action = "disappear##2##0##1"},
		}