...
return {
        ...
        {next_time = 0, actor = "10##role||11##monster", action = "born##闯入者##10##35##32##1##100##100##3500##0##0##0##0||born##霸斧牛王##64##36##33##5##100##100##3500"},
        {next_time = 1, actor = "10000##camera", action = "fly##35##32"},
        {next_time = 2, actor = "1000##npc##102", action = "dialog##{colorandsize;ff00ff;28;霸斧牛王}\n 胆敢私闯牛魔殿者，都得死，看斧！"},
        {next_time = 0, actor = "11##monster", action = "do_attack##0##5##0"},
        {next_time = 0, actor = "100000##effect", action = "born##35##32##39##1####1##0"},
        {next_time = 1, actor = "10##role||10##role", action = "change_obj_attr##max_hp##100||change_obj_attr##hp##0"},
        {next_time = 3, actor = "1001##npc##102", action = "dialog##{colorandsize;ff00ff;28;霸斧牛王}\n 还有谁！出来一战！"},
