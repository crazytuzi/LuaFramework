...
return 
		{
		{next_time = 0, actor = "401##patting", action = "born##0.5##0.5##xui/word/word_city_3.png"},
        {next_time = 5, actor = "401##patting", action = "run_action##ScaleFadeIn;2;1;1#Shake;2;10#"},
