...
-- 消费荣耀
---------------
local CSHonorActData = {}

function CSHonorActData:Init(t)
...
function CSHonorActData:Delete()
	self:RemoveAllEventListeners()
	self.is_valid = false
end

function CSHonorActData:HasRemind()
	return self.client_cfg.remind_param and (0 < #self.client_cfg.remind_param)
end

function CSHonorActData:IsValid()
	return self.is_valid
end

function CSHonorActData:ServerProtocol(protocol)
...
function CSHonorActData:GetRankDataList()
	return self.rank_data_list or {}
end

function CSHonorActData:GetEffectId()
	return self.act_cfg.config.viewEffectId or 309
end

function CSHonorActData:SetRankDataList()
	local data_list = {}
...
function CSHonorActData:SetCurPersonLevel()
	local cur_level = 1
	for i = 0, 7 do
...
function CSHonorActData:SetPersonRewardRemind()
...
function CSHonorActData:GetCurPersonLevel()
	return self.cur_person_level
end

function CSHonorActData:GetRemindNum(remind_name)
	return self.remind_num
end

return CSHonorActData