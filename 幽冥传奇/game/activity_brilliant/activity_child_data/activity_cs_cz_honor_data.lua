...
-- 消费荣耀
---------------
local CZHonorActData = {}

function CZHonorActData:Init(t)
...
function CZHonorActData:Delete()
	self:RemoveAllEventListeners()
	self.is_valid = false
end

function CZHonorActData:HasRemind()
	return self.client_cfg.remind_param and (0 < #self.client_cfg.remind_param)
end

function CZHonorActData:IsValid()
	return self.is_valid
end

function CZHonorActData:ServerProtocol(protocol)
...
function CZHonorActData:GetRankDataList()
	return self.rank_data_list or {}
end

function CZHonorActData:GetEffectId()
	return self.act_cfg.config.viewEffectId or 309
end

function CZHonorActData:SetRankDataList()
	local data_list = {}
...
function CZHonorActData:SetCurPersonLevel()
	local cur_level = 1
	for i = 0, 7 do
...
function CZHonorActData:SetPersonRewardRemind()
...
function CZHonorActData:GetCurPersonLevel()
	return self.cur_person_level
end

function CZHonorActData:GetRemindNum(remind_name)
	return self.remind_num
end

return CZHonorActData