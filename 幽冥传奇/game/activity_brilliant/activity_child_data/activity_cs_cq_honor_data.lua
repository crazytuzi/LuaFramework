...
-- 消费荣耀
---------------
local CQHonorActData = {}

function CQHonorActData:Init(t)
...
function CQHonorActData:Delete()
	self:RemoveAllEventListeners()
	self.is_valid = false
end

function CQHonorActData:HasRemind()
	return self.client_cfg.remind_param and (0 < #self.client_cfg.remind_param)
end

function CQHonorActData:IsValid()
	return self.is_valid
end

function CQHonorActData:ServerProtocol(protocol)
	...
	self:DispatchEvent("CQRY_DATA_CHANGE")
end

function CQHonorActData:GetRankDataList()
	return self.rank_data_list or {}
end

function CQHonorActData:GetEffectId()
	return self.act_cfg.config.viewEffectId or 309
end

function CQHonorActData:SetRankDataList()
	local data_list = {}
...
function CQHonorActData:SetCurPersonLevel()
	local cur_level = 1
	for i = 0, 7 do
...
function CQHonorActData:SetPersonRewardRemind()
...
function CQHonorActData:GetCurPersonLevel()
	return self.cur_person_level
end

function CQHonorActData:GetRemindNum(remind_name)
	return self.remind_num
end

return CQHonorActData