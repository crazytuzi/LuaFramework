...
-- 	local cfg = BossData.Instance:GetEquipBossCfg()
...
-- 	local fb_point = BossData.Instance:GetEquipBossData()
-- 	self.view.node_t_list.txt_point.node:setString(fb_point)
-- 	self:FlushTime()
-- end

-- function BossEquipmentPage:FlushTime()
-- 	local _, rest_time = BossData.Instance:GetEquipBossData()
-- 	local add_rest_time = BossData.Instance:GetEqBossAddRestTime()
-- 	local time_str = ""
-- 	if rest_time >= 0 then
...
-- 	BossCtrl.Instance:EquipBossReq(2, self.data.idx)
-- end