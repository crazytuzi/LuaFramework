...
-- 		index = index + 1
-- 	end
-- 	BossData.Instance:SetBossPosition(pos_t)
-- 	self:InitEvent()
...
-- 	local data = BossData.Instance:GetBossData()
-- 	local index = 0 
-- 	local cur_data  = {}
...
-- 	local data = BossData.Instance:GetBossPosition()
...
-- 	local bool_enter = BossData.Instance:CanEnter(self.data.boss_pos)
-- 	if bool_enter == true then
-- 		BossCtrl.Instance:OpenPersonalBossTip(self.data.boss_pos, self.data, bool_enter)
-- 	else
