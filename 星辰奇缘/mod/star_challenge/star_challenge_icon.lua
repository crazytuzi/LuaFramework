StarChallengeIcon = StarChallengeIcon or BaseClass(BaseView)

local Vector3 = UnityEngine.Vector3
function StarChallengeIcon:__init(model)
    self.model = model
	self.resList = {
        {file = AssetConfig.starchallengeicon, type = AssetType.Main}
        -- , {file = AssetConfig.halloween_textures, type = AssetType.Dep}
    }

    self.name = "StarChallengeIcon"
...
function StarChallengeIcon:__delete()
...
function StarChallengeIcon:InitPanel()
    self.gameObject = GameObject.Instantiate(self:GetPrefab(AssetConfig.starchallengeicon))
    self.gameObject.name = "StarChallengeIcon"
...
function StarChallengeIcon:Show()
...
function StarChallengeIcon:Hide()
...
function StarChallengeIcon:update()
...
function StarChallengeIcon:button_click()
