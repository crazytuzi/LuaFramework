...
-- 获得宠物
-- -------------------
DramaGetPet = DramaGetPet or BaseClass(BaseDramaPanel)

function DramaGetPet:__init()
...
function DramaGetPet:InitPanel()
...
function DramaGetPet:ShowTitle()
...
function DramaGetPet:PutNewImg()
    self.newImg:SetActive(true)
    self.timeId = LuaTimer.Add(500, function() self:Next() end)
end

function DramaGetPet:ShowButton()
...
function DramaGetPet:PlayAction()
...
function DramaGetPet:ActionDelay()
...
function DramaGetPet:ActionEnd()
...
function DramaGetPet:LoadPreview(modelData)
    self.rawImg:SetActive(false)
...
function DramaGetPet:SetRawImage(composite)
...
--根据模型包围盒计算中心点
function DramaGetPet:SetPosition()
...
function DramaGetPet:OnJump()
end

function DramaGetPet:BeginCountDown()
