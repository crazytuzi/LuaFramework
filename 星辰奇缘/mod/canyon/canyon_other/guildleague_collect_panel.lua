...
-- hzf
-- ---------------------------------------
GuildLeagueCollectPanel = GuildLeagueCollectPanel or BaseClass(BasePanel)

function GuildLeagueCollectPanel:__init()
    self.model = GuildLeagueManager.Instance.model
...
function GuildLeagueCollectPanel:__delete()
...
function GuildLeagueCollectPanel:InitPanel()
    self.gameObject = GameObject.Instantiate(self:GetPrefab(self.path))
    self.gameObject.name = "GuildLeagueCollectPanel"
...
function GuildLeagueCollectPanel:StartUp()
    ...
    print("类型啊啊啊啊啊啊啊啊啊"..tostring(self.openArgs.optype))
...
function GuildLeagueCollectPanel:TimeOut()
...
function GuildLeagueCollectPanel:FixedUpdate()
...
-- 4.点任务寻路
-- -----------------------------------------------
function GuildLeagueCollectPanel:Cancel()
...
function GuildLeagueCollectPanel:ShowEffect()
...
function GuildLeagueCollectPanel:HideEffect()
    if self.unitEffect ~= nil then
