...
-- hosr
-- ----------------------------------
GuideGuardUpgradeThird = GuideGuardUpgradeThird or BaseClass(BasePanel)

function GuideGuardUpgradeThird:__init(panel)
    self.panel = panel
...
function GuideGuardUpgradeThird:__delete()
    self:GuideEnd()
...
function GuideGuardUpgradeThird:InitPanel()
...
function GuideGuardUpgradeThird:First()
    -- 选中花影
    self.gameObject:SetActive(false)

    self.lastGameObject = self.panel.subFirst.BtnOneKey.gameObject
    ...
    TipsManager.Instance:ShowGuide({gameObject = self.lastGameObject, data = TI18N("点击这里一键升级所有装备"), forward = TipsEumn.Forward.Left})
end

function GuideGuardUpgradeThird:Next()
...
function GuideGuardUpgradeThird:GuideEnd()
