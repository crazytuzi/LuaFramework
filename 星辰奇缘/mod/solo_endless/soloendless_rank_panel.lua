SoloEndlessRankpanel = SoloEndlessRankpanel or BaseClass(BasePanel)


function SoloEndlessRankpanel:__init(model)
    self.model = model
...
function SoloEndlessRankpanel:__delete()
...
function SoloEndlessRankpanel:InitPanel()
    ...
    self.gameObject.name = "SoloEndlessRankpanel"
...
function SoloEndlessRankpanel:OnOpen()

end

function SoloEndlessRankpanel:OnHide()

end

function SoloEndlessRankpanel:InitList()
...
function SoloEndlessRankpanel:UpdateList()
    local list = self.Mgr.rankData
...
function SoloEndlessRankpanel:UpdateSelfData()
...
function SoloEndlessRankpanel:InitRankReward()
...
function SoloEndlessRankpanel:SetSlot(base_id, parent, num)
...
function SoloEndlessRankpanel:ShowMate(data)
    if data ~= nil then
