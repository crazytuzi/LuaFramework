-- 天启
-- ljh 20170725
ApocalypseLordTeamPanel = ApocalypseLordTeamPanel or BaseClass(BasePanel)

function ApocalypseLordTeamPanel:__init(model)
    self.model = model
    self.windowId = WindowConfig.WinID.ApocalypseLordteampanel
...
function ApocalypseLordTeamPanel:__delete()
...
function ApocalypseLordTeamPanel:OnClickClose()
    -- WindowManager.Instance:CloseWindow(self)
    self.model:CloseApocalypseLordTeamPanel()
end

function ApocalypseLordTeamPanel:OnInitCompleted()
    self.OnOpenEvent:Fire()
end

function ApocalypseLordTeamPanel:OnOpen()
...
function ApocalypseLordTeamPanel:OnHide()
end

function ApocalypseLordTeamPanel:Update()
    if self.index == 1 then
        self.titleText2.text = TI18N("天启试炼")
    else
        self.titleText2.text = TI18N("天启资格")
    end
...
function ApocalypseLordTeamPanel:OnOkButtonClick()
	if self.data ~= nil then
        ...
        WindowManager.Instance:CloseWindowById(WindowConfig.WinID.ApocalypseLordwindow)
	end
end