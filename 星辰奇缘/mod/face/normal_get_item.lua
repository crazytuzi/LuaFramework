...
-- hosr
-- ---------------------------
NormalGetItem = NormalGetItem or BaseClass()

function NormalGetItem:__init(gameObject, parent)
...
function NormalGetItem:__delete()
...
function NormalGetItem:InitPanel()
...
function NormalGetItem:SetData(data)
    self.type = data.type
