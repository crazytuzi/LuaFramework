...
GameData.LegendaryAspectIntroTextLines =
{
...
GameData.NyxWithChaosTextLines =
{
	"ChaosAboutNyx06",
	"ChaosWithNyx01",
	"ChaosWithNyx02",
...
GameData.AchillesWithPatroclusTextLines =
{
...
GameData.OrpheusWithEurydiceTextLines =
{
...
-- same as above but with one addition at the top
GameData.OrpheusWithEurydiceAltTextLines =
{
...
GameData.MegThanIntermissionTextLines =
{
...
GameData.HadesMiscPartnerTextLines =
{
	"NyxWithHades01",
	"NyxWithHades02",
	"NyxWithHades03",
...
GameData.MegThanPartnerRepeatableTextLines =
{
...
GameData.DusaMegPartnerRepeatableTextLines =
{
...
GameData.MegAchillesPartnerRepeatableTextLines =
{
...
GameData.HypnosThanPartnerRepeatableTextLines =
{
...
GameData.NyxHadesThanPartnerRepeatableTextLines =
{
...
GameData.NyxHadesPersephonePartnerRepeatableTextLines =
{
...
GameData.DusaCerberusPartnerRepeatableTextLines =
{
...
GameData.ArtemisAboutCallistoTextLines = 
{
...
GameData.AresAboutNyxTextLines = 
{
	"AresGift01",
	"NyxGift01",
	"AresAboutNyxIntro01",
...
GameData.ZeusBasicPickUpTextLines =
{
	"ZeusFirstPickUp",
	-- "ZeusMiscPickup01",
	"ZeusMiscPickup02",
...
GameData.PoseidonBasicPickUpTextLines =
{
...
GameData.PoseidonMiscRejectionTextLines =
{
	"PoseidonRejection01",
	"PoseidonRejection02",
	"PoseidonRejection03",
...
GameData.AthenaBasicPickUpTextLines =
{
	"AthenaFirstPickUp",
	-- "AthenaMiscPickup01",
	"AthenaMiscPickup02",
...
GameData.AthenaMiscRejectionTextLines =
{
	"AthenaRejection01",
	"AthenaRejection02",
	"AthenaRejection03",
...
GameData.AresBasicPickUpTextLines =
{
	"AresFirstPickUp",
	"AresMiscPickup01",
	"AresMiscPickup02",
...
GameData.ArtemisBasicPickUpTextLines =
{
	"ArtemisFirstPickUp",
	-- "ArtemisMiscPickup01",
	"ArtemisMiscPickup03",
...
GameData.DionysusBasicPickUpTextLines =
{
	"DionysusFirstPickUp",
...
GameData.DionysusMiscRejectionTextLines =
{
	"DionysusRejection01",
	"DionysusRejection02",
	"DionysusRejection03",
...
GameData.HermesBasicPickUpTextLines =
{
	"HermesFirstPickUp",
	"HermesMiscPickup01",
	"HermesMiscPickup02",
...
GameData.ChaosBasicPickUpTextLines =
{
	"ChaosMiscPickup03",
	"ChaosMiscPickup04",
	"ChaosMiscPickup05",
...
GameData.BouldyRepeatableTextLines =
{
...
GameData.GodHasWeaponVoiceLines =
{
	-- spear
	"AthenaHasWeapon01",
	"ZeusHasWeapon01",
...
-- prevents partner conversations on runs after key events
GameData.PartnerConversationRequirements =
{
	RequiredFalseFlags = { "PersephoneJustReturned" },
...
GameData.MegDusaGossipRequirements =
{
...
-- excludes Lounge and Bedchambers
GameData.MiscCosmetics =
{
	-- count = 58
