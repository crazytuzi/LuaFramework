...
function CCControlDeprecated.removeHandleOfControlEvent(self, controlEvent)
    deprecatedTip("removeHandleOfControlEvent","unregisterControlEventHandler")
    print("come in removeHandleOfControlEvent")
    self:unregisterControlEventHandler(controlEvent)
end
CCControl.removeHandleOfControlEvent = CCControlDeprecated.removeHandleOfControlEvent
