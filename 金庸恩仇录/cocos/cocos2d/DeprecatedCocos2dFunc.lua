...
function CCNotificationCenterDeprecated.sharedNotificationCenter()
    deprecatedTip("CCNotificationCenter:sharedNotificationCenter","cc.__NotificationCenter:getInstance")
    return cc.__NotificationCenter:getInstance()
end
CCNotificationCenter.sharedNotificationCenter = CCNotificationCenterDeprecated.sharedNotificationCenter
--functions of CCDirector will be deprecated,end
...
function CCNodeDeprecated.removeAllChildrenWithCleanup(self,...)
    deprecatedTip("CCNode:removeAllChildrenWithCleanup","cc.Node:removeAllChildren")
    return self:removeAllChildren(...)
end
CCNode.removeAllChildrenWithCleanup = CCNodeDeprecated.removeAllChildrenWithCleanup
...
--czy新加
function CCSpriteDeprecated.setDisplayFrame(self,spriteframe)
    deprecatedTip("CCSpriteDeprecated:setDisplayFrame","Sprite:setSpriteFrame")
    return self:setSpriteFrame(spriteframe)
end
cc.Sprite.setDisplayFrame = CCSpriteDeprecated.setDisplayFrame
--czy新加
function CCSpriteDeprecated.getDisplayFrame(self)
    deprecatedTip("CCSpriteDeprecated:getDisplayFrame","CCSpriteDeprecated:setFlippedY")
    return self:getSpriteFrame()
end
cc.Sprite.getDisplayFrame = CCSpriteDeprecated.getDisplayFrame
