...
function UseDialog:ctor()
	...
	okBtn:setPosition(_width * 0.75 - okBtn:getContentSize().width / 2, okBtn:getContentSize().height * 0.5)
	bg:addChild(okBtn)
	local availNumLabel = ui.newTTFLabel({
	text = common:getLanguageString("@CanUse"),
	...
	text = common:getLanguageString("@InputMaxNumber"),
	color = FONT_COLOR.LIGHT_ORANGE,
	size = 22,
	x = _width / 2,
	y = _height * 0.6,
